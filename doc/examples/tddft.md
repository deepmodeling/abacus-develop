...
- ocp_set : occupations multiplies the number the bands . For example, 2*6 0*6 means the occupations of the lower 6 bands are 2 and the occupations of the higer 6 bands are 0.
