# ##############################################################################
# * Find TensorFlow Find the native TensorFlow libraries.
#
# TensorFlow_FOUND        - True if lib is found. TensorFlow_LIBRARIES    - List
# of libraries
...
# Handle the QUIET and REQUIRED arguments and set TensorFlow_FOUND to TRUE if
...
if(TensorFlow_FOUND)
  if(NOT TARGET TensorFlow::tensorflow_cc)
    ...
    set_target_properties(
      TensorFlow::tensorflow_cc PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C"
