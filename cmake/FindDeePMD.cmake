...
# C++ API
find_path(
  DeePMD_INCLUDE_DIR deepmd/DeepPot.h
  HINTS ${DeePMD_DIR}
  PATH_SUFFIXES "include")
find_library(
  deepmd_cc
...
# Handle the QUIET and REQUIRED arguments and set DeePMD_FOUND to TRUE if all
# variables are non-zero.
include(FindPackageHandleStandardArgs)
if(DeePMD_INCLUDE_C_DIR)
  find_package_handle_standard_args(DeePMD DEFAULT_MSG deepmd_c
  ...
  find_package_handle_standard_args(DeePMD DEFAULT_MSG deepmd_cc
                                    DeePMD_INCLUDE_DIR)
  if(DeePMD_FOUND)
