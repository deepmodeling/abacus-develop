...
if(NOT TARGET MKL::MKL)
  ...
  if(ENABLE_MPI)
    ...
    find_package_handle_standard_args(MKL MKL_INTERFACE_LIB MKL_THREAD MKL_CORE
                                      MKL_INCLUDE)
  endif()
  ...
  if(MKL_FOUND)
    ...
    if(ENABLE_MPI)
      ...
      set_property(
        TARGET MKL::MKL
        PROPERTY INTERFACE_LINK_LIBRARIES "-Wl,--start-group"
                 MKL::INTERFACE_LIB MKL::THREAD MKL::CORE "-Wl,--end-group")
    endif()
    if(TARGET MKL::IOMP5)
      set_property(
        TARGET MKL::MKL
        APPEND
        PROPERTY INTERFACE_LINK_LIBRARIES MKL::IOMP5)
    endif()
  endif()

  if(ENABLE_MPI)
    mark_as_advanced(MKL_INCLUDE MKL_INTERFACE_LIB MKL_THREAD MKL_CORE
                     MKL_SCALAPACK MKL_BLACS)
  else()
    mark_as_advanced(MKL_INCLUDE MKL_INTERFACE_LIB MKL_THREAD MKL_CORE)
  endif()
