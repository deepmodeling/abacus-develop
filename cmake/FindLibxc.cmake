...
# Using pkg-config interface as default, to avoid linking to wrong global
# visible Libxc instead of specified one. NO REQUIRED here, otherwhile it would
# throw error with no LibXC found.
find_package(PkgConfig)
if(PKG_CONFIG_FOUND)
  pkg_search_module(Libxc IMPORTED_TARGET GLOBAL libxc)
  find_package_handle_standard_args(Libxc DEFAULT_MSG Libxc_LINK_LIBRARIES
                                    Libxc_FOUND)
endif()
if(NOT Libxc_FOUND)
  find_package(Libxc REQUIRED HINTS ${Libxc_DIR}/share/cmake/Libxc
               ${Libxc_DIR}/lib/cmake/Libxc ${Libxc_DIR}/lib64/cmake/Libxc)
endif()

# Copy the results to the output variables and target. if find_package() above
# works, Libxc::xc would be present and below would be skipped.
