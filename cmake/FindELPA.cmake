...
find_path(
  ELPA_INCLUDE_DIRS elpa/elpa.h
  HINTS ${ELPA_DIR}
  PATH_SUFFIXES "include" "include/elpa")
# Fix #3589 First if judges if ELPA dir specified
...
# Incompatible with ELPA earlier than 2021.11.001 Before ELPA 2021.11.001, its
# pkg-config file is named like "elpa-2021.05.002.pc".
...
# Handle the QUIET and REQUIRED arguments and set ELPA_FOUND to TRUE if all
# variables are non-zero.
include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(ELPA DEFAULT_MSG ELPA_LINK_LIBRARIES
                                  ELPA_INCLUDE_DIRS)
...
if(NOT ELPA_VERSION_SATISFIES)
  message(
    FATAL_ERROR "ELPA version is too old. We support version 2021 or higher.")
endif()
