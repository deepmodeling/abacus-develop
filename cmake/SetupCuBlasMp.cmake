...
function(abacus_setup_cublasmp target_name)
  ...
  # 1. Search for cuBLASMp library and header files libcublasmp.so
  find_library(
    CUBLASMP_LIBRARY
    NAMES cublasmp
  ...
  # 1. Version validation by parsing header macros
  ...
  # 1. Version constraint: ABACUS requires cuBLASMp >= 0.8.0
  ...
  # 1. Create cublasMp::cublasMp imported target
  if(NOT TARGET cublasMp::cublasMp)
    add_library(cublasMp::cublasMp IMPORTED INTERFACE)
    set_target_properties(
      cublasMp::cublasMp
      PROPERTIES INTERFACE_LINK_LIBRARIES "${CUBLASMP_LIBRARY};NCCL::NCCL"
                 INTERFACE_INCLUDE_DIRECTORIES "${CUBLASMP_INCLUDE_DIR}")
  endif()

  # 1. Link the library to the target
