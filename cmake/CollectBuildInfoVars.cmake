...
if(ENABLE_MPI)
    ...
    elseif("${MPI_CXX_LIBRARY_VERSION_STRING}" MATCHES "Open MPI")
    ...
    set(ABACUS_MPI_VERSION "(MPI standard: ${MPI_CXX_VERSION})")
    if(USE_CUDA)           
        # OpenMPI hint
        ...
        if(OMPI_INFO_EXECUTABLE)
            ...
            if(OMPI_INFO_OUT MATCHES "mpi_built_with_cuda_support:value:true")
                if(USE_CUDA_MPI)
                  ...
                  set(ABACUS_CUDA_AWARE_MPI "no (available but not enabled)")
                endif()
            else()
...
if(ENABLE_LCAO)
  set(ABACUS_LCAO_ENABLED "True")
  if(ENABLE_FFT_TWO_CENTER)
    set(ABACUS_TWO_CENTER_FFT "Enabled")
  else()
    set(ABACUS_TWO_CENTER_FFT "Disabled")
  endif()
else()
...
if(MKL_FOUND)
  ...
  set(ABACUS_FFTW_VERSION "Using MKL")
  ...
  if(USE_SW)
    set(ABACUS_BLAS_VENDOR "SW")
    set(ABACUS_FFTW_VERSION "Using SW")
  elseif(USE_KML)
    set(ABACUS_BLAS_VENDOR "KML")
    set(ABACUS_FFTW_VERSION "Using KML")
  else()
    set(ABACUS_BLAS_VENDOR "Generic BLAS")
    if(FFTW3_VERSION)
...
# ML & AI Libraries
if(ENABLE_MLALGO)
  set(ABACUS_MLALGO "Enabled")
else()
  set(ABACUS_MLALGO "Disabled")
endif()
...
# ==============================================================================
message(" ===================================================================")
message("                       ABACUS Build Summary                         ")
message(" ===================================================================")
message(" Build Type        : ${ABACUS_BUILD_TYPE}")
message(" Platform          : ${ABACUS_PLATFORM_NAME}")
message(" Compiler          : ${ABACUS_CXX_COMPILER_ID} ${ABACUS_CXX_COMPILER_VERSION}")
message(" -------------------------------------------------------------------")
message(" MPI Support       : ${ABACUS_MPI_IMPLEMENTATION} ${ABACUS_MPI_VERSION}")
message(" CUDA-Aware MPI    : ${ABACUS_CUDA_AWARE_MPI}")
message(" OpenMP Support    : ${ABACUS_OPENMP_VERSION}")
message(" -------------------------------------------------------------------")
message(" LCAO Enabled      : ${ABACUS_LCAO_ENABLED}")
if(ENABLE_LCAO)
  message(" Two-center FFT    : ${ABACUS_TWO_CENTER_FFT}")
endif()
message(" -------------------------------------------------------------------")
...
if(ENABLE_ABACUS_LIBM)
  message("                     Internal libmath enabled")
endif()
...
if(USE_CUDA)
  ...
  message("                     NCCL parallel  = ${ABACUS_NCCL_PARA}")
endif()
message("                     HIP/ROCm       = ${ABACUS_ROCM_VERSION}")
message(" Machine Learning  : MLALGO         = ${ABACUS_MLALGO}")
message("                     Torch          = ${ABACUS_LIBTORCH_VERSION}")
...
if(ENABLE_EXX_DEV)
  message("                                      (Developing features enabled)")
endif()
