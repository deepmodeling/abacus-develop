...
# ==============================================================================
message(STATUS "===================================================================")
message(STATUS "                      ABACUS Build Summary                         ")
message(STATUS "===================================================================")
message(STATUS "Build Type        : ${ABACUS_BUILD_TYPE}")
message(STATUS "Platform          : ${ABACUS_PLATFORM_NAME}")
message(STATUS "Compiler          : ${ABACUS_CXX_COMPILER_ID} ${ABACUS_CXX_COMPILER_VERSION}")
message(STATUS "-------------------------------------------------------------------")
message(STATUS "MPI Support       : ${ABACUS_MPI_IMPLEMENTATION} ${ABACUS_MPI_VERSION}")
message(STATUS "CUDA-Aware MPI    : ${ABACUS_CUDA_AWARE_MPI}")
message(STATUS "OpenMP Support    : ${ABACUS_OPENMP_VERSION}")
message(STATUS "-------------------------------------------------------------------")
message(STATUS "LCAO Enabled      : ${ABACUS_LCAO_ENABLED}")
message(STATUS "-------------------------------------------------------------------")
message(STATUS "Math Libraries    : MKL    = ${ABACUS_MKL_SUPPORT}")
message(STATUS "                    FFTW   = ${ABACUS_FFTW_VERSION}")
message(STATUS "                    ELPA   = ${ABACUS_ELPA_VERSION}")
message(STATUS "Accelerators      : CUDA   = ${ABACUS_CUDA_VERSION}")
message(STATUS "                    ROCm   = ${ABACUS_ROCM_VERSION}")
message(STATUS "Machine Learning  : Torch  = ${ABACUS_LIBTORCH_VERSION}")
message(STATUS "                    DeePMD = ${ABACUS_DEEPMD_VERSION}")
message(STATUS "                    NEP    = ${ABACUS_NEP_VERSION}")
message(STATUS "Features          : Libxc  = ${ABACUS_LIBXC_VERSION}")
message(STATUS "                    LibRI  = ${ABACUS_LIBRI_VERSION}")
message(STATUS "===================================================================")
