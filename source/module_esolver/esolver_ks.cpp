...
namespace ModuleESolver
{
    ...
    void ESolver_KS::Init(Input& inp, UnitCell_pseudo& ucell)
    {
        ...
        {
            XC_Functional::set_xc_type(ucell.atoms[0].atom_pp.xc_func);
        }
        else if (ucell.atoms[0].atom_pp.xc_func == "HSE" || ucell.atoms[0].atom_pp.xc_func == "PBE0")
        {
            XC_Functional::set_xc_type("pbe");
        }
        else if (ucell.atoms[0].atom_pp.xc_func == "SCAN0")
        {
