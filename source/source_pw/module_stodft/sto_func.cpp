...
template <typename REAL>
void
    Sto_Func<REAL>::set_E_range (REAL* Emin_in, REAL* Emax_in)
{
    Emin = Emin_in;
    Emax = Emax_in;
}
...
template <typename REAL>
REAL
    Sto_Func<REAL>::root_fd (REAL e) const
{
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nroot_fd (REAL e) const
{
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nfd (REAL e) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL ne_mu = (e * DeltaE + Ebar - mu) / this->tem;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nxfd (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::fdlnfd (REAL e) const
{
    REAL e_mu = (e - mu) / this->tem;
    if (e_mu > 36)
        {
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nfdlnfd (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::n_root_fdlnfd (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL ne_mu = (rawe * DeltaE + Ebar - mu) / this->tem;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nroot_mfd (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL ne_mu = (rawe * DeltaE + Ebar - mu) / this->tem;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::ncos (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL e = rawe * DeltaE + Ebar;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nsin (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL e = rawe * DeltaE + Ebar;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::n_sin (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL e = rawe * DeltaE + Ebar;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::gauss (REAL e) const
{
...
template <typename REAL>
REAL
    Sto_Func<REAL>::ngauss (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL e = rawe * DeltaE + Ebar;
...
template <typename REAL>
REAL
    Sto_Func<REAL>::nroot_gauss (REAL rawe) const
{
    REAL Ebar = (*Emin + *Emax) / 2;
    REAL DeltaE = (*Emax - *Emin) / 2;
    REAL e = rawe * DeltaE + Ebar;
