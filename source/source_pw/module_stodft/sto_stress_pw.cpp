...
void
    Sto_Stress_PW<FPTYPE, Device>::cal_stress (ModuleBase::matrix& sigmatot,
...
template <typename FPTYPE, typename Device>
void
    Sto_Stress_PW<FPTYPE, Device>::sto_stress_kin (ModuleBase::matrix& sigma,
...
template <typename FPTYPE, typename Device>
void
    Sto_Stress_PW<FPTYPE, Device>::sto_stress_nl (ModuleBase::matrix& sigma,
                                                  const ModuleBase::matrix& wg,
                                                  Structure_Factor* p_sf,
                                                  ModuleSymmetry::Symmetry* p_symm,
                                                  K_Vectors* p_kv,
