...
void
    elecstate::Potential::cal_v_eff (Charge const*, UnitCell const*, ModuleBase::matrix&)
{
}
void
    elecstate::Potential::cal_fixed_v (double*)
{
}
...
template <typename T, typename Device>
void
    hamilt::HamiltPW<T, Device>::updateHk (int)
{
}
template <typename T, typename Device>
void
    hamilt::HamiltPW<T, Device>::sPsi (T const*, T*, const int, const int, const int) const
{
}
