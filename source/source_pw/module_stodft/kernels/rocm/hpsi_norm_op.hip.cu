...
template <typename FPTYPE>
void
    hamilt::hpsi_norm_op<FPTYPE, base_device::DEVICE_GPU>::operator() (const base_device::DEVICE_GPU* dev,
                                                                       const int& nbands,
                                                                       const int& npwk_max,
                                                                       const int& npwk,
                                                                       const FPTYPE& Ebar,
                                                                       ...
                                                                       const std::complex<FPTYPE>* psi_in)
{
    ...
    hipLaunchKernelGGL (HIP_KERNEL_NAME (hpsi_norm<FPTYPE>),
                        dim3 (nbands),
