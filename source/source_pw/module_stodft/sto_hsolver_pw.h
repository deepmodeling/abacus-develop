#ifndef STO_HSOLVER_PW_H
#define STO_HSOLVER_PW_H
#include "source_hsolver/hsolver_pw.h"
#include "source_pw/module_stodft/sto_hamilt_pw.h"
#include "source_pw/module_stodft/sto_iter.h"
template <typename T, typename Device = base_device::DEVICE_CPU>
class StoHSolverPW : public hsolver::HSolverPW<T, Device>
{
  protected:
    using Real = typename GetTypeReal<T>::type;

  public:
    StoHSolverPW(K_Vectors* pkv,
                 ...
                 const int bndpar_in)
        : hsolver::HSolverPW<T, Device>(wfc_basis_in,
                                        calculation_type_in,
                                        basis_type_in,
                                        method_in,
                                        use_uspp_in,
