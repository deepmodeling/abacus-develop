 ...
 */
double
    KEDF_ML::get_energy (const double* const* prho, ModulePW::PW_Basis* pw_rho)
{
 ...
 */
void
    KEDF_ML::ml_potential (const double* const* prho, ModulePW::PW_Basis* pw_rho, ModuleBase::matrix& rpotential)
{
    this->updateInput (prho, pw_rho);
 ...
 */
void
    KEDF_ML::generateTrainData (const double* const* prho, ModulePW::PW_Basis* pw_rho, const double* veff)
{
 ...
 */
void
    KEDF_ML::localTest (const double* const* pprho, ModulePW::PW_Basis* pw_rho)
{
    // for test =====================
