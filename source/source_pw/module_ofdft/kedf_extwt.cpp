...
void KEDF_ExtWT::update_rho0(const double* const* prho, ModulePW::PW_Basis* pw_rho) {
...
void KEDF_ExtWT::cal_kernel(double tf_weight, double vw_weight, double rho0, ModulePW::PW_Basis* pw_rho) {
    this->rho0_ = rho0;
