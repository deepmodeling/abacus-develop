...
void
    Evolve_OFDFT::cal_Hpsi (elecstate::ElecState* pelec,
                            Charge& chr,
                            UnitCell& ucell,
...
void
    Evolve_OFDFT::renormalize_psi (Charge& chr, ModulePW::PW_Basis* pw_rho, std::vector<std::complex<double>>& pphi_)
{
...
void
    Evolve_OFDFT::cal_tf_potential (const double* const* prho, ModulePW::PW_Basis* pw_rho, ModuleBase::matrix& rpot)
{
...
void
    Evolve_OFDFT::cal_vw_potential_phi (std::vector<std::complex<double>>& pphi,
                                        ModulePW::PW_Basis* pw_rho,
                                        std::vector<std::complex<double>>& Hpsi)
{
...
void
    Evolve_OFDFT::cal_CD_potential (std::vector<std::complex<double>>& psi_,
                                    ModulePW::PW_Basis* pw_rho,
...
void
    Evolve_OFDFT::propagate_psi_RK4 (elecstate::ElecState* pelec,
                                     Charge& chr,
                                     UnitCell& ucell,
            ...
            for (int ir = 0; ir < pw_rho->nrxx; ++ir)
                {
                    ...
                    pphi_[is * nrxx + ir] += 1.0 / 6.0
                                             * (K1[is * nrxx + ir] + 2.0 * K2[is * nrxx + ir] + 2.0 * K3[is * nrxx + ir]
                                                + K4[is * nrxx + ir]);
                }
        }
...
void
    Evolve_OFDFT::propagate_psi_RK2 (elecstate::ElecState* pelec,
                                     Charge& chr,
                                     UnitCell& ucell,
                                     std::vector<std::complex<double>>& pphi_,
                                     ModulePW::PW_Basis* pw_rho)
