...
void
    Exx_Helper<T, Device>::init (const UnitCell& ucell, const Input_para& inp, const ModuleBase::matrix& wg)
{
...
template <typename T, typename Device>
void
    Exx_Helper<T, Device>::before_scf (void* p_hamilt, void* psi, const Input_para& inp)
{
...
template <typename T, typename Device>
bool
    Exx_Helper<T, Device>::iter_finish (void* p_elec,
                                        Charge* p_charge,
                                        void* psi,
                                        UnitCell& ucell,
...
template <typename T, typename Device>
double
    Exx_Helper<T, Device>::cal_exx_energy (void* psi_)
{
...
template <typename T, typename Device>
bool
    Exx_Helper<T, Device>::exx_after_converge (int& iter, bool ene_conv)
{
...
template <typename T, typename Device>
void
    Exx_Helper<T, Device>::set_psi (void* psi_)
{
