...
void
    pw::teardown_pwwfc (ModulePW::PW_Basis_K*& pw_wfc)
{
    delete pw_wfc;
}

void
    pw::setup_pwwfc (const Input_para& inp,
                     ...
                     ModulePW::PW_Basis_K*& pw_wfc)
{
    ...
    pw_wfc->initgrids (inp.ref_cell_factor * ucell.lat0, ucell.latvec, pw_rho.nx, pw_rho.ny, pw_rho.nz);
