...
void
    Forces<FPTYPE, Device>::cal_force_scc (ModuleBase::matrix& forcescc,
                            ...
                            if (nt == it)
                                {
                                    ...
                                    double &force0 = forcescc (iat, 0), &force1 = forcescc (iat, 1),
...
template <typename FPTYPE, typename Device>
void
    Forces<FPTYPE, Device>::deriv_drhoc_scc (const bool& numeric,
                                             const int mesh,
                                             const FPTYPE* r,
                                             const FPTYPE* rab,
                                             const FPTYPE* rhoc,
