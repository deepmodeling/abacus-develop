...
std::complex<double>*
    Structure_Factor::get_sk (const int ik, const int it, const int ia, const ModulePW::PW_Basis_K* wfc_basis) const
{
...
void
    Structure_Factor::get_sk (Device* ctx,
                              const int ik,
...
std::complex<double>*
    Structure_Factor::get_skq (int ik,
                               const int it,
                               const int ia,
                               const ModulePW::PW_Basis_K* wfc_basis,
