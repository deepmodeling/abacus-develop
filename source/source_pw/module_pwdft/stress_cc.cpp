...
void
    Stress_Func<FPTYPE, Device>::stress_cc (ModuleBase::matrix& sigma,
                                        ...
                                        for (int m = 0; m < 3; m++)
                                            {
                                                ...
                                                const std::complex<FPTYPE> t = conj (psic[ig]) * p_sf->strucFac (nt, ig)
                                                                               * rhocg[rho_basis->ig2igg[ig]]
                                                                               * ucell.tpiba * rho_basis->gcar[ig][l]
...
template <typename FPTYPE, typename Device>
void
    Stress_Func<FPTYPE, Device>::deriv_drhoc (const bool& numeric,
                                              const double& omega,
                                              const double& tpiba2,
                                              const int mesh,
                                              const FPTYPE* r,
