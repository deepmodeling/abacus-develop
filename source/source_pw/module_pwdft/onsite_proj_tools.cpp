...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::allocate_memory (const ModuleBase::matrix& wg,
                                                        const ModuleBase::matrix& ekb,
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::delete_memory ()
{
    // delete memory
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::cal_becp (int ik,
                                                 int npm,
                    ...
                    for (int ia = 0; ia < h_atom_na[it]; ia++)
                        {
                            ...
                            vkb_ptr
                                += nh
                                   * npw; // vkb_ptr has dimension (nhtot, npwx), this size will be the largest needed.
                            d_sk += npw;
                            // vkb_size += nh * npw;
                        }
                }
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::cal_dbecp_s (int ik, int npm, int ipol, int jpol)
{
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::cal_dbecp_f (int ik, int npm, int ipol)
{
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::save_vkb (int npw, int ipol)
{
    if (this->device == base_device::CpuDevice)
        {
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::revert_vkb (int npw, int ipol)
{
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::transfer_gcar (int npw, int npw_max, const FPTYPE* gcar_in)
{
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::cal_force_dftu (int ik,
                                                       int npm,
                                                       FPTYPE* force,
...
template <typename FPTYPE, typename Device>
void
    Onsite_Proj_tools<FPTYPE, Device>::cal_force_dspin (int ik,
                                                        int npm,
                                                        FPTYPE* force,
...
template <typename FPTYPE, typename Device>
double
    Onsite_Proj_tools<FPTYPE, Device>::cal_stress_dftu (int ik,
                                                        int npm,
                                                        const int* orb_corr,
                                                        const std::complex<FPTYPE>* vu,
                                                        const int size_vu,
...
template <typename FPTYPE, typename Device>
double
    Onsite_Proj_tools<FPTYPE, Device>::cal_stress_dspin (int ik,
                                                         int npm,
                                                         const ModuleBase::Vector3<double>* lambda,
                                                         const FPTYPE* h_wg)
{
