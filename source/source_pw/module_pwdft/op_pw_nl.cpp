                                           ...
                                           const ModulePW::PW_Basis_K* wfc_basis)
{
    if (isk_in == nullptr || ppcell_in == nullptr || ucell_in == nullptr)
        {
            ModuleBase::WARNING_QUIT ("NonlocalPW",
                                      "Constuctor of Operator::NonlocalPW is failed, please check your code!");
        }
...
template <typename T, typename Device>
void
    Nonlocal<OperatorPW<T, Device>>::init (const int ik_in)
{
...
template <typename T, typename Device>
void
    Nonlocal<OperatorPW<T, Device>>::add_nonlocal_pp (T* hpsi_in, const T* becp, const int m) const
{
            ...
            for (int it = 0; it < this->ucell->ntype; it++)
                {
                    ...
                    nonlocal_op () (this->ctx, // device context
                                    ...
                                    this->ppcell->deeq.getBound4 (), // realArray operator()
                                    this->deeq,                      // array of data
                                    this->ps,
                                    this->becp); //  array of data
                    // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    ...
                    //                     += this->ppcell->deeq(current_spin, iat, ip, ip2) * this->becp[ib * nkb + sum
                    //                     + ip];
                    //             } // end ib
                    //         } // end ih
                    //     } // end jh
            ...
            for (int it = 0; it < this->ucell->ntype; it++)
                {
                    ...
                    nonlocal_op () (this->ctx, // device context
                                    ...
                                    this->ppcell->deeq_nc.getBound4 (), // realArray operator()
...
template <typename T, typename Device>
void
    Nonlocal<OperatorPW<T, Device>>::act (const int nbands,
                                          const int nbasis,
                                          const int npol,
                                          const T* tmpsi_in,
                                          T* tmhpsi,
