...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::allocate_memory (const ModuleBase::matrix& wg, const ModuleBase::matrix* p_ekb)
{
    // allocate memory
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::delete_memory ()
{
    // delete memory
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_vkb (const int& ik, const int& nbdall)
{
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_becp (const int& ik,
                                                 const int& npm,
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::reduce_pool_becp (const int& npm)
{
    const int npol = this->ucell_->get_npol ();
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_vkb_deri_s (const int& ik,
                                                       const int& nbdall,
                                                       const int& ipol,
                                                       const int& jpol)
{
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_dbecp_s (const int& ik,
                                                    const int& npm,
                                                    const std::complex<FPTYPE>* ppsi,
                                                    const int& nbd0)
{
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_stress (const int& ik,
                                                   const int& npm,
                                                   const bool& occ,
                                                   const int& ipol,
                                                   const int& jpol,
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_vkb_deri_f (const int& ik, const int& nbdall, const int& ipol)
{
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_dbecp_f (const int& ik,
                                                    const int& nbdall,
                                                    const int& npm,
                                                    const int& ipol,
                                                    const std::complex<FPTYPE>* ppsi,
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::save_vkb (const int& ik, const int& ipol)
{
    const int npw = this->wfc_basis_->npwk[ik];
    if (this->device == base_device::CpuDevice)
        {
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::revert_vkb (const int& ik, const int& ipol)
{
    const int npw = this->wfc_basis_->npwk[ik];
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::transfer_gcar (const int& npw, const int& npw_max, const FPTYPE* gcar_in)
{
...
template <typename FPTYPE, typename Device>
void
    FS_Nonlocal_tools<FPTYPE, Device>::cal_force (const int& ik,
                                                  const int& nbdall,
                                                  const int& npm,
                                                  const bool& occ,
                                                  FPTYPE* force,
