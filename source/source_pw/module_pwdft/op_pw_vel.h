...
class Velocity
{
  ...
  private:
    ...
    std::complex<FPTYPE>* gradvkb_
        = nullptr;           ///<[Device, 3*nkb * npwk_max] gradient of nonlocal pseudopotential gradvkb
    ...
    using castmem_complex_h2d_op = base_device::memory::
        cast_memory_op<std::complex<FPTYPE>, std::complex<double>, Device, base_device::DEVICE_CPU>;
