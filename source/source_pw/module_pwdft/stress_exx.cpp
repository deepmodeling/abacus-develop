...
void
    Stress_PW<FPTYPE, Device>::stress_exx (ModuleBase::matrix& sigma,
                            ...
                            for (int mband = 0; mband < d_psi_in->get_nbands (); mband++)
                                {
                                    ...
                                    for (int ig = 0; ig < rhopw->nrxx; ig++)
                                        {
                                            density_real[ig]
                                                = psi_nk_real[ig] * std::conj (psi_mq_real[ig]) * omega_inv;
                                        }
