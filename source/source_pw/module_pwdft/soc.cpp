...
void
    Fcoef::create (const int i1, const int i2, const int i3)
{
...
double
    Soc::spinor (const int l, const double j, const int m, const int spin) const
{
    if (spin != 0 && spin != 1)
        {
...
int
    Soc::sph_ind (const int l, const double j, const int m, const int spin) const
{
