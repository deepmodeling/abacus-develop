...
template <typename T, typename Device>
void
    HamiltPW<T, Device>::updateHk (const int ik)
{
    ...
    while (node != nullptr)
        {
            if (node->classname == "Ekinetic")
                ...
                {
                    Operator<T, Device>* veff = new Veff<OperatorPW<T, Device>> (
                ...
                {
                    Operator<T, Device>* meta = new Meta<OperatorPW<T, Device>> (
...
template <typename T, typename Device>
void
    HamiltPW<T, Device>::sPsi (const T* psi_in, // psi
                               T* spsi,         // spsi
...
template <typename T, typename Device>
void
    HamiltPW<T, Device>::set_exx_helper (Exx_Helper<T, Device>& exx_helper)
{
    auto op = this->ops;
    while (op != nullptr)
        {
