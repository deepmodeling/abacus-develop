...
void
    Stress_Func<FPTYPE, Device>::stress_loc (const UnitCell& ucell,
...
template <typename FPTYPE, typename Device>
void
    Stress_Func<FPTYPE, Device>::dvloc_of_g (const int& msh,
                                             const FPTYPE* rab,
                                             const FPTYPE* r,
...
template <typename FPTYPE, typename Device>
void
    Stress_Func<FPTYPE, Device>::dvloc_coulomb (const UnitCell& ucell,
                                                const FPTYPE& zp,
                                                FPTYPE* dvloc,
                                                ModulePW::PW_Basis* rho_basis)
{
