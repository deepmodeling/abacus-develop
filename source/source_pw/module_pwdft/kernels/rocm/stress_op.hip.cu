...
{
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_dbecp_noevc_nl<FPTYPE>),
                        dim3 (nkb),
...
void
    cal_stress_nl_op<FPTYPE, base_device::DEVICE_GPU>::operator() (const base_device::DEVICE_GPU* ctx,
                                                                   ...
                                                                   FPTYPE* stress)
{
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_stress_nl<FPTYPE>),
                                                             ...
                                                             std::complex<FPTYPE>* vkbs_out)
{
    ...
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_vkb<FPTYPE>),
                        gridsize,
                        THREADS_PER_BLOCK,
                        0,
                        0,
                                                                  ...
                                                                  std::complex<FPTYPE>* vkbs_out)
{
    ...
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_vkb_deri<FPTYPE>),
                        gridsize,
                        THREADS_PER_BLOCK,
                        0,
                        0,
                                                            ...
                                                            FPTYPE* vq)
{
    ...
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_vq<FPTYPE>),
                        gridsize,
                        THREADS_PER_BLOCK,
                        0,
                        0,
                                                                 ...
                                                                 FPTYPE* vq)
{
    const int block = (npw + THREADS_PER_BLOCK - 1) / THREADS_PER_BLOCK;
    dim3 gridsize (block, nbeta);
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_vq_deri<FPTYPE>),
                        gridsize,
                        THREADS_PER_BLOCK,
                        0,
                        0,
                                                                          ...
                                                                          int type)
{
    ...
    if (type == 0)
        {
            hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_stress_drhoc_aux0<FPTYPE>),
                                block,
                                THREADS_PER_BLOCK,
                                0,
                                0,
        ...
        {
            hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_stress_drhoc_aux1<FPTYPE>),
                                block,
                                THREADS_PER_BLOCK,
                                0,
                                0,
        ...
        {
            hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_stress_drhoc_aux2<FPTYPE>),
                                block,
                                THREADS_PER_BLOCK,
                                0,
                                0,
        ...
        {
            hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_stress_drhoc_aux3<FPTYPE>),
                                block,
                                THREADS_PER_BLOCK,
                                0,
                                0,
...
void
    cal_force_npw_op<FPTYPE, base_device::DEVICE_GPU>::operator() (const std::complex<FPTYPE>* psiv,
                                                                   ...
                                                                   const int na)
{
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_force_npw<FPTYPE>),
                        na,
                        THREADS_PER_BLOCK,
                        0,
                        0,
                                                                   ...
                                                                   const std::complex<FPTYPE>* psi)
{
    ...
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_multi_dot<FPTYPE>),
                        dim3 (block),
                        dim3 (THREADS_PER_BLOCK),
                        0,
                        0,
...
void
    cal_stress_nl_op<FPTYPE, base_device::DEVICE_GPU>::operator() (const base_device::DEVICE_GPU* ctx,
                                                                   ...
                                                                   FPTYPE* stress)
{
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_stress_onsite<FPTYPE>),
                        dim3 (nbands_occ * ntype),
                        dim3 (THREADS_PER_BLOCK),
                        0,
                        0,
