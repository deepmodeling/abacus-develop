...
template <typename FPTYPE>
void
    hamilt::ekinetic_pw_op<FPTYPE, base_device::DEVICE_GPU>::operator() (const base_device::DEVICE_GPU* dev,
                                                                         const int& nband,
                                                                         const int& npw,
                                                                         const int& max_npw,
                                                                         const bool& is_first_node,
                                                                         ...
                                                                         const std::complex<FPTYPE>* tmpsi_in)
{
    ...
    // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    hipLaunchKernelGGL (HIP_KERNEL_NAME (ekinetic_pw<FPTYPE>),
                        dim3 (nband),
