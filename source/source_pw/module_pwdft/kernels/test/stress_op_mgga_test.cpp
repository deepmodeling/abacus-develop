...
TYPED_TEST(StressMggaTest, cal_stress_mgga_op) {
    ...
    ct::Tensor gradwfc = std::move(ct::Tensor({static_cast<Type>(0.0000001909712),
                                               static_cast<Type>(-0.0000001687233),
                                               static_cast<Type>(-0.0000002392604),
                                               static_cast<Type>(0.0000000154653),
                                               static_cast<Type>(0.0000004211339),
                                               static_cast<Type>(0.0000007242030),
                                               static_cast<Type>(0.0000007559914),
                                               static_cast<Type>(0.0000005232479),
                                               static_cast<Type>(0.0000001903915),
                                               static_cast<Type>(-0.0000000207916),
                                               static_cast<Type>(0.0000000366767),
                                               static_cast<Type>(0.0000003353377)})
                                       .to_device<Device>());

    ct::Tensor crosstaus =
        std::move(ct::Tensor(ct::DataTypeToEnum<Real>::value, ct::DeviceTypeToEnum<Device>::value, {nrxx * 6}));
    crosstaus.zero();
