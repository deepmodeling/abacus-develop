...
template <typename FPTYPE>
__global__ void cal_force_nl(const int ntype,
                             const int deeq_2,
                             const int deeq_3,
                             const int deeq_4,
                             const int forcenl_nc,
...
template <typename FPTYPE>
__global__ void force_loc_kernel(const int nat,
                                 const int npw,
...
template <typename FPTYPE>
__global__ void force_ew_kernel(const int nat,
                                const int npw,
                                const int ig_gge0,
                                const int* iat2it,
                                const FPTYPE* gcar_d,
...
template <typename FPTYPE>
void cal_force_loc_op<FPTYPE, base_device::DEVICE_GPU>::operator()(const int nat,
                                                                   const int npw,
                                                                   const FPTYPE tpiba_omega,
                                                                   const int* iat2it,
                                                                   const int* ig2igg,
...
template <typename FPTYPE>
void cal_force_ew_op<FPTYPE, base_device::DEVICE_GPU>::operator()(const int nat,
                                                                  const int npw,
                                                                  const int ig_gge0,
                                                                  const int* iat2it,
                                                                  const FPTYPE* gcar,
