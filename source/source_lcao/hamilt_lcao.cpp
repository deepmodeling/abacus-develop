    ...
    if (std::is_same<TK, double>::value)
        {
            ...
            if (PARAM.inp.vnl_in_h)
                {
                    Operator<TK>* nonlocal
                        = new Nonlocal<OperatorLCAO<TK, TR>> (this->hsk,
                                                              this->kv->kvec_d,
                                                              this->hR,
                                                              &ucell,
                                                              orb.cutoffs (),
            ...
            if (PARAM.inp.deepks_scf)
                {
                    Operator<TK>* deepks_op
                        = new DeePKS<OperatorLCAO<TK, TR>> (this->hsk,
                                                            this->kv->kvec_d,
                                                            this->hR, // no explicit call yet
                                                            &ucell,
                                                            &grid_d,
    ...
    // multi-k-points case to initialize HamiltLCAO, ops will be used
    else if (std::is_same<TK, std::complex<double>>::value)
        {
            ...
            if (PARAM.inp.esolver_type == "tddft" && PARAM.inp.td_stype == 2)
                {
                    Operator<TK>* td_pot_hybrid
                        = new TD_pot_hybrid<OperatorLCAO<TK, TR>> (this->hsk,
                                                                   this->kv,
                                                                   this->hR,
                                                                   this->sR,
                                                                   orb,
            ...
            if (PARAM.inp.sc_mag_switch)
                {
                    Operator<TK>* sc_lambda
                        = new DeltaSpin<OperatorLCAO<TK, TR>> (this->hsk,
                                                               this->kv->kvec_d,
                                                               this->hR,
                                                               ucell,
                                                               &grid_d,
...
template <typename TK, typename TR>
std::vector<HContainer<TR>*>
    HamiltLCAO<TK, TR>::getHR_vector ()
{
    if (PARAM.inp.nspin == 2)
        {
...
template <typename TK, typename TR>
void
    HamiltLCAO<TK, TR>::matrix (MatrixBlock<TK>& hk_in, MatrixBlock<TK>& sk_in)
{
...
template <typename TK, typename TR>
void
    HamiltLCAO<TK, TR>::updateHk (const int ik)
{
...
template <typename TK, typename TR>
void
    HamiltLCAO<TK, TR>::refresh (bool yes)
{
...
template <typename TK, typename TR>
void
    HamiltLCAO<TK, TR>::updateSk (const int ik, const int hk_type)
{
