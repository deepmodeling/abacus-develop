...
template <typename T>
std::vector<T>
    cal_orbs_ccp (const std::vector<T>& orbs,
...
template <typename T>
double
    get_rmesh_proportion (const std::vector<T>& orbs, const double psi_threshold)
{
...
template <typename T>
std::vector<T>
    cal_orbs_ccp_spencer (const std::vector<T>& orbs,
...
template <typename T>
std::vector<T>
    operator* (const T& s, const std::vector<T>& v_in)
{
