...
void
    Inverse_Matrix<Tdata>::cal_inverse (const Method& method, const double& threshold_condition_number)
{
    switch (method)
        {
        case Method::potrf:
...
template <typename Tdata>
void
    Inverse_Matrix<Tdata>::using_potrf ()
{
    int info;
...
struct InverseMatrixTraits<double>
{
    ...
    static void
        syev (RI::Tensor<double>& A, value_type* w, int& info)
    {
...
struct InverseMatrixTraits<std::complex<double>>
{
    ...
    static void
        syev (RI::Tensor<std::complex<double>>& A, value_type* w, int& info)
    {
        ABFs_Construct::PCA::tensor_syev ('V', 'U', A, w, info);
    }
...
struct InverseMatrixTraits<float>
{
    ...
    static void
        syev (RI::Tensor<float>& A, value_type* w, int& info)
    {
        ABFs_Construct::PCA::tensor_syev ('V', 'U', A, w, info);
    }
    static constexpr char gemm_trans = 'T';
...
struct InverseMatrixTraits<std::complex<float>>
{
    ...
    using value_type = float;
    static void
        syev (RI::Tensor<std::complex<float>>& A, value_type* w, int& info)
    {
        ABFs_Construct::PCA::tensor_syev ('V', 'U', A, w, info);
    }
    static constexpr char gemm_trans = 'C';
...
template <typename T>
inline void
    Inverse_Matrix<T>::using_syev (const double& threshold_condition_number)
{
    ...
    BlasConnector::gemm (traits::gemm_trans,
                         'N',
                         eA.nc,
                         eA.nc,
                         ie,
...
template <typename Tdata>
void
    Inverse_Matrix<Tdata>::input (const RI::Tensor<Tdata>& m)
{
...
template <typename Tdata>
void
    Inverse_Matrix<Tdata>::input (const std::vector<std::vector<RI::Tensor<Tdata>>>& ms)
{
...
template <typename Tdata>
RI::Tensor<Tdata>
    Inverse_Matrix<Tdata>::output () const
{
    return this->A.copy ();
}
...
template <typename Tdata>
void
    Inverse_Matrix<Tdata>::copy_down_triangle ()
{
