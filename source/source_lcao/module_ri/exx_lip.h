...
class Exx_Lip {
  ...
  public:
    ...
    void cal_exx();
    const std::vector<std::vector<std::vector<T>>>& get_exx_matrix() const { return this->exx_matrix; }
    Treal get_exx_energy() const { return this->exx_energy; }
    ...
    psi::Psi<T, Device> get_hvec() const { return *this->k_pack->hvec_array; }
