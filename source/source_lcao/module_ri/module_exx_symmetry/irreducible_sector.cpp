...
TCdouble Irreducible_Sector::get_aRb_direct(const Atom* atoms,
                                            const Statistics& st,
                                            const int iat1,
                                            const int iat2,
                                            const TCdouble& R,
...
void Irreducible_Sector::output_sector_star() {
    ...
    for (auto& irap_irR: this->irreducible_sector_) {
        for (auto& irR: irap_irR.second) {
            std::cout << "atompair (" << irap_irR.first.first << ", " << irap_irR.first.second << "), R = (" << irR[0]
                      << ", " << irR[1] << ", " << irR[2] << ") \n";
        }
        std::cout << std::endl;
    }
...
void Irreducible_Sector::write_irreducible_sector() {
    if (GlobalV::MY_RANK == 0) {
        ...
        for (auto& irap_irR: this->irreducible_sector_) {
            for (auto& irR: irap_irR.second) {
                ofs << "atompair (" << irap_irR.first.first << ", " << irap_irR.first.second << "), R = (" << irR[0]
                    << ", " << irR[1] << ", " << irR[2] << ") \n";
            }
        }
        ofs.close();
...
void Irreducible_Sector::find_irreducible_sector(const Symmetry& symm,
                                                 const Atom* atoms,
                                                 const Statistics& st,
