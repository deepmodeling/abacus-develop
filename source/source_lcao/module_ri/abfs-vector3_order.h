...
template <typename T>
class Abfs::Vector3_Order : public ModuleBase::Vector3<T>
{
  public:
...
template <>
inline bool
    operator< (const Abfs::Vector3_Order<double>& v1, const Abfs::Vector3_Order<double>& v2)
{
...
template <>
inline bool
    operator< (const Abfs::Vector3_Order<int>& v1, const Abfs::Vector3_Order<int>& v2)
{
    if (v1.x < v2.x)
        {
            return true;
...
template <typename T>
Abfs::Vector3_Order<T>
    operator% (const Abfs::Vector3_Order<T>& v1, const Abfs::Vector3_Order<T>& v2)
{
