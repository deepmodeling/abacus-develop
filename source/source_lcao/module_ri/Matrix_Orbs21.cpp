                         ...
                         int& Lmax)
{
    ...
    switch (mode)
    {
        case 1:
            ...
            Lmax_used = 2 * Lmax + 1;
            Lmax = std::max(Lmax, GlobalC::exx_info.info_ri.abfs_Lmax);
            Lmax_used += GlobalC::exx_info.info_ri.abfs_Lmax;
            break;
        default:
            ModuleBase::WARNING_QUIT("Matrix_Orbs21::init", "unsupported mode");
    }
