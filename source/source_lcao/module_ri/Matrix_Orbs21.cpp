...
void Matrix_Orbs21::init(const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orb_A1,
    ...
    const int Lmax = std::max({Exx_Abfs::Construct_Orbs::get_Lmax(orb_A1) + Exx_Abfs::Construct_Orbs::get_Lmax(orb_A2),
