...
void
    Exx_Opt_Orb::generate_matrix (const Exx_Info::Exx_Info_Opt_ABFs& info,
                                  const K_Vectors& kv,
                                            ...
                                            if (!judge_orbs_empty (abfs))
                                                {
                                                    ...
                                                    // < lcaos lcaos | lcaos lcaos > - < lcaos lcaos | abfs > * < abfs |
                                                    // abfs >.I * < abfs | lcaos lcaos >
                                                    ...
                                                    // < lcaos lcaos | jys > - < lcaos lcaos | abfs > * < abfs | abfs
                                                    // >.I * < abfs | jys >
...
RI::Tensor<double>
    Exx_Opt_Orb::cal_mul_22 (const std::vector<RI::Tensor<double>>& m_left,
            ...
            for (size_t ir = 0; ir != m_right.size (); ++ir)
                {
                    ...
                    const RI::Tensor<double> m_lm
                        = RI::Tensor_Multiply::x0x1y1_x0x1a_ay1 (m_left[il], m_middle[il][ir]);
...
RI::Tensor<double>
    Exx_Opt_Orb::cal_mul_21 (const std::vector<RI::Tensor<double>>& m_left,
                             const std::vector<std::vector<RI::Tensor<double>>>& m_middle,
                             const std::vector<RI::Tensor<double>>& m_right) const
{
...
RI::Tensor<double>
    Exx_Opt_Orb::cal_mul_12 (const std::vector<RI::Tensor<double>>& m_left,
                             const std::vector<std::vector<RI::Tensor<double>>>& m_middle,
                             const std::vector<RI::Tensor<double>>& m_right) const
{
...
RI::Tensor<double>
    Exx_Opt_Orb::cal_mul_11 (const std::vector<RI::Tensor<double>>& m_left,
                             const std::vector<std::vector<RI::Tensor<double>>>& m_middle,
                             const std::vector<RI::Tensor<double>>& m_right) const
{
...
std::map<size_t, std::map<size_t, std::set<double>>>
    Exx_Opt_Orb::get_radial_R (const UnitCell& ucell) const
{
