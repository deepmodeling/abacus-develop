...
inline void
    init_elem (Tdata& data, const size_t ndim0, const size_t ndim1)
{
...
inline void
    add_elem (Tdata& data, const Tdata& val, const Tdata& frac)
{
    data += frac * val;
};
template <typename T, std::size_t N>
