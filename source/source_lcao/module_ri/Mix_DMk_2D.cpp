...
void
    Mix_DMk_2D::mix (const std::vector<std::vector<double>>& dm, const bool flag_restart)
{
...
void
    Mix_DMk_2D::mix (const std::vector<std::vector<std::complex<double>>>& dm, const bool flag_restart)
{
    ModuleBase::TITLE ("Mix_DMk_2D", "mix");
...
std::vector<const std::vector<double>*>
    Mix_DMk_2D::get_DMk_gamma_out () const
{
...
std::vector<const std::vector<std::complex<double>>*>
    Mix_DMk_2D::get_DMk_k_out () const
{
