    ...
    test_pblas ()
{
    ...
    auto ofs_pro = [&] ()
        {
            ...
            ofs << comm_sz << "\t" << dim[0] << "\t" << dim[1] << "\t" << nprow << "\t" << npcol << "\t" << myprow
                << "\t" << mypcol << "\t" << std::endl;
            ofs.close ();
        };
    ofs_pro ();
    ...
    auto init_desc = [&] (const int m, const int n, const int mb, const int nb, const int irsrc, const int icsrc)
        {
            ...
            ScalapackConnector::descinit (ModuleBase::GlobalFunc::VECTOR_TO_PTR (descv),
                                          m,
                                          n,
                                          mb,
                                          nb,
    ...
    */
    ...
    auto init_matrix_I5511_32 = [&] ()
        {
            switch (my_rank)
                ...
                case 4:
                    return std::vector<double>{0, 1, 0};
                case 5:
                    return std::vector<double>{0, 0};
                }
        };
    auto init_matrix_I5521_32 = [&] ()
        {
            switch (my_rank)
                ...
                case 3:
                    return std::vector<double>{0, 0, 0, 1};
                case 4:
                    return std::vector<double>{0, 0, 1};
                case 5:
                    return std::vector<double>{0, 0};
                }
        };
    auto init_matrix_I5522_32 = [&] ()
        {
            switch (my_rank)
                {
                case 0:
                    return std::vector<double>{1, 0, 0, 1, 0, 0};
                case 1:
                    return std::vector<double>{0, 0, 0, 0};
                case 2:
                    return std::vector<double>{0, 0, 0, 0, 0, 0};
                case 3:
                    return std::vector<double>{1, 0, 0, 1};
                case 4:
                    return std::vector<double>{0, 0, 1};
                case 5:
                    return std::vector<double>{0, 0};
    ...
    auto init_matrix_A5321_32 = [&] ()
        {
            switch (my_rank)
                {
                case 0:
                    return std::vector<double>{1, 6, 3, 8};
                case 1:
                    return std::vector<double>{2, 7};
                case 2:
                    return std::vector<double>{11, 16, 13, 18};
                case 3:
                    return std::vector<double>{12, 17};
                case 4:
                    return std::vector<double>{21, 23};
                case 5:
                    return std::vector<double>{22};
                }
        };
    auto init_matrix_A5521_32 = [&] ()
        {
            switch (my_rank)
                {
                case 0:
                    return std::vector<double>{1, 6, 3, 8, 5, 10};
                case 1:
                    return std::vector<double>{2, 7, 4, 9};
                case 2:
                    return std::vector<double>{11, 16, 13, 18, 15, 20};
                case 3:
                    return std::vector<double>{12, 17, 14, 19};
                case 4:
                    return std::vector<double>{21, 23, 25};
                case 5:
                    return std::vector<double>{22, 24};
                }
        };
    auto init_matrix_A5522_32 = [&] ()
        {
            switch (my_rank)
                {
                case 0:
                    return std::vector<double>{1, 6, 2, 7, 5, 10};
                case 1:
                    return std::vector<double>{3, 8, 4, 9};
                case 2:
                    return std::vector<double>{11, 16, 12, 17, 15, 20};
                case 3:
                    return std::vector<double>{13, 18, 14, 19};
                case 4:
                    return std::vector<double>{21, 22, 25};
                case 5:
                    return std::vector<double>{23, 24};
                }
        };
    ...
    ScalapackConnector::pgemm ('T',
                               'N',
                               3,
                               5,
                               5,
                               1,
                               ModuleBase::GlobalFunc::VECTOR_TO_PTR (mA5321_32),
                               1,
                               1,
                               desc_5321_32,
                               ModuleBase::GlobalFunc::VECTOR_TO_PTR (mI5511_32),
                               1,
                               1,
                               desc_5511_32,
                               0,
                               ModuleBase::GlobalFunc::VECTOR_TO_PTR (mC),
                               1,
                               1,
                               desc_5522_32);
