...
std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>
    Exx_Abfs::Construct_Orbs::change_orbs (const LCAO_Orbitals& orbs_in, const double kmesh_times)
{
...
std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>
    Exx_Abfs::Construct_Orbs::change_orbs (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs_in,
...
// P = f * Y
std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>
    Exx_Abfs::Construct_Orbs::abfs_same_atom (const UnitCell& ucell,
...
#error "TEST_EXX_LCAO"
    ...
    const std::vector<std::vector<std::vector<std::vector<double>>>> abfs_same_atom_pca_psi
        = pca (ucell, orb, abfs_same_atom, orbs, kmesh_times_mot, times_threshold);
...
std::vector<std::vector<std::vector<std::vector<double>>>>
    Exx_Abfs::Construct_Orbs::psi_mult_psi (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs)
{
                                    ...
                                    for (int N2 = ((L2 == L1) ? N1 : 0); N2 != orbs[T][L2].size (); ++N2)
                                        {
                                            ...
                                            for (int ir = 0; ir != orbs[T][L1][N1].getNr (); ++ir)
                                                {
                                                    mult_psir[ir]
                                                        = orbs[T][L1][N1].getPsi (ir) * orbs[T][L2][N2].getPsi (ir);
                                                }
...
std::vector<std::vector<std::vector<std::vector<double>>>>
    Exx_Abfs::Construct_Orbs::psir_mult_psir (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs)
{
                                    ...
                                    for (int N2 = ((L2 == L1) ? N1 : 0); N2 != orbs[T][L2].size (); ++N2)
                                        {
                                            ...
                                            for (int ir = 0; ir != orbs[T][L1][N1].getNr (); ++ir)
                                                {
                                                    mult_psir[ir]
                                                        = orbs[T][L1][N1].getPsi_r (ir) * orbs[T][L2][N2].getPsi_r (ir);
                                                }
                                            for (int L_new = std::abs (L1 - L2); L_new <= L1 + L2; ++L_new)
                                                {
                                                    psir_mult_psir[T][L_new].push_back (mult_psir);
...
std::vector<std::vector<std::vector<std::vector<double>>>>
    Exx_Abfs::Construct_Orbs::pca (const UnitCell& ucell,
                                   const LCAO_Orbitals& orb,
                                   ...
                                   const double times_threshold)
{
    ...
    const std::vector<std::vector<std::pair<std::vector<double>, RI::Tensor<double>>>> eig
        = ABFs_Construct::PCA::cal_PCA (ucell, orb, orbs, abfs, kmesh_times_mot);
            ...
            else
                {
                    ModuleBase::WARNING (std::string (__FILE__),
                                         "Element " + ModuleBase::GlobalFunc::TO_STRING (T)
                                             + " , all training data (lcao[i]*lcao[j]) are all the same. So PCA "
                                               "randomly choose an abf as the result.");
                    psis_new[T].resize (psis[T].size ());
...
std::vector<std::vector<std::vector<std::vector<double>>>>
    Exx_Abfs::Construct_Orbs::orth (const std::vector<std::vector<std::vector<std::vector<double>>>>& psis,
                                    const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs,
                                    const double norm_threshold)
{
...
std::vector<std::vector<std::vector<std::vector<double>>>>
    Exx_Abfs::Construct_Orbs::div_r (const std::vector<std::vector<std::vector<std::vector<double>>>>& psirs,
...
std::vector<std::vector<std::vector<std::vector<double>>>>
    Exx_Abfs::Construct_Orbs::get_psi (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs)
{
...
std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>
    Exx_Abfs::Construct_Orbs::orbital (const std::vector<std::vector<std::vector<std::vector<double>>>>& psis,
...
void
    Exx_Abfs::Construct_Orbs::print_orbs_size (const UnitCell& ucell,
                                               const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs,
                                               std::ostream& os)
{
...
std::vector<std::vector<std::vector<double>>>
    Exx_Abfs::Construct_Orbs::get_multipole (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orb_in)
{
...
std::vector<double>
    Exx_Abfs::Construct_Orbs::get_Rcut (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orb_in)
{
...
void
    Exx_Abfs::Construct_Orbs::filter_empty_orbs (std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orbs)
{
    for (int T = 0; T < orbs.size (); ++T)
        {
