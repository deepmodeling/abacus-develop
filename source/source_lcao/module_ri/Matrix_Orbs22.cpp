...
void
    Matrix_Orbs22::init (const std::vector<std::vector<std::vector<Numerical_Orbital_Lm>>>& orb_A1,
                                                            ...
                                                            for (size_t NB1 = 0; NB1 != orb_B1[TB][LB1].size (); ++NB1)
                                                                {
                                                                    for (int LB2 = 0; LB2 != orb_B2[TB].size (); ++LB2)
                                                                        {
                                                                            for (size_t NB2 = 0;
                                                                                 NB2 != orb_B2[TB][LB2].size ();
                                                                                 ++NB2)
                                                                                {
                                                                                    center2_orb22_s
                                                                                        [TA][TB][LA1][NA1][LA2][NA2]
                                                                                        [LB1][NB1][LB2]
...
void
    Matrix_Orbs22::init_radial_table (const std::map<size_t, std::map<size_t, std::set<double>>>& Rs)
{
                            ...
                            std::map<
                                ...
                                std::map<
                                    ...
                                    std::map<
                                        int,
                                        std::map<size_t,
                                                 std::map<int, std::map<size_t, Center2_Orb::Orb22>>>>>>>>* const> (
