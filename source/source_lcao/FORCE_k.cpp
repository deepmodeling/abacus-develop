...
template <>
void
    Force_LCAO<std::complex<double>>::allocate (const UnitCell& ucell,
...
template <>
void
    Force_LCAO<std::complex<double>>::finish_ftable (ForceStressArrays& fsr)
{
    delete[] fsr.DSloc_Rx;
    delete[] fsr.DSloc_Ry;
    delete[] fsr.DSloc_Rz;
...
template <>
void
    Force_LCAO<std::complex<double>>::ftable (
        const bool isforce,
        const bool isstress,
        ForceStressArrays& fsr, // mohan add 2024-06-15
        ...
        Record_adj* ra)
{
    ...
    // tvnl_dphi
    PulayForceStress::cal_pulay_fs (ftvnl_dphi,
                                    stvnl_dphi,
                                    *dm,
                                    ucell,
                                    pv,
