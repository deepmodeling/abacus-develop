...
void
    build_Nonlocal_mu_new (const Parallel_Orbitals& pv,
                                                    ...
                                                    for (int k = 0; k < atom2->nw * npol; k++)
                                                        {
                                                            ...
                                                            if (!calc_deri)
                                                                    ...
                                                                    if (nspin == 2 || nspin == 1)
                                                                        {
                                                                            ...
                                                                            for (int no = 0;
                                                                                 no < ucell.atoms[T0]
                                                                                          .ncpp.non_zero_count_soc[0];
                                                                                 no++)
                                                                                {
                                                                                    const int p1
                                                                                        = ucell.atoms[T0]
                                                                                              .ncpp.index1_soc[0][no];
                                                                                    const int p2
                                                                                        = ucell.atoms[T0]
                                                                                              .ncpp.index2_soc[0][no];
                                                                                    ucell.atoms[T0].ncpp.get_d (0,
                                                                                                                p1,
                                                                                                                p2,
                                                                                                                tmp_d);
                                                                                    nlm_tmp += nlm_2[p2] * nlm_1[p1]
                                                                                               * (*tmp_d);
                                                                                }
                                                            ...
                                                            else // calculate the derivative
                                                                {
                                                                    if (nspin == 4)
                                                                        {
                                                                            std::vector<double> nlm_1
                                                                                = (*nlm_cur2_f)[iw2_all][0];
                                                                            std::vector<std::vector<double>> nlm_2;
                                                                            nlm_2.resize (3);
                                                                            for (int i = 0; i < 3; i++)
                                                                                {
                                                                                    nlm_2[i]
                                                                                        = (*nlm_cur1_f)[iw1_all][i + 1];
                                                                                }
                                                                            std::complex<double> nlm[4][3]
                                                                                = {ModuleBase::ZERO};
                                                                            int is0
                                                                                = (j - j0 * npol) + (k - k0 * npol) * 2;
                                                                            for (int no = 0;
                                                                                 no < ucell.atoms[T0]
                                                                                          .ncpp.non_zero_count_soc[is0];
                                                                                 no++)
                                                                                {
                                                                                    const int p1
                                                                                        = ucell.atoms[T0]
                                                                                              .ncpp.index1_soc[is0][no];
                                                                                    const int p2
                                                                                        = ucell.atoms[T0]
                                                                                              .ncpp.index2_soc[is0][no];
                                                                                    if (is0 == 0)
                                                                                        {
                                                                                            fsr.DHloc_fixedR_x
                                                                                                [nnr + nnr_inner]
                                                                    ...
                                                                    else if (nspin == 1 || nspin == 2)
                                                                        {
                                                                            if (gamma_only_local)
                                                                                ...
                                                                                {
                                                                                    // mohan change the order on
                                                                                    // 2011-06-17 origin: < psi1 | beta
                                                                                    // > < beta | dpsi2/dtau > now: <
                                                                                    // psi1/dtau | beta > < beta | psi2
                                                                                    // >
                                                                                    double nlm[3] = {0, 0, 0};
