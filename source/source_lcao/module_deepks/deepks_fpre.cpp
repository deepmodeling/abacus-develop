...
void
    DeePKS_domain::cal_gdmx (const int nks,
                                ...
                                for (int L0 = 0; L0 <= orb.Alpha[0].getLmax (); ++L0)
                                    {
                                        for (int N0 = 0; N0 < orb.Alpha[0].getNchi (L0); ++N0)
                                            {
                                                const int inl
                                                    = deepks_param.inl_index[ucell.iat2it[iat]](ucell.iat2ia[iat],
                                                                                                L0,
                                                                                                N0);
                                                const int nm = 2 * L0 + 1;
                                                        ...
                                                        for (int m2 = 0; m2 < nm; ++m2)
                                                            {
                                                                for (int i = 0; i < 3; i++)
                                                                    {
                                                                        double value
                                                                            = grad_overlap_2[i]->get_value (
                                                                                  col_indexes[iw2],
                                                                                  ib + m2)
                                                                              * overlap_1->get_value (row_indexes[iw1],
                                                                                                      ib + m1)
                                                                              * *dm_current;
                                                                        ...
                                                                        // (<chi_mu|d/dX alpha_m>)<chi_nu|alpha_m'> =
                                                                        // -(<d/dX chi_mu|alpha_m>)<chi_nu|alpha_m'>
                                                                        accessor[i][ibt2][inl][m1][m2] -= value;

                                                                        //(<chi_nu|d/dX alpha_m'>)<chi_mu|alpha_m> =
                                                                        //-(<d/dX
...
void
    DeePKS_domain::cal_gvx (const int nat,
                            const DeePKS_Param& deepks_param,
