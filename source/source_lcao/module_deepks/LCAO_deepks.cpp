...
template <typename T>
void
    LCAO_Deepks<T>::init (const LCAO_Orbitals& orb,
                          const int nat,
                          const int ntype,
                          const int nks,
...
template <typename T>
void
    LCAO_Deepks<T>::init_index (const int ntype,
                                const int nat,
                                std::vector<int> na,
...
template <typename T>
void
    LCAO_Deepks<T>::allocate_V_delta (const int nat, const int nks)
{
...
template <typename T>
void
    LCAO_Deepks<T>::init_DMR (const UnitCell& ucell,
                              const LCAO_Orbitals& orb,
...
template <typename T>
void
    LCAO_Deepks<T>::dpks_cal_e_delta_band (const std::vector<std::vector<T>>& dm, const int nks)
{
