...
void
    K_Vectors::set (const std::string& k_file_name,
                    const int& nspin_in,
...
bool
    K_Vectors::read_kpoints (const std::string& fn,
                             bool& GAMMA_ONLY_LOCAL,
                             std::ofstream& ofs_warning,
                             std::ofstream& ofs_running)
{
                    ...
                    for (int iks = 1; iks < nks_special; iks++)
                        {
                            ...
                            //				GlobalV::ofs_running << " dx=" << dx << " dy=" << dy << " dz=" << dz <<
                            // std::endl;
...
void
    K_Vectors::set_both_kvec (const ModuleBase::Matrix3& G, const ModuleBase::Matrix3& R, std::ofstream& ofs_running)
{
...
void
    K_Vectors::set_kup_and_kdw (std::ofstream& ofs_running)
{
    //=========================================================================
...
void
    K_Vectors::print_klists (std::ofstream& ofs_running)
{
