...
void
    DeePKS_domain::allocate_phialpha (const bool& cal_deri,
...
void
    DeePKS_domain::build_phialpha (const bool& cal_deri,
                                   const UnitCell& ucell,
                                   const LCAO_Orbitals& orb,
                                   const Grid_Driver& GridD,
                                   const Parallel_Orbitals* pv,
...
void
    DeePKS_domain::check_phialpha (const bool& cal_deri,
                                   const UnitCell& ucell,
                                   const LCAO_Orbitals& orb,
                                   const Grid_Driver& GridD,
                                   const Parallel_Orbitals* pv,
