...
void
    DeePKS_domain::cal_orbital_precalc (const std::vector<TH>& dm_hl,
                                        const int nat,
                                        const int nks,
                    ...
                    for (int ad1 = 0; ad1 < GridD.getAdjacentNum () + 1; ++ad1)
                        {
                            ...
                            ModuleBase::Vector3<int> dR1 (GridD.getBox (ad1).x,
                                                          GridD.getBox (ad1).y,
                                                          GridD.getBox (ad1).z);
                            ...
                            for (int ad2 = 0; ad2 < GridD.getAdjacentNum () + 1; ad2++)
                                {
                                    ...
                                    ModuleBase::Vector3<int> dR2 (GridD.getBox (ad2).x,
                                                                  GridD.getBox (ad2).y,
                                                                  GridD.getBox (ad2).z);
                                    ...
                                    for (int icol = 0; icol < col_size; icol++)
                                        {
                                            hamilt::BaseMatrix<double>* col_ptr
                                                = phialpha[0]->find_matrix (iat, ibt2, dR2);
                                            for (int i = 0; i < trace_alpha_size; i++)
                                                {
                                    ...
                                    for (int ik = 0; ik < dm_hl.size (); ik++)
                                        {
                                            ...
                                            if (ModuleBase::GlobalFunc::IS_COLUMN_MAJOR_KS_SOLVER (PARAM.inp.ks_solver))
                                                {
                                                    dm_pair.add_from_matrix (dm_hl[ik].c,
                                                                             pv.get_row_size (),
                                                                             *kphase_ptr,
                                                                             1);
                                                }
                                                    ...
                                                    for (int m1 = 0; m1 < nm; ++m1) // m1 = 1 for s, 3 for p, 5 for d
                                                        {
                                                            for (int m2 = 0; m2 < nm;
                                                                ...
                                                                {
                                                                    accessor[ik][inl][m1][m2] += BlasConnector::dot (
                                                                        row_size,
