...
void Gint_vl_metagga_gpu::init_hr_gint_() { hr_gint_ = gint_info_->get_hr<double>(); }
...
#pragma omp for schedule(dynamic)
        for (int i = 0; i < gint_info_->get_bgrid_batches_num(); ++i) {
            ...
            phi_op.phi_mul_vldr3(vr_eff_d_.get_device_ptr(), dr3_, phi.get_device_ptr(), phi_vldr3.get_device_ptr());
            ...
            phi_op.phi_mul_phi(phi.get_device_ptr(), phi_vldr3.get_device_ptr(), hr_gint_, hr_gint_d_.get_device_ptr());
