...
class UnitCellInfo {
  public:
    ...
    Vec3i bgrid_idx_1Dto3D(const int index_1d) const { return index1Dto3D(index_1d, nbx_, nby_, nbz_); }
    ...
    Vec3d get_bgrid_coord(Vec3i index_3d) const { return biggrid_info_->get_cartesian_coord(index_3d); }

    // get the cartesian coordinate of a big grid in the unit cell from the 1D index
    Vec3d get_bgrid_coord(int index_1d) const { return get_bgrid_coord(bgrid_idx_1Dto3D(index_1d)); }
    ...
    Vec3i mgrid_idx_1Dto3D(const int index_1d) const { return index1Dto3D(index_1d, nmx_, nmy_, nmz_); }
    ...
    Vec3d get_mgrid_coord(Vec3i index_3d) const { return meshgrid_info_->get_cartesian_coord(index_3d); }

    // get the cartesian coordinate of a meshgrid in the unit cell from the 1D index
    Vec3d get_mgrid_coord(int index_1d) const { return get_mgrid_coord(mgrid_idx_1Dto3D(index_1d)); }
