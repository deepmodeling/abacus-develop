...
class UnitCellInfo
{
  public:
    // constructor
    UnitCellInfo (const Vec3d& unitcell_vec1,
    ...
    int
        get_mgrids_num () const
    {
        return nmxyz_;
    }
    std::shared_ptr<const BigGridInfo>
        get_bgrid_info () const
    {
        return biggrid_info_;
    }
    std::shared_ptr<const MeshGridInfo>
        get_mgrid_info () const
    {
        return meshgrid_info_;
    }
    ...
    Vec3i
        bgrid_idx_1Dto3D (const int index_1d) const
    {
    ...
    int
        bgrid_idx_3Dto1D (const Vec3i index_3d) const
    {
    ...
    Vec3d
        get_bgrid_coord (Vec3i index_3d) const
    {
    ...
    Vec3d
        get_bgrid_coord (int index_1d) const
    {
    ...
    Vec3i
        get_bgrid_idx_3d (const Vec3d coord) const
    {
        Vec3d direct_coord = biggrid_info_->get_direct_coord (coord);
        return Vec3i (static_cast<int> (floor (direct_coord.x)),
    ...
    Vec3d
        get_relative_coord (Vec3i index_3d_a, Vec3i index_3d_b) const
    {
    ...
    Vec3i
        get_unitcell_idx (const Vec3i index_3d) const
    {
        return Vec3i (floor_div (index_3d.x, nbx_), floor_div (index_3d.y, nby_), floor_div (index_3d.z, nbz_));
    }

    // map the extended big grid index to the big grid index in unitcell
    Vec3i
        map_ext_idx_to_ucell (const Vec3i index_3d) const
    {
    ...
    Vec3i
        mgrid_idx_1Dto3D (const int index_1d) const
    {
    ...
    int
        mgrid_idx_3Dto1D (const Vec3i index_3d) const
    {
    ...
    Vec3d
        get_mgrid_coord (Vec3i index_3d) const
    {
    ...
    Vec3d
        get_mgrid_coord (int index_1d) const
    {
