...
template <typename T>
void PhiOperator::phi_mul_dm(const T* const phi,      // phi(ir,iwt)
...
template <typename T>
void PhiOperator::phi_mul_vldr3(const T* const vl, // vl(ir)
                                const T dr3,
...
template <typename T>
void PhiOperator::phi_mul_phi(const T* const phi_i, // phi_i(ir,iwt)
...
void PhiOperator::phi_dot_phi(const Tin* const phi_i, // phi_i(ir,iwt)
