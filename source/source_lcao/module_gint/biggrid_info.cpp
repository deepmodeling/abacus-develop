...
Vec3i
    BigGridInfo::max_ext_bgrid_num (double r) const
{
    const double g1 = sqrt (biggrid_GT_.e11 * biggrid_GT_.e11 + biggrid_GT_.e21 * biggrid_GT_.e21
                            + biggrid_GT_.e31 * biggrid_GT_.e31);
    const double g2 = sqrt (biggrid_GT_.e12 * biggrid_GT_.e12 + biggrid_GT_.e22 * biggrid_GT_.e22
                            + biggrid_GT_.e32 * biggrid_GT_.e32);
    const double g3 = sqrt (biggrid_GT_.e13 * biggrid_GT_.e13 + biggrid_GT_.e23 * biggrid_GT_.e23
