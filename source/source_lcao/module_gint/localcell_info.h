...
class LocalCellInfo
{
  public:
    ...
    // getter functions
    int
        get_startidx_bx () const
    {
        return startidx_bx_;
    }
    int
        get_startidx_by () const
    {
        return startidx_by_;
    }
    int
        get_startidx_bz () const
    {
        return startidx_bz_;
    }
    int
    ...
    {
        return unitcell_info_->get_bgrid_info ();
    }
