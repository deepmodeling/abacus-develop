...
class MeshGridInfo
{
  public:
    ...
    MeshGridInfo (Vec3d meshgrid_vec1, Vec3d meshgrid_vec2, Vec3d meshgrid_vec3)
        : meshgrid_vec1_ (meshgrid_vec1), meshgrid_vec2_ (meshgrid_vec2), meshgrid_vec3_ (meshgrid_vec3)
    {
