...
class GintInfo
{
  public:
    ...
    static GintInfo
        make_test_instance (const UnitCell& ucell, std::vector<int> ijr_info)
    {
        GintInfo info;
        info.ucell_ = &ucell;
    ...
    static GintInfo*
        make_test_instance_ptr (const UnitCell& ucell, std::vector<int> ijr_info)
    {
    ...
    // getter functions
    const std::vector<std::shared_ptr<BigGrid>>&
        get_biggrids ()
    {
        return biggrids_;
    }
    ...
    {
        return static_cast<int> (biggrids_.size ());
    }
    ...
    int
        get_local_mgrid_num () const
    {
        return localcell_info_->get_mgrids_num ();
    }
    double
        get_mgrid_volume () const
    {
        return meshgrid_info_->get_volume ();
    }
    GintPrecision
        get_exec_precision () const
    {
        return exec_precision_;
    }
    void
        set_exec_precision (const GintPrecision precision)
    {
        exec_precision_ = precision;
    }
...
#ifdef __CUDA
  public:
    std::vector<std::shared_ptr<BatchBigGrid>>&
        get_bgrid_batches ()
    {
        return bgrid_batches_;
    };
    int
        get_bgrid_batches_num () const
    {
