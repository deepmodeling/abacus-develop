...
inline int
    index3Dto1D (const int id_x, const int id_y, const int id_z, const int dim_x, const int dim_y, const int dim_z)
{
    return id_z + id_y * dim_z + id_x * dim_y * dim_z;
}

inline Vec3i
    index1Dto3D (const int index_1d, const int dim_x, const int dim_y, const int dim_z)
{
...
inline double
    pow_int (const double base, const int exp)
{
    switch (exp)
        {
        case 0:
...
inline int
    floor_div (const int a, const int b)
{
...
inline int
    ceil_div (const int a, const int b)
{
    return a / b + (a % b != 0 && (a ^ b) > 0);
}
