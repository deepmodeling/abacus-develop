...
class BatchBigGrid
{
  public:
    ...
    int
        get_batch_size () const
    {
        return biggrids_.size ();
    }
    int
        get_atoms_num () const
    {
    ...
    int
        get_max_atoms_num_per_bgrid () const
    {
        return max_atoms_num_per_bgrid_;
    }
    bool
        empty ()
    {
    ...
    {
        return max_atom_pairs_num_;
    }
    static std::shared_ptr<const BigGridInfo>
        get_bgrid_info ()
    {
        return BigGrid::get_bgrid_info ();
    }
