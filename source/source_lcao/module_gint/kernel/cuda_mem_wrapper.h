...
class CudaMemWrapper {
  public:
    ...
    void copy_host_to_device_sync() { copy_host_to_device_sync(size_); }
    ...
    void copy_host_to_device_async() { copy_host_to_device_async(size_); }
    ...
    void copy_device_to_host_sync() { copy_device_to_host_sync(size_); }
    ...
    void copy_device_to_host_async() { copy_device_to_host_async(size_); }

    void memset_device_sync(const size_t size, const int value = 0) {
        CHECK_CUDA(cudaMemset(device_ptr_, value, size * sizeof(T)));
    }

    void memset_device_sync(const int value = 0) { memset_device_sync(size_, value); }
    ...
    void memset_device_async(const int value = 0) { memset_device_async(size_, value); }
    ...
    void memset_host(const int value = 0) { memset_host(size_, value); }
