...
class BigGridInfo
{
  public:
    ...
    Vec3d
        get_cartesian_coord (const Vec3d& index_3d) const
    {
        return index_3d * biggrid_latvec0_;
    }
    Vec3d
        get_cartesian_coord (const Vec3i& index_3d) const
    {
        return index_3d * biggrid_latvec0_;
    }
    Vec3d
        get_direct_coord (const Vec3d& cart_coord) const
    {
        return cart_coord * biggrid_GT_;
    }
    ...
    const std::vector<Vec3d>&
        get_mgrids_coord () const
    {
        return meshgrid_coords_;
    }
    const Vec3d&
        get_mgrid_coord (int index_1d) const
    {
        return meshgrid_coords_[index_1d];
    }
    ...
    Vec3i
        mgrid_idx_1Dto3D (int index_1d) const
    {
