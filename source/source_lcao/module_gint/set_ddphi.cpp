...
template <typename T>
void
    GintAtom::set_ddphi (const std::vector<Vec3d>& coords,
                         const int stride,
                         T* ddphi_xx,
                         T* ddphi_xy,
                         T* ddphi_xz,
    ...
    for (int im = 0; im < num_mgrids; im++)
        {
            ...
            //             p_ddphi_xy[iw] = term_xy * rly[idx_lm] + term_1x * grly[idx_lm][1] + term_1y *
            //             grly[idx_lm][0]
            //                                 + tmp / rl * hrly[idx_lm][1];
            //             p_ddphi_xz[iw] = term_xz * rly[idx_lm] + term_1x * grly[idx_lm][2] + term_1z *
            //             grly[idx_lm][0]
            //                                 + tmp / rl * hrly[idx_lm][2];
            //             p_ddphi_yy[iw]
            //                 = term_yy * rly[idx_lm] + 2.0 * term_1y * grly[idx_lm][1] + tmp / rl * hrly[idx_lm][3];
            //             p_ddphi_yz[iw] = term_yz * rly[idx_lm] + term_1y * grly[idx_lm][2] + term_1z *
            //             grly[idx_lm][1]
