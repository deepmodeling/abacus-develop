...
LocalCellInfo::LocalCellInfo(int startidx_bx,
    ...
    : startidx_bx_(startidx_bx), startidx_by_(startidx_by), startidx_bz_(startidx_bz), nbx_(nbx), nby_(nby), nbz_(nbz),
      nbxyz_(nbx * nby * nbz), unitcell_info_(unitcell_info), biggrid_info_(unitcell_info->get_bgrid_info()) {
...
Vec3i LocalCellInfo::bgrid_idx_1Dto3D(const int index_1d) const { return index1Dto3D(index_1d, nbx_, nby_, nbz_); }
...
Vec3i LocalCellInfo::mgrid_idx_1Dto3D(const int index_1d) const { return index1Dto3D(index_1d, nmx_, nmy_, nmz_); }
