...
void
    Gint_vl_nspin4_gpu::init_hr_gint_ ()
{
...
void
    Gint_vl_nspin4_gpu::transfer_cpu_to_gpu_ ()
{
...
void
    Gint_vl_nspin4_gpu::transfer_gpu_to_cpu_ ()
{
    for (int i = 0; i < nspin_; i++)
        {
...
void
    Gint_vl_nspin4_gpu::cal_hr_gint_ ()
{
