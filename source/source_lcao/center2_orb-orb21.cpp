...
void
    Center2_Orb::Orb21::init_radial_table ()
{
...
void
    Center2_Orb::Orb21::init_radial_table (const std::set<size_t>& radials)
{
    const Numerical_Orbital_Lm& nA_short = (this->nA1.getNr () <= this->nA2.getNr ()) ? this->nA1 : this->nA2;
...
double
    Center2_Orb::Orb21::cal_overlap (const ModuleBase::Vector3<double>& RA,
...
ModuleBase::Vector3<double>
    Center2_Orb::Orb21::cal_grad_overlap (const ModuleBase::Vector3<double>& RA,
                                          const ModuleBase::Vector3<double>& RB,
                                          const int& mA1,
                                          const int& mA2,
                                          const int& mB) const
