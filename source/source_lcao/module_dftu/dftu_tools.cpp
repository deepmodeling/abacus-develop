...
#ifdef __LCAO
void
    Plus_U::cal_VU_pot_mat_complex (const int spin, const bool newlocale, std::complex<double>* VU)
{
                                    ...
                                    for (int m1 = 0; m1 < 2 * L + 1; m1++)
                                        {
                                            for (int ipol1 = 0; ipol1 < PARAM.globalv.npol; ipol1++)
                                                {
                                                    const int mu = this->paraV->global2local_row (
                                                        this->iatlnmipol2iwt[iat][L][n][m1][ipol1]);
                                                    if (mu < 0)
                                                        {
                                                            continue;
                                                        }
                                                    ...
                                                    for (int m2 = 0; m2 < 2 * L + 1; m2++)
                                                        {
                                                            for (int ipol2 = 0; ipol2 < PARAM.globalv.npol; ipol2++)
                                                                {
                                                                    const int nu = this->paraV->global2local_col (
                                                                        this->iatlnmipol2iwt[iat][L][n][m2][ipol2]);
                                                                    if (nu < 0)
                                                                        {
                                                                            continue;
                                                                        }
                                                                    ...
                                                                    double val = get_onebody_eff_pot (it,
                                                                                                      iat,
                                                                                                      L,
                                                                                                      n,
                                                                                                      spin,
...
void
    Plus_U::cal_VU_pot_mat_real (const int spin, const bool newlocale, double* VU)
{
...
double
    Plus_U::get_onebody_eff_pot (const int T,
                                 const int iat,
                                 const int L,
                                 const int N,
                                 const int spin,
