...
#ifdef __LCAO
void
    Plus_U::cal_eff_pot_mat_complex (const int ik,
                                     ...
                                     const std::complex<double>* sk)
{
    ...
    ScalapackConnector::gemm (transN,
                              ...
                              PARAM.globalv.nlocal,
                              half,
                              ModuleBase::GlobalFunc::VECTOR_TO_PTR (VU),
                              one_int,
                              one_int,
                              this->paraV->desc,
                              sk,
...
#ifdef __MPI
    ScalapackConnector::tranu (PARAM.globalv.nlocal,
                               PARAM.globalv.nlocal,
                               one,
                               &VU[0],
                               one_int,
...
void
    Plus_U::cal_eff_pot_mat_real (const int ik, double* eff_pot, const std::vector<int>& isk, const double* sk)
{
...
#ifdef __MPI
    pdtran_ (&PARAM.globalv.nlocal,
             &PARAM.globalv.nlocal,
             &one,
             &VU[0],
             &one_int,
             &one_int,
             const_cast<int*> (this->paraV->desc),
             &one,
             eff_pot,
             &one_int,
             &one_int,
...
void
    Plus_U::cal_eff_pot_mat_R_double (const int ispin, double* SR, double* HR)
{
    const char transN = 'N', transT = 'T';
    const int one_int = 1;
...
void
    Plus_U::cal_eff_pot_mat_R_complex_double (const int ispin, std::complex<double>* SR, std::complex<double>* HR)
{
    const char transN = 'N', transT = 'T';
    const int one_int = 1;
