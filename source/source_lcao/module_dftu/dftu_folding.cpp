...
void
    Plus_U::fold_dSR_gamma (const UnitCell& ucell,
...
void
    Plus_U::folding_matrix_k (const UnitCell& ucell,
                              const Grid_Driver& gd,
                            ...
                            if (adj)
                                {
                                    ...
                                    //------------------------------------------------
                                    ModuleBase::Vector3<double> dR (gd.getBox (ad).x,
                                                                    gd.getBox (ad).y,
                                                                    gd.getBox (ad).z);
                                            ...
                                            for (int jj = 0; jj < atom2->nw * PARAM.globalv.npol; jj++)
                                                {
                                                    ...
                                                    if (dim1 <= 3)
                                                        ...
                                                        {
                                                            mat_k[iic]
                                                                += mat_ptr[nnr] * fsr.DH_r[nnr * 3 + dim2] * kphase;
                                                        }
...
void
    Plus_U::folding_matrix_k_new (const int ik, hamilt::Hamilt<std::complex<double>>* p_ham)
{
