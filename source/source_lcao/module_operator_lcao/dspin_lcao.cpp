...
inline void
cal_coeff_lambda(const std::vector<double>& current_lambda,
                 std::vector<std::complex<double>>& coefficients) { // {\lambda^{I,3}, \lambda^{I,1}+i\lambda^{I,2},
                                                                    // \lambda^{I,1}-i\lambda^{I,2}, -\lambda^{I,3}}
