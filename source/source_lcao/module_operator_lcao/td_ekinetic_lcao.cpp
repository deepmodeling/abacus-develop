...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::td_ekinetic_scalar (std::complex<double>* Hloc, const TR& overlap, int nnr)
{
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::td_ekinetic_grad (std::complex<double>* Hloc,
                                                        int nnr,
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::calculate_HR ()
{
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::cal_HR_IJR (const int& iat1,
                                                  const int& iat2,
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::update_td ()
{
...
template <typename TK, typename TR>
void
    hamilt::TDEkinetic<hamilt::OperatorLCAO<TK, TR>>::set_HR_fixed (void* hR_tmp_in)
{
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::initialize_HR (const Grid_Driver* GridD)
{
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::initialize_HR_tmp ()
{
    if (elecstate::H_TDDFT_pw::stype != 1)
        {
            return;
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::contributeHR ()
{
...
template <typename TK, typename TR>
void
    TDEkinetic<OperatorLCAO<TK, TR>>::contributeHk (int ik)
{
