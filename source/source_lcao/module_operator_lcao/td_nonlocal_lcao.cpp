...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::update_td ()
{
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::initialize_HR (const Grid_Driver* GridD)
{
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::initialize_HR_tmp (const Parallel_Orbitals* paraV)
{
    if (elecstate::H_TDDFT_pw::stype != 1)
        {
            return;
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::calculate_HR ()
{
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::cal_HR_IJR (
        const int& iat1,
        const int& iat2,
        const int& T0,
                                    ...
                                    for (int dir = 0; dir < 3; dir++)
                                        {
                                            ...
                                            for (int no = 0; no < this->ucell->atoms[T0].ncpp.non_zero_count_soc[is];
                                                 no++)
                                                {
                                                    const int p1 = this->ucell->atoms[T0].ncpp.index1_soc[is][no];
                                                    const int p2 = this->ucell->atoms[T0].ncpp.index2_soc[is][no];
                                                    ...
                                                    nlm_r_tmp
                                                        += (nlm1[dir + 1]->at (p1) * std::conj (nlm2[0]->at (p2))
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::set_HR_fixed (void* hR_tmp_in)
{
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::contributeHR ()
{
...
template <typename TK, typename TR>
void
    hamilt::TDNonlocal<hamilt::OperatorLCAO<TK, TR>>::contributeHk (int ik)
{
    return;
}
