...
namespace hamilt
{
RI::Cell_Nearest<int, int, 3, double, 3>
    init_cell_nearest (const UnitCell& ucell, const std::array<int, 3>& Rs_period)
{
...
template <>
void
    OperatorEXX<OperatorLCAO<double, double>>::add_loaded_Hexx (const int ik)
{
    BlasConnector::axpy (this->hR->get_paraV ()->get_local_size (),
                         1.0,
...
template <>
void
    OperatorEXX<OperatorLCAO<std::complex<double>, double>>::add_loaded_Hexx (const int ik)
{
    BlasConnector::axpy (this->hR->get_paraV ()->get_local_size (),
                         1.0,
...
template <>
void
    OperatorEXX<OperatorLCAO<std::complex<double>, std::complex<double>>>::add_loaded_Hexx (const int ik)
{
    BlasConnector::axpy (this->hR->get_paraV ()->get_local_size (),
                         1.0,
                         this->Hexxc_k_load[ik].data (),
