...
template <typename TK, typename TR>
void
    hamilt::Nonlocal<hamilt::OperatorLCAO<TK, TR>>::initialize_HR (const Grid_Driver* GridD)
{
...
template <typename TK, typename TR>
void
    hamilt::Nonlocal<hamilt::OperatorLCAO<TK, TR>>::calculate_HR ()
{
...
template <typename TK, typename TR>
void
    hamilt::Nonlocal<hamilt::OperatorLCAO<TK, TR>>::cal_HR_IJR (
        const int& iat1,
        const int& iat2,
        const int& T0,
...
template <typename TK, typename TR>
void
    hamilt::Nonlocal<hamilt::OperatorLCAO<TK, TR>>::set_HR_fixed (void* HR_fixed_in)
{
...
template <typename TK, typename TR>
void
    hamilt::Nonlocal<hamilt::OperatorLCAO<TK, TR>>::contributeHR ()
{
