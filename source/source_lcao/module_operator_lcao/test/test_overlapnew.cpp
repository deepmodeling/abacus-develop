...
TEST_F(OverlapNewTest, hermitianProperty)
{
    ...
    // For overlap matrix, SK should be Hermitian: SK(i,j) = conj(SK(j,i))
    // Note: This test is simplified and assumes square matrix layout
    // In practice, the matrix might be distributed across MPI processes
