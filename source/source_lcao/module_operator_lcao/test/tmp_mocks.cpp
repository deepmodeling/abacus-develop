...
void
    hamilt::OperatorLCAO<TK, TR>::init (const int ik_in)
{
    if (!this->hr_done)
        {
...
template <typename TK, typename TR>
void
    hamilt::OperatorLCAO<TK, TR>::contributeHk (int ik)
{
...
template <typename TK, typename TR>
void
    hamilt::OperatorLCAO<TK, TR>::get_hs_pointers ()
{
    return;
}
...
void
    TwoCenterIntegrator::tabulate (const RadialCollection& bra,
...
void
    TwoCenterIntegrator::calculate (const int itype1,
                                    const int l1,
                                    const int izeta1,
                                    const int m1,
                                    const int itype2,
...
void
    TwoCenterIntegrator::snap (const int itype1,
                               const int l1,
                               const int izeta1,
                               const int m1,
                               const int itype2,
...
void
    Grid_Driver::Find_atom (const UnitCell& ucell,
...
void
    filter_adjs (const std::vector<bool>& is_adj, AdjacentAtomInfo& adjs)
{
...
void
    Numerical_Orbital::set_orbital_info (const int&, const std::string&, const int&, const int*, const int&)
{
}
