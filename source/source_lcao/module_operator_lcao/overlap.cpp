...
void
    populate_atom_pairs (hamilt::HContainer<TR>* container,
...
template <typename TK, typename TR>
void
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::initialize_SR (const Grid_Driver* GridD)
{
...
template <typename TK, typename TR>
void
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::calculate_SR ()
{
...
template <typename TK, typename TR>
void
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::cal_SR_IJR (const int& iat1,
                                                               const int& iat2,
...
template <typename TK, typename TR>
void
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::contributeHR ()
{
...
template <>
void
    hamilt::Overlap<hamilt::OperatorLCAO<double, double>>::contributeHk (int ik)
{
...
template <typename TK, typename TR>
void
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::contributeHk (int ik)
{
    ModuleBase::TITLE ("Overlap", "contributeHk");
    ModuleBase::timer::start ("Overlap", "contributeHk");
...
template <typename TK, typename TR>
TK*
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::getSk ()
{
    if (this->hsk != nullptr)
        {
...
hamilt::HContainer<TR>*
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::calculate_SR_async (const UnitCell& ucell_in,
                                                                       const double md_dt,
                                                                       const Parallel_Orbitals* paraV)
{
...
template <typename TK, typename TR>
void
    hamilt::Overlap<hamilt::OperatorLCAO<TK, TR>>::output_SR_async_csr (const int istep,
