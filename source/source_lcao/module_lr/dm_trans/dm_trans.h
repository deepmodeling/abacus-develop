...
template <typename T>
std::vector<container::Tensor> cal_dm_trans_pblas(const T* const X_istate,
...
template <typename T>
std::vector<container::Tensor> cal_dm_trans_blas(const T* const X_istate,
                                                 const psi::Psi<T>& c,
                                                 const int& nocc,
                                                 const int& nvirt,
                                                 const T factor = (T)1.0,
...
template <typename T>
std::vector<container::Tensor> cal_dm_trans_forloop_serial(const T* const X_istate,
                                                           const psi::Psi<T>& c,
                                                           const int& nocc,
                                                           const int& nvirt,
                                                           const T factor = (T)1.0,
