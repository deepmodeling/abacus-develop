...
template <typename T>
void print_psi_bandfirst(const psi::Psi<T>& psi,
...
template <typename T>
void write_psi_bandfirst(const psi::Psi<T>& psi,
...
template <typename T>
void write_psi_bandfirst(const T* psi,
                         const int& nband,
                         const int& nk,
                         const int& nbasis,
                         const std::string& filename,
...
template <typename T>
void print_tensor(const container::Tensor& t,
                  const std::string& label,
