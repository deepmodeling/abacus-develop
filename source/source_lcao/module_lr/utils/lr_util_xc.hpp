...
template <typename T>
void
    grad (const T* rhor, ModuleBase::Vector3<T>* gradrho, const ModulePW::PW_Basis& rho_basis, const double& tpiba)
{
...
template <typename T>
void
    lapl (const T* rhor, T* lapn, const ModulePW::PW_Basis& rho_basis, const double& tpiba2)
{
...
template <typename T>
void
    lapl (const std::vector<T>& rhor, std::vector<T>& lapn, const ModulePW::PW_Basis& rho_basis, const double& tpiba2)
{
