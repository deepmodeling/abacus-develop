                                          ...
                                          ModuleSymmetry::Symmetry* symm)
{
    ...
    if (PARAM.inp.deepks_scf)
    {
        ...
        {
            DeePKS_domain::cal_f_delta<double>(ucell, orb, gd,
                                               *flk.ParaV, nks, deepks.ld.deepks_param,
                                               kv.kvec_d, deepks.ld.phialpha,
                                               fvnl_dalpha, isstress, svnl_dalpha,
                                               deepks.ld.dm_r, deepks.ld.gedm,
        ...
        {
            DeePKS_domain::cal_f_delta<std::complex<double>>(ucell, orb, gd,
                                                              *flk.ParaV, nks, deepks.ld.deepks_param,
                                                              kv.kvec_d, deepks.ld.phialpha,
                                                              fvnl_dalpha, isstress, svnl_dalpha,
                                                              deepks.ld.dm_r, deepks.ld.gedm,
