...
void
    transferSerial2Parallels (const hamilt::HContainer<TR>& hR_s, hamilt::HContainer<TR>* hR_p, const int serial_rank)
{
    int my_rank, size;
...
template <typename TR>
void
    transferParallels2Serial (const hamilt::HContainer<TR>& hR_p, hamilt::HContainer<TR>* hR_s, const int serial_rank)
{
    int my_rank, size;
    MPI_Comm_rank (MPI_COMM_WORLD, &my_rank);
    MPI_Comm_size (MPI_COMM_WORLD, &size);
...
template <typename TR>
void
    transferSerials2Parallels (const hamilt::HContainer<TR>& hR_s, hamilt::HContainer<TR>* hR_p)
{
    int my_rank, size;
    MPI_Comm_rank (MPI_COMM_WORLD, &my_rank);
    MPI_Comm_size (MPI_COMM_WORLD, &size);
...
template <typename TR>
void
    transferParallels2Serials (const hamilt::HContainer<TR>& hR_p, hamilt::HContainer<TR>* hR_s)
{
    int my_rank, size;
    MPI_Comm_rank (MPI_COMM_WORLD, &my_rank);
    MPI_Comm_size (MPI_COMM_WORLD, &size);
...
template <typename TR>
void
    gatherParallels (const hamilt::HContainer<TR>& hR_p, hamilt::HContainer<TR>* hR_s, const int serial_rank)
{
            ...
            for (int i = 0; i < size; ++i)
                {
                    ...
                    MPI_Recv (tmp_ijrs.data (), tmp_ijrs.size (), MPI_INT, i, 0, MPI_COMM_WORLD, &status);
...
template void transferParallels2Serials (const hamilt::HContainer<std::complex<double>>& hR_p,
                                         hamilt::HContainer<std::complex<double>>* hR_s);
template void
    gatherParallels (const hamilt::HContainer<double>& hR_p, hamilt::HContainer<double>* hR_s, const int serial_rank);
