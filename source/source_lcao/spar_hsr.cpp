...
#ifdef __MPI
void
    sparse_format::sync_all_R_coor (std::set<Abfs::Vector3_Order<int>>& all_R_coor, MPI_Comm comm)
{
...
void
    sparse_format::cal_HContainer (const Parallel_Orbitals& pv,
...
void
    sparse_format::clear_zero_elements (LCAO_HS_Arrays& HS_Arrays, const int& current_spin, const double& sparse_thr)
{
...
void
    sparse_format::destroy_HS_R_sparse (LCAO_HS_Arrays& HS_Arrays)
{
