...
class SpinConstrain
{
  ...
  public:
    ...
    void
        set_solver_parameters (const K_Vectors& kv_in, void* p_hamilt_in, void* psi_in, elecstate::ElecState* pelec_in);
  ...
  public:
    ...
    void
        set_mag_converged (bool is_Mi_converged_in)
    {
        this->is_Mi_converged = is_Mi_converged_in;
    }
    /// @brief get is_Mi_converged
    bool
        mag_converged () const
    {
        return this->is_Mi_converged;
    }
