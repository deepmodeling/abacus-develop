...
template <typename TK>
double
    SpinConstrain<TK>::get_escon () const
{
    return this->escon_;
}
...
template <typename TK>
void
    SpinConstrain<TK>::set_atomCounts (const std::map<int, int>& atomCounts_in)
{
...
const std::map<int, int>&
    SpinConstrain<TK>::get_atomCounts () const
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_nspin (int nspin_in)
{
...
template <typename TK>
int
    SpinConstrain<TK>::get_nspin () const
{
    return this->nspin_;
}
...
template <typename TK>
void
    SpinConstrain<TK>::check_atomCounts ()
{
    ...
    for (std::map<int, int>::iterator it = this->atomCounts.begin (); it != this->atomCounts.end (); ++it)
        {
            ...
            if (inat <= 0)
                {
                    ModuleBase::WARNING_QUIT ("SpinConstrain::check_atomCounts",
...
template <typename TK>
int
    SpinConstrain<TK>::get_iat (int itype, int atom_index)
{
    if (itype < 0 || itype >= this->get_ntype ())
        {
...
template <typename TK>
void
    SpinConstrain<TK>::set_orbitalCounts (const std::map<int, int>& orbitalCounts_in)
{
...
template <typename TK>
const std::map<int, int>&
    SpinConstrain<TK>::get_orbitalCounts () const
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_lnchiCounts (const std::map<int, std::map<int, int>>& lnchiCounts_in)
{
...
const std::map<int, std::map<int, int>>&
    SpinConstrain<TK>::get_lnchiCounts () const
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_sc_lambda ()
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_target_mag ()
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
...
template <typename TK>
void
    SpinConstrain<TK>::set_constrain ()
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
...
template <typename TK>
void
    SpinConstrain<TK>::set_sc_lambda (const ModuleBase::Vector3<double>* lambda_in, int nat_in)
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
    if (nat_in != nat)
...
template <typename TK>
void
    SpinConstrain<TK>::set_target_mag (const ModuleBase::Vector3<double>* target_mag_in, int nat_in)
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
    if (nat_in != nat)
...
template <typename TK>
void
    SpinConstrain<TK>::set_target_mag (const std::vector<ModuleBase::Vector3<double>>& target_mag_in)
{
    int nat = this->get_nat ();
...
template <typename TK>
void
    SpinConstrain<TK>::set_constrain (const ModuleBase::Vector3<int>* constrain_in, int nat_in)
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
    if (nat_in != nat)
...
const std::vector<ModuleBase::Vector3<double>>&
    SpinConstrain<TK>::get_sc_lambda () const
{
    return this->lambda_;
}
...
template <typename TK>
const std::vector<ModuleBase::Vector3<double>>&
    SpinConstrain<TK>::get_target_mag () const
{
...
/// get_constrain
template <typename TK>
const std::vector<ModuleBase::Vector3<int>>&
    SpinConstrain<TK>::get_constrain () const
{
...
template <typename TK>
double
    SpinConstrain<TK>::get_decay_grad (int itype)
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_decay_grad ()
{
    this->check_atomCounts ();
...
const std::vector<double>&
    SpinConstrain<TK>::get_decay_grad ()
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_decay_grad (const double* decay_grad_in, int ntype_in)
{
    this->check_atomCounts ();
    int ntype = this->get_ntype ();
    if (ntype_in != ntype)
...
template <typename TK>
void
    SpinConstrain<TK>::set_input_parameters (double sc_thr_in,
                                             int nsc_in,
                                             int nsc_min_in,
...
template <typename TK>
double
    SpinConstrain<TK>::get_sc_thr () const
{
    return this->sc_thr_;
}
...
template <typename TK>
int
    SpinConstrain<TK>::get_nsc () const
{
    return this->nsc_;
}
...
template <typename TK>
int
    SpinConstrain<TK>::get_nsc_min () const
{
...
template <typename TK>
double
    SpinConstrain<TK>::get_alpha_trial () const
{
...
template <typename TK>
double
    SpinConstrain<TK>::get_sccut () const
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_sc_drop_thr (double sc_drop_thr_in)
{
    this->sc_drop_thr_ = sc_drop_thr_in;
}
...
template <typename TK>
double
    SpinConstrain<TK>::get_sc_drop_thr () const
{
...
template <typename TK>
void
    SpinConstrain<TK>::set_solver_parameters (const K_Vectors& kv_in,
                                              void* p_hamilt_in,
                                              void* psi_in,
...
template <typename TK>
void
    SpinConstrain<TK>::set_ParaV (Parallel_Orbitals* ParaV_in)
{
    this->ParaV = ParaV_in;
...
template <typename TK>
void
    SpinConstrain<TK>::print_Mi (std::ofstream& ofs_running)
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
...
template <typename TK>
void
    SpinConstrain<TK>::print_Mag_Force (std::ofstream& ofs_running)
{
    this->check_atomCounts ();
    int nat = this->get_nat ();
