...
double
    maxval_abs_2d (const std::vector<ModuleBase::Vector3<double>>& array)
{
    double max = 0;
...
std::pair<int, int>
    maxloc_abs_2d (const std::vector<ModuleBase::Vector3<double>>& array)
{
    double max = 0;
    int i_max = 0;
    int j_max = 0;
...
template <typename T>
T
    sum_2d (const std::vector<ModuleBase::Vector3<T>>& array)
{
...
void
    scalar_multiply_2d (const std::vector<ModuleBase::Vector3<double>>& array,
                        double scalar,
...
void
    add_scalar_multiply_2d (const std::vector<ModuleBase::Vector3<double>>& array_1,
...
void
    subtract_2d (const std::vector<ModuleBase::Vector3<double>>& array_1,
                 const std::vector<ModuleBase::Vector3<double>>& array_2,
                 std::vector<ModuleBase::Vector3<double>>& result)
{
    int size = array_1.size ();
...
void
    fill_scalar_2d (double scalar, std::vector<ModuleBase::Vector3<double>>& result)
{
    for (auto& row: result)
        {
            row.x = scalar;
...
void
    where_fill_scalar_2d (const std::vector<ModuleBase::Vector3<int>>& array_mask,
                          int mask,
                          double scalar,
                          std::vector<ModuleBase::Vector3<double>>& result)
{
...
void
    where_fill_scalar_else_2d (const std::vector<ModuleBase::Vector3<int>>& array_mask,
                               int mask,
                               double scalar,
...
void
    print_2d (const std::string info,
