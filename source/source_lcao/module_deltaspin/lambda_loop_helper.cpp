...
template <>
void
    spinconstrain::SpinConstrain<std::complex<double>>::print_termination ()
{
...
template <>
bool
    spinconstrain::SpinConstrain<std::complex<double>>::check_rms_stop (int outer_step,
                                                                        int i_step,
                                                                        double rms_error,
                                                                        double duration,
...
template <>
void
    spinconstrain::SpinConstrain<std::complex<double>>::print_header ()
{
    std::cout << "===============================================================================" << std::endl;
...
template <>
void
    spinconstrain::SpinConstrain<std::complex<double>>::check_restriction (
...
template <>
double
    spinconstrain::SpinConstrain<std::complex<double>>::cal_alpha_opt (
...
template <>
bool
    spinconstrain::SpinConstrain<std::complex<double>>::check_gradient_decay (
