...
template <>
void
    spinconstrain::SpinConstrain<std::complex<double>>::calculate_delta_hcc (
        ...
        const int* nh_iat)
{
    ...
    if (PARAM.inp.device == "gpu")
        {
            ...
            base_device::memory::synchronize_memory_op<std::complex<double>,
                                                       ...
                                                       base_device::DEVICE_GPU> () (becp_cpu, becp_k, size_ps);
#endif
        }
                    ...
                    for (int ip = 0; ip < nproj; ip++)
                        {
                            ...
                            ps[becpind] += coefficients0 * becp1 + coefficients2 * becp2;
                            ps[becpind + nkb] += coefficients1 * becp1 + coefficients3 * becp2;
                        } // end ip
                } // end ib
            sum += nproj;
        } // end iat
    ...
    if (PARAM.inp.device == "gpu")
        {
            ...
            base_device::DEVICE_GPU* ctx = {};
            base_device::DEVICE_CPU* cpu_ctx = {};
            base_device::memory::resize_memory_op<std::complex<double>, base_device::DEVICE_GPU> () (ps_pointer,
                                                                                                     size_ps);
            base_device::memory::synchronize_memory_op<std::complex<double>,
                                                       base_device::DEVICE_GPU,
                                                       base_device::DEVICE_CPU> () (ps_pointer, ps.data (), size_ps);
#endif
        }
    else if (PARAM.inp.device == "cpu")
        {
    ...
    if (PARAM.inp.device == "gpu")
...
#if ((defined __CUDA) || (defined __ROCM))
            base_device::DEVICE_GPU* ctx = {};
            ModuleBase::gemm_op<std::complex<double>, base_device::DEVICE_GPU> () (transa,
                                                                                   transb,
                                                                                   nbands,
                                                                                   nbands,
                                                                                   npm,
    ...
    else if (PARAM.inp.device == "cpu")
        {
            ...
            ModuleBase::gemm_op<std::complex<double>, base_device::DEVICE_CPU> () (transa,
                                                                                   transb,
                                                                                   nbands,
                                                                                   nbands,
                                                                                   npm,
...
template <>
void
    spinconstrain::SpinConstrain<std::complex<double>>::cal_mw_from_lambda (
        int i_step,
        const ModuleBase::Vector3<double>* delta_lambda)
{
...
#endif
        {
            /*if (i_step == -1 && this->higher_mag_prec)
            {
                ...
                if (PARAM.inp.device == "cpu")
                {
                    psi::Psi<std::complex<double>>* psi_t = static_cast<psi::Psi<std::complex<double>>*>(this->psi);
                    hamilt::Hamilt<std::complex<double>>* hamilt_t =
            static_cast<hamilt::Hamilt<std::complex<double>>*>(this->p_hamilt); hsolver::HSolver<std::complex<double>,
            base_device::DEVICE_CPU>* hsolver_t = static_cast<hsolver::HSolver<std::complex<double>,
            base_device::DEVICE_CPU>*>(this->phsol); hsolver_t->solve(hamilt_t, psi_t[0], this->pelec, this->KS_SOLVER,
            true);
                }
                else
                {
                    psi::Psi<std::complex<double>, base_device::DEVICE_GPU>* psi_t =
            static_cast<psi::Psi<std::complex<double>, base_device::DEVICE_GPU>*>(this->psi);
                    hamilt::Hamilt<std::complex<double>, base_device::DEVICE_GPU>* hamilt_t =
            static_cast<hamilt::Hamilt<std::complex<double>, base_device::DEVICE_GPU>*>(this->p_hamilt);
                    hsolver::HSolver<std::complex<double>, base_device::DEVICE_GPU>* hsolver_t =
            static_cast<hsolver::HSolver<std::complex<double>, base_device::DEVICE_GPU>*>(this->phsol);
                ...
                if (PARAM.inp.device == "cpu")
                    {
                        ...
                        hamilt::Hamilt<std::complex<double>, base_device::DEVICE_CPU>* hamilt_t
                            = static_cast<hamilt::Hamilt<std::complex<double>, base_device::DEVICE_CPU>*> (
                                this->p_hamilt);
                        ...
                        for (int ik = 0; ik < nk; ++ik)
                            {
                                ...
                                if (i_step != -1)
                                    {
                                        this->calculate_delta_hcc (h_tmp.data (),
                                                                   becp_k,
                                                                   delta_lambda,
                                                                   nbands,
                                                                   nkb,
                ...
                else
                    {
                        ...
                        psi::Psi<std::complex<double>, base_device::DEVICE_GPU>* psi_t
                            = static_cast<psi::Psi<std::complex<double>, base_device::DEVICE_GPU>*> (this->psi);
                        hamilt::Hamilt<std::complex<double>, base_device::DEVICE_GPU>* hamilt_t
                            = static_cast<hamilt::Hamilt<std::complex<double>, base_device::DEVICE_GPU>*> (
                                this->p_hamilt);
                        ...
                        if (this->sub_h_save == nullptr)
                            {
                                ...
                                base_device::memory::resize_memory_op<std::complex<double>,
                                                                      base_device::DEVICE_GPU> () (this->sub_h_save,
                                                                                                   nbands * nbands
                                                                                                       * nk);
                                base_device::memory::resize_memory_op<std::complex<double>,
                                                                      base_device::DEVICE_GPU> () (this->sub_s_save,
                                                                                                   nbands * nbands
                                                                                                       * nk);
                                base_device::memory::resize_memory_op<std::complex<double>,
                                                                      base_device::DEVICE_GPU> () (this->becp_save,
                                                                                                   size_becp * nk);
                            }
                        ...
                        for (int ik = 0; ik < nk; ++ik)
                            {
                                ...
                                if (initial_hs)
                                    {
                                        /// update H(k) for each k point
                                        hamilt_t->updateHk (ik);
                                        hsolver::DiagoIterAssist<std::complex<double>,
                                                                 base_device::DEVICE_GPU>::cal_hs_subspace (hamilt_t,
                                                                                                            psi_t[0],
                                                                                                            h_k,
                                                                                                            s_k);
                                        base_device::memory::synchronize_memory_op<std::complex<double>,
                                ...
                                base_device::memory::synchronize_memory_op<std::complex<double>,
                                                                           base_device::DEVICE_GPU,
                                                                           base_device::DEVICE_GPU> () (h_tmp,
                                                                                                        h_k,
                                                                                                        nbands
                                                                                                            * nbands);
                                base_device::memory::synchronize_memory_op<std::complex<double>,
                                                                           base_device::DEVICE_GPU,
                                                                           base_device::DEVICE_GPU> () (s_tmp,
                                                                                                        s_k,
                                                                                                        nbands
                                                                                                            * nbands);
                                // update h_tmp by delta_lambda
                                ...
                                hsolver::DiagoIterAssist<std::complex<double>, base_device::DEVICE_GPU>::diag_responce (
                                    h_tmp,
                                    s_tmp,
                                    nbands,
                                    becp_k,
...
template <>
void
    spinconstrain::SpinConstrain<std::complex<double>>::update_psi_charge (
        const ModuleBase::Vector3<double>* delta_lambda,
        bool pw_solve)
{
            ...
            if (PARAM.inp.device == "cpu")
                {
                    psi::Psi<std::complex<double>>* psi_t = static_cast<psi::Psi<std::complex<double>>*> (this->psi);
                    hamilt::Hamilt<std::complex<double>, base_device::DEVICE_CPU>* hamilt_t
                        = static_cast<hamilt::Hamilt<std::complex<double>, base_device::DEVICE_CPU>*> (this->p_hamilt);
                    auto* onsite_p = projectors::OnsiteProjector<double, base_device::DEVICE_CPU>::get_instance ();
                    nbands = psi_t->get_nbands ();
                    npol = psi_t->get_npol ();
                    nkb = onsite_p->get_tot_nproj ();
                    ...
                    for (int ik = 0; ik < nk; ++ik)
                        {
                            ...
                            hsolver::DiagoIterAssist<std::complex<double>>::diag_subspace_psi (
                                h_tmp.data (),
                                s_tmp.data (),
                                nbands,
                                psi_t[0],
            ...
            else
                {
                    ...
                    for (int ik = 0; ik < nk; ++ik)
                        {
                            ...
                            base_device::memory::synchronize_memory_op<std::complex<double>,
                                                                       ...
                                                                       base_device::DEVICE_GPU> () (s_tmp,
                                                                                                    ...
                                                                                                    nbands * nbands);
                            this->calculate_delta_hcc (h_tmp, becp_k, delta_lambda, nbands, nkb, nh_iat);
                            hsolver::DiagoIterAssist<std::complex<double>, base_device::DEVICE_GPU>::diag_subspace_psi (
                                h_tmp,
                                s_tmp,
                                nbands,
                                psi_t[0],
                    ...
                    if (pw_solve)
                        ...
                        { // update charge density only
                            reinterpret_cast<elecstate::ElecStatePW<std::complex<double>, base_device::DEVICE_GPU>*> (
                                this->pelec)
                                ->psiToRho (*psi_t);
                        }
                }
