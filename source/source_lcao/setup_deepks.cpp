...
template <typename TK>
void
    Setup_DeePKS<TK>::build_overlap (const UnitCell& ucell,
    ...
    if (PARAM.globalv.deepks_setorb)
        {
            ...
            if (inp.deepks_out_unittest)
                {
                    DeePKS_domain::check_phialpha (inp.cal_force,
                                                   ucell,
                                                   orb,
                                                   gd,
                                                   &pv,
...
template <typename TK>
void
    Setup_DeePKS<TK>::before_runner (const UnitCell& ucell,    // unitcell
...
template <typename TK>
void
    Setup_DeePKS<TK>::delta_e (const UnitCell& ucell,
                               const K_Vectors& kv,
                               const LCAO_Orbitals& orb,
...
template <typename TK>
void
    Setup_DeePKS<TK>::write_forces (const ModuleBase::matrix& fcs,
...
template <typename TK>
void
    Setup_DeePKS<TK>::write_stress (const ModuleBase::matrix& scs,
