...
inline void
    print_tensor_shape (const ct::Tensor& tensor, const std::string& name)
{
...
template <typename T>
inline void
    print_single_element (const T& val, double threshold)
{
...
inline void
    print_single_element (const std::complex<double>& val, double threshold)
{
...
template <typename T>
inline void
    print_tensor_data_recursive (const T* data,
...
template <typename T>
inline void
    print_tensor_data (const ct::Tensor& tensor, const std::string& name)
{
...
template <>
inline void
    print_tensor_data<std::complex<double>> (const ct::Tensor& tensor, const std::string& name)
{
    const ct::Tensor* p_tensor = &tensor;
    ct::Tensor cpu_tensor_buffer;
