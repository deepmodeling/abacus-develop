...
#ifdef __MPI
void
    Propagator::compute_propagator_cn2 (const int nlocal,
...
void
    Propagator::compute_propagator_cn2_tensor (const int nlocal,
                                               ...
                                               CublasMpResources& cublas_res) const
{
    ...
    ct::Tensor Denominator_gpu (ct::DataType::DT_COMPLEX_DOUBLE,
                                ct::DeviceType::GpuDevice,
                                ct::TensorShape ({len_loc}));
...
void
    Propagator::compute_propagator_cn2_tensor_lapack (const int nlocal,
                                                      const ct::Tensor& Stmp,
                                                      const ct::Tensor& Htmp,
                                                      ct::Tensor& U_operator,
                                                      std::ofstream& ofs_running,
