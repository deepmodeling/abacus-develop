...
__device__ inline int
    get_global_index_dev (int local_idx, int block_size, int num_procs, int proc_coord)
{
...
__global__ void
    extract_ekb_kernel (const cuDoubleComplex* d_Eij,
                        double* d_eii,
                        int lld,
                        int local_elems,
                        int nb,
...
void
    launch_extract_ekb_kernel (const cuDoubleComplex* d_Eij,
                               double* d_eii,
                               int lld,
                               int local_elems,
                               int nb,
