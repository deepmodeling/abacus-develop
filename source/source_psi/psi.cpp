...
template <typename T, typename Device>
void
    Psi<T, Device>::set_all_psi (const T* another_pointer, const std::size_t size_in)
{
...
template <typename T, typename Device>
Psi<T, Device>&
    Psi<T, Device>::operator= (const Psi<T, Device>& psi_in)
{
    //    printf("%d\n", &psi_in);
    this->ngk = psi_in.ngk;
    this->nk = psi_in.get_nk ();
...
template <typename T, typename Device>
void
    Psi<T, Device>::resize (const int nks_in, const int nbands_in, const int nbasis_in)
{
...
template <typename T, typename Device>
T*
    Psi<T, Device>::get_pointer () const
{
...
template <typename T, typename Device>
T*
    Psi<T, Device>::get_pointer (const int& ikb) const
{
    assert (ikb >= 0);
...
template <typename T, typename Device>
const bool&
    Psi<T, Device>::get_k_first () const
{
    return this->k_first;
}
...
template <typename T, typename Device>
const int*
    Psi<T, Device>::get_ngk_pointer () const
{
    return this->ngk;
}
...
template <typename T, typename Device>
const size_t&
    Psi<T, Device>::get_psi_bias () const
{
...
template <typename T, typename Device>
const int&
    Psi<T, Device>::get_current_ngk () const
{
    if (this->get_npol () == 1)
        {
...
template <typename T, typename Device>
void
    Psi<T, Device>::fix_k (const int ik) const
{
    assert (ik >= 0);
    this->current_k = ik;
    if (this->ngk != nullptr)
...
template <typename T, typename Device>
void
    Psi<T, Device>::fix_b (const int ib) const
{
    assert (ib >= 0);
    this->current_b = ib;
...
template <typename T, typename Device>
void
    Psi<T, Device>::fix_kb (const int ik, const int ib) const
{
    assert (ik >= 0 && ib >= 0);
    this->current_k = ik;
    this->current_b = ib;
...
template <typename T, typename Device>
T&
    Psi<T, Device>::operator() (const int ikb1, const int ikb2, const int ibasis) const
{
...
template <typename T, typename Device>
T&
    Psi<T, Device>::operator() (const int ikb2, const int ibasis) const
{
...
template <typename T, typename Device>
T&
    Psi<T, Device>::operator() (const int ibasis) const
{
    assert (ibasis >= 0 && ibasis < this->nbasis);
...
template <typename T, typename Device>
int
    Psi<T, Device>::get_current_k () const
{
...
template <typename T, typename Device>
int
    Psi<T, Device>::get_current_b () const
{
...
template <typename T, typename Device>
int
    Psi<T, Device>::get_current_nbas () const
{
    return this->current_nbasis;
}
...
template <typename T, typename Device>
const int&
    Psi<T, Device>::get_ngk (const int ik_in) const
{
...
template <typename T, typename Device>
std::tuple<const T*, int>
    Psi<T, Device>::to_range (const Range& range) const
{
