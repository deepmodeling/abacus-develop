...
class Setup_Psi_pw
{
  public:
    ...
    void before_runner (const UnitCell& ucell,
                        const K_Vectors& kv,
    ...
    int
        get_nbands () const
    {
        return this->psi_cpu->get_nbands ();
    }
    int
        get_nk () const
    {
        return this->psi_cpu->get_nk ();
    }
    int
        get_nbasis () const
    {
        return this->psi_cpu->get_nbasis ();
    }
    size_t
        size () const
    {
        return this->psi_cpu->size ();
    }
    ...
    psi::Psi<T, Device>*
        get_psi_t ()
    {
        return static_cast<psi::Psi<T, Device>*> (psi_t);
    }
    ...
    const psi::Psi<T, Device>*
        get_psi_t () const
    {
        return static_cast<const psi::Psi<T, Device>*> (psi_t);
    }

    // Get psi_d pointer (template version, for backward compatibility)
    template <typename T, typename Device>
    psi::Psi<std::complex<double>, Device>*
        get_psi_d ()
    {
    ...
    template <typename T, typename Device>
    const psi::Psi<std::complex<double>, Device>*
        get_psi_d () const
    {
  ...
  private:
    ...
    template <typename T, typename Device>
    void before_runner_impl (const UnitCell& ucell,
                             const K_Vectors& kv,
                             const Structure_Factor& sf,
                             const ModulePW::PW_Basis_K& pw_wfc,
                             const pseudopot_cell_vnl& ppcell,
