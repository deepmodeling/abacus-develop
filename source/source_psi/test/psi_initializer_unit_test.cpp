...
- Tested functions:
    ...
    - psi_initializer_atomic_random::proj_ao_onkG
      - calculate wavefunction initial guess (before diagonalization) with atomic pseudo wavefunctions and random
numbers
    ...
    - psi_initializer_nao_random::proj_ao_onkG
      - calculate wavefunction initial guess (before diagonalization) with numerical atomic orbital wavefunctions and
random numbers
*/
...
Structure_Factor::~Structure_Factor () {}
void
    Structure_Factor::setup (const UnitCell* Ucell, const Parallel_Grid&, const ModulePW::PW_Basis* rho_basis)
{
}
std::complex<double>*
    Structure_Factor::get_sk (int ik, int it, int ia, ModulePW::PW_Basis_K const* wfc_basis) const
{
...
class PsiIntializerUnitTest : public ::testing::Test
{
  ...
  protected:
        ...
        SetUp () override
    {
        ...
        this->p_ucell->latvec.e11 = 10.0;
        this->p_ucell->latvec.e12 = 0.0;
        this->p_ucell->latvec.e13 = 0.0;
        this->p_ucell->latvec.e21 = 0.0;
        this->p_ucell->latvec.e22 = 10.0;
        this->p_ucell->latvec.e23 = 0.0;
        this->p_ucell->latvec.e31 = 0.0;
        this->p_ucell->latvec.e32 = 0.0;
        this->p_ucell->latvec.e33 = 10.0;
