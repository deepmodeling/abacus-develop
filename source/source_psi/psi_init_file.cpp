...
template <typename T>
void
    psi_init_file<T>::initialize (const Structure_Factor* sf,
...
template <typename T>
void
    psi_init_file<T>::init_psig (T* psig, const int& ik)
{
    ...
    std::string fn = ModuleIO::filename_output (PARAM.globalv.global_readin_dir,
                                                "wf",
                                                "pw",
                                                ik,
                                                this->p_kv->ik2iktot,
