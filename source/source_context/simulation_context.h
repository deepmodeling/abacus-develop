...
#if !defined(ABACUS_CAN_READ_SIMULATION_CONTEXT) && !defined(ABACUS_CAN_BIND_SIMULATION_CONTEXT)
#error "simulation_context.h is restricted to L0/L1 Context-capable targets"
#endif
