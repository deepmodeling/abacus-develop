...
struct blas_gemv_batched<T, DEVICE_GPU>
{
    ...
    {
        hipBlasConnector::gemv_batched (hipblas_handle,
                                        trans,
                                        m,
                                        n,
                                        *alpha,
...
struct blas_gemv_batched_strided<T, DEVICE_GPU>
{
    void
        operator() (const char& trans,
                    ...
                    const int& batch_size)
    {
        hipBlasConnector::gemv_batched_strided (hipblas_handle,
                                                trans,
                                                m,
                                                n,
                                                *alpha,
...
struct blas_gemm_batched<T, DEVICE_GPU>
{
    ...
    {
        hipBlasConnector::
            gemm_batched (hipblas_handle, transa, transb, m, n, k, *alpha, A, lda, B, ldb, *beta, C, ldc, batch_size);
    }
};
...
struct blas_gemm_batched_strided<T, DEVICE_GPU>
{
    void
        operator() (const char& transa,
                    ...
                    const int& batch_size)
    {
        hipBlasConnector::gemm_batched_strided (hipblas_handle,
                                                transa,
                                                transb,
                                                m,
                                                n,
