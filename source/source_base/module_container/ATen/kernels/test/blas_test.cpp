...
TYPED_TEST (BlasTest, Copy)
{
    ...
    const Tensor x = std::move (
        Tensor ({static_cast<Type> (1.0), static_cast<Type> (2.0), static_cast<Type> (3.0)}).to_device<Device> ());
    Tensor y = std::move (
        Tensor ({static_cast<Type> (0.0), static_cast<Type> (0.0), static_cast<Type> (0.0)}).to_device<Device> ());
...
TYPED_TEST (BlasTest, Nrm2)
{
    ...
    const int n = 3;
    const Tensor x = std::move (
        Tensor ({static_cast<Type> (3.0), static_cast<Type> (4.0), static_cast<Type> (0.0)}).to_device<Device> ());
...
TYPED_TEST (BlasTest, Dot)
{
    ...
    const Tensor y = std::move (
        Tensor ({static_cast<Type> (4.0), static_cast<Type> (5.0), static_cast<Type> (6.0)}).to_device<Device> ());
...
TYPED_TEST (BlasTest, Scal)
{
    ...
    const Tensor expected = std::move (
        Tensor ({static_cast<Type> (2.0), static_cast<Type> (4.0), static_cast<Type> (6.0)}).to_device<Device> ());
