...
TYPED_TEST (EinsumOpTest, Stride)
{
    ...
    Tensor expected = std::move (
        Tensor ({static_cast<Type> (1.0), static_cast<Type> (4.0), static_cast<Type> (6.0)}).to_device<Device> ());
...
TYPED_TEST (EinsumOpTest, ContractGemv)
{
    ...
    const Tensor expected_1
        = std::move (Tensor ({static_cast<Type> (20.0), static_cast<Type> (60.0)}).to_device<Device> ());
    const Tensor expected_2 = std::move (
        Tensor (
            {static_cast<Type> (11.0), static_cast<Type> (14.0), static_cast<Type> (17.0), static_cast<Type> (20.0)})
            .to_device<Device> ());
...
TYPED_TEST (EinsumOpTest, ContractGemm)
{
    ...
    Tensor expected_1 = std::move (
        Tensor (
            {static_cast<Type> (50.0), static_cast<Type> (60.0), static_cast<Type> (114.0), static_cast<Type> (140.0)})
            .to_device<Device> ());
