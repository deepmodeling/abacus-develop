...
size_t
    TensorBuffer::GetAllocatedBytes () const
{
...
DeviceType
    TensorBuffer::GetDeviceType () const
{
    if (alloc_ != nullptr)
        {
...
void
    TensorBuffer::resize (size_t size)
{
