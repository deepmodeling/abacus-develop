...
#if __CUDA || __ROCM
using ComplexTypes = ::testing::Types<std::tuple<std::complex<float>, ct::DEVICE_CPU>,
                                      std::tuple<std::complex<float>, ct::DEVICE_GPU>,
                                      std::tuple<std::complex<double>, ct::DEVICE_CPU>,
                                      std::tuple<std::complex<double>, ct::DEVICE_GPU>>;
using Types = ::testing::Types<std::tuple<float, ct::DEVICE_CPU>,
                               std::tuple<float, ct::DEVICE_GPU>,
                               std::tuple<double, ct::DEVICE_CPU>,
                               std::tuple<double, ct::DEVICE_GPU>,
...
#else
using ComplexTypes =
    ::testing::Types<std::tuple<std::complex<float>, ct::DEVICE_CPU>, std::tuple<std::complex<double>, ct::DEVICE_CPU>>;
using Types = ::testing::Types<std::tuple<float, ct::DEVICE_CPU>,
                               std::tuple<double, ct::DEVICE_CPU>,
                               std::tuple<std::complex<float>, ct::DEVICE_CPU>,
                               std::tuple<std::complex<double>, ct::DEVICE_CPU>>;
