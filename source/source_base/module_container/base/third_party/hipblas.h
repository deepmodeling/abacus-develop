...
static inline void
    scal (hipblasHandle_t& handle, const int& n, const float& alpha, float* x, const int& incx)
{
    hipblasErrcheck (hipblasSscal (handle, n, &alpha, x, incx));
}
static inline void
    scal (hipblasHandle_t& handle, const int& n, const double& alpha, double* x, const int& incx)
{
    hipblasErrcheck (hipblasDscal (handle, n, &alpha, x, incx));
}
static inline void
    scal (hipblasHandle_t& handle,
          const int& n,
          const std::complex<float>& alpha,
          std::complex<float>* x,
          const int& incx)
...
template <typename T>
static inline void
    gemv_batched (hipblasHandle_t& handle,
                  const char& trans,
                  const int& m,
                  const int& n,
                  const T& alpha,
...
template <typename T>
static inline void
    gemv_batched_strided (hipblasHandle_t& handle,
                          const char& transa,
                          const int& m,
                          const int& n,
                          const T& alpha,
...
template <typename T>
static inline T**
    allocate_ (T** in, const int& batch_size)
{
    T** out = nullptr;
...
static inline void
    gemm_batched (hipblasHandle_t& handle,
                  const char& transa,
                  const char& transb,
                  const int& m,
                  const int& n,
...
static inline void
    gemm_batched_strided (hipblasHandle_t& handle,
                          const char& transa,
                          const char& transb,
                          const int& m,
                          const int& n,
