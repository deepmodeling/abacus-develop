...
template <typename T>
static inline void
trtri(cusolverDnHandle_t& cusolver_handle, const char& uplo, const char& diag, const int& n, T* A, const int& lda) {
    size_t d_lwork = 0, h_lwork = 0;
    using Type = typename GetTypeThrust<T>::type;
    CHECK_CUSOLVER(cusolverDnXtrtri_bufferSize(cusolver_handle,
                                               cublas_fill_mode(uplo),
                                               cublas_diag_type(diag),
                                               n,
    ...
    CHECK_CUSOLVER(cusolverDnXtrtri(cusolver_handle,
                                    cublas_fill_mode(uplo),
                                    cublas_diag_type(diag),
                                    n,
                                    GetTypeCuda<T>::cuda_data_type,
...
static inline void
potri(cusolverDnHandle_t& cusolver_handle, const char& uplo, const char& diag, const int& n, float* A, const int& lda) {
    int lwork;
...
static inline void potri(cusolverDnHandle_t& cusolver_handle,
                         const char& uplo,
                         const char& diag,
                         const int& n,
                         double* A,
...
static inline void potri(cusolverDnHandle_t& cusolver_handle,
                         ...
                         const int& lda) {
    int lwork;
    CHECK_CUSOLVER(cusolverDnCpotri_bufferSize(cusolver_handle,
                                               cublas_fill_mode(uplo),
                                               n,
    ...
    // Perform Cholesky decomposition
    CHECK_CUSOLVER(cusolverDnCpotri(cusolver_handle,
                                    cublas_fill_mode(uplo),
                                    n,
                                    reinterpret_cast<cuComplex*>(A),
                                    n,
...
static inline void potri(cusolverDnHandle_t& cusolver_handle,
                         ...
                         const int& lda) {
    int lwork;
    CHECK_CUSOLVER(cusolverDnZpotri_bufferSize(cusolver_handle,
                                               cublas_fill_mode(uplo),
                                               n,
    ...
    // Perform Cholesky decomposition
    CHECK_CUSOLVER(cusolverDnZpotri(cusolver_handle,
                                    cublas_fill_mode(uplo),
                                    n,
                                    reinterpret_cast<cuDoubleComplex*>(A),
                                    n,
...
static inline void
potrf(cusolverDnHandle_t& cusolver_handle, const char& uplo, const int& n, float* A, const int& lda) {
    int lwork;
    int* info = nullptr;
...
static inline void
potrf(cusolverDnHandle_t& cusolver_handle, const char& uplo, const int& n, double* A, const int& lda) {
    int lwork;
    int* info = nullptr;
    CHECK_CUDA(cudaMalloc((void**)&info, 1 * sizeof(int)));
...
static inline void
potrf(cusolverDnHandle_t& cusolver_handle, const char& uplo, const int& n, std::complex<float>* A, const int& lda) {
    int lwork;
    int* info = nullptr;
    CHECK_CUDA(cudaMalloc((void**)&info, 1 * sizeof(int)));
    CHECK_CUSOLVER(cusolverDnCpotrf_bufferSize(cusolver_handle,
                                               cublas_fill_mode(uplo),
                                               n,
                                               reinterpret_cast<cuComplex*>(A),
                                               lda,
    ...
    CHECK_CUDA(cudaMalloc((void**)&work, lwork * sizeof(cuComplex)));
    // Perform Cholesky decomposition
    CHECK_CUSOLVER(cusolverDnCpotrf(cusolver_handle,
                                    cublas_fill_mode(uplo),
                                    n,
                                    reinterpret_cast<cuComplex*>(A),
                                    lda,
...
static inline void
potrf(cusolverDnHandle_t& cusolver_handle, const char& uplo, const int& n, std::complex<double>* A, const int& lda) {
    int lwork;
    int* info = nullptr;
    CHECK_CUDA(cudaMalloc((void**)&info, 1 * sizeof(int)));
    CHECK_CUSOLVER(cusolverDnZpotrf_bufferSize(cusolver_handle,
                                               cublas_fill_mode(uplo),
                                               n,
                                               reinterpret_cast<cuDoubleComplex*>(A),
                                               lda,
    ...
    CHECK_CUDA(cudaMalloc((void**)&work, lwork * sizeof(cuDoubleComplex)));
    // Perform Cholesky decomposition
    CHECK_CUSOLVER(cusolverDnZpotrf(cusolver_handle,
                                    cublas_fill_mode(uplo),
                                    n,
                                    reinterpret_cast<cuDoubleComplex*>(A),
                                    lda,
...
static inline void heevd(cusolverDnHandle_t& cusolver_handle,
                         const char& jobz,
                         const char& uplo,
                         const int& n,
                         float* A,
    ...
    CHECK_CUSOLVER(cusolverDnSsyevd_bufferSize(cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnSsyevd(cusolver_handle,
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
                                    A,
...
static inline void heevd(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnDsyevd_bufferSize(cusolver_handle,
                                               cublas_eig_mode(jobz),
                                               cublas_fill_mode(uplo),
                                               n,
                                               A,
    ...
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnDsyevd(cusolver_handle,
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
                                    A,
...
static inline void heevd(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnCheevd_bufferSize(cusolver_handle,
                                               cublas_eig_mode(jobz),
                                               cublas_fill_mode(uplo),
                                               n,
                                               reinterpret_cast<cuComplex*>(A),
    ...
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnCheevd(cusolver_handle,
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
                                    reinterpret_cast<cuComplex*>(A),
...
static inline void heevd(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnZheevd_bufferSize(cusolver_handle,
                                               cublas_eig_mode(jobz),
                                               cublas_fill_mode(uplo),
                                               n,
                                               reinterpret_cast<cuDoubleComplex*>(A),
    ...
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnZheevd(cusolver_handle,
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
                                    reinterpret_cast<cuDoubleComplex*>(A),
...
// =====================================================================================================
// --- float ---
static inline void heevdx(cusolverDnHandle_t& cusolver_handle,
                          const int n,
                          const int lda,
                          float* d_A,
                          const char jobz,
    ...
    CHECK_CUSOLVER(cusolverDnSsyevdx_bufferSize(cusolver_handle,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
                                                n,
    ...
    // Main call
    CHECK_CUSOLVER(cusolverDnSsyevdx(cusolver_handle,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
                                     n,
...
static inline void heevdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnDsyevdx_bufferSize(cusolver_handle,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
                                                n,
    ...
    CHECK_CUSOLVER(cusolverDnDsyevdx(cusolver_handle,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
                                     n,
...
static inline void heevdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnCheevdx_bufferSize(cusolver_handle,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
                                                n,
    ...
    CHECK_CUSOLVER(cusolverDnCheevdx(cusolver_handle,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
                                     n,
...
static inline void heevdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnZheevdx_bufferSize(cusolver_handle,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
                                                n,
    ...
    CHECK_CUSOLVER(cusolverDnZheevdx(cusolver_handle,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
                                     n,
...
static inline void hegvd(cusolverDnHandle_t& cusolver_handle,
                         const int& itype,
                         const char& jobz,
                         const char& uplo,
                         const int& n,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnSsygvd_bufferSize(cusolver_handle,
    ...
    CHECK_CUDA(cudaMalloc((void**)&d_work, sizeof(float) * lwork));
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnSsygvd(cusolver_handle,
                                    cublas_eig_type(itype),
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
...
static inline void hegvd(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnDsygvd_bufferSize(cusolver_handle,
                                               cublas_eig_type(itype),
                                               cublas_eig_mode(jobz),
                                               cublas_fill_mode(uplo),
                                               n,
    ...
    CHECK_CUDA(cudaMalloc((void**)&d_work, sizeof(double) * lwork));
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnDsygvd(cusolver_handle,
                                    cublas_eig_type(itype),
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
...
static inline void hegvd(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnChegvd_bufferSize(cusolver_handle,
                                               cublas_eig_type(itype),
                                               cublas_eig_mode(jobz),
                                               cublas_fill_mode(uplo),
                                               n,
    ...
    CHECK_CUDA(cudaMalloc((void**)&d_work, sizeof(cuComplex) * lwork));
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnChegvd(cusolver_handle,
                                    cublas_eig_type(itype),
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
...
static inline void hegvd(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(cusolverDnZhegvd_bufferSize(cusolver_handle,
                                               cublas_eig_type(itype),
                                               cublas_eig_mode(jobz),
                                               cublas_fill_mode(uplo),
                                               n,
    ...
    CHECK_CUDA(cudaMalloc((void**)&d_work, sizeof(cuDoubleComplex) * lwork));
    // compute eigenvalues and eigenvectors.
    CHECK_CUSOLVER(cusolverDnZhegvd(cusolver_handle,
                                    cublas_eig_type(itype),
                                    cublas_eig_mode(jobz),
                                    cublas_fill_mode(uplo),
                                    n,
...
// --- float ---
static inline void hegvdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnSsygvdx_bufferSize(cusolver_handle,
                                                itype_t,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
    ...
    // Main call
    CHECK_CUSOLVER(cusolverDnSsygvdx(cusolver_handle,
                                     itype_t,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
    ...
    if (h_info < 0) {
        ...
        if (jobz_t == CUSOLVER_EIG_MODE_NOVECTOR && h_info <= n) {
            throw std::runtime_error("hegvdx (float): failed to converge, " + std::to_string(h_info) +
                                     " off-diagonal elements didn't converge");
        } else if (h_info > n) {
            throw std::runtime_error("hegvdx (float): leading minor of order " + std::to_string(h_info - n) +
...
static inline void hegvdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnDsygvdx_bufferSize(cusolver_handle,
                                                itype_t,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
    ...
    CHECK_CUSOLVER(cusolverDnDsygvdx(cusolver_handle,
                                     itype_t,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
    ...
    if (h_info < 0) {
        ...
        if (jobz_t == CUSOLVER_EIG_MODE_NOVECTOR && h_info <= n) {
            throw std::runtime_error("hegvdx (double): failed to converge, " + std::to_string(h_info) +
                                     " off-diagonal elements didn't converge");
        } else if (h_info > n) {
            throw std::runtime_error("hegvdx (double): leading minor of order " + std::to_string(h_info - n) +
                                     " of B is not positive definite");
        }
    }
...
static inline void hegvdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUDA(
        cudaMemcpy(d_A_copy, reinterpret_cast<cuComplex*>(d_A), sizeof(cuComplex) * n * lda, cudaMemcpyDeviceToDevice));
    CHECK_CUDA(
        cudaMemcpy(d_B_copy, reinterpret_cast<cuComplex*>(d_B), sizeof(cuComplex) * n * lda, cudaMemcpyDeviceToDevice));
    ...
    CHECK_CUSOLVER(cusolverDnChegvdx(cusolver_handle,
                                     itype_t,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
    ...
    if (h_info < 0) {
        ...
        if (jobz_t == CUSOLVER_EIG_MODE_NOVECTOR && h_info <= n) {
            throw std::runtime_error("hegvdx (complex<float>): failed to converge, " + std::to_string(h_info) +
                                     " off-diagonal elements didn't converge");
        } else if (h_info > n) {
            throw std::runtime_error("hegvdx (complex<float>): leading minor of order " + std::to_string(h_info - n) +
                                     " of B is not positive definite");
        }
    }
    ...
    if (jobz == 'V') {
        const int m = (*h_meig);
        CHECK_CUDA(cudaMemcpy(reinterpret_cast<cuComplex*>(d_eigen_vec),
                              d_A_copy,
                              sizeof(cuComplex) * n * m,
...
static inline void hegvdx(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUDA(cudaMemcpy(d_A_copy,
                          reinterpret_cast<cuDoubleComplex*>(d_A),
                          sizeof(cuDoubleComplex) * n * lda,
                          cudaMemcpyDeviceToDevice));
    CHECK_CUDA(cudaMemcpy(d_B_copy,
    ...
    CHECK_CUSOLVER(cusolverDnZhegvdx_bufferSize(cusolver_handle,
                                                itype_t,
                                                jobz_t,
                                                range_t,
                                                uplo_t,
    ...
    CHECK_CUSOLVER(cusolverDnZhegvdx(cusolver_handle,
                                     itype_t,
                                     jobz_t,
                                     range_t,
                                     uplo_t,
    ...
    if (h_info < 0) {
        ...
        if (jobz_t == CUSOLVER_EIG_MODE_NOVECTOR && h_info <= n) {
            throw std::runtime_error("hegvdx (complex<double>): failed to converge, " + std::to_string(h_info) +
                                     " off-diagonal elements didn't converge");
        } else if (h_info > n) {
            throw std::runtime_error("hegvdx (complex<double>): leading minor of order " + std::to_string(h_info - n) +
                                     " of B is not positive definite");
        }
    }
    ...
    if (jobz == 'V') {
        const int m = (*h_meig);
        CHECK_CUDA(cudaMemcpy(reinterpret_cast<cuDoubleComplex*>(d_eigen_vec),
                              d_A_copy,
                              sizeof(cuDoubleComplex) * n * m,
                              cudaMemcpyDeviceToDevice));
    }
...
// --- getrf
static inline void
getrf(cusolverDnHandle_t& cusolver_handle, const int& m, const int& n, float* A, const int& lda, int* ipiv) {
...
static inline void
getrf(cusolverDnHandle_t& cusolver_handle, const int& m, const int& n, double* A, const int& lda, int* ipiv) {
...
static inline void getrf(cusolverDnHandle_t& cusolver_handle,
                         const int& m,
                         const int& n,
                         std::complex<float>* A,
                         const int& lda,
...
static inline void getrf(cusolverDnHandle_t& cusolver_handle,
    ...
    // calculate the sizes needed for pre-allocated buffer.
    CHECK_CUSOLVER(
        cusolverDnZgetrf_bufferSize(cusolver_handle, m, n, reinterpret_cast<cuDoubleComplex*>(A), lda, &lwork));
    ...
    // Perform LU decomposition
    CHECK_CUSOLVER(
        cusolverDnZgetrf(cusolver_handle, m, n, reinterpret_cast<cuDoubleComplex*>(A), lda, d_work, ipiv, d_info));
...
static inline void getrs(cusolverDnHandle_t& cusolver_handle,
                         const char& trans,
                         const int& n,
                         const int& nrhs,
                         float* A,
...
static inline void getrs(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnCgetrs(cusolver_handle,
                                    GetCublasOperation(trans),
                                    n,
                                    nrhs,
                                    reinterpret_cast<cuComplex*>(A),
                                    lda,
...
static inline void getrs(cusolverDnHandle_t& cusolver_handle,
    ...
    CHECK_CUSOLVER(cusolverDnZgetrs(cusolver_handle,
                                    GetCublasOperation(trans),
                                    n,
                                    nrhs,
                                    reinterpret_cast<cuDoubleComplex*>(A),
...
// --- float ---
static inline void
geqrf(cusolverDnHandle_t& cusolver_handle, const int m, const int n, float* d_A, const int lda, float* d_tau) {
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnSgeqrf_bufferSize(cusolver_handle, m, n, d_A, lda, &lwork));
    ...
    CHECK_CUSOLVER(cusolverDnSgeqrf(cusolver_handle, m, n, d_A, lda, d_tau, d_work, lwork, d_info));
...
// --- double ---
static inline void
geqrf(cusolverDnHandle_t& cusolver_handle, const int m, const int n, double* d_A, const int lda, double* d_tau) {
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnDgeqrf_bufferSize(cusolver_handle, m, n, d_A, lda, &lwork));
    ...
    CHECK_CUSOLVER(cusolverDnDgeqrf(cusolver_handle, m, n, d_A, lda, d_tau, d_work, lwork, d_info));
...
// --- std::complex<float> ---
static inline void geqrf(cusolverDnHandle_t& cusolver_handle,
                         const int m,
                         const int n,
                         std::complex<float>* d_A,
                         const int lda,
    ...
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnCgeqrf_bufferSize(cusolver_handle,
                                               m,
                                               n,
                                               reinterpret_cast<cuComplex*>(d_A),
                                               lda,
    ...
    CHECK_CUSOLVER(cusolverDnCgeqrf(cusolver_handle,
                                    m,
                                    n,
                                    reinterpret_cast<cuComplex*>(d_A),
                                    lda,
...
static inline void geqrf(cusolverDnHandle_t& cusolver_handle,
    ...
    int lwork = 0;
    CHECK_CUSOLVER(
        cusolverDnZgeqrf_bufferSize(cusolver_handle, m, n, reinterpret_cast<cuDoubleComplex*>(d_A), lda, &lwork));
    ...
    CHECK_CUSOLVER(cusolverDnZgeqrf(cusolver_handle,
                                    m,
                                    n,
                                    reinterpret_cast<cuDoubleComplex*>(d_A),
                                    lda,
...
// --- float ---
static inline void orgqr(cusolverDnHandle_t& cusolver_handle,
                         const int m,
                         const int n,
                         const int k,
                         float* d_A,
                         ...
                         float* d_tau) {
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnSorgqr_bufferSize(cusolver_handle, m, n, k, d_A, lda, d_tau, &lwork));
    ...
    CHECK_CUSOLVER(cusolverDnSorgqr(cusolver_handle, m, n, k, d_A, lda, d_tau, d_work, lwork, d_info));
...
static inline void orgqr(cusolverDnHandle_t& cusolver_handle,
                         ...
                         double* d_tau) {
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnDorgqr_bufferSize(cusolver_handle, m, n, k, d_A, lda, d_tau, &lwork));
    ...
    CHECK_CUSOLVER(cusolverDnDorgqr(cusolver_handle, m, n, k, d_A, lda, d_tau, d_work, lwork, d_info));
...
static inline void orgqr(cusolverDnHandle_t& cusolver_handle,
                         ...
                         std::complex<float>* d_tau) {
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnCungqr_bufferSize(cusolver_handle,
                                               m,
                                               n,
                                               k,
                                               reinterpret_cast<cuComplex*>(d_A),
    ...
    CHECK_CUSOLVER(cusolverDnCungqr(cusolver_handle,
                                    m,
                                    n,
                                    k,
                                    reinterpret_cast<cuComplex*>(d_A),
...
static inline void orgqr(cusolverDnHandle_t& cusolver_handle,
                         ...
                         std::complex<double>* d_tau) {
    int lwork = 0;
    CHECK_CUSOLVER(cusolverDnZungqr_bufferSize(cusolver_handle,
                                               m,
                                               n,
                                               k,
                                               reinterpret_cast<cuDoubleComplex*>(d_A),
    ...
    CHECK_CUSOLVER(cusolverDnZungqr(cusolver_handle,
                                    m,
                                    n,
                                    k,
                                    reinterpret_cast<cuDoubleComplex*>(d_A),
