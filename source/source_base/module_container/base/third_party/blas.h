...
extern "C"
{
    ...
    void
        zcopy_ (const int* n, const std::complex<double>* a, const int* incx, std::complex<double>* b, int const* incy);
...
// x=a*x
static inline void
    scal (const int& n, const float& alpha, float* x, const int& incx)
{
...
static inline void
    scal (const int& n, const std::complex<float>& alpha, std::complex<float>* x, const int& incx)
{
...
// d=x*y
static inline float
    dot (const int& n, const float* x, const int& incx, const float* y, const int& incy)
{
    return sdot_ (&n, x, &incx, y, &incy);
}
static inline double
    dot (const int& n, const double* x, const int& incx, const double* y, const int& incy)
{
...
template <typename T>
static inline void
    gemm_batched (const char& transa,
                  const char& transb,
                  const int& m,
                  const int& n,
                  const int& k,
...
template <typename T>
static inline void
    gemm_batched_strided (const char& transa,
                          const char& transb,
                          const int& m,
                          const int& n,
                          const int& k,
...
template <typename T>
static inline void
    gemv_batched_strided (const char& transa,
                          const int& m,
                          const int& n,
                          const T& alpha,
                          const T* A,
...
// out = ||x||_2
static inline float
    nrm2 (const int n, const float* x, const int incx)
{
...
static inline double
    nrm2 (const int n, const std::complex<float>* x, const int incx)
{
    return scnrm2_ (&n, x, &incx);
}
static inline double
    nrm2 (const int n, const std::complex<double>* x, const int incx)
{
...
// copies a into b
static inline void
    copy (const int n, const float* a, const int incx, float* b, const int incy)
{
    scopy_ (&n, a, &incx, b, &incy);
}
static inline void
    copy (const int n, const double* a, const int incx, double* b, const int incy)
