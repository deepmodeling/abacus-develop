...
static inline void
    potrf (const char& uplo, const int& n, std::complex<float>* A, const int& lda, int& info)
{
    cpotrf_ (&uplo, &n, A, &lda, &info);
}
static inline void
    potrf (const char& uplo, const int& n, std::complex<double>* A, const int& lda, int& info)
{
    zpotrf_ (&uplo, &n, A, &lda, &info);
}

static inline void
    trtri (const char& uplo, const char& diag, const int& n, float* A, const int& lda, int& info)
{
    strtri_ (&uplo, &diag, &n, A, &lda, &info);
}
static inline void
    trtri (const char& uplo, const char& diag, const int& n, double* A, const int& lda, int& info)
{
...
static inline void
    getrf (const int m, const int n, std::complex<float>* A, const int lda, int* ipiv, int& info)
{
    cgetrf_ (&m, &n, A, &lda, ipiv, &info);
}
static inline void
    getrf (const int m, const int n, std::complex<double>* A, const int lda, int* ipiv, int& info)
{
