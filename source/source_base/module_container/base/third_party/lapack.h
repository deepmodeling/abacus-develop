...
static inline int
ilaenv(int ispec, const char* name, const char* opts, const int n1, const int n2, const int n3, const int n4) {
    const int nb = ilaenv_(&ispec, name, opts, &n1, &n2, &n3, &n4);
    return nb;
}
// wrap function of fortran lapack routine zhegvd. (pointer version)
static inline void hegvd(const int itype,
                         const char jobz,
                         const char uplo,
                         const int n,
                         float* a,
...
static inline void hegvx(const int itype,
                         const char jobz,
                         const char range,
                         const char uplo,
                         const int n,
...
static inline void heevx(const char jobz,
                         const char range,
                         const char uplo,
                         const int n,
                         float* a,
...
static inline void heevd(const char jobz,
                         const char uplo,
                         const int n,
                         float* a,
                         const int lda,
...
static inline void potrf(const char& uplo, const int& n, float* A, const int& lda, int& info) {
    spotrf_(&uplo, &n, A, &lda, &info);
}
static inline void potrf(const char& uplo, const int& n, double* A, const int& lda, int& info) {
    dpotrf_(&uplo, &n, A, &lda, &info);
}
static inline void potrf(const char& uplo, const int& n, std::complex<float>* A, const int& lda, int& info) {
    cpotrf_(&uplo, &n, A, &lda, &info);
}
static inline void potrf(const char& uplo, const int& n, std::complex<double>* A, const int& lda, int& info) {
    zpotrf_(&uplo, &n, A, &lda, &info);
}

static inline void trtri(const char& uplo, const char& diag, const int& n, float* A, const int& lda, int& info) {
    strtri_(&uplo, &diag, &n, A, &lda, &info);
}
static inline void trtri(const char& uplo, const char& diag, const int& n, double* A, const int& lda, int& info) {
    dtrtri_(&uplo, &diag, &n, A, &lda, &info);
}
static inline void
trtri(const char& uplo, const char& diag, const int& n, std::complex<float>* A, const int& lda, int& info) {
    ctrtri_(&uplo, &diag, &n, A, &lda, &info);
}
static inline void
trtri(const char& uplo, const char& diag, const int& n, std::complex<double>* A, const int& lda, int& info) {
...
static inline void
getri(const int n, float* A, const int lda, const int* ipiv, float* work, const int lwork, int& info) {
    sgetri_(&n, A, &lda, ipiv, work, &lwork, &info);
}
static inline void
getri(const int n, double* A, const int lda, const int* ipiv, double* work, const int lwork, int& info) {
    dgetri_(&n, A, &lda, ipiv, work, &lwork, &info);
}
static inline void getri(const int n,
                         std::complex<float>* A,
                         const int lda,
                         const int* ipiv,
                         std::complex<float>* work,
...
static inline void getrs(const char& trans,
                         const int n,
                         const int nrhs,
                         float* A,
                         const int lda,
...
static inline void geqrf(const int m,
                         const int n,
                         std::complex<float>* A,
                         const int lda,
                         std::complex<float>* tau,
...
static inline void orgqr(const int m,
                         const int n,
                         const int k,
                         float* A,
                         const int lda,
