...
double
    w_becke (int nR0, const double* drR, const double* dRR, int nR, const int* iR, int c)
{
    assert (nR > 0 && nR0 >= nR);
...
double
    w_stratmann (int nR0, const double* drR, const double* dRR, const double* drR_thr, int nR, int* iR, int c)
{
    assert (nR > 0 && nR0 >= nR);
    int I = iR[c], J = 0;
