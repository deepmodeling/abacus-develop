                         ...
                         base_device::AbacusDevice_t device_type)
{
    ...
    {
        mtfunc::sgemm_mth_(&transb, &transa, &n, &m, &k, &alpha, b, &ldb, a, &lda, &beta, c, &ldc, GlobalV::MY_RANK);
    }
#endif
#ifdef __CUDA
                            ...
                            base_device::AbacusDevice_t device_type)
{
    ...
    {
        mtfunc::sgemm_mth_(&transb, &transa, &m, &n, &k, &alpha, a, &lda, b, &ldb, &beta, c, &ldc, GlobalV::MY_RANK);
    }
#endif
#ifdef __CUDA
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
                            ...
                            base_device::AbacusDevice_t device_type)
{
    ...
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
    {
        cublasSideMode_t sideMode = BlasUtils::judge_side(side);
        cublasFillMode_t fillMode = BlasUtils::judge_fill(uplo);
        cublasErrcheck(cublasCsymm(BlasUtils::cublas_handle,
                                   sideMode,
                                   fillMode,
                                   m,
                                   n,
                            ...
                            base_device::AbacusDevice_t device_type)
{
    ...
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
    {
        cublasSideMode_t sideMode = BlasUtils::judge_side(side);
        cublasFillMode_t fillMode = BlasUtils::judge_fill(uplo);
        cublasErrcheck(cublasZsymm(BlasUtils::cublas_handle,
                                   sideMode,
                                   fillMode,
                                   m,
                                   n,
                            ...
                            base_device::AbacusDevice_t device_type)
{
    ...
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
    {
        cublasSideMode_t sideMode = BlasUtils::judge_side(side);
        cublasFillMode_t fillMode = BlasUtils::judge_fill(uplo);
        cublasErrcheck(cublasChemm(BlasUtils::cublas_handle,
                                   sideMode,
                                   fillMode,
                                   m,
                                   n,
                            ...
                            base_device::AbacusDevice_t device_type)
{
    ...
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
    {
        cublasSideMode_t sideMode = BlasUtils::judge_side(side);
        cublasFillMode_t fillMode = BlasUtils::judge_fill(uplo);
        cublasErrcheck(cublasZhemm(BlasUtils::cublas_handle,
                                   sideMode,
                                   fillMode,
                                   m,
                                   n,
                         ...
                         base_device::AbacusDevice_t device_type)
{
    ...
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
    {
        ...
        cublasErrcheck(cublasCgemv(BlasUtils::cublas_handle,
                                   cutransA,
                                   m,
                                   n,
                                   &alpha_cu,
                         ...
                         base_device::AbacusDevice_t device_type)
{
    ...
    else if (device_type == base_device::AbacusDevice_t::GpuDevice)
    {
        ...
        cublasOperation_t cutransA = BlasUtils::judge_trans(true, trans, "gemv_op");
        cublasErrcheck(cublasZgemv(BlasUtils::cublas_handle,
                                   cutransA,
                                   m,
                                   n,
                                   &alpha_cu,
