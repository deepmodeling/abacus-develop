...
Lebedev_laikov_grid::Lebedev_laikov_grid (int degree)
{
    ...
    if (it == allowed_degree.end ())
        {
            std::cerr << "In the Lebedev_laikov_grid class, the degree = " << degree
                      << " is not within the allowed range." << std::endl;
            assert (false);
        }
...
void
    Lebedev_laikov_grid::print_grid_and_weight (std::string filename)
{
    std::stringstream ss;
...
void
    Lebedev_laikov_grid::generate_grid_points ()
{
    int start = 0;
    double a = 0.0;
    double b = 0.0;
...
int
    Lebedev_laikov_grid::getLebedevReccurencePoints (int type, int start, double a, double b, double v)
{
