...
static inline double xflow(uint32_t sign, double y) {
    y = (sign ? -y : y) * y;
    return y;
}

static inline double __math_uflow(uint32_t sign) { return xflow(sign, 1.2882297539194267e-231); }

static inline double __math_oflow(uint32_t sign) { return xflow(sign, 3.105036184601418e+231); }
...
double __exp(double x) {
    ...
    if ((abstop - top12(5.551115123125783e-17) >= top12(512.0) - top12(5.551115123125783e-17))) {
