...
template <typename T, typename Device>
void
    PGemmCN<T, Device>::set_dimension (
#ifdef __MPI
        MPI_Comm comm_col,
        MPI_Comm comm_row,
#endif
...
template <typename T, typename Device>
void
    PGemmCN<T, Device>::multiply (const T alpha, const T* A, const T* B, const T beta, T* C)
{
...
template <typename T, typename Device>
void
    PGemmCN<T, Device>::multiply_single (const T alpha, const T* A, const T* B, const T beta, T* C)
{
    const Device* ctx = {};
#ifdef __MPI
...
template <typename T, typename Device>
void
    PGemmCN<T, Device>::multiply_col (const T alpha, const T* A, const T* B, const T beta, T* C)
{
    const Device* ctx = {};
...
template <typename T, typename Device>
void
    PGemmCN<T, Device>::multiply_row (const T alpha, const T* A, const T* B, const T beta, T* C)
{
    const Device* ctx = {};
