...
class atom_in {
  public:
    ...
    std::map<std::string, int> principle_quantum_number = {
        {"H", 1},  {"He", 1}, {"Li", 2}, {"Be", 2}, {"B", 2},  {"C", 2},  {"N", 2},  {"O", 2},  {"F", 2},  {"Ne", 1},
        {"Na", 2}, {"Mg", 3}, {"Al", 3}, {"Si", 3}, {"P", 3},  {"S", 3},  {"Cl", 3}, {"Ar", 2}, {"K", 3},  {"Ca", 4},
        {"Sc", 4}, {"Ti", 4}, {"V", 4},  {"Cr", 4}, {"Mn", 4}, {"Fe", 4}, {"Co", 4}, {"Ni", 4}, {"Cu", 4}, {"Zn", 4},
        {"Ga", 4}, {"Ge", 4}, {"As", 4}, {"Se", 4}, {"Br", 4}, {"Kr", 3}, {"Rb", 4}, {"Sr", 5}, {"Y", 5},  {"Zr", 5},
        {"Nb", 5}, {"Mo", 5}, {"Tc", 5}, {"Ru", 5}, {"Rh", 5}, {"Pd", 5}, {"Ag", 5}, {"Cd", 5}, {"In", 5}, {"Sn", 5},
        {"Sb", 5}, {"Te", 5}, {"I", 5},  {"Xe", 4}, {"Cs", 5}, {"Ba", 6}, {"La", 6}, {"Ce", 6}, {"Pr", 6}, {"Nd", 6},
        {"Pm", 6}, {"Sm", 6}, {"Eu", 6}, {"Gd", 6}, {"Tb", 6}, {"Dy", 6}, {"Ho", 6}, {"Er", 6}, {"Tm", 6}, {"Yb", 6},
        {"Lu", 6}, {"Hf", 6}, {"Ta", 6}, {"W", 6},  {"Re", 6}, {"Os", 6}, {"Ir", 6}, {"Pt", 6}, {"Au", 6}, {"Hg", 6},
        {"Tl", 6}, {"Pb", 6}, {"Bi", 6}, {"Po", 6}, {"At", 6}, {"Rn", 6}, {"Fr", 7}, {"Ra", 7}, {"Ac", 7}, {"Th", 7},
        {"Pa", 7}, {"U", 7},  {"Np", 7}, {"Pu", 7}, {"Am", 7}, {"Cm", 7}, {"Bk", 7}, {"Cf", 7}, {"Es", 7}, {"Fm", 7},
        {"Md", 7}, {"No", 7}, {"Lr", 7}, {"Rf", 7}, {"Db", 7}, {"Sg", 7}, {"Bh", 7}, {"Hs", 7}, {"Mt", 7}, {"Ds", 7},
        {"Rg", 7}, {"Cn", 7}, {"Nh", 7}, {"Fl", 7}, {"Mc", 7}, {"Lv", 7}, {"Ts", 7}, {"Og", 7}};
    /// @brief ground state electron configuration, sequence of orbitals in key is in accord with the sequence of n then
    /// l
    ...
    std::map<std::string, std::vector<int>> groundstate_electronconfiguration = {
        ...
        {"Na", {2, 2, 6, 1}},
        {"Mg", {2, 2, 6, 2}}, // 3rd period
                              //      1s 2s 2p 3s 3p           1s 2s 2p 3s 3p           1s 2s 2p 3s 3p
        {"Al", {2, 2, 6, 2, 1}},
        {"Si", {2, 2, 6, 2, 2}},
        {"P", {2, 2, 6, 2, 3}}, // 3rd period
        {"S", {2, 2, 6, 2, 4}},
        {"Cl", {2, 2, 6, 2, 5}},
        {"Ar", {2, 2, 6, 2, 6}}, // 3rd period
        //      1s 2s 2p 3s 3p 3d 4s           1s 2s 2p 3s 3p 3d 4s            1s 2s 2p 3s 3p 3d 4s
        {"K", {2, 2, 6, 2, 6, 0, 1}},
        {"Ca", {2, 2, 6, 2, 6, 0, 2}},
        {"Sc", {2, 2, 6, 2, 6, 1, 2}}, // 4th period
        {"Ti", {2, 2, 6, 2, 6, 2, 2}},
        {"V", {2, 2, 6, 2, 6, 3, 2}},
        {"Cr", {2, 2, 6, 2, 6, 4, 2}}, // 4th period
        {"Mn", {2, 2, 6, 2, 6, 5, 2}},
        {"Fe", {2, 2, 6, 2, 6, 6, 2}},
        {"Co", {2, 2, 6, 2, 6, 7, 2}}, // 4th period
        {"Ni", {2, 2, 6, 2, 6, 8, 2}},
        {"Cu", {2, 2, 6, 2, 6, 10, 1}},
        {"Zn", {2, 2, 6, 2, 6, 10, 2}}, // 4th period
                                        //      1s 2s 2p 3s 3p 3d  4s 4p           1s 2s 2p 3s 3p 3d  4s 4p           1s
                                        //      2s 2p 3s 3p 3d  4s 4p
        {"Ga", {2, 2, 6, 2, 6, 10, 2, 1}},
        {"Ge", {2, 2, 6, 2, 6, 10, 2, 2}},
        {"As", {2, 2, 6, 2, 6, 10, 2, 3}}, // 4th period
        {"Se", {2, 2, 6, 2, 6, 10, 2, 4}},
        {"Br", {2, 2, 6, 2, 6, 10, 2, 5}},
        {"Kr", {2, 2, 6, 2, 6, 10, 2, 6}}, // 4th period
                                           //      1s 2s 2p 3s 3p 3d  4s 4p 4d 4f 5s            1s 2s 2p 3s 3p 3d  4s 4p
                                           //      4d 4f 5s            1s 2s 2p 3s 3p 3d  4s 4p 4d 4f 5s
        {"Rb", {2, 2, 6, 2, 6, 10, 2, 6, 0, 0, 1}},
        {"Sr", {2, 2, 6, 2, 6, 10, 2, 6, 0, 0, 2}},
        {"Y", {2, 2, 6, 2, 6, 10, 2, 6, 1, 0, 2}}, // 5th period
        {"Zr", {2, 2, 6, 2, 6, 10, 2, 6, 2, 0, 2}},
        {"Nb", {2, 2, 6, 2, 6, 10, 2, 6, 4, 0, 1}},
        {"Mo", {2, 2, 6, 2, 6, 10, 2, 6, 5, 0, 1}}, // 5th period
        {"Tc", {2, 2, 6, 2, 6, 10, 2, 6, 5, 0, 2}},
        {"Ru", {2, 2, 6, 2, 6, 10, 2, 6, 7, 0, 1}},
        {"Rh", {2, 2, 6, 2, 6, 10, 2, 6, 8, 0, 1}}, // 5th period
        {"Pd", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 0}},
        {"Ag", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 1}},
        {"Cd", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2}}, // 5th period
                                                     //      1s 2s 2p 3s 3p 3d  4s 4p 4d  4f 5s 5p           1s 2s 2p 3s
                                                     //      3p 3d  4s 4p 4d  4f 5s 5p           1s 2s 2p 3s 3p 3d  4s
                                                     //      4p 4d  4f 5s 5p
        {"In", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 1}},
        {"Sn", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 2}},
        {"Sb", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 3}}, // 6th period
        {"Te", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 4}},
        {"I", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 5}},
        {"Xe", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 6}}, // 6th period
                                                        //      1s 2s 2p 3s 3p 3d  4s 4p 4d  4f 5s 5p 5d 5f 5g 6s 1s 2s
                                                        //      2p 3s 3p 3d  4s 4p 4d  4f 5s 5p 5d 5f 5g 6s
        {"Cs", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 6, 0, 0, 0, 1}},
        {"Ba", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 6, 0, 0, 0, 2}}, // 6th period
        {"La", {2, 2, 6, 2, 6, 10, 2, 6, 10, 0, 2, 6, 1, 0, 0, 2}},
        {"Ce", {2, 2, 6, 2, 6, 10, 2, 6, 10, 1, 2, 6, 1, 0, 0, 2}}, // 6th period
        {"Pr", {2, 2, 6, 2, 6, 10, 2, 6, 10, 3, 2, 6, 0, 0, 0, 2}},
        {"Nd", {2, 2, 6, 2, 6, 10, 2, 6, 10, 4, 2, 6, 0, 0, 0, 2}}, // 6th period
        {"Pm", {2, 2, 6, 2, 6, 10, 2, 6, 10, 5, 2, 6, 0, 0, 0, 2}},
        {"Sm", {2, 2, 6, 2, 6, 10, 2, 6, 10, 6, 2, 6, 0, 0, 0, 2}}, // 6th period
        {"Eu", {2, 2, 6, 2, 6, 10, 2, 6, 10, 7, 2, 6, 0, 0, 0, 2}},
        {"Gd", {2, 2, 6, 2, 6, 10, 2, 6, 10, 7, 2, 6, 1, 0, 0, 2}}, // 6th period
        {"Tb", {2, 2, 6, 2, 6, 10, 2, 6, 10, 9, 2, 6, 0, 0, 0, 2}},
        {"Dy", {2, 2, 6, 2, 6, 10, 2, 6, 10, 10, 2, 6, 0, 0, 0, 2}}, // 6th period
        {"Ho", {2, 2, 6, 2, 6, 10, 2, 6, 10, 11, 2, 6, 0, 0, 0, 2}},
        {"Er", {2, 2, 6, 2, 6, 10, 2, 6, 10, 12, 2, 6, 0, 0, 0, 2}}, // 6th period
        {"Tm", {2, 2, 6, 2, 6, 10, 2, 6, 10, 13, 2, 6, 0, 0, 0, 2}},
        {"Yb", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 0, 0, 0, 2}}, // 6th period
        {"Lu", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 1, 0, 0, 2}},
        {"Hf", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 2, 0, 0, 2}}, // 6th period
        {"Ta", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 3, 0, 0, 2}},
        {"W", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 4, 0, 0, 2}}, // 6th period
        {"Re", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 5, 0, 0, 2}},
        {"Os", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 6, 0, 0, 2}}, // 6th period
        {"Ir", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 7, 0, 0, 2}},
        {"Pt", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 9, 0, 0, 1}}, // 6th period
        {"Au", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 1}},
        {"Hg", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2}}, // 6th period
                                                                      //      1s 2s 2p 3s 3p 3d  4s 4p 4d  4f  5s 5p 5d
                                                                      //      5f 5g 6s 6p           1s 2s 2p 3s 3p 3d 4s
                                                                      //      4p 4d  4f  5s 5p 5d  5f 5g 6s 6p
        {"Tl", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2, 1}},
        {"Pb", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2, 2}}, // 6th period
        {"Bi", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2, 3}},
        {"Po", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2, 4}}, // 6th period
        {"At", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2, 5}},
        {"Rn", {2, 2, 6, 2, 6, 10, 2, 6, 10, 14, 2, 6, 10, 0, 0, 2, 6}} // 6th period
    };
};
