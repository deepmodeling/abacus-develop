...
template <typename T>
__global__ void
    vector_mul_real_kernel (const int size, T* result, const T* vector, const typename GetTypeReal<T>::type constant)
{
...
template <typename T>
__global__ void
    vector_mul_vector_kernel (const int size,
                              T* result,
                              const T* vector1,
...
template <typename T>
__global__ void
    vector_div_constant_kernel (const int size,
                                T* result,
                                const T* vector,
...
template <typename T>
__global__ void
    vector_div_vector_kernel (const int size, T* result, const T* vector1, const typename GetTypeReal<T>::type* vector2)
{
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    if (i < size)
        {
...
__global__ void
    constantvector_addORsub_constantVector_kernel (const int size,
                                                   T* result,
                                                   const T* vector1,
...
template <>
void
    vector_mul_real_op<double, base_device::DEVICE_GPU>::operator() (const int dim,
                                                                     double* result,
                                                                     const double* vector,
...
inline void
    vector_mul_real_wrapper (const int dim,
...
template <>
void
    vector_mul_real_op<std::complex<float>, base_device::DEVICE_GPU>::operator() (const int dim,
...
template <>
void
    vector_mul_real_op<std::complex<double>, base_device::DEVICE_GPU>::operator() (const int dim,
...
template <>
void
    vector_div_constant_op<double, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                         double* result,
                                                                         const double* vector,
                                                                         const double constant)
{
...
template <typename FPTYPE>
inline void
    vector_div_constant_wrapper (const int& dim,
                                 std::complex<FPTYPE>* result,
                                 const std::complex<FPTYPE>* vector,
                                 const FPTYPE constant)
{
...
template <>
void
    vector_div_constant_op<std::complex<float>, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                                      std::complex<float>* result,
                                                                                      const std::complex<float>* vector,
                                                                                      const float constant)
{
...
template <>
void
    vector_div_constant_op<std::complex<double>, base_device::DEVICE_GPU>::operator() (
        const int& dim,
        std::complex<double>* result,
        const std::complex<double>* vector,
        const double constant)
...
template <>
void
    vector_mul_vector_op<double, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                       double* result,
...
template <typename FPTYPE>
inline void
    vector_mul_vector_complex_wrapper (const int& dim,
                                       std::complex<FPTYPE>* result,
...
template <>
void
    vector_mul_vector_op<std::complex<float>, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                                    std::complex<float>* result,
...
template <>
void
    vector_mul_vector_op<std::complex<double>, base_device::DEVICE_GPU>::operator() (
        const int& dim,
        std::complex<double>* result,
...
template <>
void
    vector_div_vector_op<double, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                       double* result,
                                                                       const double* vector1,
                                                                       const double* vector2)
{
...
template <typename FPTYPE>
inline void
    vector_div_vector_complex_wrapper (const int& dim,
                                       std::complex<FPTYPE>* result,
                                       const std::complex<FPTYPE>* vector1,
                                       const FPTYPE* vector2)
{
...
template <>
void
    vector_div_vector_op<std::complex<float>, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                                    std::complex<float>* result,
                                                                                    const std::complex<float>* vector1,
                                                                                    const float* vector2)
{
...
template <>
void
    vector_div_vector_op<std::complex<double>, base_device::DEVICE_GPU>::operator() (
        const int& dim,
        std::complex<double>* result,
        const std::complex<double>* vector1,
        const double* vector2)
...
template <typename T>
void
    vector_add_vector_op<T, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                                  T* result,
                                                                  const T* vector1,
                                                                  const Real constant1,
                                                                  const T* vector2,
...
template <>
double
    dot_real_op<double, base_device::DEVICE_GPU>::operator() (const int& dim,
                                                              const double* psi_L,
                                                              const double* psi_R,
                                                              const bool reduce)
{
...
template <typename FPTYPE>
inline FPTYPE
    dot_complex_wrapper (const int& dim,
...
template <>
float
    dot_real_op<std::complex<float>, base_device::DEVICE_GPU>::operator() (const int& dim,
...
template <>
double
    dot_real_op<std::complex<double>, base_device::DEVICE_GPU>::operator() (const int& dim,
