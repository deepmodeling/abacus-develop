...
sph_harm(const int nwl, const double x_in, const double y_in, const double z_in, double* __restrict__ ylma) {
    ...
    ***************************/
    ...
    ylma[25] = ylmcoef[24] * z * ylma[16] - tmp0; // l=5,m=0
...
__device__ static void grad_rl_sph_harm(const int nwl,
                                        const double x,
                                        const double y,
                                        const double z,
    ...
    ***************************/
    ...
    grly[42] =
        ylmcoef[12] * grly[30] - ylmcoef[13] * (rly[2] * tx + grly[6] * r2) - ylmcoef[14] * (rly[7] + x * grly[21]);
    ...
    grly[45] =
        ylmcoef[12] * grly[33] - ylmcoef[13] * (rly[3] * tx + grly[9] * r2) - ylmcoef[14] * (rly[8] + x * grly[24]);
    ...
    ***************************/
    ...
    grly[69] =
        ylmcoef[21] * grly[57] - ylmcoef[22] * (rly[7] * tx + grly[21] * r2) - ylmcoef[23] * (x * grly[42] + rly[14]);
    ...
    grly[72] =
        ylmcoef[21] * grly[60] - ylmcoef[22] * (rly[8] * tx + grly[24] * r2) - ylmcoef[23] * (x * grly[45] + rly[15]);
    ...
    ***************************/
    ...
    grly[102] =
        ylmcoef[33] * grly[90] - ylmcoef[34] * (rly[14] * tx + grly[42] * r2) - ylmcoef[35] * (x * grly[69] + rly[23]);
    ...
    grly[105] =
        ylmcoef[33] * grly[93] - ylmcoef[34] * (rly[15] * tx + grly[45] * r2) - ylmcoef[35] * (x * grly[72] + rly[24]);
