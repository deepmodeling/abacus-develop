...
__device__ static void
    grad_rl_sph_harm (const int nwl,
                      const double x,
                      const double y,
                      const double z,
                      ...
                      double* __restrict__ grly)
{
    ...
    ***************************/
    ...
    grly[102] = ylmcoef[33] * grly[90] - ylmcoef[34] * (rly[14] * tx + grly[42] * r2)
                - ylmcoef[35] * (x * grly[69] + rly[23]);
    ...
    grly[105] = ylmcoef[33] * grly[93] - ylmcoef[34] * (rly[15] * tx + grly[45] * r2)
                - ylmcoef[35] * (x * grly[72] + rly[24]);
