    ...
    for (int l = 0; l <= lmax; l++)
        {
            ...
            if (l == 0)
            ...
            else
                {
                    ...
                    p[l * (lmax + 1) * ng + l * ng + ig]
                        = __semi_fact (l3) * pow (x2, static_cast<double> (l) / 2.0); // mohan modify 2007-10-13
                    if (l % 2 == 1)
                        {
            ...
            for (int m = 1; m <= l; m++)
                {
                    // Y_lm, m > 0
                    const FPTYPE same = c * sqrt (__fact<double> (l - m) / __fact<double> (l + m)) * SQRT2;
                                                                  ...
                                                                  FPTYPE* ylm)
{
    ...
    hipLaunchKernelGGL (HIP_KERNEL_NAME (cal_ylm_real<FPTYPE>),
                        dim3 (block),
