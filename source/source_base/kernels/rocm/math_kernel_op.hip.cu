...
template <>
void matrix_mul_vector_op<double, base_device::DEVICE_GPU>::operator()(const int& m,
                                                                       const int& n,
                                                                       double* a,
                                                                       const int& lda,
                                                                       const double* b,
...
template <>
void matrix_mul_vector_op<std::complex<float>, base_device::DEVICE_GPU>::operator()(const int& m,
                                                                                    const int& n,
                                                                                    std::complex<float>* a,
                                                                                    const int& lda,
                                                                                    const float* b,
...
template <>
void matrix_mul_vector_op<std::complex<double>, base_device::DEVICE_GPU>::operator()(const int& m,
                                                                                     const int& n,
