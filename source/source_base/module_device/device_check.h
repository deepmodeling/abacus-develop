...
static const char*
    _cublasGetErrorString (cublasStatus_t error)
{
    switch (error)
        {
...
static const char*
    _cusolverGetErrorString (cusolverStatus_t error)
{
    switch (error)
        {
...
static const char*
    _cufftGetErrorString (cufftResult_t error)
{
    switch (error)
        {
        case CUFFT_SUCCESS:
...
static const char*
    _calGetErrorString (calError_t error)
{
    switch (error)
        {
        case CAL_OK:
...
static const char*
    _hipblasGetErrorString (hipblasStatus_t error)
{
    switch (error)
        {
...
static const char*
    _hipfftGetErrorString (hipfftResult_t error)
{
    switch (error)
        {
        case HIPFFT_SUCCESS:
...
static const char*
    _hipsolverGetErrorString (hipsolverStatus_t error)
{
    switch (error)
        {
