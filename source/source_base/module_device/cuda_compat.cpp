...
//---------------------------------------------------------------------------
void
    printDeprecatedDeviceInfo (std::ostream& ofs_device, const cudaDeviceProp& deviceProp)
{
...
void
    printComputeModeInfo (std::ostream& ofs_device, const cudaDeviceProp& deviceProp)
{
#if defined(CUDA_VERSION) && CUDA_VERSION < 13000
    char msg[1024];
    sprintf (msg,
