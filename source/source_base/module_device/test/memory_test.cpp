...
class TestModulePsiMemory : public ::testing::Test {
  protected:
    const std::vector<double> xx = {-0.65412617, -0.74208893, -2.21731157, 0.42540039, 3.36373004,  -2.51647562,
                                    -2.985111,   -0.53251562, 0.37908265,  0.81605825, 1.66281318,  2.71761869,
                                    2.2010268,   0.65498149,  1.51153638,  0.71501482, 0.53546578,  1.4564317,
                                    -2.36701143, 1.23009056,  3.41302551,  -2.3175205, -0.27628221, -1.35701656};
...
TEST_F(TestModulePsiMemory, synchronize_memory_op_complex_double_cpu_to_gpu) {
    ...
    synchronize_memory_complex_double_cpu_to_gpu_op()(thrust::raw_pointer_cast(dz_xx), z_xx.data(), z_xx.size());
