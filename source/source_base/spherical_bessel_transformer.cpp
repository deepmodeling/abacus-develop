...
void SphericalBesselTransformer::Impl::_tabulate(const int l,
                                                 const int ngrid_in,
                                                 const double* const grid_in,
                                                 const int ngrid_out,
                                                 const double* const grid_out) {
...
size_t SphericalBesselTransformer::heap_usage() const { return impl_->heap_usage(); }

void SphericalBesselTransformer::clear() { impl_->clear(); }
