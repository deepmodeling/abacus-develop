...
class Matrix_Wrapper
{
  public:
    ...
    inline Matrix_Wrapper&
        operator= (const Matrix_Wrapper& m)
    {
        nr = m.nr;
        nc = m.nc;
        c = m.c;
...
inline void
    Matrix_Wrapper::create (const int nr_in, const int nc_in, const bool flag_zero)
{
    nr = nr_in;
    nc = nc_in;
    c = new double[nr * nc];
