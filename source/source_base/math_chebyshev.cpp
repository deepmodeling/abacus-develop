...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::getpolyval (const REAL x, REAL* polyval, const int N)
{
    polyval[0] = 1;
    polyval[1] = x;
    for (int i = 2; i < N; ++i)
...
template <typename REAL, typename Device>
inline REAL
    Chebyshev<REAL, Device>::recurs (const REAL x, const REAL Tn, REAL const Tn_1)
{
    return 2 * x * Tn - Tn_1;
}
...
template <typename REAL, typename Device>
REAL
    Chebyshev<REAL, Device>::ddot_real (const std::complex<REAL>* psi_L,
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::calcoef_real (std::function<REAL (REAL)> fun)
{
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::calcoef_complex (std::function<std::complex<REAL> (std::complex<REAL>)> fun)
{
    std::complex<REAL>* pcoef = (std::complex<REAL>*)this->fftw.ccoef;
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::calcoef_pair (std::function<REAL (REAL)> fun1, std::function<REAL (REAL)> fun2)
{
    std::complex<REAL>* pcoef = (std::complex<REAL>*)this->fftw.ccoef;
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::calfinalvec_real (
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::calfinalvec_complex (
        std::function<void (std::complex<REAL>*, std::complex<REAL>*, const int)> funA,
        std::complex<REAL>* wavein,
        std::complex<REAL>* waveout,
        const int N,
        ...
        const int m)
{
    ...
    for (int ior = 2; ior < norder; ++ior)
        {
            recurs_complex (funA, arraynp1, arrayn, arrayn_1, N, LDA, m);
            container::kernels::blas_axpy<std::complex<REAL>, ct_Device> () (ndmxt,
                                                                             &coefc_cpu[ior],
                                                                             arraynp1,
                                                                             1,
                                                                             waveout,
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::calpolyvec_complex (
        std::function<void (std::complex<REAL>*, std::complex<REAL>*, const int)> funA,
        std::complex<REAL>* wavein,
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::tracepolyA (
...
template <typename REAL, typename Device>
void
    Chebyshev<REAL, Device>::recurs_complex (
        std::function<void (std::complex<REAL>* in, std::complex<REAL>* out, const int)> funA,
...
template <typename REAL, typename Device>
bool
    Chebyshev<REAL, Device>::checkconverge (
        std::function<void (std::complex<REAL>* in, std::complex<REAL>* out, const int)> funA,
        std::complex<REAL>* wavein,
        const int N,
        const int LDA,
