 ...
 */
void
    Opt_CG::refresh (int nx_new, double* pinp_b)
{
    this->iter_ = 0;
    this->alpha_ = 0.;
    this->beta_ = 0.;
 ...
 */
void
    Opt_CG::next_direct (double* pgradient, int label, double* rdirect)
{
 ...
 */
double
    Opt_CG::step_length (double* pAd, double* pdirect, int& ifPD)
{
 ...
 */
void
    Opt_CG::stantard_CGdirect (double* pAd, double* rdirect)
{
    if (this->iter_ == 0)
        {
            for (int i = 0; i < this->nx_; ++i)
 ...
 */
void
    Opt_CG::PR_beta (double* pgradient)
{
    double temp_beta = 0.;
 ...
 */
void
    Opt_CG::HZ_beta (double* pgradient)
{
