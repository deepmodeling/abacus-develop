...
void
    Sph_Bessel_Recursive::D1::set_dx (const double dx_in)
{
...
const std::vector<std::vector<double>>&
    Sph_Bessel_Recursive::D1::cal_jlx (const int lmax, const size_t ix_size)
{
    if (lmax < 0)
        {
...
void
    Sph_Bessel_Recursive::D1::cal_jlx_0 (const int l_size)
{
...
void
    Sph_Bessel_Recursive::D1::cal_jlx_smallx (const int l_size, const size_t ix_size)
{
    if (jlx.size () < static_cast<size_t> (l_size))
        {
            jlx.resize (l_size);
...
void
    Sph_Bessel_Recursive::D1::cal_jlx_recursive (const int l_size, const size_t ix_size)
{
    if (jlx.size () < static_cast<size_t> (l_size))
        {
            jlx.resize (l_size);
