...
class ComplexArray
{
  public:
    ...
    std::complex<double>&
        operator() (const int ind1 = 0, const int ind2 = 0, const int ind3 = 0, const int ind4 = 0)
    {
        assert (ind1 >= 0);
        assert (ind1 < bound1);
        assert (ind2 >= 0);
    ...
    const std::complex<double>&
        operator() (const int ind1 = 0, const int ind2 = 0, const int ind3 = 0, const int ind4 = 0) const
    {
        assert (ind1 >= 0);
        assert (ind1 < bound1);
        assert (ind2 >= 0);
