...
void
    CHECK_NAME (std::ifstream& ifs, const std::string& name_in, bool quit)
{
    std::string name;
    ifs >> name;
    if (name != name_in)
...
void
    CHECK_INT (std::ifstream& ifs, const int& v, bool quit)
{
    int v_in = 0;
    ifs >> v_in;
    if (v != v_in)
...
void
    CHECK_DOUBLE (std::ifstream& ifs, const double& v, bool quit)
{
...
void
    CHECK_STRING (std::ifstream& ifs, const std::string& v, bool quit)
{
    std::string v_in;
    ifs >> v_in;
    if (v_in != v)
