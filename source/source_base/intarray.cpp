...
IntArray::IntArray (IntArray&& other) noexcept
    : size (other.size), dim (other.dim), bound1 (other.bound1), bound2 (other.bound2), bound3 (other.bound3),
      bound4 (other.bound4), bound5 (other.bound5), bound6 (other.bound6), ptr (other.ptr)
{
    other.ptr = nullptr;
    other.size = 0;
    other.dim = 0;
