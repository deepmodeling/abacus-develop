...
class FFT_DSP : public FFT_BASE<FPTYPE>
{
  public:
     ...
     *
     */
    virtual __attribute__ ((weak)) void initfft (int nx_in, int ny_in, int nz_in) override;

    /**
     * @brief Get the real space data
     * @return real space data
     */
    virtual __attribute__ ((weak)) std::complex<FPTYPE>* get_auxr_3d_data () const override;
