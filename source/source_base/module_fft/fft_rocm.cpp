...
void
    FFT_ROCM<FPTYPE>::initfft (int nx_in, int ny_in, int nz_in)
{
    this->nx = nx_in;
    this->ny = ny_in;
    this->nz = nz_in;
...
template <>
void
    FFT_ROCM<float>::fft3D_forward (std::complex<float>* in, std::complex<float>* out) const
{
...
template <>
void
    FFT_ROCM<double>::fft3D_forward (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_ROCM<float>::fft3D_backward (std::complex<float>* in, std::complex<float>* out) const
{
    CHECK_CUFFT (hipfftExecC2C (this->c_handle,
                                reinterpret_cast<hipfftComplex*> (in),
                                reinterpret_cast<hipfftComplex*> (out),
...
template <>
void
    FFT_ROCM<double>::fft3D_backward (std::complex<double>* in, std::complex<double>* out) const
{
    CHECK_CUFFT (hipfftExecZ2Z (this->z_handle,
                                reinterpret_cast<hipfftDoubleComplex*> (in),
                                reinterpret_cast<hipfftDoubleComplex*> (out),
...
template <>
std::complex<float>*
    FFT_ROCM<float>::get_auxr_3d_data () const
{
    return this->c_auxr_3d;
}
template <>
std::complex<double>*
    FFT_ROCM<double>::get_auxr_3d_data () const
{
