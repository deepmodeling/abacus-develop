    ...
    FFT_CPU<float>::setupFFT ()
{
    ...
    //					                fftw_complex *out, const int *onembed, int ostride, int odist, int sign,
    // unsigned flags);
...
template <>
void
    FFT_CPU<float>::clearfft (fftwf_plan& plan)
{
    if (plan)
        {
...
template <>
void
    FFT_CPU<float>::fftxyfor (std::complex<float>* in, std::complex<float>* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
    ...
    else
        {
            ...
            fftwf_execute_dft (this->planfxfor1, (fftwf_complex*)in, (fftwf_complex*)out);
            fftwf_execute_dft (this->planfxfor2,
                               (fftwf_complex*)&in[rixy * nplane],
                               (fftwf_complex*)&out[rixy * nplane]);
        }
}
template <>
void
    FFT_CPU<float>::fftxybac (std::complex<float>* in, std::complex<float>* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
        ...
        {
            fftwf_execute_dft (this->planfxbac1, (fftwf_complex*)in, (fftwf_complex*)out);
            fftwf_execute_dft (this->planfxbac2,
                               (fftwf_complex*)&in[rixy * nplane],
                               (fftwf_complex*)&out[rixy * nplane]);
...
template <>
void
    FFT_CPU<float>::fftzfor (std::complex<float>* in, std::complex<float>* out) const
{
    fftwf_execute_dft (this->planfzfor, (fftwf_complex*)in, (fftwf_complex*)out);
}
template <>
void
    FFT_CPU<float>::fftzbac (std::complex<float>* in, std::complex<float>* out) const
{
    fftwf_execute_dft (this->planfzbac, (fftwf_complex*)in, (fftwf_complex*)out);
}
template <>
void
    FFT_CPU<float>::fftxyr2c (float* in, std::complex<float>* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
...
template <>
void
    FFT_CPU<float>::fftxyc2r (std::complex<float>* in, float* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
...
template <>
float*
    FFT_CPU<float>::get_rspace_data () const
{
    return s_rspace;
}
template <>
std::complex<float>*
    FFT_CPU<float>::get_auxr_data () const
{
    return c_auxr;
}
template <>
std::complex<float>*
    FFT_CPU<float>::get_auxg_data () const
{
    return c_auxg;
}
} // namespace ModuleBase