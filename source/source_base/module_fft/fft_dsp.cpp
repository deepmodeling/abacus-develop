...
template <>
void
    FFT_DSP<double>::initfft (int nx_in, int ny_in, int nz_in)
{
    this->nx = nx_in;
    this->ny = ny_in;
    this->nz = nz_in;
...
template <>
void
    FFT_DSP<double>::resource_handler (const int flag) const
{
    if (flag == 0)
        {
...
template <>
void
    FFT_DSP<double>::fft3D_forward (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_DSP<double>::fft3D_backward (std::complex<double>* in, std::complex<double>* out) const
{
