...
void
    FFT_CPU<FPTYPE>::initfft (int nx_in,
                              int ny_in,
                              int nz_in,
                              int lixy_in,
                              int rixy_in,
...
template <>
void
    FFT_CPU<double>::clearfft (fftw_plan& plan)
{
    if (plan)
        {
...
template <>
void
    FFT_CPU<double>::fftxyfor (std::complex<double>* in, std::complex<double>* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
...
template <>
void
    FFT_CPU<double>::fftxybac (std::complex<double>* in, std::complex<double>* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
...
template <>
void
    FFT_CPU<double>::fftzfor (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_CPU<double>::fftzbac (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_CPU<double>::fftxyr2c (double* in, std::complex<double>* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
...
template <>
void
    FFT_CPU<double>::fftxyc2r (std::complex<double>* in, double* out) const
{
    int npy = this->nplane * this->ny;
    if (this->xprime)
        {
...
template <>
double*
    FFT_CPU<double>::get_rspace_data () const
{
    return d_rspace;
}
template <>
std::complex<double>*
    FFT_CPU<double>::get_auxr_data () const
{
    return z_auxr;
}
template <>
std::complex<double>*
    FFT_CPU<double>::get_auxg_data () const
{
    return z_auxg;
}
