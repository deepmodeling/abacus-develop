...
{
FFT_Bundle::~FFT_Bundle () { this->clear (); }

void
    FFT_Bundle::setfft (std::string device_in, std::string precision_in)
{
...
void
    FFT_Bundle::resource_handler (const int flag) const
{
    if (this->device == "dsp")
        {
            if (double_flag)
...
template <>
void
    FFT_Bundle::fftxyfor (std::complex<float>* in, std::complex<float>* out) const
{
    fft_float->fftxyfor (in, out);
}
template <>
void
    FFT_Bundle::fftxyfor (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_Bundle::fftzfor (std::complex<float>* in, std::complex<float>* out) const
{
    fft_float->fftzfor (in, out);
}
template <>
void
    FFT_Bundle::fftzfor (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_Bundle::fftxybac (std::complex<float>* in, std::complex<float>* out) const
{
    fft_float->fftxybac (in, out);
}
template <>
void
    FFT_Bundle::fftxybac (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_Bundle::fftzbac (std::complex<float>* in, std::complex<float>* out) const
{
    fft_float->fftzbac (in, out);
}
template <>
void
    FFT_Bundle::fftzbac (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_Bundle::fftxyr2c (float* in, std::complex<float>* out) const
{
    fft_float->fftxyr2c (in, out);
}
template <>
void
    FFT_Bundle::fftxyr2c (double* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_Bundle::fftxyc2r (std::complex<float>* in, float* out) const
{
    fft_float->fftxyc2r (in, out);
}
template <>
void
    FFT_Bundle::fftxyc2r (std::complex<double>* in, double* out) const
{
...
template <>
void
    FFT_Bundle::fft3D_forward (std::complex<float>* in, std::complex<float>* out) const
{
    fft_float->fft3D_forward (in, out);
}
template <>
void
    FFT_Bundle::fft3D_forward (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
void
    FFT_Bundle::fft3D_backward (std::complex<float>* in, std::complex<float>* out) const
{
    fft_float->fft3D_backward (in, out);
}
template <>
void
    FFT_Bundle::fft3D_backward (std::complex<double>* in, std::complex<double>* out) const
{
...
template <>
float*
    FFT_Bundle::get_rspace_data () const
{
...
template <>
std::complex<float>*
    FFT_Bundle::get_auxr_data () const
{
...
template <>
std::complex<float>*
    FFT_Bundle::get_auxg_data () const
{
...
template <>
std::complex<float>*
    FFT_Bundle::get_auxr_3d_data () const
{
