...
class Vector3
{
  public:
     ...
     */
    void
        set (const T& x1, const T& y1, const T& z1)
    {
        x = x1;
        y = y1;
        z = z1;
...
template <class T>
inline Vector3<T>
    operator+ (const Vector3<T>& u, const Vector3<T>& v)
{
...
template <class T>
inline Vector3<T>
    operator* (const T& s, const Vector3<T>& u)
{
...
template <class T>
inline Vector3<T>
    operator* (const Vector3<T>& u, const T& s)
{
    return Vector3<T> (u.x * s, u.y * s, u.z * s);
} // mohan add 2009-5-10
...
template <class T>
void
    Vector3<T>::print (const int precision) const
{
...
template <class T>
static std::ostream&
    operator<< (std::ostream& os, const Vector3<T>& u)
{
