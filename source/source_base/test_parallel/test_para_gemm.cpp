...
void
    random_data (std::vector<double>& A_global,
...
void
    random_data (std::vector<std::complex<double>>& A_global,
...
double
    get_double (std::complex<double>& val)
{
    return val.real () + val.imag ();
}
double
    get_double (double& val)
{
    return val;
}

void
    scatterv_data (const double* sendbuf,
...
void
    scatterv_data (const std::complex<double>* sendbuf,
                   const int* sendcounts,
                   const int* displs,
...
class PgemmTest : public ::testing::Test
{
  ...
  public:
    void
        decide_ngroup (const int& willing_ncolgroup, const int& willing_nrowgroup)
    {
    ...
    void
        prepare (const int& ncolA_global,
    ...
    void
        getncol_and_row (const int& ncolA_global, const int& ncolB_global, const int& nrow_global)
    {
    ...
    void
        scatter_matrix (const int& ncolA_global,
                        const int& ncolB_global,
                        const int& nrow_global,
                        const int& LDA_global,
                        const int& LDB_global)
    ...
    void
        compare_result (const int& nrowC_global, const int& ncolC_global, const int& LDC_global)
    {
