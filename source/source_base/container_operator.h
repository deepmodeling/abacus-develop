...
template <typename T>
std::vector<T>
    operator+ (const std::vector<T>& x1, const std::vector<T>& x2)
{
...
std::map<T1, T2>
    operator+ (const std::map<T1, T2>& x1, const std::map<T1, T2>& x2)
{
    assert (x1.size () == x2.size ());
    std::map<T1, T2> x;
...
template <typename T1, typename T2>
std::vector<T2>
    operator* (const T1& x1, const std::vector<T2>& x2)
{
    std::vector<T2> x;
...
std::map<T21, T22>
    operator* (const T1& x1, const std::map<T21, T22>& x2)
{
    std::map<T21, T22> x;
