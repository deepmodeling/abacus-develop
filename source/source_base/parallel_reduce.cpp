...
template <>
void
    Parallel_Reduce::reduce_all<int> (int& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<long long> (long long& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_int_diag (int& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<double> (double& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<float> (float& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<int> (int* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<long long> (long long* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_int_grid (int* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<double> (double* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_grid (double* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_diag (double* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<float> (float& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<double> (double& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<int> (int* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<double> (double* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_allpool (const int& npool, const int& nproc_in_pool, double& object)
{
    if (npool == 1)
        {
            return;
...
// (2) we need to reduce the value from different pool.
void
    Parallel_Reduce::reduce_double_allpool (const int& npool, const int& nproc_in_pool, double* object, const int n)
{
    if (npool == 1)
        {
            return;
...
template <>
void
    Parallel_Reduce::reduce_all<std::complex<double>> (std::complex<double>& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<std::complex<double>> (std::complex<double>* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<std::complex<float>> (std::complex<float>& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_all<std::complex<float>> (std::complex<float>* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<std::complex<double>> (std::complex<double>& object)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<std::complex<float>> (std::complex<float>* object, const int n)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_pool<std::complex<double>> (std::complex<double>* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::gather_int_all (int& v, int* all)
{
#ifdef __MPI
    assert (all != nullptr);
...
template <>
void
    Parallel_Reduce::reduce_min<int> (int& v)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_min<float> (float& v)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_min<double> (double& v)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_max<float> (float& v)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_max<double> (double& v)
{
#ifdef __MPI
...
template <>
void
    Parallel_Reduce::reduce_max_pool<double> (const int& nproc_in_pool, double& v)
{
#ifdef __MPI
    if (nproc_in_pool == 1)
        {
...
template <>
void
    Parallel_Reduce::reduce_min_pool<double> (const int& nproc_in_pool, double& v)
{
#ifdef __MPI
    if (nproc_in_pool == 1)
        {
