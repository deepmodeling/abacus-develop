...
inline void
    EXPECT_COMPLEX_EQ (const std::complex<double>& a, const std::complex<double>& b)
{
...
TEST_F (ComplexMatrixTest, OperatorParentheses) { EXPECT_EQ (cm22 (0, 0), cm22.c[0]); }
...
TEST_F (ComplexMatrixTest, Trace) { EXPECT_COMPLEX_EQ (trace (cm22), std::complex<double>{5.0, 7.0}); }
...
TEST_F (ComplexMatrixTest, abs2) { EXPECT_EQ (abs2 (cm22), 84.0); }
