...
class MemoryTest : public testing::Test {
  protected:
    ...
    std::ofstream ofs;
    std::ifstream ifs;
    void TearDown() { remove("tmp"); }
};

TEST_F(MemoryTest, Constructor) { EXPECT_NO_THROW(ModuleBase::Memory mem); }

TEST_F(MemoryTest, CalculateMem) {
    // three types of complex number
    EXPECT_EQ(ModuleBase::Memory::calculate_mem(n, "ModuleBase::ComplexMatrix"), n * complex_matrix_mem);
    EXPECT_EQ(ModuleBase::Memory::calculate_mem(n, "complexmatrix"), n * complex_matrix_mem);
    EXPECT_EQ(ModuleBase::Memory::calculate_mem(n, "cdouble"), n * complex_matrix_mem);
    ...
    EXPECT_EQ(ModuleBase::Memory::calculate_mem(n, "ModuleBase::Vector3<double>"), n * 3 * double_mem);
    ...
    EXPECT_EQ(ModuleBase::Memory::calculate_mem(n, "AtomLink"), n * (int_mem * 2 + 3 * double_mem));
