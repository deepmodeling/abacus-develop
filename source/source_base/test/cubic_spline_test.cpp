...
CubicSplineTest::CubicSplineTest ()
    : n_max_ (1000), spline_ (3 * n_max_), x_ (spline_.data ()), y_ (x_ + n_max_), dy_ (y_ + n_max_),
      n_interp_max_ (1000), interp_ (7 * n_interp_max_), x_interp_ (interp_.data ()),
      y_interp_ (x_interp_ + n_interp_max_), dy_interp_ (y_interp_ + n_interp_max_),
      d2y_interp_ (dy_interp_ + n_interp_max_), y_ref_ (d2y_interp_ + n_interp_max_), dy_ref_ (y_ref_ + n_interp_max_),
...
double
    CubicSplineTest::error_bound (int n, const double* x, const std::function<double (double)>& d4f, int d) const
{
...
void
    CubicSplineTest::read (const std::string& fname,
                           int& n,
                           double* x,
                           double* y,
                           BoundaryCondition& bc_start,
