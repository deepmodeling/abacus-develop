...
class toolfunc
{
  public:
    ...
    std::complex<double>
        expi (std::complex<double> x)
    {
        const std::complex<double> j (0.0, 1.0);
        return exp (j * x);
    }
    std::complex<double>
        expi2 (std::complex<double> x)
    {
        const std::complex<double> j (0.0, 1.0);
    ...
    double factor = 1;
    void
        sigma_y (std::complex<double>* spin_in, std::complex<double>* spin_out, const int m = 1)
    {
        const std::complex<double> j (0.0, 1.0);
        if (this->LDA < 2)
            {
    ...
    std::complex<float>
        expi (std::complex<float> x)
    {
        const std::complex<float> j (0.0, 1.0);
        return exp (j * x);
    }
    std::complex<float>
        expi2 (std::complex<float> x)
    {
        const std::complex<float> j (0.0, 1.0);
    ...
    // Pauli matrix: [0,-i;i,0]
    void
        sigma_y (std::complex<float>* spin_in, std::complex<float>* spin_out, const int m = 1)
    {
        const std::complex<float> j (0.0, 1.0);
        if (this->LDA < 2)
            this->LDA = 2;
