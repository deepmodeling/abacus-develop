...
TEST_F (Matrix3Test, Det)
{
    ...
    double determinant = ma.e11 * ma.e22 * ma.e33 - ma.e11 * ma.e32 * ma.e23 - ma.e12 * ma.e21 * ma.e33
                         + ma.e12 * ma.e31 * ma.e23 + ma.e13 * ma.e21 * ma.e32 - ma.e13 * ma.e22 * ma.e31;
...
TEST_F (Matrix3Test, Transpose)
{
    ...
    ma = get_random_matrix3 ();
    mb = ma.Transpose ();
    EXPECT_EQ (ma.e11, mb.e11);
    EXPECT_EQ (ma.e12, mb.e21);
    EXPECT_EQ (ma.e13, mb.e31);
    EXPECT_EQ (ma.e21, mb.e12);
    EXPECT_EQ (ma.e22, mb.e22);
    EXPECT_EQ (ma.e23, mb.e32);
    EXPECT_EQ (ma.e31, mb.e13);
    EXPECT_EQ (ma.e32, mb.e23);
    EXPECT_EQ (ma.e33, mb.e33);
}
...
TEST_F (Matrix3Test, Assignment)
{
    ...
    mb = ma;
    EXPECT_EQ (ma.e11, mb.e11);
    EXPECT_EQ (ma.e12, mb.e12);
    EXPECT_EQ (ma.e13, mb.e13);
    EXPECT_EQ (ma.e21, mb.e21);
    EXPECT_EQ (ma.e22, mb.e22);
    EXPECT_EQ (ma.e23, mb.e23);
    EXPECT_EQ (ma.e31, mb.e31);
    EXPECT_EQ (ma.e32, mb.e32);
    EXPECT_EQ (ma.e33, mb.e33);
}
...
TEST_F (Matrix3Test, AddEqual)
{
    ...
    ma = get_random_matrix3 ();
    mb += ma;
    EXPECT_EQ (ma.e11 + 1.0, mb.e11);
    EXPECT_EQ (ma.e12, mb.e12);
    EXPECT_EQ (ma.e13, mb.e13);
    EXPECT_EQ (ma.e21, mb.e21);
    EXPECT_EQ (ma.e22 + 1.0, mb.e22);
    EXPECT_EQ (ma.e23, mb.e23);
    EXPECT_EQ (ma.e31, mb.e31);
    EXPECT_EQ (ma.e32, mb.e32);
    EXPECT_EQ (ma.e33 + 1.0, mb.e33);
}
...
TEST_F (Matrix3Test, MinusEqual)
{
    ...
    ma = get_random_matrix3 ();
    mb -= ma;
    EXPECT_EQ (1.0 - ma.e11, mb.e11);
    EXPECT_EQ (-ma.e12, mb.e12);
    EXPECT_EQ (-ma.e13, mb.e13);
    EXPECT_EQ (-ma.e21, mb.e21);
    EXPECT_EQ (1.0 - ma.e22, mb.e22);
    EXPECT_EQ (-ma.e23, mb.e23);
    EXPECT_EQ (-ma.e31, mb.e31);
    EXPECT_EQ (-ma.e32, mb.e32);
    EXPECT_EQ (1.0 - ma.e33, mb.e33);
}
...
TEST_F (Matrix3Test, MultiplyEqual)
{
    ...
    mb = ma;
    mb *= 3.0;
    EXPECT_EQ (ma.e11 * 3.0, mb.e11);
    EXPECT_EQ (ma.e12 * 3.0, mb.e12);
    EXPECT_EQ (ma.e13 * 3.0, mb.e13);
    EXPECT_EQ (ma.e21 * 3.0, mb.e21);
    EXPECT_EQ (ma.e22 * 3.0, mb.e22);
    EXPECT_EQ (ma.e23 * 3.0, mb.e23);
    EXPECT_EQ (ma.e31 * 3.0, mb.e31);
    EXPECT_EQ (ma.e32 * 3.0, mb.e32);
    EXPECT_EQ (ma.e33 * 3.0, mb.e33);
}
...
TEST_F (Matrix3Test, MmultiplyNum)
{
    ...
    EXPECT_EQ (ma.e32 * 3.0, mb.e32);
    EXPECT_EQ (ma.e33 * 3.0, mb.e33);
    EXPECT_EQ (ma.e11 * 3.0, mc.e11);
    EXPECT_EQ (ma.e12 * 3.0, mc.e12);
    EXPECT_EQ (ma.e13 * 3.0, mc.e13);
    EXPECT_EQ (ma.e21 * 3.0, mc.e21);
    EXPECT_EQ (ma.e22 * 3.0, mc.e22);
    EXPECT_EQ (ma.e23 * 3.0, mc.e23);
    EXPECT_EQ (ma.e31 * 3.0, mc.e31);
    EXPECT_EQ (ma.e32 * 3.0, mc.e32);
    EXPECT_EQ (ma.e33 * 3.0, mc.e33);
}
...
TEST_F (Matrix3Test, ToMatrix)
{
    ...
    ma = get_random_matrix3 ();
    mb = ma.to_matrix ();
    EXPECT_EQ (ma.e11, mb (0, 0));
    EXPECT_EQ (ma.e12, mb (0, 1));
    EXPECT_EQ (ma.e13, mb (0, 2));
    EXPECT_EQ (ma.e21, mb (1, 0));
    EXPECT_EQ (ma.e22, mb (1, 1));
    EXPECT_EQ (ma.e23, mb (1, 2));
    EXPECT_EQ (ma.e31, mb (2, 0));
    EXPECT_EQ (ma.e32, mb (2, 1));
    EXPECT_EQ (ma.e33, mb (2, 2));
}
