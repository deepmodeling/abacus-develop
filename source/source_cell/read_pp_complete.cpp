...
void
    Pseudopot_upf::complete_default (Atom_pseudo& pp)
{
...
void
    Pseudopot_upf::complete_default_h (Atom_pseudo& pp)
{
...
void
    Pseudopot_upf::complete_default_atom (Atom_pseudo& pp)
{
    ...
    if (br)
        {
            ...
            pp.msh = 2 * static_cast<int> ((pp.msh + 1) / 2)
                     - 1; // Use static_cast instead of C-style cast for type safety
        }
    else
        {
            pp.msh = pp.mesh;
...
void
    Pseudopot_upf::complete_default_vl (Atom_pseudo& pp)
{
