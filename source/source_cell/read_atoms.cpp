...
bool unitcell::read_atom_positions(UnitCell& ucell,
    ...
    if (ModuleBase::GlobalFunc::SCAN_LINE_BEGIN(ifpos, "ATOMIC_POSITIONS")) {
        ...
        for (int it = 0; it < ntype; it++) {
            ...
            if (!unitcell::read_atom_type_header(it, ucell, ifpos, ofs_running, ofs_warning, set_element_mag_zero)) {
                return false;
            }
            ...
            if (na > 0) {
                ...
                for (int ia = 0; ia < na; ia++) {
                    ...
                    if (!unitcell::parse_atom_properties(ifpos,
                                                         ucell.atoms[it],
                                                         ia,
                                                         mv,
                                                         input_vec_mag,
                    ...
                    unitcell::process_magnetization(ucell.atoms[it],
                                                    it,
                                                    ia,
                                                    nspin,
                                                    input_vec_mag,
                    ...
                    unitcell::transform_atom_coordinates(ucell.atoms[it],
                                                         ia,
                                                         Coordinate,
                                                         v,
                                                         ucell.latvec,
