...
{
void
    print_tau (Atom* atoms, const std::string& Coordinate, const int ntype, const double lat0, std::ofstream& ofs)
{
    ...
    // Cartesian_angstrom_center_yz and Cartesian_angstrom_center_xyz
    ...
    ofs << std::setw (5) << "atom" << std::setw (19) << "vx" << std::setw (19) << "vy" << std::setw (19) << "vz"
        << std::endl;
...
void
    print_stru_file (const UnitCell& ucell,
                     const Atom* atoms,
