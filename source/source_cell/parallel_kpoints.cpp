...
void
    Parallel_Kpoints::kinfo (int& nkstot_in,
                             const int& kpar_in,
...
void
    Parallel_Kpoints::set_startpro_pool ()
{
...
void
    Parallel_Kpoints::gatherkvec (const std::vector<ModuleBase::Vector3<double>>& vec_local,
...
void
    Parallel_Kpoints::pool_collection (double* value_re,
                                       double* value_im,
...
void
    Parallel_Kpoints::pool_collection (std::complex<double>* value,
...
void
    Parallel_Kpoints::pool_collection_aux (T* value, const V& w, const int& dim, const int& ik) const
{
#ifdef __MPI
    const int ik_now = ik - this->startk_pool[this->my_pool];
