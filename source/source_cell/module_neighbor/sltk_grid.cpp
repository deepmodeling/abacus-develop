...
void
    Grid::init (std::ofstream& ofs_in, const UnitCell& ucell, const double radius_in, const bool boundary)
{
...
void
    Grid::Check_Expand_Condition (const UnitCell& ucell)
{
...
void
    Grid::setMemberVariables (std::ofstream& ofs_in, //  output data to ofs
                            ...
                            for (int i = 0; i < ucell.ntype; i++)
                                {
                                    for (int j = 0; j < ucell.atoms[i].na; j++)
                                        {
                                            double x
                                                = ucell.atoms[i].tau[j].x + vec1[0] * ix + vec2[0] * iy + vec3[0] * iz;
                                            double y
                                                = ucell.atoms[i].tau[j].y + vec1[1] * ix + vec2[1] * iy + vec3[1] * iz;
                                            double z
                                                = ucell.atoms[i].tau[j].z + vec1[2] * ix + vec2[2] * iy + vec3[2] * iz;
...
void
    Grid::Construct_Adjacent (const UnitCell& ucell)
{
...
void
    Grid::Construct_Adjacent_near_box (const FAtom& fatom)
{
...
void
    Grid::Construct_Adjacent_final (const FAtom& fatom1, FAtom* fatom2)
{
