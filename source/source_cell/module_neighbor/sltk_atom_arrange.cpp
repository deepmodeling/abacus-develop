...
double
    atom_arrange::set_sr_NL (std::ofstream& ofs_in,
...
void
    atom_arrange::search (const bool pbc_flag,
                          std::ofstream& ofs_in,
                          Grid_Driver& grid_d,
    ...
    if (test_only)
        {
            ...
            ofs_in << " " << std::setw (5) << "Type" << std::setw (5) << "Atom" << std::setw (8) << "AdjNum"
                   << std::endl;
            std::cout << std::setw (8) << "Labels" << std::setw (15) << "tau.x" << std::setw (15) << "tau.y"
                      << std::setw (15) << "tau.z" << std::setw (8) << "box.x" << std::setw (8) << "box.y"
                      << std::setw (8) << "box.z" << std::endl;
                    ...
                    for (int ia = 0; ia < ucell.atoms[it].na; ia++)
                        {
                            ...
                            ofs_in << " " << std::setw (5) << it << std::setw (5) << ia << std::setw (8)
                                   << grid_d.getAdjacentNum () + 1 << std::endl;
                            ...
                            for (int ad = 0; ad < grid_d.getAdjacentNum() + 1; ad++)
                            {
                                ...
                                std::cout << std::setw(8) << ucell.atoms[it].label + std::to_string(ia + 1) <<
                            std::setw(15)
                                          << tau.x << " " << std::setw(15) << tau.y << " " << std::setw(15) << tau.z <<
                            " "
                                          << std::setw(8) << box.x << std::setw(8) << box.y << std::setw(8) << box.z <<
                            std::endl;
                            }*/
                        }
                }
