    ...
    for (int stru = 0; stru < stru_lib.size (); stru++)
        {
            ...
            symm.veccon (gtrans_veccon,
                         ...
                         symm.a3);
            for (int i = 0; i < symm.nrotk; ++i)
                EXPECT_EQ (gtrans_optconf[i],
                           ModuleBase::Vector3<double> (gtrans_optconf_veccon[i * 3],
                                                        gtrans_optconf_veccon[i * 3 + 1],
                                                        gtrans_optconf_veccon[i * 3 + 2]));
            ...
            symm.gmatrix_convert_int (gmatrix_input_back,
                                      gmatrix_opt_back,
                                      symm.nrotk,
                                      ucell.latvec,
                                      symm.optlat); // 3->4
            ...
            for (int i = 0; i < symm.nrotk; ++i)
                {
                    ...
                    if (!symm.equal (tmpG.e13, tmpG_int.e13) || !symm.equal (tmpG.e23, tmpG_int.e23)
                        || !symm.equal (tmpG.e12, tmpG_int.e12))
                        {
                            std::cout << "stru_ibrav:" << stru_lib[stru].ibrav << std::endl;
                            std::cout << "isymm: " << i << std::endl;
                            std::cout << "kgmatrix[i], int:" << std::endl;
                            std::cout << symm.kgmatrix[i].e11 << " " << symm.kgmatrix[i].e12 << " "
                                      << symm.kgmatrix[i].e13 << std::endl;
                            std::cout << symm.kgmatrix[i].e21 << " " << symm.kgmatrix[i].e22 << " "
                                      << symm.kgmatrix[i].e23 << std::endl;
                            std::cout << symm.kgmatrix[i].e31 << " " << symm.kgmatrix[i].e32 << " "
                                      << symm.kgmatrix[i].e33 << std::endl;
                            std::cout << "kgmatrix[i], nonint:" << std::endl;
                            std::cout << kgmatrix_nonint[i].e11 << " " << kgmatrix_nonint[i].e12 << " "
                                      << kgmatrix_nonint[i].e13 << std::endl;
                            std::cout << kgmatrix_nonint[i].e21 << " " << kgmatrix_nonint[i].e22 << " "
                                      << kgmatrix_nonint[i].e23 << std::endl;
                            std::cout << kgmatrix_nonint[i].e31 << " " << kgmatrix_nonint[i].e32 << " "
                                      << kgmatrix_nonint[i].e33 << std::endl;
                        }
