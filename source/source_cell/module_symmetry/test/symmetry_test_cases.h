...
std::vector<stru_> supercell_lib{
    ...
    stru_{2,
          ...
          "O_h",
          std::vector<double>{1., 0., 0., 0., 1., 0., 0., 0., 1.},
          std::vector<atomtype_>{atomtype_{"C", std::vector<std::vector<double>>{{0., 0., 0.}, {0.5, 0.5, 0.5}}}},
          "D",
          std::vector<int>{0, 1},
          {},
          {},
    ...
    stru_{4,
          ...
          "O_h",
          std::vector<double>{1., 0., 0., 0., 1., 0., 0., 0., 1.},
          std::vector<atomtype_>{atomtype_{
              "C",
              std::vector<std::vector<double>>{{0., 0., 0.}, {0.5, 0.5, 0.}, {0.5, 0., 0.5}, {0., 0.5, 0.5}}}},
          "D",
    ...
    stru_{
        ...
        std::vector<atomtype_>{
            atomtype_{"C", std::vector<std::vector<double>>{{0., 0.1, 0.5}, {1. / 3., 0.1, 0.5}, {2. / 3., 0.1, 0.5}}}},
        "D",
        std::vector<int>{1},
        std::map<int, int>{{0, 2}},
        {},
    ...
    stru_{
        ...
        std::vector<atomtype_>{
            atomtype_{"C", std::vector<std::vector<double>>{{0.4, 0., 0.1}, {0.4, 1. / 3., 0.1}, {0.4, 2. / 3., 0.1}}}},
        "D",
        std::vector<int>{2},
        std::map<int, int>{{0, 1}},
        {},
    ...
    stru_{
        ...
        std::vector<atomtype_>{
            atomtype_{"C", std::vector<std::vector<double>>{{0.3, 0.1, 0.}, {0.3, 0.1, 1. / 3.}, {0.3, 0.1, 2. / 3.}}}},
        "D",
        std::vector<int>{1},
        std::map<int, int>{{0, 2}},
        {},
    ...
    stru_{6,
          ...
          std::vector<atomtype_>{atomtype_{"C",
                                           std::vector<std::vector<double>>{{0., 0., 0.1},
                                                                            {0., 1. / 3., 0.1},
                                                                            {0., 2. / 3., 0.1},
                                                                            {0.5, 0., 0.1},
                                                                            {0.5, 1. / 3., 0.1},
    ...
    stru_{6,
          ...
          std::vector<atomtype_>{atomtype_{"C",
                                           std::vector<std::vector<double>>{{0., 0.1, 0.},
                                                                            {1. / 3., 0.1, 0.},
                                                                            {2. / 3., 0.1, 0.},
                                                                            {0., 0.1, 0.5},
                                                                            {1. / 3., 0.1, 0.5},
    ...
    stru_{3,
          ...
          std::vector<atomtype_>{atomtype_{"Mo",
                                           std::vector<std::vector<double>>{
                                               {2. / 3., 0.1859875, 0.22222222},
                                               {2. / 3., 0.1859875, 0.55555555},
                                               {2. / 3., 0.1859875, 0.88888888},
                                           }},
                                 atomtype_{"S",
                                           std::vector<std::vector<double>>{
                                               {1. / 3., 0.2642317, 0.11111111},
                                               {1. / 3., 0.1077433, 0.11111111},
                                               {1. / 3., 0.2642317, 0.44444444},
                                               {1. / 3., 0.1077433, 0.44444444},
                                               {1. / 3., 0.2642317, 0.77777777},
                                               {1. / 3., 0.1077433, 0.77777777},
                                           }}},
          "D",
          {},
          {},
