...
std::string
    Symmetry_Basic::get_brav_name (const int ibrav) const
{
    switch (ibrav)
        {
        case 1:
            return "01. Cubic P (simple)";
        case 2:
            return "02. Cubic I (body-centered)";
        case 3:
            return "03. Cubic F (face-centered)";
        case 4:
            return "04. Hexagonal cell";
        case 5:
            return "05. Tetrogonal P (simple)";
        case 6:
            return "06. Tetrogonal I (body-centered)";
        case 7:
            return "07. Rhombohedral (Trigonal) cell";
        case 8:
            return "08. Orthorhombic P(simple)";
        case 9:
            return "09. Orthorhombic I (body-centered)";
        case 10:
            return "10. Orthorhombic F (face-centered)";
        case 11:
            return "11. Orthorhombic C (base-centered)";
        case 12:
            return "12. Monoclinic P (simple)";
        case 13:
            return "13. Monoclinic A (base-center)";
        case 14:
            return "14. Triclinic cell";
        case 15:
            return "wrong !! ";
        }
...
bool
    Symmetry_Basic::equal (const double& m, const double& n) const
{
    // if( fabs(m-n) < 1.0e-5 )
...
void
    Symmetry_Basic::check_boundary (double& x) const
{
    if (equal (x, -0.5) || equal (x, 0.5))
        {
            x = -0.5;
        }
}
...
double
    Symmetry_Basic::get_translation_vector (const double& x1, const double& x2) const
{
    double t = 0.0; // "t"ranslation
    t = x2 - x1;
    t = fmod (t + 100.0, 1.0);
    if (fabs (t - 1) < epsilon * 0.5)
        {
            t = 0.0;
        }
    return t;
...
void
    Symmetry_Basic::check_translation (double& x, const double& t) const
{
    x += t;
...
double
    Symmetry_Basic::check_diff (const double& x1, const double& x2) const
{
    double diff = x1 - x2;
...
void
    Symmetry_Basic::order_atoms (double* pos, const int& nat, const int* index) const
{
...
void
    Symmetry_Basic::veccon (double* carpos,
                            double* rotpos,
                            const int num,
...
void
    Symmetry_Basic::matrigen (ModuleBase::Matrix3* symgen, const int ngen, ModuleBase::Matrix3* symop, int& nop) const
{
    int m1 = 0;
    int m2 = 0;
    int n = 0;
            ...
            for (int j = 0; j < nop; ++j)
                {
                    if (symop[j] == sig)
                        {
                            flag = false; // not a new symmetry operation
                            break;
                        }
                }
...
//--------------------------------------------------------------
void
    Symmetry_Basic::setgroup (ModuleBase::Matrix3* symop, int& nop, const int& ibrav) const
{
...
int
    Symmetry_Basic::subgroup (const int& nrot,
                              const int& ninv,
                              const int& nc2,
                              const int& nc3,
                              const int& nc4,
                              ...
                              const int& ns6) const
{
    if (nrot > 24)
        {
            if (ninv)
                ...
                {
                    if (nc2 >= 9 && nc3 >= 8 && nc4 >= 6)
                        {
                            return 30;
                        } // O
                    if (nc2 >= 3 && nc3 >= 8 && ns1 >= 6 && ns4 >= 6)
                        {
                            return 31;
                        } // T_d
                }
    ...
    if (nrot > 16) // not else if: nrot>24 can also fall in this part and below
        {
            if (ninv && nc2 >= 5 && nc4 >= 2 && ns1 >= 5 && ns4 >= 2)
                {
                    return 20;
                } // D_4h
        }
    if (nrot > 12)
        {
            if (ninv)
                {
                    if (nc2 >= 1 && nc3 >= 2 && nc6 >= 2 && ns1 >= 1 && ns3 >= 2 && ns6 >= 2)
                        {
                            return 23;
                        } // C_6h
                    if (nc2 >= 3 && nc3 >= 2 && ns1 >= 3 && ns6 >= 2)
                        {
                            return 13;
                        } // D_3d
                }
            else
                {
                    ...
                    if (nc2 >= 3 && nc3 >= 2 && ns1 >= 4 && ns3 >= 2)
                        {
                            return 26;
                        } // D_3h
                    if (nc2 >= 1 && nc3 >= 2 && nc6 >= 2 && ns1 >= 6)
                        {
                            return 25;
                        } // C_6v
                    if (nc2 >= 7 && nc3 >= 2 && nc6 >= 2)
                        {
                            return 24;
                        } // D_6
                }
    ...
    if (nrot > 8)
        {
            if (ninv)
                ...
                {
                    if (nc2 >= 3 && ns1 >= 2 && ns4 >= 2)
                        {
                            return 19;
                        } // D_2d
                    if (nc2 >= 1 && nc4 >= 2 && ns1 >= 4)
                        {
                            return 18;
                        } // C_4v
                    if (nc2 >= 5 && nc4 >= 2)
    ...
    if (nrot > 6)
        {
            if (nc3 >= 2 && ns1 >= 1 && ns3 >= 2)
                {
                    return 22;
                } // C_3h
            if (nc2 >= 1 && nc3 >= 2 && nc6 >= 2)
                {
                    return 21;
                } // C_6
            if (nc3 >= 2 && ns1 >= 3)
...
bool
    Symmetry_Basic::pointgroup (const int& nrot,
                                int& pgnumber,
                                std::string& pgname,
                                ...
                                std::ofstream& ofs_running) const
{
    ...
    std::vector<std::string> pgdict
        = {"none", "C_1",  "S_2",  "C_2",  "C_1h", "C_2h", "D_2", "C_2v", "D_2h", "C_3",  "S_6",
           "D_3",  "C_3v", "D_3d", "C_4",  "S_4",  "C_4h", "D_4", "C_4v", "D_2d", "D_4h", "C_6",
           "C_3h", "C_6h", "D_6",  "C_6v", "D_3h", "D_6h", "T",   "T_h",  "O",    "T_d",  "O_h"};
    ...
    for (int i = 0; i < nrot; ++i)
        {
            ...
            else if (trace == 0 && det == 1)
                {
                    ++nc3;
                }
            else if (trace == 1 && det == 1)
                {
                    ++nc4;
                }
            else if (trace == 2 && det == 1)
                {
                    ++nc6;
                }
            else if (trace == 1 && det == -1)
...
void
    Symmetry_Basic::rotate (ModuleBase::Matrix3& gmatrix,
                            ModuleBase::Vector3<double>& gtrans,
                            int i,
                            int j,
                            int k, // FFT grid index.
                            const int nr1,
                            const int nr2,
                            const int nr3, // dimension of FFT grid.
                            int& ri,
                            int& rj,
                            int& rk)
{
...
void
    Symmetry_Basic::atom_ordering_new (double* posi, const int natom, int* subindex) const
{
...
void
    Symmetry_Basic::test_atom_ordering (double* posi, const int natom, int* subindex) const
{
