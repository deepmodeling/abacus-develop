...
void Symmetry_Basic::setgroup(ModuleBase::Matrix3* symop, int& nop, const int& ibrav) const {
    ...
    case 14:
        ...
        break;
    default:
        ModuleBase::WARNING_QUIT("Symmetry_Basic::setgroup", "ibrav = " + std::to_string(ibrav) + " is not supported.");
        break;
    }
...
bool Symmetry_Basic::pointgroup(const int& nrot,
    ...
    std::vector<std::string> pgdict = {"none", "C_1",  "S_2",  "C_2",  "C_1h", "C_2h", "D_2", "C_2v", "D_2h",
                                       "C_3",  "S_6",  "D_3",  "C_3v", "D_3d", "C_4",  "S_4", "C_4h", "D_4",
                                       "C_4v", "D_2d", "D_4h", "C_6",  "C_3h", "C_6h", "D_6", "C_6v", "D_3h",
