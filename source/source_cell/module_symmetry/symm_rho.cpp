...
void
    Symmetry::rho_symmetry (double* rho, const int& nr1, const int& nr2, const int& nr3)
{
...
void
    Symmetry::rhog_symmetry (std::complex<double>* rhogtot,
                             int* ixyz2ipw,
                             const int& nx,
                             const int& ny,
                             const int& nz,
                            ...
                            if (symflag[ixyz0] == -1)
                                {
                                    ...
                                    for (int isym = 0; isym < nrotk; ++isym)
                                        {
                                            if (invmap[isym] < 0 || invmap[isym] > nrotk)
                                                {
                                                    continue;
                                                }
                                            // tmp variables
                                            ...
                                            if (ii >= fftnx || jj >= fftny || kk >= fftnz)
                                                {
                                                    if (!PARAM.globalv.gamma_only_pw)
                                                        {
                                                            std::cout << " ROTATE OUT OF FFT-GRID IN RHOG_SYMMETRY !"
                                                                      << std::endl;
                                                            ModuleBase::QUIT ();
                                                        }
