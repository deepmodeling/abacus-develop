...
{
void
    Symm_Other::print1 (const int& ibrav, const double* cel_const, std::ofstream& ofs_running)
{
...
bool
    Symm_Other::right_hand_sense (ModuleBase::Vector3<double>& v1,
...
double
    Symm_Other::celvol (const ModuleBase::Vector3<double>& a,
