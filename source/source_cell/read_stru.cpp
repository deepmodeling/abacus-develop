...
bool
    unitcell::check_tau (const Atom* atoms, const int& ntype, const double& lat0)
{
                                            ...
                                            if (norm < tolerence_bohr) // unit is Bohr
                                                {
                                                    ...
                                                    GlobalV::ofs_warning << " type:" << atoms[T1].label << " atom "
                                                                         << I1 + 1 << std::endl;
                                                    GlobalV::ofs_warning << " type:" << atoms[T2].label << " atom "
                                                                         << I2 + 1 << std::endl;
                                                    GlobalV::ofs_warning << " distance = " << norm << " Bohr"
                                                                         << std::endl;
...
void
    unitcell::check_dtau (Atom* atoms, const int& ntype, const double& lat0, ModuleBase::Matrix3& latvec)
{
