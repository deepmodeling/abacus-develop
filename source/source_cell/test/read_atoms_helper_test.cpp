...
{
bool
    read_orb_file (int it, std::string& orbital_file, std::ofstream& ofs_running, Atom* atom)
{
...
void
    output::printrm (std::ofstream& ofs,
...
{
bool
    read_atom_positions (UnitCell& ucell, std::ifstream& ifpos, std::ofstream& ofs_running, std::ofstream& ofs_warning)
{
    // Mock implementation
    return true;
}
