...
void
    ParaPrepare::test_gatherkvec (const Parallel_Kpoints* Pkpts, const MPIContext& mpi)
{
...
void
    ParaPrepare::test_kinfo (const Parallel_Kpoints* Pkpts)
{
...
void
    ParaPrepare::test_init_pools (const int& NPROC,
                                  const int& MY_RANK,
                                  const int& MY_POOL,
                                  const int& RANK_IN_POOL,
                                  const int& NPROC_IN_POOL)
