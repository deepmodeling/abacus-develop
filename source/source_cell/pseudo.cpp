...
void
    pseudo::print_pseudo (std::ofstream& ofs) const
{
    print_pseudo_vl (ofs);
    ofs << "\n pseudo : ";
    ofs << "\n kkbeta	" << kkbeta;
...
void
    pseudo::print_pseudo_atom (std::ofstream& ofs) const
{
    print_pseudo_h (ofs);
    ofs << "\n pseudo_atom : ";
    ofs << "\n msh	" << msh;
...
void
    pseudo::print_pseudo_vl (std::ofstream& ofs) const
{
    ofs << "\n pseudo_vl:";
...
void
    pseudo::print_pseudo_h (std::ofstream& ofs) const
{
    ofs << "\n pseudo_info :";
    ofs << "\n nv       " << nv;
    ofs << "\n psd  " << psd;
