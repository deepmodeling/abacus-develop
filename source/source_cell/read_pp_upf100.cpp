...
int
    Pseudopot_upf::read_pseudo_upf (std::ifstream& ifs, Atom_pseudo& pp)
{
    std::string dummy;
    pp.has_so = false;
    this->q_with_l = false;
...
void
    Pseudopot_upf::read_pseudo_header (std::ifstream& ifs, Atom_pseudo& pp)
{
...
void
    Pseudopot_upf::read_pseudo_mesh (std::ifstream& ifs, Atom_pseudo& pp)
{
    assert (pp.mesh > 0);
...
void
    Pseudopot_upf::read_pseudo_nlcc (std::ifstream& ifs, Atom_pseudo& pp)
{
    assert (pp.mesh > 0);
...
void
    Pseudopot_upf::read_pseudo_local (std::ifstream& ifs, Atom_pseudo& pp)
{
    assert (pp.mesh > 0);
...
void
    Pseudopot_upf::read_pseudo_nl (std::ifstream& ifs, Atom_pseudo& pp)
{
                    ...
                    if (nb < 0 || mb < 0 || nb >= pp.nbeta || mb >= pp.nbeta)
                        {
                            ModuleBase::WARNING_QUIT ("Pseudopot_upf::read_pseudo_nl",
                                                      "PP_DIJ index out of range: nb=" + std::to_string (nb)
                                                          + ", mb=" + std::to_string (mb)
...
void
    Pseudopot_upf::read_pseudo_pswfc (std::ifstream& ifs, Atom_pseudo& pp)
{
...
void
    Pseudopot_upf::read_pseudo_rhoatom (std::ifstream& ifs, Atom_pseudo& pp)
{
...
void
    Pseudopot_upf::read_pseudo_so (std::ifstream& ifs, Atom_pseudo& pp)
{
...
void
    Pseudopot_upf::print_pseudo_upf (std::ofstream& ofs, Atom_pseudo& pp)
{
