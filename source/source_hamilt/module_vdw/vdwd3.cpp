...
void
    Vdwd3::set_criteria (double rthr, const std::vector<ModuleBase::Vector3<double>>& lat, std::vector<double>& tau_max)
{
    tau_max.resize (3);
                                    ...
                                    for (int tauy = -rep_vdw_[1]; tauy <= rep_vdw_[1]; tauy++)
                                        {
                                            for (int tauz = -rep_vdw_[2]; tauz <= rep_vdw_[2]; tauz++)
                                                {
                                                    tau = static_cast<double> (taux) * lat_[0]
                                                          + static_cast<double> (tauy) * lat_[1]
                                            ...
                                            for (int tauz = -rep_vdw_[2]; tauz <= rep_vdw_[2]; tauz++)
                                                {
                                                    ...
                                                    damp6 = std::pow (
                                                        (para_.rs6 () * std::sqrt (3.0 * r42) + para_.rs18 ()),
                                                        6);
                                                    damp8 = std::pow (
                                                        (para_.rs6 () * std::sqrt (3.0 * r42) + para_.rs18 ()),
                                                        8);
...
void
    Vdwd3::get_c6 (int iat, int jat, double nci, double ncj, double& c6)
{
...
void
    Vdwd3::pbc_ncoord (std::vector<double>& cn)
{
...
void
    Vdwd3::pbc_three_body (const std::vector<int>& iz,
                                            ...
                                            for (int jtauz = -rep_cn_[2]; jtauz <= rep_cn_[2]; jtauz++)
                                                {
                                                    ...
                                                    jtau = static_cast<double> (jtaux) * lat_[0]
                                                           + static_cast<double> (jtauy) * lat_[1]
                                                    ...
                                                    for (int ktaux = repmin[0]; ktaux <= repmax[0]; ktaux++)
                                                        {
                                                            for (int ktauy = repmin[1]; ktauy <= repmax[1]; ktauy++)
                                                                {
                                                                    for (int ktauz = repmin[2]; ktauz <= repmax[2];
                                                                         ktauz++)
                                                                        {
                                                                            ktau = static_cast<double> (ktaux) * lat_[0]
                                                                                   + static_cast<double> (ktauy)
                                                                                         * lat_[1]
                                                                                   + static_cast<double> (ktauz)
                                                                                         * lat_[2];
                                                                            ...
                                                                            geomean = std::pow (rr0ij * rr0ik * rr0jk,
                                                                                                1.0 / 3.0);
                                                                            fdamp = 1.0
                                                                                    / (1.0
                                                                                       + 6.0
                                                            ...
                                                            for (int ktauz = repmin[2]; ktauz <= repmax[2]; ktauz++)
                                                                {
                                                                    ...
                                                                    geomean
                                                                        = std::pow (rr0ij * rr0ik * rr0jk, 1.0 / 3.0);
                                                                    fdamp = 1.0
                                                                            / (1.0
                                                                               + 6.0 * std::pow (sr9 * geomean, alp9));
                                                                    tmp1 = (rij2 + rjk2 - rik2);
                                                                    tmp2 = (rij2 + rik2 - rjk2);
                                                                    tmp3 = (rik2 + rjk2 - rij2);
                                                                    tmp4 = rij2 * rjk2 * rik2;

                                                                    ang = (0.375 * tmp1 * tmp2 * tmp3 / tmp4 + 1.0)
                                                                          / std::pow (tmp4, 1.5);
...
void
    Vdwd3::pbc_gdisp (std::vector<ModuleBase::Vector3<double>>& g, ModuleBase::matrix& smearing_sigma)
{
                                            ...
                                            if (r2 > 0.1 && r2 < para_.rthr2 ())
                                                {
                                                    ...
                                                    // d(r^(-6))/d(tau)
                                                    drij[linii][taux + rep_vdw_[0]][tauy + rep_vdw_[1]]
                                                        [tauz + rep_vdw_[2]]
                                                    ...
                                                    drij[linii][taux + rep_vdw_[0]][tauy + rep_vdw_[1]]
                                                        [tauz + rep_vdw_[2]]
                                                        += (para_.s6 () * c6 / r7 * 6.0 * para_.alp6 () * t6 * damp6
                                                                * damp6
                                                            + para_.s18 () * c6 * r42 / r9 * 18.0 * para_.alp8 () * t8
                                                                  * damp8 * damp8)
                                                           * 0.5;

                                                    dc6_rest = (para_.s6 () / r6 * damp6
                                                                + 3.0 * para_.s18 () * r42 / r8 * damp8)
                                                               * 0.5;
                                            ...
                                            for (int tauz = -rep_vdw_[2]; tauz <= rep_vdw_[2]; tauz++)
                                                {
                                                    ...
                                                    // d(r^(-6))/d(r_ij)
                                                    drij[linij][taux + rep_vdw_[0]][tauy + rep_vdw_[1]]
                                                        [tauz + rep_vdw_[2]]
                                                        += -para_.s6 () * (6.0 / (r7)*c6 * damp6)
                                                           - para_.s18 () * (24.0 / (r9)*c6 * r42 * damp8);
                                                    // d(f_dmp)/d(r_ij)
                                                    ...
                                                    for (int jtauz = -rep_cn_[2]; jtauz <= rep_cn_[2]; jtauz++)
                                                        {
                                                            ...
                                                            rr0ij
                                                                = std::sqrt (rij2) / para_.r0ab ()[iz_[jat]][iz_[iat]];

                                                            for (int ktaux = repmin[0]; ktaux <= repmax[0]; ktaux++)
                                                                {
                                                                    for (int ktauy = repmin[1]; ktauy <= repmax[1];
                                                                         ktauy++)
                                                                        {
                                                                            for (int ktauz = repmin[2];
                                                                                 ktauz <= repmax[2];
                                                                                 ktauz++)
                                                                                {
                                                                                    ktau = static_cast<double> (ktaux)
                                                                                               * lat_[0]
                                                                                           + static_cast<double> (ktauy)
                                                                                                 * lat_[1]
                                                                                           + static_cast<double> (ktauz)
                                                                                    ...
                                                                                    tmp1 = -dang * c9 * damp9
                                                                                           + dfdmp / r * c9 * ang;
                                                                                    drij[linij][jtaux + rep_vdw_[0]]
                                                                                        [jtauy + rep_vdw_[1]]
                                                                                        [jtauz + rep_vdw_[2]] -= tmp1;
                                                                                    ...
                                                                                    tmp1 = -dang * c9 * damp9
                                                                                           + dfdmp / r * c9 * ang;
                                                                                    drij[linik][ktaux + rep_vdw_[0]]
                                                                                        [ktauy + rep_vdw_[1]]
                                                                                        [ktauz + rep_vdw_[2]] -= tmp1;
                                                                                    ...
                                                                                    tmp1 = -dang * c9 * damp9
                                                                                           + dfdmp / r * c9 * ang;
                                                                                    drij[linjk]
                                                                                        [ktaux - jtaux + rep_vdw_[0]]
                                                                                        [ktauy - jtauy + rep_vdw_[1]]
                                                                                        [ktauz - jtauz + rep_vdw_[2]]
                                                                                        -= tmp1;

                                                                                    dc9 = (dc6ij[jat][iat] / c6ij
                                                                                           + dc6ij[kat][iat] / c6ik)
                                                                                          * c9 * 0.5;
                                                                                    dc6i[iat] += dc6_rest * dc9;

                                                                                    dc9 = (dc6ij[iat][jat] / c6ij
                                                                                           + dc6ij[kat][jat] / c6jk)
                                                                                          * c9 * 0.5;
                                                                                    dc6i[jat] += dc6_rest * dc9;

                                                                                    dc9 = (dc6ij[iat][kat] / c6ik
                                                                                           + dc6ij[jat][kat] / c6jk)
                                                                                          * c9 * 0.5;
                                                            ...
                                                            for (int ktauy = repmin[1]; ktauy <= repmax[1]; ktauy++)
                                                                {
                                                                    for (int ktauz = repmin[2]; ktauz <= repmax[2];
                                                                         ktauz++)
                                                                        {
                                                                            ...
                                                                            rr0ik = std::sqrt (rik2)
                                                                                    / para_.r0ab ()[iz_[kat]][iz_[iat]];
                                                                            rr0jk = std::sqrt (rjk2)
                                                                                    / para_.r0ab ()[iz_[kat]][iz_[jat]];

                                                                            geomean2 = rij2 * rjk2 * rik2;
                                                                            r0av = std::pow (rr0ij * rr0ik * rr0jk,
                                                                                             1.0 / 3.0);
                                                                            damp9 = 1.0
                                                                                    / (1.0
                                                                                       + 6.0
                                                                                      ...
                                                                                      + rjk2
                                                                                            * (3.0 * std::pow (rik2, 2)
                                                                                               ...
                                                                                               + 3.0
                                                                                                     * std::pow (rij2,
                                                                                                                 2))
                                                                                      - 5.0 * std::pow (rik2 - rij2, 2)
                                                                                            * (rik2 + rij2))
                                                                                   / (r * geomean3 * geomean2);
                                                                            tmp1 = -dang * c9 * damp9
                                                                                   + dfdmp / r * c9 * ang;
                                                                            drij[linjk][ktaux - jtaux + rep_vdw_[0]]
                                                                                [ktauy - jtauy + rep_vdw_[1]]
                                                                                [ktauz - jtauz + rep_vdw_[2]]
                                                                                -= tmp1 / 2.0;
                                                            ...
                                                            for (int ktauz = repmin[2]; ktauz <= repmax[2]; ktauz++)
                                                                {
                                                                    ...
                                                                    dfdmp = 2.0 * alp9 * std::pow (0.75 * r0av, alp9)
                                                                            * damp9 * damp9;

                                                                    r = std::sqrt (rij2);
                                                                    dang = -0.375
                                                                           * (std::pow (rij2, 3)
                                                                              + std::pow (rij2, 2) * (rjk2 + rik2)
                                                                              + rij2
                                                                                    * (3.0 * std::pow (rjk2, 2)
                                                                                       + 2.0 * rjk2 * rik2
                                                                                       + 3.0 * std::pow (rik2, 2))
                                                                    ...
                                                                    drij[linij][jtaux + rep_vdw_[0]]
                                                                        [jtauy + rep_vdw_[1]][jtauz + rep_vdw_[2]]
                                                                        -= tmp1 / 6.0;

                                                                    r = std::sqrt (rik2);
                                                                    dang = -0.375
                                                                           * (std::pow (rik2, 3)
                                                                              + std::pow (rik2, 2) * (rjk2 + rij2)
                                                                              + rik2
                                                                                    * (3.0 * std::pow (rjk2, 2)
                                                                                       + 2.0 * rjk2 * rij2
                                                                                       + 3.0 * std::pow (rij2, 2))
                                                                    ...
                                                                    tmp1 = -dang * c9 * damp9 + dfdmp / r * c9 * ang;
                                                                    drij[linik][ktaux + rep_vdw_[0]]
                                                                        [ktauy + rep_vdw_[1]][ktauz + rep_vdw_[2]]
                                                                        -= tmp1 / 6.0;

                                                                    r = std::sqrt (rjk2);
                                                                    dang = -0.375
                                                                           * (std::pow (rjk2, 3)
                                                                              + std::pow (rjk2, 2) * (rik2 + rij2)
                                                                              + rjk2
                                                                                    * (3.0 * std::pow (rik2, 2)
                                                                                       + 2.0 * rik2 * rij2
                                                                                       + 3.0 * std::pow (rij2, 2))
                                                                    ...
                                                                    drij[linjk][ktaux - jtaux + rep_vdw_[0]]
                                                                        [ktauy - jtauy + rep_vdw_[1]]
                                                                        [ktauz - jtauz + rep_vdw_[2]] -= tmp1 / 6.0;
                                            ...
                                            if (r2 < para_.cn_thr2 ())
                                                {
                                                    ...
                                                    dcnn = -para_.k1 () * rcovij * expterm
                                                           / (r2 * (expterm + 1.0) * (expterm + 1.0));
                                                }
                                            else
                                                {
                                                    dcnn = 0.0;
                            ...
                            for (int tauz = -rep_vdw_[2]; tauz <= rep_vdw_[2]; tauz++)
                                {
                                    ...
                                    x1 = drij[linii][taux + rep_vdw_[0]][tauy + rep_vdw_[1]][tauz + rep_vdw_[2]]
                                         + dcnn * dc6i[iat];
