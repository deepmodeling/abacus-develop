...
void
    lapl_rho (const double& tpiba2, const std::complex<double>* rhog, double* lapn, const ModulePW::PW_Basis* rho_basis)
{
...
void
    shape_gradn (const std::complex<double>* ps_totn, const ModulePW::PW_Basis* rho_basis, double* eprime)
{
...
void
    surchem::createcavity (const UnitCell& ucell,
...
void
    surchem::cal_vcav (const UnitCell& ucell,
                       const ModulePW::PW_Basis* rho_basis,
