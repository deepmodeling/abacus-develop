...
void
    shape_gradn (const double* PS_TOTN_real, const ModulePW::PW_Basis* rho_basis, double* eprime)
{
...
void
    eps_pot (const double* PS_TOTN_real,
             const double& tpiba,
...
void
    surchem::cal_vel (const UnitCell& cell,
                      const ModulePW::PW_Basis* rho_basis,
