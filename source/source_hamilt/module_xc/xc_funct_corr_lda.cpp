...
void XC_Functional::pw_spin(const double& rs, const double& zeta, double& ec, double& vcup, double& vcdw) {
    const double a = 0.0310910;
    ...
    dfz =
        (pow((1.0 + zeta), (1.0 / 3.0)) - pow((1.0 - zeta), (1.0 / 3.0))) * 4.0 / (3.0 * (pow(2.0, (4.0 / 3.0)) - 2.0));
...
// J.P. Perdew and Y. Wang, PRB 45, 13244 (1992)
void XC_Functional::pz_spin(const double& rs, const double& zeta, double& ec, double& vcup, double& vcdw) {
