...
TEST_F (XCTest_GRADCORR, set_xc_type)
{
    ...
    std::vector<double> stress1_ref
        = {-0.02536030461, 0, 0, -0.02536030461, -0.02536030461, 0, -0.02536030461, -0.02536030461, -0.02536030461};
    ...
    std::vector<double> stress2_ref
        = {-0.0280735975, 0, 0, -0.0280735975, -0.0280735975, 0, -0.0280735975, -0.0280735975, -0.0280735975};
