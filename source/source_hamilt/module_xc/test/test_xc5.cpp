...
class XCTest_VXC : public XCTest
{
  protected:
        ...
        SetUp ()
    {
        ...
        PARAM.input.nspin = 1;
        std::tuple<double, double, ModuleBase::matrix> etxc_vtxc_v = XC_Functional::v_xc (rhopw.nrxx, &chr, &ucell);
        et1 = std::get<0> (etxc_vtxc_v);
        vt1 = std::get<1> (etxc_vtxc_v);
        v1 = std::get<2> (etxc_vtxc_v);

        PARAM.input.nspin = 2;
        etxc_vtxc_v = XC_Functional::v_xc (rhopw.nrxx, &chr, &ucell);
...
class XCTest_VXC_meta : public XCTest
{
  protected:
        ...
        SetUp ()
    {
        ...
        PARAM.input.nspin = 2;
        etxc_vtxc_v = XC_Functional_Libxc::v_xc_meta (XC_Functional::get_func_id (),
                                                      rhopw.nrxx,
                                                      ucell.omega,
                                                      ucell.tpiba,
                                                      &chr);
