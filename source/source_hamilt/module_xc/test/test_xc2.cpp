...
TEST_F(XCTest_BP_SPN, set_xc_type) {
    ...
    std::vector<double> e_gga_ref = {-2.527553387e-14,
                                     -0.005791315733,
                                     -0.09840317072,
                                     -0.004480017364,
                                     -0.00633879446};
...
TEST_F(XCTest_revPBE_SPN, set_xc_type) {
    ...
    std::vector<double> v1_lda_ref = {-1.259358955, -1.323886052, -1.352864095, -0.5692699308, -15.16995135};
    std::vector<double> v2_lda_ref = {-1.259358955, -1.186042827, -1.011084744, -0.3739376001, -0.6598499399};
    std::vector<double> e_gga_ref = {-5.063224319e-14,
                                     -0.01154733753,
                                     -0.2341920935,
                                     -0.006370370784,
                                     -0.0001006666667};
...
TEST_F(XCTest_PZ_SPN, set_xc_type) {
    ...
    std::vector<double> e_lda_ref = {-0.95651735756525513,
                                     -0.96317186117476516,
                                     -0.95998479865326902,
                                     -0.41690422190075471,
                                     -11.392818565518368};
    std::vector<double> v1_lda_ref = {-1.2588131365004438,
                                      -1.3213867444561467,
                                      -1.3486549996482768,
                                      -0.56794400635336095,
                                      -15.170993784117668};
    std::vector<double> v2_lda_ref = {-1.2588131365004438,
                                      -1.1877924103859072,
                                      -1.0155330910438201,
                                      -0.37092937962238148,
                                      -0.51758342826640091};
...
TEST_F(XCTest_P86_SPN, set_xc_type) {
    std::vector<double> e_gga_ref = {1.69759930415e-14,
                                     0.00308117598269,
                                     0.0408000476851,
                                     0.00290513793266,
                                     8.49954060062e-08};
    std::vector<double> v1_gga_ref = {-1.32642497169e-14,
                                      -0.0022804667616,
                                      -0.0166964664575,
                                      -0.00685850787795,
                                      -6.30224371228e-11};
    std::vector<double> v2_gga_ref = {-1.32642497169e-14,
                                      -0.00188528133486,
                                      -0.00317100883673,
                                      0.0160558001336,
                                      -2.36727121199e-11};
    std::vector<double> v3_gga_ref = {0.00419160260597,
                                      0.00338159500585,
                                      0.00145591122701,
                                      0.0336591369313,
                                      3.09070721877e-07};
...
TEST_F(XCTest_PBE0_SPN, set_xc_type) {
    ...
    std::vector<double> e_gga_ref = {-3.387102535e-14,
                                     -0.007743108067,
                                     -0.1276936518,
                                     -0.003065679956,
                                     -4.873559704e-05};
