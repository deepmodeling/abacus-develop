...
TEST_F (XCTest_BLYP, set_xc_type)
{
    ...
    std::vector<double> e_lda_ref
        = {-0.931174253662, -0.931174253662, -0.894576862875, -0.361975213747, -9.04968167694};
...
{
    std::vector<double> e_lda_ref
        = {-0.1208055896280259, -0.1009063676832011, -0.0028726241745994537, -0.0026920464558317734};
    std::vector<double> v_lda_ref
        = {-0.13053328412744325, -0.11030492316729694, -0.0035935897272457141, -0.0033812515019294776};
...
{
    std::vector<double> e_lda_ref
        = {-0.0481692845703, -0.0481692845703, -0.0508581491890, -0.1250586358990, -0.0002168020098};
    std::vector<double> v_lda_ref
        = {-0.0552381037021, -0.0552381037021, -0.0581101146837, -0.1347585962230, -0.0002868652922};
...
{
    std::vector<double> e_lda_ref
        = {-0.046226266609, -0.046226266609, -0.047220614485, -0.055675743921, -0.000242863497};
    std::vector<double> v_lda_ref
        = {-0.048984187643, -0.048984187643, -0.049759880946, -0.055882739698, -0.000323468803};
...
{
    std::vector<double> e_lda_ref
        = {-0.0516082763238, -0.0516082763238, -0.0541421102571, -0.1158270158400, -0.0001959621612};
    std::vector<double> v_lda_ref
        = {-0.0583140751521, -0.0583140751521, -0.0609311295248, -0.1232802590140, -0.0002609805565};
...
{
    std::vector<double> e_lda_ref
        = {-0.0588659395493, -0.0588659395493, -0.0623311764511, -0.1512549418480, -0.0001577756901};
    std::vector<double> v_lda_ref
        = {-0.0679980665055, -0.0679980665055, -0.0716536813685, -0.1622283251780, -0.0002102349565};
...
TEST_F (XCTest_WCX, set_xc_type)
{
    ...
    std::vector<double> v2_gga_ref
        = {-4.1745209791E-03, -4.1145164232E-03, -3.4066592749E-03, -8.0662091283E-02, -3.8681965771E-07};
...
TEST_F (XCTest_PBE0, set_xc_type)
{
    ...
    std::vector<double> e_lda_ref
        = {-0.516361900865, -0.516361900865, -0.497297777983, -0.216575173845, -4.63279938014};
