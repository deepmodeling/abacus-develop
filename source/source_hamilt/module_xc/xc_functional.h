...
class XC_Functional {
  public:
    ...
    // [etxc, vtxc, v] = v_xc(...)
    static std::tuple<double, double, ModuleBase::matrix> v_xc(const int& nrxx, // number of real-space grid
    ...
    static int get_func_type() { return func_type; };
    ...
    static double get_hybrid_alpha() { return hybrid_alpha; };
    static bool get_ked_flag() { return ked_flag; };
  ...
  public:
    ...
    // spin polarized GGA
    static void gcx_spin(double rhoup,
                         double rhodw,
                         double grhoup2,
                         double grhodw2,
                         double& sx,
    ...
    static void grad_rho(const std::complex<double>* rhog,
                         ...
                         const double tpiba);
    static void
    grad_dot(const ModuleBase::Vector3<double>* h, double* dh, const ModulePW::PW_Basis* rho_basis, const double tpiba);
    ...
    static void
    perdew86_spin(double rho, double zeta, double grho, double& sc, double& v1cup, double& v1cdw, double& v2c);
    // static void ggac_spin(double rho, double zeta, double grho, double &sc,
    //     double &v1cup, double &v1cdw, double &v2c);
    static void pbec_spin(double rho,
                          double zeta,
                          double grho,
                          const int& flag,
                          double& sc,
