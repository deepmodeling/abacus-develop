...
// from gradcorr.f90
void
    XC_Functional::gradcorr (double& etxc,
                             double& vtxc,
                             ModuleBase::matrix& v,
                                        ...
                                        if (func_type == 3 || func_type == 5) // the gradcorr part to stress of mGGA
                                            {
                                                ...
                                                XC_Functional_Libxc::tau_xc (func_id,
                                                                             arho,
                                                                             grho2a,
                                                                             atau,
                                                                             sxc,
                                            ...
                                            {
                                                XC_Functional_Libxc::gcxc_libxc (func_id,
                                                                                 arho,
                                                                                 grho2a,
                                                                                 sxc,
                                                                                 v1xc,
                        ...
                        if (use_libxc)
                            {
                                ...
                                if (func_type == 3 || func_type == 5) // the gradcorr part to stress of mGGA
                                    {
                                        ...
                                        XC_Functional_Libxc::tau_xc_spin (func_id,
                                                                          rhotmp1[ir],
                                                                          rhotmp2[ir],
                                                                          gdr1[ir],
                                                                          gdr2[ir],
                                    ...
                                    {
                                        XC_Functional_Libxc::gcxc_spin_libxc (func_id,
                                                                              rhotmp1[ir],
                                                                              rhotmp2[ir],
                                                                              gdr1[ir],
                                                                              gdr2[ir],
                                ...
                                if (is_stress)
                                        ...
                                        for (int l = 0; l < 3; l++)
                                            {
                                                for (int m = 0; m < l + 1; m++)
                                                    {
                                                        int ind = l * 3 + m;
                                                        local_stress_gga[ind]
                                                            += (tt1[l] * tt1[m] * v2xcup + tt2[l] * tt2[m] * v2xcdw
                                ...
                                else
                                    {
                                        ...
                                        local_vtxcgc
                                            = local_vtxcgc
                                              + ModuleBase::e2 * v1xcup * (rhotmp1[ir] - chr->rho_core[ir] * fac);
                                        local_vtxcgc
                                            = local_vtxcgc
                                              + ModuleBase::e2 * v1xcdw * (rhotmp2[ir] - chr->rho_core[ir] * fac);
                        ...
                        else
                            {
                                ...
                                XC_Functional::gcx_spin (rhotmp1[ir],
                                                         rhotmp2[ir],
                                                         grho2a,
                                                         grho2b,
                                                         sx,
                                ...
                                if (rh > epsr)
                                    {
                                        if (igcc_is_lyp)
                                            {
                                                ModuleBase::WARNING_QUIT ("XC_Functional",
                                                                          "igcc_is_lyp is not available now.");
                                            }
                                        else
                                            {
                                ...
                                if (is_stress)
                                                ...
                                                for (int m = 0; m < l + 1; m++)
                                                    {
                                                        ...
                                                        //    exchange
                                                        local_stress_gga[ind]
                                                            += tt1[l] * tt1[m] * ModuleBase::e2 * v2xup
                                                               + tt2[l] * tt2[m] * ModuleBase::e2 * v2xdw;
                                                        //    correlation
                                                        local_stress_gga[ind]
                                                            += (tt1[l] * tt1[m] * v2cup + tt2[l] * tt2[m] * v2cdw
                                ...
                                else
                                    {
                                        ...
                                        local_vtxcgc = local_vtxcgc
                                                       + ModuleBase::e2 * (v1xup + v1cup)
                                                             * (rhotmp1[ir] - chr->rho_core[ir] * fac);
                                        local_vtxcgc = local_vtxcgc
                                                       + ModuleBase::e2 * (v1xdw + v1cdw)
                                                             * (rhotmp2[ir] - chr->rho_core[ir] * fac);
                    ...
                    for (int ir = 0; ir < rhopw->nrxx; ir++)
                        {
                            ...
                            double amag
                                = sqrt (pow (chr->rho[1][ir], 2) + pow (chr->rho[2][ir], 2) + pow (chr->rho[3][ir], 2));
                            if (amag > 1e-12)
                                {
                                    for (int i = 1; i < 4; i++)
                                        {
                                            v (i, ir)
                                                += neg[ir] * 0.5 * (vgg[0][ir] - vgg[1][ir]) * chr->rho[i][ir] / amag;
                                        }
                                }
                        }
                }
...
void
    XC_Functional::grad_wfc (const int ik,
                             const Real tpiba,
...
void
    XC_Functional::grad_rho (const std::complex<double>* rhog,
...
void
    XC_Functional::grad_dot (const ModuleBase::Vector3<double>* h,
                             double* dh,
                             const ModulePW::PW_Basis* rho_basis,
                             const double tpiba)
{
...
void
    XC_Functional::noncolin_rho (double* rhoout1,
                                 double* rhoout2,
                                 double* neg,
