...
void
    XC_Functional::gcxc (const double& rho, const double& grho, double& sxc, double& v1xc, double& v2xc)
{
    //-----------------------------------------------------------------------
    ...
    for (int id: func_id)
        {
            switch (id)
                ...
                default: // SCAN_X,SCAN_C,HSE, and so on
                    throw std::domain_error ("functional unfinished in " + std::string (__FILE__) + " line "
...
//-----------------------------------------------------------------------
void
    XC_Functional::gcx_spin (double rhoup,
                             double rhodw,
                             double grhoup2,
                             double grhodw2,
                             double& sx,
...
//-----------------------------------------------------------------------
void
    XC_Functional::gcc_spin (double rho,
                             double& zeta,
                             double grho,
                             double& sc,
                             double& v1cup,
    ...
    switch (id)
        ...
        case XC_GGA_C_PW91: // PW91_C
            ModuleBase::WARNING_QUIT (
                "xc_wrapper_gcxc",
                "there seems to be something wrong with ggac_spin, better use libxc version instead");
            break;
