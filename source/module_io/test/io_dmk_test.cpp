...
TEST(DMKTest, WriteDMK)
{
    ...
    if (GlobalV::MY_RANK == 0)
    {
        ...
        EXPECT_THAT(str,
                    testing::HasSubstr(
                        "(1.600e+00,1.600e+01) (1.700e+00,1.700e+01) (1.800e+00,1.800e+01) (1.900e+00,1.900e+01)\n"));
        ifs.close();
        ...
        EXPECT_THAT(str,
                    testing::HasSubstr(
                        "(2.600e+00,1.610e+01) (2.700e+00,1.710e+01) (2.800e+00,1.810e+01) (2.900e+00,1.910e+01)\n"));
        ifs.close();
        ...
        EXPECT_THAT(str,
                    testing::HasSubstr(
                        "(3.600e+00,1.620e+01) (3.700e+00,1.720e+01) (3.800e+00,1.820e+01) (3.900e+00,1.920e+01)\n"));
        ifs.close();
        ...
        EXPECT_THAT(str,
                    testing::HasSubstr(
                        "(4.600e+00,1.630e+01) (4.700e+00,1.730e+01) (4.800e+00,1.830e+01) (4.900e+00,1.930e+01)\n"));
        ifs.close();
        remove("dms1_nao.txt");
        remove("dms2_nao.txt");
