                                ...
                                const UnitCell& ucell)
{
    ...
    // calculate ldos
#ifndef __NEW_GINT
    ModuleBase::WARNING_QUIT("Cal_ldos::dm2ldos", "do not support old grid integral, please recompile with __NEW_GINT");
#else
    ...
    const int precision = PARAM.inp.out_ldos[1];
    ModuleIO::write_vdata_palgrid(pgrid, ldos_space.data(), 0, PARAM.inp.nspin, 0, fn.str(), 0, &ucell, precision, 0);
