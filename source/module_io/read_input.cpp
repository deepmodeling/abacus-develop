...
void read_information(std::ifstream& ifs,
...
void ReadInput::read_parameters(Parameter& param,
...
void ReadInput::create_directory(const Parameter& param) {
    ...
    if (!param.input.out_app_flag
        && (param.input.out_mat_hs2 || param.input.out_mat_r
...
void ReadInput::write_parameters(const Parameter& param,
...
void ReadInput::write_txt_input(const Parameter& param,
