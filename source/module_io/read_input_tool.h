...
#define add_doublevec_bcast(PARAMETER, N)                                                                              \
    {                                                                                                                  \
        bcastfuncs.push_back([](Parameter& para) { Parallel_Common::bcast_double(para.PARAMETER.data(), N); });        \
    }
#define add_intvec_bcast(PARAMETER, N)                                                                                 \
    {                                                                                                                  \
        bcastfuncs.push_back([](Parameter& para) { Parallel_Common::bcast_int(para.PARAMETER.data(), N); });           \
    }
#define add_stringvec_bcast(PARAMETER, N)                                                                              \
    {                                                                                                                  \
        bcastfuncs.push_back([](Parameter& para) { Parallel_Common::bcast_string(para.PARAMETER.data(), N); });        \
    }
...
#define sync_string(PARAMETER)                                                                                         \
    {                                                                                                                  \
        item.getfinalvalue = [](Input_Item& item, const Parameter& para) { item.final_value << para.PARAMETER; };      \
