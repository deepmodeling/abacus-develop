...
#define add_double_bcast(PARAMETER)                                            \
    {                                                                          \
        bcastfuncs.push_back([](Parameter& para) {                             \
            Parallel_Common::bcast_double(para.input.PARAMETER);               \
        });                                                                    \
    }
#define add_int_bcast(PARAMETER)                                               \
    {                                                                          \
        bcastfuncs.push_back([](Parameter& para) {                             \
            Parallel_Common::bcast_int(para.input.PARAMETER);                  \
        });                                                                    \
    }
...
#define add_string_bcast(PARAMETER)                                            \
    {                                                                          \
        bcastfuncs.push_back([](Parameter& para) {                             \
            Parallel_Common::bcast_string(para.input.PARAMETER);               \
        });                                                                    \
    }
...
#define sync_string(PARAMETER)                                                 \
    {                                                                          \
        item.getfinalvalue = [](Input_Item& item, const Parameter& para) {     \
            item.final_value << para.input.PARAMETER;                          \
        };                                                                     \
...
#define read_sync_double(PARAMETER)                                            \
    {                                                                          \
        item.readvalue = [](const Input_Item& item, Parameter& para) {         \
            para.input.PARAMETER = doublevalue;                                \
        };                                                                     \
...
#define read_sync_bool(PARAMETER)                                              \
    {                                                                          \
        item.readvalue = [](const Input_Item& item, Parameter& para) {         \
            para.input.PARAMETER = boolvalue;                                  \
        };                                                                     \
        sync_bool(PARAMETER);                                                  \
    }
