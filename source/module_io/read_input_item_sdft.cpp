...
void ReadInput::item_sdft()
{
    ...
    }
    {
        ...
        bcast_string_param(nbndsto_str);
        bcast_int_param(nbands_sto);
        this->add_item(item);
    }
    {
        Input_Item item("nche_sto");
        item.annotation = "Chebyshev expansion orders";
        read_bcast_int(nche_sto);
        this->add_item(item);
    }
    {
