...
//      };
//      item.resetvalue = [](const Input_Item& item, Parameter& para) { if(para.kspacing[0] <= 0) para.kspacing[0] = 1;
//      };
//      item.checkvalue = [](const Input_Item& item, const Parameter& para) {assert(para.kspacing[0]>0);};
//      bcast_doublevec_param(kspacing, 3);
//      this->add_item(item);
//  }
