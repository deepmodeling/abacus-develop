...
Direct
 ...
 5.773e-01 3.902e-02 1.661e-02 4.797e-17 -2.255e-17 5.773e-01 3.902e-02 -1.661e-02
 -1.461e-17 -4.414e-17
 ...
 '''
 */
...
)
{
    ...
    auto check_consistency = [&](const std::string& fn, const std::string& name, const std::string& value, const int& target) {
    ...
    if (my_rank == 0)
    {
        ...
        for (int ispin = 0; ispin < nspin; ispin++)
        {
            for (int ik = 0; ik < nk; ik++)
            {
                ...
                ifs >> tmp; ifs >> tmp; ifs >> tmp;// fermi energy
                ifs >> tmp; // nlocal
