...
double* Output_Sk<double>::get_Sk(int ik) {
    ...
    return dynamic_cast<hamilt::HamiltLCAO<double, double>*>(this->p_hamilt_)
        ->getSk();
}
...
std::complex<double>* Output_Sk<std::complex<double>>::get_Sk(int ik) {
    ...
    if (this->nspin_ == 4) {
        dynamic_cast<
            ...
            this->p_hamilt_)
            ->updateSk(ik, 1);
        return dynamic_cast<hamilt::HamiltLCAO<std::complex<double>,
                                               std::complex<double>>*>(
                   this->p_hamilt_)
            ->getSk();
    } else {
        dynamic_cast<hamilt::HamiltLCAO<std::complex<double>, double>*>(
            this->p_hamilt_)
            ->updateSk(ik, 1);
        return dynamic_cast<hamilt::HamiltLCAO<std::complex<double>, double>*>(
                   this->p_hamilt_)
            ->getSk();
    }
    return nullptr;
