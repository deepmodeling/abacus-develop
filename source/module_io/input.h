...
class Input
{
  public:
     ...
     */
    int sc_mag_switch; // the switch to open the DeltaSpin function, 0: no spin-constrained DFT; 1: constrain atomic
                       // magnetization; 2: output atomic magnetization with weight
