...
void ReadInput::item_others()
{
    ...
    }
    {
        ...
        read_bcast_bool(exx_separate_loop);
        this->add_item(item);
    }
    {
    ...
    }
    {
        ...
        read_bcast_double(exx_cauchy_stress_threshold);
        this->add_item(item);
    }
    {
    ...
    }
    {
        ...
        read_bcast_double(exx_opt_orb_tolerence);
        this->add_item(item);
    }
    {
        ...
        item.annotation = "how many times larger the radial mesh required for calculating Columb potential is to that "
                          "of atomic orbitals";
        read_bcast_double(rpa_ccp_rmesh_times);
        this->add_item(item);
    }
    ...
    }
    {
        ...
        read_bcast_double(onsite_radius);
        this->add_item(item);
    }
    {
...
#ifdef __MPI
        this->bcastfuncs.push_back(
            [](Parameter& para) { Parallel_Common::bcast_double(para.hubbard_u.data(), para.ntype); });
#endif
        this->add_item(item);
    }
    {
...
#ifdef __MPI
        this->bcastfuncs.push_back(
            [](Parameter& para) { Parallel_Common::bcast_int(para.orbital_corr.data(), para.ntype); });
#endif
        this->add_item(item);
    }
...
#ifdef __MPI
        this->bcastfuncs.push_back([](Parameter& para) {
            Parallel_Common::bcast_double(para.bessel_nao_rcuts.data(), para.nrcut);
            Parallel_Common::bcast_double(para.bessel_nao_rcut);
        });
#endif
        this->add_item(item);
    }
...
#ifdef __MPI
        this->bcastfuncs.push_back(
            [](Parameter& para) { Parallel_Common::bcast_string(para.qo_strategy.data(), para.ntype); });
#endif
        this->add_item(item);
    };
...
#ifdef __MPI
        this->bcastfuncs.push_back(
            [](Parameter& para) { Parallel_Common::bcast_double(para.qo_screening_coeff.data(), para.ntype); });
#endif
        this->add_item(item);
    }
    ...
    }
    {
        ...
        read_bcast_double(pexsi_mu_thr);
        this->add_item(item);
    }
    {
        ...
        item.annotation = "If the chemical potential is not in the initial interval, the interval is expanded by "
                          "muInertiaExpansion";
        read_bcast_double(pexsi_mu_expand);
        this->add_item(item);
    }
    {
        ...
        read_bcast_double(pexsi_mu_guard);
        this->add_item(item);
    }
    {
        ...
        item.annotation = "Stopping criterion of the PEXSI iteration in terms of the number of electrons compared to "
                          "numElectronExact";
        read_bcast_double(pexsi_elec_thr);
        this->add_item(item);
    }
    {
        ...
        read_bcast_double(pexsi_zero_thr);
        this->add_item(item);
    }
}
} // namespace ModuleIO