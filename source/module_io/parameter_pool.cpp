...
bool input_parameters_get(const std::string& fn)
{
    ...
    while (ifs.good())
    {
        ...
        input_parameters[word] = input_param;
    }
    return true;
}

bool input_parameters_set()
{
    ...
    {
        INPUT.suffix = static_cast<std::string>(input_parameters["suffix"].get());
    }
    else if (input_parameters.count("stru_file") != 0)
    {
        INPUT.stru_file = static_cast<std::string>(input_parameters["stru_file"].get());
    }
    else if (input_parameters.count("pseudo_dir") != 0)
    {
        INPUT.pseudo_dir = static_cast<std::string>(input_parameters["pseudo_dir"].get());
    }
    else if (input_parameters.count("orbital_dir") != 0)
    {
        INPUT.orbital_dir = static_cast<std::string>(input_parameters["orbital_dir"].get());
    }
    else if (input_parameters.count("read_file_dir") != 0)
    {
        INPUT.read_file_dir = static_cast<std::string>(input_parameters["read_file_dir"].get());
    }
    else if (input_parameters.count("kpoint_file") != 0)
    {
        INPUT.kpoint_file = static_cast<std::string>(input_parameters["kpoint_file"].get());
    }
    else if (input_parameters.count("wannier_card") != 0)
    {
        INPUT.wannier_card = static_cast<std::string>(input_parameters["wannier_card"].get());
    }
    else if (input_parameters.count("latname") != 0)
    {
        INPUT.latname = static_cast<std::string>(input_parameters["latname"].get());
    }
    else if (input_parameters.count("calculation") != 0)
    {
        INPUT.calculation = static_cast<std::string>(input_parameters["calculation"].get());
    }
    else if (input_parameters.count("esolver_type") != 0)
    {
        INPUT.esolver_type = static_cast<std::string>(input_parameters["esolver_type"].get());
    }
    ...
    {
        INPUT.kspacing[0] = static_cast<double>(input_parameters["kspacing"].get()[0]);
        INPUT.kspacing[1] = static_cast<double>(input_parameters["kspacing"].get()[1]);
        INPUT.kspacing[2] = static_cast<double>(input_parameters["kspacing"].get()[2]);
    }
    ...
    {
        INPUT.nnkpfile = static_cast<std::string>(input_parameters["nnkpfile"].get());
    }
    else if (input_parameters.count("wannier_spin") != 0)
    {
        INPUT.wannier_spin = static_cast<std::string>(input_parameters["wannier_spin"].get());
    }
    ...
    {
        INPUT.nbndsto_str = static_cast<std::string>(input_parameters["nbndsto_str"].get());
    }
    ...
    {
        INPUT.dft_functional = static_cast<std::string>(input_parameters["dft_functional"].get());
    }
    ...
    {
        INPUT.basis_type = static_cast<std::string>(input_parameters["basis_type"].get());
    }
    else if (input_parameters.count("ks_solver") != 0)
    {
        INPUT.ks_solver = static_cast<std::string>(input_parameters["ks_solver"].get());
    }
    ...
    {
        INPUT.fixed_axes = static_cast<std::string>(input_parameters["fixed_axes"].get());
    }
    ...
    {
        INPUT.relax_method = static_cast<std::string>(input_parameters["relax_method"].get());
    }
    ...
    {
        INPUT.out_level = static_cast<std::string>(input_parameters["out_level"].get());
    }
    ...
    {
        INPUT.occupations = static_cast<std::string>(input_parameters["occupations"].get());
    }
    else if (input_parameters.count("smearing_method") != 0)
    {
        INPUT.smearing_method = static_cast<std::string>(input_parameters["smearing_method"].get());
    }
    ...
    {
        INPUT.mixing_mode = static_cast<std::string>(input_parameters["mixing_mode"].get());
    }
    ...
    {
        INPUT.init_wfc = static_cast<std::string>(input_parameters["init_wfc"].get());
    }
    else if (input_parameters.count("init_chg") != 0)
    {
        INPUT.init_chg = static_cast<std::string>(input_parameters["init_chg"].get());
    }
    else if (input_parameters.count("chg_extrap") != 0)
    {
        INPUT.chg_extrap = static_cast<std::string>(input_parameters["chg_extrap"].get());
    }
    ...
    {
        INPUT.vdw_method = static_cast<string>(input_parameters["vdw_method"].get());
    }
    else if (input_parameters.count("vdw_s6") != 0)
    {
        INPUT.vdw_s6 = static_cast<string>(input_parameters["vdw_s6"].get());
    }
    else if (input_parameters.count("vdw_s8") != 0)
    {
        INPUT.vdw_s8 = static_cast<string>(input_parameters["vdw_s8"].get());
    }
    else if (input_parameters.count("vdw_a1") != 0)
    {
        INPUT.vdw_a1 = static_cast<string>(input_parameters["vdw_a1"].get());
    }
    else if (input_parameters.count("vdw_a2") != 0)
    {
        INPUT.vdw_a2 = static_cast<string>(input_parameters["vdw_a2"].get());
    }
    ...
    {
        INPUT.vdw_cutoff_radius = static_cast<string>(input_parameters["vdw_cutoff_radius"].get());
    }
    else if (input_parameters.count("vdw_radius_unit") != 0)
    {
        INPUT.vdw_radius_unit = static_cast<string>(input_parameters["vdw_radius_unit"].get());
    }
    ...
    {
        INPUT.vdw_cn_thr_unit = static_cast<string>(input_parameters["vdw_cn_thr_unit"].get());
    }
    else if (input_parameters.count("vdw_C6_file") != 0)
    {
        INPUT.vdw_C6_file = static_cast<string>(input_parameters["vdw_C6_file"].get());
    }
    else if (input_parameters.count("vdw_C6_unit") != 0)
    {
        INPUT.vdw_C6_unit = static_cast<string>(input_parameters["vdw_C6_unit"].get());
    }
    else if (input_parameters.count("vdw_R0_file") != 0)
    {
        INPUT.vdw_R0_file = static_cast<string>(input_parameters["vdw_R0_file"].get());
    }
    else if (input_parameters.count("vdw_R0_unit") != 0)
    {
        INPUT.vdw_R0_unit = static_cast<string>(input_parameters["vdw_R0_unit"].get());
    }
    else if (input_parameters.count("vdw_cutoff_type") != 0)
    {
        INPUT.vdw_cutoff_type = static_cast<string>(input_parameters["vdw_cutoff_type"].get());
    }
    ...
    {
        INPUT.ocp_set = static_cast<string>(input_parameters["ocp_set"].get());
    }
    ...
    {
        INPUT.exx_hybrid_alpha = static_cast<string>(input_parameters["exx_hybrid_alpha"].get());
    }
    ...
    {
        INPUT.exx_real_number = static_cast<string>(input_parameters["exx_real_number"].get());
    }
    ...
    {
        INPUT.exx_cauchy_stress_threshold = static_cast<double>(input_parameters["exx_cauchy_stress_threshold"].get());
    }
    ...
    {
        INPUT.exx_ccp_rmesh_times = static_cast<string>(input_parameters["exx_ccp_rmesh_times"].get());
    }
    else if (input_parameters.count("exx_distribute_type") != 0)
    {
        INPUT.exx_distribute_type = static_cast<string>(input_parameters["exx_distribute_type"].get());
    }
    ...
    {
        INPUT.td_vext_dire = static_cast<string>(input_parameters["td_vext_dire"].get());
    }
    ...
    {
        INPUT.td_ttype = static_cast<string>(input_parameters["td_ttype"].get());
    }
    ...
    {
        INPUT.td_gauss_freq = static_cast<string>(input_parameters["td_gauss_freq"].get());
    }
    else if (input_parameters.count("td_gauss_phase") != 0)
    {
        INPUT.td_gauss_phase = static_cast<string>(input_parameters["td_gauss_phase"].get());
    }
    else if (input_parameters.count("td_gauss_sigma") != 0)
    {
        INPUT.td_gauss_sigma = static_cast<string>(input_parameters["td_gauss_sigma"].get());
    }
    else if (input_parameters.count("td_gauss_t0") != 0)
    {
        INPUT.td_gauss_t0 = static_cast<string>(input_parameters["td_gauss_t0"].get());
    }
    else if (input_parameters.count("td_gauss_amp") != 0)
    {
        INPUT.td_gauss_amp = static_cast<string>(input_parameters["td_gauss_amp"].get());
    }
    else if (input_parameters.count("td_trape_freq") != 0)
    {
        INPUT.td_trape_freq = static_cast<string>(input_parameters["td_trape_freq"].get());
    }
    else if (input_parameters.count("td_trape_phase") != 0)
    {
        INPUT.td_trape_phase = static_cast<string>(input_parameters["td_trape_phase"].get());
    }
    else if (input_parameters.count("td_trape_t1") != 0)
    {
        INPUT.td_trape_t1 = static_cast<string>(input_parameters["td_trape_t1"].get());
    }
    else if (input_parameters.count("td_trape_t2") != 0)
    {
        INPUT.td_trape_t2 = static_cast<string>(input_parameters["td_trape_t2"].get());
    }
    else if (input_parameters.count("td_trape_t3") != 0)
    {
        INPUT.td_trape_t3 = static_cast<string>(input_parameters["td_trape_t3"].get());
    }
    else if (input_parameters.count("td_trape_amp") != 0)
    {
        INPUT.td_trape_amp = static_cast<string>(input_parameters["td_trape_amp"].get());
    }
    else if (input_parameters.count("td_trigo_freq1") != 0)
    {
        INPUT.td_trigo_freq1 = static_cast<string>(input_parameters["td_trigo_freq1"].get());
    }
    else if (input_parameters.count("td_trigo_freq2") != 0)
    {
        INPUT.td_trigo_freq2 = static_cast<string>(input_parameters["td_trigo_freq2"].get());
    }
    else if (input_parameters.count("td_trigo_phase1") != 0)
    {
        INPUT.td_trigo_phase1 = static_cast<string>(input_parameters["td_trigo_phase1"].get());
    }
    else if (input_parameters.count("td_trigo_phase2") != 0)
    {
        INPUT.td_trigo_phase2 = static_cast<std::string>(input_parameters["td_trigo_phase2"].get());
    }
    else if (input_parameters.count("td_trigo_amp") != 0)
    {
        INPUT.td_trigo_amp = static_cast<std::string>(input_parameters["td_trigo_amp"].get());
    }
    else if (input_parameters.count("td_heavi_t0") != 0)
    {
        INPUT.td_heavi_t0 = static_cast<std::string>(input_parameters["td_heavi_t0"].get());
    }
    else if (input_parameters.count("td_heavi_amp") != 0)
    {
        INPUT.td_heavi_amp = static_cast<std::string>(input_parameters["td_heavi_amp"].get());
    }
    ...
    {
        INPUT.coulomb_type = static_cast<std::string>(input_parameters["coulomb_type"].get());
    }
    ...
    {
        INPUT.deepks_model = static_cast<std::string>(input_parameters["deepks_model"].get());
    }
    ...
    {
        INPUT.of_kinetic = static_cast<std::string>(input_parameters["of_kinetic"].get());
    }
    else if (input_parameters.count("of_method") != 0)
    {
        INPUT.of_method = static_cast<std::string>(input_parameters["of_method"].get());
    }
    else if (input_parameters.count("of_conv") != 0)
    {
        INPUT.of_conv = static_cast<std::string>(input_parameters["of_conv"].get());
    }
    ...
    {
        INPUT.of_kernel_file = static_cast<std::string>(input_parameters["of_kernel_file"].get());
    }
    ...
    {
        INPUT.bessel_nao_ecut = static_cast<std::string>(input_parameters["bessel_nao_ecut"].get());
    }
    ...
    {
        INPUT.bessel_descriptor_ecut = static_cast<std::string>(input_parameters["bessel_descriptor_ecut"].get());
    }
    ...
    {
        INPUT.bessel_descriptor_tolerence = static_cast<double>(input_parameters["bessel_descriptor_tolerence"].get());
    }
    else if (input_parameters.count("device") != 0)
    {
        INPUT.device = static_cast<std::string>(input_parameters["device"].get());
    }
    else if (input_parameters.count("precision") != 0)
    {
        INPUT.precision = static_cast<std::string>(input_parameters["precision"].get());
    }
