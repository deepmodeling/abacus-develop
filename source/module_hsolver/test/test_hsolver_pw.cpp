...
TEST_F(TestHSolverPW, solve) {
    ...
    float test_diagethr = hs_f.set_diagethr(GlobalV::PW_DIAG_THR, 0, 1, 1.0);
    EXPECT_NEAR(hs_f.diag_ethr, 0.01, 1.0e-7);
    EXPECT_NEAR(test_diagethr, 0.01, 1.0e-7);
    GlobalV::CALCULATION = "md";
    GlobalV::init_chg = "file";
    test_diagethr = hs_f.set_diagethr(GlobalV::PW_DIAG_THR, 0, 1, 1.0);
    EXPECT_NEAR(test_diagethr, 1e-5, 1.0e-7);
    test_diagethr = hs_f.set_diagethr(GlobalV::PW_DIAG_THR, 0, 2, 1.0);
    EXPECT_NEAR(test_diagethr, 0.01, 1.0e-7);
    ...
    GlobalV::PW_DIAG_THR = 1e-7;
    GlobalV::CALCULATION = "scf";
    double test_diagethr_d = hs_d.set_diagethr(GlobalV::PW_DIAG_THR, 0, 1, 1.0);
    EXPECT_EQ(hs_d.diag_ethr, 0.01);
    EXPECT_EQ(test_diagethr_d, 0.01);
    GlobalV::CALCULATION = "md";
    GlobalV::init_chg = "file";
    test_diagethr_d = hs_d.set_diagethr(GlobalV::PW_DIAG_THR, 0, 1, 1.0);
    EXPECT_EQ(test_diagethr_d, 1e-5);
    test_diagethr_d = hs_d.set_diagethr(GlobalV::PW_DIAG_THR, 0, 2, 1.0);
    EXPECT_EQ(test_diagethr_d, 0.01);
