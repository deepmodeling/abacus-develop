...
{	
	...
	for(int it = 0; it < GlobalC::ucell.ntype; it++)
	{
		...
		{
			if(GlobalC::ucell.atoms[it].atom_pp.zv % 2 == 1)
			{
	...
	for(int it = 0; it < GlobalC::ucell.ntype; it++)
	{
		for(int ia = 0; ia < GlobalC::ucell.atoms[it].na; ia++)
		{
			pdl_ion_R1[atom_index] = GlobalC::ucell.atoms[it].atom_pp.zv * (GlobalC::ucell.atoms[it].tau[ia] * rcell_1);
			pdl_ion_R2[atom_index] = GlobalC::ucell.atoms[it].atom_pp.zv * (GlobalC::ucell.atoms[it].tau[ia] * rcell_2);
			pdl_ion_R3[atom_index] = GlobalC::ucell.atoms[it].atom_pp.zv * (GlobalC::ucell.atoms[it].tau[ia] * rcell_3);
			atom_index++;
		}
	}
