...
void Cal_Test::test_memory(void)
{
	...
	std::cout << " Mixing mode = " << GlobalC::CHR_MIX.mixing_mode << std::endl;
	if(GlobalC::CHR_MIX.mixing_mode == "pulay")
	{
		std::cout << " Mixing dimension = " << GlobalC::CHR_MIX.mixing_ndim << std::endl;
		mRrho = GlobalC::CHR_MIX.mixing_ndim * mrho;
		mdRrho = (GlobalC::CHR_MIX.mixing_ndim-1) * mrho;
		mdrho = (GlobalC::CHR_MIX.mixing_ndim-1) * mrho;
		mrho_save2 = mrho;
