...
#pragma omp for schedule(dynamic)
        for (int grid_index = 0; grid_index < this->nbxx; grid_index++)
        {
            ...
            const ModuleBase::Array_Pool<double>& psir_ylm_1 = (!this->psir_func_1) ? psir_ylm
                                                                                    : this->psir_func_1(psir_ylm,
                                                                                                        *this->gridt,
                                                                                                        grid_index,
                                                                                                        0,
                                                                                                        block_iw,
                                                                                                        ...
                                                                                                        block_index,
                                                                                                        cal_flag);
            const ModuleBase::Array_Pool<double>& psir_ylm_2 = (!this->psir_func_2) ? psir_ylm
                                                                                    : this->psir_func_2(psir_ylm,
                                                                                                        *this->gridt,
                                                                                                        grid_index,
                                                                                                        0,
                                                                                                        block_iw,
            ...
            this->cal_meshball_vlocal(na_grid,
                                      LD_pool,
                                      block_size.data(),
                                      block_index.data(),
                                      grid_index,
...
#pragma omp for schedule(dynamic)
        for (int grid_index = 0; grid_index < this->nbxx; grid_index++)
        {
            ...
            const ModuleBase::Array_Pool<double> dpsix_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                          na_grid,
                                                                                          LD_pool,
                                                                                          block_index.data(),
                                                                                          cal_flag.get_ptr_2D(),
                                                                                          vkdr3.data(),
                                                                                          dpsir_ylm_x.get_ptr_2D());
            const ModuleBase::Array_Pool<double> dpsiy_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                          na_grid,
                                                                                          LD_pool,
                                                                                          block_index.data(),
                                                                                          cal_flag.get_ptr_2D(),
                                                                                          vkdr3.data(),
                                                                                          dpsir_ylm_y.get_ptr_2D());
            const ModuleBase::Array_Pool<double> dpsiz_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                          na_grid,
                                                                                          LD_pool,
                                                                                          block_index.data(),
                                                                                          cal_flag.get_ptr_2D(),
