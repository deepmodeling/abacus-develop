...
#pragma omp for schedule(dynamic)
        for (int grid_index = 0; grid_index < this->nbxx; grid_index++)
        {
            ...
            const ModuleBase::Array_Pool<double> psir_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                         na_grid,
                                                                                         LD_pool,
                                                                                         block_index.data(),
                                                                                         cal_flag.get_ptr_2D(),
            ...
            if (inout->isstress)
            {
                ...
                this->cal_meshball_stress(na_grid,
                                          block_index.data(),
                                          psir_vlbr3_DM.get_ptr_1D(),
                                          dpsirr_ylm.get_ptr_1D(),
                                          svl_dphi_thread);
            }
        }
...
#pragma omp for schedule(dynamic)
        for (int grid_index = 0; grid_index < this->nbxx; grid_index++)
        {
            ...
            Gint_Tools::cal_ddpsir_ylm(*this->gridt,
                                       ...
                                       block_size.data(),
                                       cal_flag.get_ptr_2D(),
                                       ddpsir_ylm_xx.get_ptr_2D(),
                                       ddpsir_ylm_xy.get_ptr_2D(),
                                       ddpsir_ylm_xz.get_ptr_2D(),
                                       ddpsir_ylm_yy.get_ptr_2D(),
                                       ddpsir_ylm_yz.get_ptr_2D(),
                                       ddpsir_ylm_zz.get_ptr_2D());
            ...
            const ModuleBase::Array_Pool<double> psir_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                         ...
                                                                                         vldr3.data(),
                                                                                         psir_ylm.get_ptr_2D());
            const ModuleBase::Array_Pool<double> dpsir_x_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                            na_grid,
                                                                                            LD_pool,
                                                                                            block_index.data(),
                                                                                            cal_flag.get_ptr_2D(),
                                                                                            vkdr3.data(),
                                                                                            dpsir_ylm_x.get_ptr_2D());
            const ModuleBase::Array_Pool<double> dpsir_y_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                            na_grid,
                                                                                            LD_pool,
                                                                                            block_index.data(),
                                                                                            cal_flag.get_ptr_2D(),
                                                                                            vkdr3.data(),
                                                                                            dpsir_ylm_y.get_ptr_2D());
            const ModuleBase::Array_Pool<double> dpsir_z_vlbr3 = Gint_Tools::get_psir_vlbr3(this->bxyz,
                                                                                            na_grid,
                                                                                            LD_pool,
                                                                                            block_index.data(),
                                                                                            cal_flag.get_ptr_2D(),
            ...
            Gint_Tools::mult_psi_DMR(*this->gridt,
                                     ...
                                     block_size.data(),
                                     cal_flag.get_ptr_2D(),
                                     dpsir_x_vlbr3.get_ptr_2D(),
                                     dpsirx_v_DM.get_ptr_2D(),
                                     this->DMRGint[inout->ispin],
                                     false);
            ...
            Gint_Tools::mult_psi_DMR(*this->gridt,
                                     ...
                                     block_size.data(),
                                     cal_flag.get_ptr_2D(),
                                     dpsir_y_vlbr3.get_ptr_2D(),
                                     dpsiry_v_DM.get_ptr_2D(),
                                     this->DMRGint[inout->ispin],
                                     false);
            ...
            Gint_Tools::mult_psi_DMR(*this->gridt,
                                     ...
                                     block_size.data(),
                                     cal_flag.get_ptr_2D(),
                                     dpsir_z_vlbr3.get_ptr_2D(),
                                     dpsirz_v_DM.get_ptr_2D(),
                                     this->DMRGint[inout->ispin],
                                     false);
