...
class Gint_inout
{
  public:
    ...
    Gint_inout(const int ispin_in, const double* vl_in, bool isforce_in, bool isstress_in,
               ModuleBase::matrix* fvl_dphi_in, ModuleBase::matrix* svl_dphi_in, Gint_Tools::job_type job_in)
    {
        vl = vl_in;
        isforce = isforce_in;
    ...
    // force (mGGA)
    Gint_inout(const int ispin_in, const double* vl_in, const double* vofk_in, const bool isforce_in,
               const bool isstress_in, ModuleBase::matrix* fvl_dphi_in, ModuleBase::matrix* svl_dphi_in,
...
// vindex[pw.bxyz]
int* get_vindex(const int bxyz, const int bx, const int by, const int bz, const int nplane, const int ncyz,
...
// vldr3[bxyz]
double* get_vldr3(const double* const vlocal, const int bxyz, const int bx, const int by, const int bz,
                  const int nplane, const int ncyz, const int ibx, const int jby, const int kbz, const double dv);

double* get_vldr3(const double* const vlocal, const int bxyz, const int bx, const int by, const int bz,
                  const int nplane, const int start_ind, const int ncyz, const double dv);
...
void cal_psir_ylm(const Grid_Technique& gt, const int bxyz,
