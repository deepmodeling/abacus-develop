...
template <>
void SpinConstrain<double, base_device::DEVICE_CPU>::cal_h_lambda(
...
template <>
void SpinConstrain<double, base_device::DEVICE_CPU>::cal_mw_from_lambda(
    int i_step) {}
...
template <>
void SpinConstrain<double, base_device::DEVICE_CPU>::cal_MW(const int& step,
                                                            LCAO_Matrix* LM,
                                                            bool print) {}
...
std::vector<std::vector<std::vector<double>>>
    SpinConstrain<double, base_device::DEVICE_CPU>::convert(
...
template <>
void SpinConstrain<double, base_device::DEVICE_CPU>::run_lambda_loop(
    int outer_step) {}

template <>
bool SpinConstrain<double, base_device::DEVICE_CPU>::check_rms_stop(
    int outer_step,
    int i_step,
    double rms_error,
    double duration,
...
/// calculate alpha_opt
template <>
double SpinConstrain<double, base_device::DEVICE_CPU>::cal_alpha_opt(
...
template <>
void SpinConstrain<double, base_device::DEVICE_CPU>::collect_MW(
