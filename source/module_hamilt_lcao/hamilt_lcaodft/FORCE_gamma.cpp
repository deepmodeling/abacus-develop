    ...
    LCAO_Matrix &lm)
{
    ...
    gen_h.build_ST_new('S', cal_deri, GlobalC::ucell, GlobalC::ORB, lm.Sloc.data());
    // ModuleBase::timer::tick("Force_LCAO_gamma","build_S_new");
    ...
    gen_h.build_ST_new('T', cal_deri, GlobalC::ucell, GlobalC::ORB, lm.Hloc_fixed.data());
    // ModuleBase::timer::tick("Force_LCAO_gamma","build_T_new");
    // test_gamma(lm.DHloc_fixed_x, "dHloc_fixed_x T part");

    // ModuleBase::timer::tick("Force_LCAO_gamma","build_Nonlocal_mu");
    gen_h.build_Nonlocal_mu_new(lm.Hloc_fixed.data(), cal_deri, GlobalC::ucell, GlobalC::ORB);
    // ModuleBase::timer::tick("Force_LCAO_gamma","build_Nonlocal_mu");
    ...
    if (INPUT.cal_syns)
    {
        ...
        gen_h.build_ST_new('S', cal_deri, GlobalC::ucell, GlobalC::ORB, lm.Sloc.data(), INPUT.cal_syns, INPUT.dmax);
