...
HamiltLCAO<TK, TR>::HamiltLCAO(const Parallel_Orbitals* paraV,
    ...
    this->getOperator()
        = new OverlapNew<OperatorLCAO<TK, TR>>(this->hsk,
                                               this->kv->kvec_d,
                                               this->hR,
                                               this->sR,
                                               &GlobalC::ucell,
...
HamiltLCAO<TK, TR>::HamiltLCAO(Gint_Gamma* GG_in,
    ...
    if (std::is_same<TK, double>::value) {
        ...
        // in Gamma_only case, target SK is this->hsk->get_sk(), the target SR
        // is this->sR
    ...
    // multi-k-points case to initialize HamiltLCAO, ops will be used
        ...
        if (GlobalV::ESOLVER_TYPE == "tddft"
            ...
            Operator<TK>* td_ekinetic
                = new TDEkinetic<OperatorLCAO<TK, TR>>(this->hsk,
                                                       this->hR,
                                                       this->sR,
                                                       kv,
                                                       &GlobalC::ucell,
            ...
            Operator<TK>* td_nonlocal
                = new TDNonlocal<OperatorLCAO<TK, TR>>(this->hsk,
                                                       this->kv->kvec_d,
                                                       this->hR,
                                                       &GlobalC::ucell,
                                                       &GlobalC::GridD);
