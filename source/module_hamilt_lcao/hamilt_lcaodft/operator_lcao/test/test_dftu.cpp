...
// DFTU is a derivative class of Operator, it is used to calculate the kinetic
// matrix It use HContainer to store the real space HR matrix In this test, we
// test the correctness and time consuming of 3 functions in DFTU class
