...
void TDEkinetic<OperatorLCAO<TK, TR>>::cal_HR_IJR(
    ...
    for (int iw1l = 0; iw1l < row_indexes.size(); iw1l += npol) {
        ...
        for (int iw2l = 0; iw2l < col_indexes.size(); iw2l += npol) {
            ...
            // center2_orb11_s are used to calculate <psi|∇|psi> no matter
            // whether to use new two-center or not for now.
            ModuleBase::Vector3<double> grad_overlap
                = center2_orb11_s.at(T1)
                      .at(T2)
                      .at(L1)
                      .at(N1)
                      .at(L2)
                      .at(N2)
                      .cal_grad_overlap(tau1 * ucell->lat0,
                                        tau2 * ucell->lat0,
                                        m1,
                                        m2);
