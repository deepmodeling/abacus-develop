...
// initialize_HR()
template <typename TK, typename TR>
void hamilt::NonlocalNew<hamilt::OperatorLCAO<TK, TR>>::initialize_HR(
    Grid_Driver* GridD) {
...
void hamilt::NonlocalNew<hamilt::OperatorLCAO<TK, TR>>::calculate_HR() {
    ...
    const Parallel_Orbitals* paraV
        = this->HR_fixed->get_atom_pair(0).get_paraV();
            ...
            for (int ad1 = 0; ad1 < adjs.adj_num + 1; ++ad1) {
                ...
                for (int ad2 = 0; ad2 < adjs.adj_num + 1; ++ad2) {
                    ...
                    hamilt::BaseMatrix<TR>* tmp
                        = this->HR_fixed->find_matrix(iat1,
                                                      iat2,
                                                      R_vector[0],
                                                      R_vector[1],
                                                      R_vector[2]);
...
// set_HR_fixed()
template <typename TK, typename TR>
void hamilt::NonlocalNew<hamilt::OperatorLCAO<TK, TR>>::set_HR_fixed(
    void* HR_fixed_in) {
...
void hamilt::NonlocalNew<hamilt::OperatorLCAO<TK, TR>>::contributeHR() {
    ...
    if (!this->HR_fixed_done) {
        // if this Operator is the first node of the sub_chain, then HR_fixed is
        // nullptr
...
template class hamilt::NonlocalNew<
