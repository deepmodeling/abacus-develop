...
void DFTU::cal_occ_pw(const int iter,
                      const void* psi_in,
    ...
    for (int iat = 0; iat < cell.nat; iat++)
    {
        ...
        for (int m1 = 0; m1 < m_size; m1++)
        {
            for (int m2 = 0; m2 < m_size; m2++)
            {
                ...
                this->EU += u_value * 0.25 * this->locale[iat][target_l][0][0].c[m2 * m_size + m1]
        ...
        for (int is = 1; is < 4; ++is)
        {
            ...
            for (int m1 = 0; m1 < m_size; m1++)
            {
                for (int m2 = 0; m2 < m_size; m2++)
                {
                    ...
                    this->EU += u_value * 0.25 * this->locale[iat][target_l][0][0].c[start + m2 * m_size + m1]
