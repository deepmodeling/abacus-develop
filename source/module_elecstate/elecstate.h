...
class ElecState
{
    ...
    virtual void updateRhoK(const psi::Psi<double> &psi){return;}
    
    //update charge density for next scf step
    //in this function, 1. input rho for construct Hamilt and 2. calculated rho from Psi will mix to 3. new charge density rho
    //among these rho, 
