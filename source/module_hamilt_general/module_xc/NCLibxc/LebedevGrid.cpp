...
std::vector<std::array<double, 4>> MakeAngularGrid_14() {
    ...
    g = SphGenOh(2, a, b, v); // SphGenOh 返回 vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}
...
std::vector<std::array<double, 4>> MakeAngularGrid_26() {
    ...
    g = SphGenOh(1, a, b, v); // SphGenOh 返回 vector
    grids.insert(grids.end(), g.begin(), g.end());
    v = 0.3214285714285714e-1;
    // g = SphGenOh(3, a, b, v); // SphGenOh 返回 vector
    g = SphGenOh(2, a, b, v); // SphGenOh 返回 vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}
...
std::vector<std::array<double, 4>> MakeAngularGrid_38() {
    ...
    g = SphGenOh(4, a, b, v); // SphGenOh 返回 vector
    grids.insert(grids.end(), g.begin(), g.end());
...
std::vector<std::array<double, 4>> MakeAngularGrid_146() {
    ...
    g = SphGenOh(5, a, b, v); // SphGenOh 返回 vector
    grids.insert(grids.end(), g.begin(), g.end());
    return grids;
}
...
int main() {
    // 设置输出格式
    std::cout << std::fixed;  // 固定小数点输出
    std::cout << std::setprecision(7);  // 小数点后保留3位
    std::cout << std::setw(12);  // 总宽度为10，包括小数点
    std::cout << "\n";
    std::vector<int> nums = {6, 14, 26, 38, 50, 74, 86, 110, 146, 170, 194, 230, 266, 302, 350, 434, 590, 770, 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, 3470, 3890, 4334, 4802, 5294, 5810}; // available grid levels
    ...
    {        
        ...
        double total_sum = 0.0;  // 初始化总和为0.0
