...
namespace DFTD3 {
    ...
    std::map<std::string, std::vector<double>> zero = {
        ...
        {"bp", {1.0, 1.139, 1.139, 1.683, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"blyp", {1.0, 1.094, 1.094, 1.682, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"revpbe", {1.0, 0.923, 0.923, 1.01, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"rpbe", {1.0, 0.872, 0.872, 0.514, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b97d", {1.0, 0.892, 0.892, 0.909, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b973c", {1.0, 1.06, 1.06, 1.5, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pbe", {1.0, 1.217, 1.217, 0.722, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"rpw86pbe", {1.0, 1.224, 1.224, 0.901, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b3lyp", {1.0, 1.261, 1.261, 1.703, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"tpss", {1.0, 1.166, 1.166, 1.105, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"hf", {1.0, 1.158, 1.158, 1.746, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"tpss0", {1.0, 1.252, 1.252, 1.242, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pbe0", {1.0, 1.287, 1.287, 0.928, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"hse06", {1.0, 1.129, 1.129, 0.109, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"revpbe38", {1.0, 1.021, 1.021, 0.862, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pw6b95", {1.0, 1.532, 1.532, 0.862, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b2plyp", {0.64, 1.427, 1.427, 1.022, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"dsdblyp", {0.5, 1.569, 1.569, 0.705, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpwlyp", {1.0, 1.239, 1.239, 1.098, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"olyp", {1.0, 0.806, 0.806, 1.764, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"bpbe", {1.0, 1.087, 1.087, 2.033, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"opbe", {1.0, 0.837, 0.837, 2.033, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"ssb", {1.0, 1.215, 1.215, 0.663, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"revssb", {1.0, 1.221, 1.221, 0.56, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"otpss", {1.0, 1.128, 1.128, 1.494, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b3pw91", {1.0, 1.176, 1.176, 1.775, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"bhlyp", {1.0, 1.37, 1.37, 1.442, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"tpssh", {1.0, 1.223, 1.223, 1.219, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpw1b95", {1.0, 1.605, 1.605, 1.118, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pwb6k", {1.0, 1.66, 1.66, 0.55, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b1b95", {1.0, 1.613, 1.613, 1.868, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"bmk", {1.0, 1.931, 1.931, 2.168, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"camb3lyp", {1.0, 1.378, 1.378, 1.217, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"lcwpbe", {1.0, 1.355, 1.355, 1.279, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b2gpplyp", {0.56, 1.586, 1.586, 0.76, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"ptpss", {0.75, 1.541, 1.541, 0.879, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pwpb95", {0.82, 1.557, 1.557, 0.705, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pw1pw", {1.0, 1.4968, 1.4968, 1.1786, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"scan", {1.0, 1.324, 1.324, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"wb97x", {1.0, 1.281, 1.281, 1.0, 1.094, 1.094, 1.0, 14.0, 0.0}},
        {"pbehpbe", {1.0, 1.5703, 1.5703, 1.401, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"xlyp", {1.0, 0.9384, 0.9384, 0.7447, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpwpw", {1.0, 1.3725, 1.3725, 1.9467, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"hcth407", {1.0, 4.0426, 4.0426, 2.7694, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"revtpss", {1.0, 1.3491, 1.3491, 1.3666, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"tauhcth", {1.0, 0.932, 0.932, 0.5662, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b3p", {1.0, 1.1897, 1.1897, 1.1961, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b1p", {1.0, 1.1815, 1.1815, 1.1209, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b1lyp", {1.0, 1.3725, 1.3725, 1.9467, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpwb1k", {1.0, 1.671, 1.671, 1.061, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpw1lyp", {1.0, 2.0512, 2.0512, 1.9529, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpw1pw", {1.0, 1.2892, 1.2892, 1.4758, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpw1kcis", {1.0, 1.7231, 1.7231, 2.2917, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpwkcis1k", {1.0, 1.4853, 1.4853, 1.7553, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pbeh1pbe", {1.0, 1.3719, 1.3719, 1.043, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pbe1kcis", {1.0, 3.6355, 3.6355, 1.7934, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"x3lyp", {1.0, 1.0, 1.0, 0.299, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"o3lyp", {1.0, 1.406, 1.406, 1.8058, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b97_1", {1.0, 3.7924, 3.7924, 1.6418, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b97_2", {1.0, 1.7066, 1.7066, 1.6418, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"b98", {1.0, 2.6895, 2.6895, 1.9078, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"hiss", {1.0, 1.3338, 1.3338, 0.7615, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"hse03", {1.0, 1.3944, 1.3944, 1.0156, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"revtpssh", {1.0, 1.3224, 1.3224, 1.2504, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"revtpss0", {1.0, 1.2881, 1.2881, 1.0649, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"tpss1kcis", {1.0, 1.7729, 1.7729, 2.0902, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"tauhcthhyb", {1.0, 1.5001, 1.5001, 1.6302, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pkzb", {1.0, 0.6327, 0.6327, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"n12", {1.0, 1.3493, 1.3493, 2.3916, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mpw2plyp", {0.66, 1.5527, 1.5527, 0.7529, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m05", {1.0, 1.373, 1.373, 0.595, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m052x", {1.0, 1.417, 1.417, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m06l", {1.0, 1.581, 1.581, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m06", {1.0, 1.325, 1.325, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m062x", {1.0, 1.619, 1.619, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m08hx", {1.0, 1.6247, 1.6247, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"m11l", {1.0, 2.3933, 2.3933, 1.1129, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"mn15l", {1.0, 3.3388, 3.3388, 0.0, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"pwp", {1.0, 2.104, 2.104, 0.8747, 1.0, 0.0, 1.0, 14.0, 0.0}},
    };
    ...
    std::map<std::string, std::vector<double>> zerom = {
        {"bp", {1.0, 1.23346, 1.23346, 1.945174, 1.0, 0.0, 1.0, 14.0, 0.0}},
        {"blyp", {1.0, 1.279637, 1.279637, 1.841686, 1.0, 0.0, 1.0, 14.0, 0.01437}},
        {"b97d", {1.0, 1.151808, 1.151808, 1.020078, 1.0, 0.0, 1.0, 14.0, 0.035964}},
        {"pbe", {1.0, 2.340218, 2.340218, 0.0, 1.0, 0.0, 1.0, 14.0, 0.129434}},
        {"b3lyp", {1.0, 1.338153, 1.338153, 1.532981, 1.0, 0.0, 1.0, 14.0, 0.013988}},
        {"pbe0", {1.0, 2.077949, 2.077949, 8.1e-05, 1.0, 0.0, 1.0, 14.0, 0.116755}},
        {"b2plyp", {0.64, 1.313134, 1.313134, 0.717543, 1.0, 0.0, 1.0, 14.0, 0.016035}},
        {"lcwpbe", {1.0, 1.366361, 1.366361, 1.280619, 1.0, 0.0, 1.0, 14.0, 0.00316}},
    };
