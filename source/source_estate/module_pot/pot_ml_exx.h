...
class ML_EXX : public ML_Base
{
  public:
    ...
    void init_data (const int& nkernel,
...
class PotML_EXX : public PotBase
{
  public:
    ...
    void
        cal_v_eff (const Charge* const chg, const UnitCell* const ucell, ModuleBase::matrix& v_eff) override
    {
        if (PARAM.inp.of_ml_local_test)
            this->ml_exx.localTest (chg->rho, this->rho_basis_);
    ...
    {
        return this->ml_exx.ml_exx_energy;
    }
