...
/** This class is the base class of Potential module
 ...
 2. components of potentials on real space grids can derived from it and will be registered into Potential.
    a. cal_fixed_v() is a virtual function, it can be override to contribute potentials which do not change with Charge<double> object.
    b. cal_v_eff() is a virtual function, it can be override to contribute potentials which change with Charge<double> object.
...
class PotBase
{
  public:
    ...
    virtual void cal_v_eff(const Charge<double>*const chg, const UnitCell*const ucell, ModuleBase::matrix& v_eff){}
