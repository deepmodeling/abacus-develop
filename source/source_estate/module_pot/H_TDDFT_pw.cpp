...
void
    H_TDDFT_pw::current_step_info (const std::string& file_dir, int& istep)
{
...
void
    H_TDDFT_pw::cal_fixed_v (double* vl_pseudo)
{
...
void
    H_TDDFT_pw::cal_v_space (std::vector<double>& vext_space, int direc)
{
...
void
    H_TDDFT_pw::cal_v_space_length (std::vector<double>& vext_space, int direc)
{
...
double
    H_TDDFT_pw::cal_v_space_length_potential (double i)
{
...
int
    H_TDDFT_pw::check_ncut (int t_type)
{
    int ncut = 0;
    switch (t_type)
        {
...
double
    H_TDDFT_pw::cal_v_time (int t_type, const bool last)
{
...
double
    H_TDDFT_pw::cal_v_time_Gauss (const bool last)
{
    double vext_time = 0.0;
...
double
    H_TDDFT_pw::cal_v_time_trapezoid (const bool last)
{
    double vext_time = 0.0;
...
double
    H_TDDFT_pw::cal_v_time_trigonometric (const bool last)
{
    double vext_time = 0.0;
    ...
    vext_time
        = amp * cos (omega1 * timenow + phase1) * sin (omega2 * timenow + phase2) * sin (omega2 * timenow + phase2);
    if (last)
        {
            trigo_count++;
        }
...
double
    H_TDDFT_pw::cal_v_time_heaviside (const bool last)
{
...
void
    H_TDDFT_pw::compute_force (const UnitCell& cell, ModuleBase::matrix& fe)
{
    int iat = 0;
