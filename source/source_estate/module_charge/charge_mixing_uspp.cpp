...
void
    Charge_Mixing::divide_data (std::complex<double>* data_d,
...
void
    Charge_Mixing::combine_data (std::complex<double>* data_d,
                                 std::complex<double>*& data_s,
                                 std::complex<double>*& data_hf)
{
...
void
    Charge_Mixing::clean_data (std::complex<double>*& data_s, std::complex<double>*& data_hf)
{
