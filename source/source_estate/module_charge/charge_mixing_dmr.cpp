...
void
    Charge_Mixing::allocate_mixing_dmr (const int nnr)
{
...
void
    Charge_Mixing::mix_dmr (elecstate::DensityMatrix<double, double>* DM)
{
...
void
    Charge_Mixing::mix_dmr (elecstate::DensityMatrix<std::complex<double>, double>* DM)
{
    // Notice that DensityMatrix object is a Template class
    ModuleBase::TITLE ("Charge_Mixing", "mix_dmr");
    ModuleBase::timer::start ("Charge_Mixing", "mix_dmr");
