...
void
    GintPrecisionController::set_mode (const std::string& precision_mode)
{
    this->mode_ = parse_mode_ (precision_mode);
}

GintPrecisionController::PrecisionMode
    GintPrecisionController::parse_mode_ (const std::string& precision_mode)
{
...
void
    GintPrecisionController::reset_for_new_scf ()
{
    switch (this->mode_)
        {
...
bool
    GintPrecisionController::update_after_iteration (double drho, double scf_thr)
{
...
ModuleGint::GintPrecision
    GintPrecisionController::current_precision () const
{
