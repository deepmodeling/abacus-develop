...
template <typename FPTYPE>
void
    elecstate_pw_op<FPTYPE, base_device::DEVICE_GPU>::operator() (const base_device::DEVICE_GPU* ctx,
                                                                  const int& spin,
                                                                  const int& nrxx,
                                                                  const FPTYPE& w1,
                                                                  FPTYPE** rho,
                                                                  const std::complex<FPTYPE>* wfcr)
{
    ...
    elecstate_pw<FPTYPE><<<block, THREADS_PER_BLOCK>>> (spin,
                                                        nrxx,
                                                        w1,
                                                        rho[0],
