...
class DensityMatrix
{
  ...
  public:
     ...
     */
    const std::vector<hamilt::HContainer<TR>*>&
        get_DMR_vector () const
    {
        return this->_DMR;
    }
    std::vector<hamilt::HContainer<TR>*>&
        get_DMR_vector ()
    {
        return this->_DMR;
    }

    const std::vector<std::vector<TR>>&
        get_DMR_save () const
    {
        return this->_DMR_save;
    }
    std::vector<std::vector<TR>>&
        get_DMR_save ()
    {
        return this->_DMR_save;
    }
