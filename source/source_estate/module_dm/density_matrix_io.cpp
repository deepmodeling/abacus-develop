...
void
    DensityMatrix<TK, TR>::init_DMR (const Grid_Driver* GridD_in, const UnitCell* ucell)
{
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::init_DMR (Record_adj& ra, const UnitCell* ucell)
{
    ModuleBase::TITLE ("DensityMatrix", "init_DMR");
    // ensure _DMR is empty
    for (auto& it: this->_DMR)
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::init_DMR (const hamilt::HContainer<TR>& DMR_in)
{
    ModuleBase::TITLE ("DensityMatrix", "init_DMR");
    // ensure _DMR is empty
    for (auto& it: this->_DMR)
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::init_DMR (const hamilt::HContainer<TRShift>& DMR_in)
{
    ModuleBase::TITLE ("DensityMatrix", "init_DMR");
    // ensure _DMR is empty
    for (auto& it: this->_DMR)
...
hamilt::HContainer<TR>*
    DensityMatrix<TK, TR>::get_DMR_pointer (const int ispin) const
{
#ifdef __DEBUG
...
template <typename TK, typename TR>
TK*
    DensityMatrix<TK, TR>::get_DMK_pointer (const int ik) const
{
#ifdef __DEBUG
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::set_DMK_pointer (const int ik, TK* DMK_in)
{
#ifdef __DEBUG
    assert (ik < this->_nk * this->_nspin);
#endif
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::set_DMK (const int ispin, const int ik, const int i, const int j, const TK value)
{
#ifdef __DEBUG
    assert (ispin > 0 && ispin <= this->_nspin);
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::set_DMK_zero ()
{
...
template <typename TK, typename TR>
TK
    DensityMatrix<TK, TR>::get_DMK (const int ispin, const int ik, const int i, const int j) const
{
#ifdef __DEBUG
    assert (ispin > 0 && ispin <= this->_nspin);
#endif
...
template <typename TK, typename TR>
int
    DensityMatrix<TK, TR>::get_DMK_nks () const
{
#ifdef __DEBUG
...
template <typename TK, typename TR>
int
    DensityMatrix<TK, TR>::get_DMK_size () const
{
#ifdef __DEBUG
...
template <typename TK, typename TR>
int
    DensityMatrix<TK, TR>::get_DMK_nrow () const
{
#ifdef __DEBUG
    assert (this->_DMK.size () != 0);
#endif
...
template <typename TK, typename TR>
int
    DensityMatrix<TK, TR>::get_DMK_ncol () const
{
#ifdef __DEBUG
    assert (this->_DMK.size () != 0);
#endif
...
template <typename TK, typename TR>
void
    DensityMatrix<TK, TR>::read_DMK (const std::string directory, const int ispin, const int ik)
{
...
template <>
void
    DensityMatrix<double, double>::write_DMK (const std::string directory, const int ispin, const int ik)
{
...
template <>
void
    DensityMatrix<std::complex<double>, double>::write_DMK (const std::string directory, const int ispin, const int ik)
{
    ModuleBase::TITLE ("DensityMatrix", "write_DMK");
#ifdef __DEBUG
    assert (ispin > 0 && ispin <= this->_nspin);
