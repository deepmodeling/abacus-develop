...
double ElecState::get_hartree_energy() { return H_Hartree_pw::hartree_energy; }

double ElecState::get_etot_efield() { return Efield::etotefield; }

double ElecState::get_etot_gatefield() { return Gatefield::etotgatefield; }

double ElecState::get_solvent_model_Ael() { return surchem::Ael; }

double ElecState::get_solvent_model_Acav() { return surchem::Acav; }

double ElecState::get_dftu_energy() { return Plus_U::get_energy(); }
