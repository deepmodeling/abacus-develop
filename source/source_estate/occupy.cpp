    ...
    else if (name == "smearing")
        {
            ...
            if (smearing_method == "gaussian" || smearing_method == "gauss")
            ...
            else if (smearing_method == "mp3")
                {
                    ...
                    ModuleBase::WARNING_QUIT ("occupy",
                                              "Some refactor of smearing shoule be done before supporting any order of "
                                              "Methfessel-Paxton method!");
                }
 ...
 */
void
    Occupy::efermig (const ModuleBase::matrix& ekb,
                     const int nband,
                     const int nks,
                     const double& nelec,
                     const std::vector<double>& wk,
 ...
 */
double
    Occupy::sumkg (const ModuleBase::matrix& ekb,
                   const int nband,
                   const int nks,
                   const std::vector<double>& wk,
                   const double& smearing_sigma,
...
double
    Occupy::wgauss (const double& x, const int n)
{
...
double
    Occupy::w1gauss (const double& x, const int n)
{
    //========================================================================
