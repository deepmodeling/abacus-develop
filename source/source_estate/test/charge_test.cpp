...
void Set_GlobalV_Default()
{
    ...
    PARAM.input_for_test().test_charge = 0;
    PARAM.input_for_test().nelec = 8;
}
} // namespace elecstate
 ...
 *     - using rhopw and PARAM.inp.nspin
...
TEST_F(ChargeTest, SumRho)
{
    ...
    charge->allocate(PARAM.inp.nspin, kin_den);
    EXPECT_TRUE(charge->allocate_rho);
    int nspin = (PARAM.inp.nspin == 2) ? 2 : 1;
