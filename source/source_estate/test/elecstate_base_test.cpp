...
void
    ModulePW::PW_Basis::initgrids (double, ModuleBase::Matrix3, double)
{
}
void
    ModulePW::PW_Basis::initgrids (double, ModuleBase::Matrix3, int, int, int)
{
}
void
...
TEST_F (ElecStateDeathTest, FixedWeightsWarning1)
{
    ...
    EXPECT_EXIT (elecstate::fixed_weights (ocp_kb,
                                           PARAM.input.nbands,
                                           PARAM.input.nelec,
                                           klist,
                                           elecstate->wg,
