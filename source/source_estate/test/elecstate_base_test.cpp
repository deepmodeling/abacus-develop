...
class MockElecState : public ElecState
{
  public:
    void Set_GlobalV_Default()
    {
        ...
        PARAM.input_for_test().nbands = GLOBAL_NBANDS;
        PARAM.sys_for_test().nbands_l = 6;
