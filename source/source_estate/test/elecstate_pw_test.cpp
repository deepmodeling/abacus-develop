...
{
void
    Potential::init_pot (Charge const*)
{
}
void
    Potential::cal_v_eff (const Charge* chg, const UnitCell* ucell, ModuleBase::matrix& v_eff)
{
}
void
...
template <>
void
    pseudopot_cell_vnl::radial_fft_q<float, base_device::DEVICE_CPU> (base_device::DEVICE_CPU* ctx,
                                                                      const int ng,
                                                                      const int ih,
                                                                      const int jh,
                                                                      const int itype,
...
template <>
void
    pseudopot_cell_vnl::radial_fft_q<double, base_device::DEVICE_CPU> (base_device::DEVICE_CPU* ctx,
                                                                       const int ng,
                                                                       const int ih,
                                                                       const int jh,
                                                                       const int itype,
...
template <>
std::complex<float>*
    pseudopot_cell_vnl::get_vkb_data<float> () const
{
    return nullptr;
}
template <>
std::complex<double>*
    pseudopot_cell_vnl::get_vkb_data<double> () const
{
    return nullptr;
}
template <>
void
    pseudopot_cell_vnl::getvnl<float, base_device::DEVICE_CPU> (base_device::DEVICE_CPU*,
                                                                const UnitCell&,
                                                                int const&,
...
template <>
void
    pseudopot_cell_vnl::getvnl<double, base_device::DEVICE_CPU> (base_device::DEVICE_CPU*,
                                                                 const UnitCell&,
                                                                 int const&,
...
void
    Charge::set_rho_core (const UnitCell& ucell, ModuleBase::ComplexMatrix const&, const bool*)
{
}
void
    Charge::init_rho (const UnitCell&,
                      const Parallel_Grid&,
...
void
    Charge::set_rhopw (ModulePW::PW_Basis*)
{
}
void
