...
{
void
    cal_nwfc (std::ofstream& log, UnitCell& ucell, Atom* atoms)
{
...
void
    cal_meshx (int& meshx, const Atom* atoms, const int ntype)
{
    meshx = 0;
    for (int it = 0; it < ntype; it++)
        {
...
void
    cal_natomwfc (std::ofstream& log, int& natomwfc, const int ntype, const Atom* atoms)
{
    natomwfc = 0;
    for (int it = 0; it < ntype; it++)
        {
