...
Magnetism::~Magnetism () { delete[] start_mag; }

void
    Magnetism::compute_mag (const double& omega,
                            const int& nrxx,
                            const int& nxyz,
...
bool
    Magnetism::judge_parallel (const double a[3], const ModuleBase::Vector3<double>& b)
{
    bool jp = false;
