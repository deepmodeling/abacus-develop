...
template <>
double
    ElecStateLCAO<double>::get_spin_constrain_energy ()
{
...
template <>
double
    ElecStateLCAO<std::complex<double>>::get_spin_constrain_energy ()
{
...
template <>
void
    ElecStateLCAO<double>::dm2rho (std::vector<double*> pexsi_DM,
...
template <>
void
    ElecStateLCAO<std::complex<double>>::dm2rho (std::vector<std::complex<double>*> pexsi_DM,
