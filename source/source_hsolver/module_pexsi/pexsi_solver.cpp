...
void
    PEXSI_Solver::prepare (const int blacs_text,
                           const int nb,
                           const int nrow,
                           const int ncol,
                           const double* h,
...
const double
    PEXSI_Solver::get_totalFreeEnergy () const
{
    return totalFreeEnergy;
}

const double
    PEXSI_Solver::get_totalEnergyH () const
{
    return totalEnergyH;
}

const double
    PEXSI_Solver::get_totalEnergyS () const
{
    return totalEnergyS;
}

const double
    PEXSI_Solver::get_mu () const
{
    return mu;
}
