...
template <typename T>
void
    DiagoElpaNative<T>::diag_pool (hamilt::MatrixBlock<T>& h_mat,
...
template <typename T>
void
    DiagoElpaNative<T>::diag (hamilt::Hamilt<T>* phm_in, psi::Psi<T>& psi, Real* eigenvalue_in)
{
