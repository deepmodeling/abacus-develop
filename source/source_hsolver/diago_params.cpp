...
void
    setup_diago_params_pw (const int istep, const int iter, const double ethr, const Input_para& inp)
{
...
template <typename T, typename Device>
void
    setup_diago_params_sdft (const int istep, const int iter, const double ethr, const Input_para& inp)
{
    /// choose if psi should be diag in subspace
    /// be careful that istep start from 0 and iter start from 1
