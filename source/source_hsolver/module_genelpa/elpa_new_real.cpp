...
int
    ELPA_Solver::eigenvector (double* A, double* EigenValue, double* EigenVector)
{
    int info = 0;
    double t = 0.0;
...
int
    ELPA_Solver::generalized_eigenvector (double* A,
                                          double* B,
                                          int& DecomposedState,
                                          double* EigenValue,
                                          double* EigenVector)
...
int
    ELPA_Solver::decomposeRightMatrix (double* B, double* EigenValue, double* EigenVector, int& DecomposedState)
{
    int info = 0;
    int allinfo = 0;
    double t;
...
int
    ELPA_Solver::composeEigenVector (int DecomposedState, double* B, double* EigenVector)
{
    double t;
    if (DecomposedState == 1 || DecomposedState == 2)
        {
...
void
    ELPA_Solver::verify (double* A, double* EigenValue, double* EigenVector, double& maxError, double& meanError)
{
