...
void
    ELPA_Solver::setLoglevel (int loglevel)
{
    int error;
...
void
    ELPA_Solver::setKernel (bool isReal, int kernel)
{
...
int
    ELPA_Solver::read_complex_kernel ()
{
    int kernel_id;
...
void
    ELPA_Solver::timer (int myid, const char function[], const char step[], double& t0)
{
    double t1 = 0.0;
