 ...
 */
inline void
    elpa_set (elpa_t handle, const char* name, int value, int* error)
{
    elpa_set_integer (handle, name, value, error);
}
inline void
    elpa_set (elpa_t handle, const char* name, double value, int* error)
{
 ...
 */
inline void
    elpa_get (elpa_t handle, const char* name, int* value, int* error)
{
    elpa_get_integer (handle, name, value, error);
}
inline void
    elpa_get (elpa_t handle, const char* name, double* value, int* error)
{
...
inline void
    elpa_eigenvectors (const elpa_t handle, double* a, double* ev, double* q, int* error)
{
    elpa_eigenvectors_d (handle, a, ev, q, error);
}

inline void
    elpa_eigenvectors (const elpa_t handle, float* a, float* ev, float* q, int* error)
{
    elpa_eigenvectors_f (handle, a, ev, q, error);
}

inline void
    elpa_eigenvectors (const elpa_t handle, std::complex<double>* a, double* ev, std::complex<double>* q, int* error)
{
    elpa_eigenvectors_dc (handle,
                          reinterpret_cast<double _Complex*> (a),
                          ev,
                          reinterpret_cast<double _Complex*> (q),
                          error);
}

inline void
    elpa_eigenvectors (const elpa_t handle, std::complex<float>* a, float* ev, std::complex<float>* q, int* error)
{
    elpa_eigenvectors_fc (handle,
                          reinterpret_cast<float _Complex*> (a),
                          ev,
                          reinterpret_cast<float _Complex*> (q),
                          error);
}
...
inline void
    elpa_eigenvectors (const elpa_t handle, std::complex<double>* a, double* ev, std::complex<double>* q, int* error)
{
    elpa_eigenvectors_all_host_arrays_dc (handle,
                                          reinterpret_cast<double _Complex*> (a),
                                          ev,
                                          reinterpret_cast<double _Complex*> (q),
                                          error);
...
inline void
    elpa_eigenvectors (const elpa_t handle, std::complex<float>* a, float* ev, std::complex<float>* q, int* error)
{
    elpa_eigenvectors_all_host_arrays_fc (handle,
                                          reinterpret_cast<float _Complex*> (a),
                                          ev,
                                          reinterpret_cast<float _Complex*> (q),
                                          error);
...
inline void
    elpa_eigenvectors (const elpa_t handle, std::complex<double>* a, double* ev, std::complex<double>* q, int* error)
{
    elpa_eigenvectors_a_h_a_dc (handle,
                                reinterpret_cast<double _Complex*> (a),
                                ev,
                                reinterpret_cast<double _Complex*> (q),
                                error);
...
inline void
    elpa_eigenvectors (const elpa_t handle, std::complex<float>* a, float* ev, std::complex<float>* q, int* error)
{
    elpa_eigenvectors_a_h_a_fc (handle,
                                reinterpret_cast<float _Complex*> (a),
                                ev,
                                reinterpret_cast<float _Complex*> (q),
                                error);
...
#if ELPA_API_VERSION <= 20210502 // ELPA 2021.05.002 and earlier versions
inline void
    elpa_skew_eigenvectors (const elpa_t handle, double* a, double* ev, double* q, int* error)
{
    elpa_eigenvectors_d (handle, a, ev, q, error);
}

inline void
    elpa_skew_eigenvectors (const elpa_t handle, float* a, float* ev, float* q, int* error)
{
    elpa_eigenvectors_f (handle, a, ev, q, error);
}
#elif ELPA_API_VERSION < 20220501 // ELPA version between 2021.11.001 and 2022.05.001
 ...
 */
inline void
    elpa_generalized_eigenvectors (elpa_t handle,
                                   double* a,
                                   double* b,
                                   double* ev,
                                   double* q,
                                   ...
                                   int* error)
{
    elpa_generalized_eigenvectors_dc (handle,
                                      reinterpret_cast<double _Complex*> (a),
                                      reinterpret_cast<double _Complex*> (b),
                                      ev,
                                      reinterpret_cast<double _Complex*> (q),
...
inline void
    elpa_generalized_eigenvectors (elpa_t handle,
                                   ...
                                   int* error)
{
    elpa_generalized_eigenvectors_fc (handle,
                                      reinterpret_cast<float _Complex*> (a),
                                      reinterpret_cast<float _Complex*> (b),
                                      ev,
                                      reinterpret_cast<float _Complex*> (q),
                                      is_already_decomposed,
                                      error);
...
#if ELPA_API_VERSION <= 20210502 // ELPA 2021.05.002 and earlier versions
inline void
    elpa_eigenvalues (elpa_t handle, double* a, double* ev, int* error)
{
    elpa_eigenvalues_d (handle, a, ev, error);
}
inline void
    elpa_eigenvalues (elpa_t handle, float* a, float* ev, int* error)
{
    elpa_eigenvalues_f (handle, a, ev, error);
}
inline void
    elpa_eigenvalues (elpa_t handle, std::complex<double>* a, double* ev, int* error)
{
    elpa_eigenvalues_dc (handle, reinterpret_cast<double _Complex*> (a), ev, error);
}
inline void
    elpa_eigenvalues (elpa_t handle, std::complex<float>* a, float* ev, int* error)
{
...
#if ELPA_API_VERSION <= 20210502 // ELPA 2021.05.002 and earlier versions
inline void
    elpa_skew_eigenvalues (elpa_t handle, double* a, double* ev, int* error)
{
    elpa_eigenvalues_d (handle, a, ev, error);
}
inline void
    elpa_skew_eigenvalues (elpa_t handle, float* a, float* ev, int* error)
{
    elpa_eigenvalues_f (handle, a, ev, error);
}
#elif ELPA_API_VERSION < 20220501 // ELPA version between 2021.11.001 and 2022.05.001
...
inline void
    elpa_cholesky (elpa_t handle, double* a, int* error)
{
    elpa_cholesky_d (handle, a, error);
}
inline void
    elpa_cholesky (elpa_t handle, float* a, int* error)
{
    elpa_cholesky_f (handle, a, error);
}
inline void
    elpa_cholesky (elpa_t handle, std::complex<double>* a, int* error)
{
    elpa_cholesky_dc (handle, reinterpret_cast<double _Complex*> (a), error);
}
inline void
    elpa_cholesky (elpa_t handle, std::complex<float>* a, int* error)
{
...
#if ELPA_API_VERSION < 20220501 // ELPA version before 2022.05.001
inline void
    elpa_hermitian_multiply (elpa_t handle,
                             char uplo_a,
                             char uplo_c,
                             int ncb,
                             double* a,
...
inline void
    elpa_hermitian_multiply (elpa_t handle,
                             ...
                             int* error)
{
    elpa_hermitian_multiply_dc (handle,
                                uplo_a,
                                uplo_c,
                                ncb,
                                reinterpret_cast<double _Complex*> (a),
...
inline void
    elpa_hermitian_multiply (elpa_t handle,
                             ...
                             int* error)
{
    elpa_hermitian_multiply_fc (handle,
                                uplo_a,
                                uplo_c,
                                ncb,
                                reinterpret_cast<float _Complex*> (a),
...
inline void
    elpa_hermitian_multiply (elpa_t handle,
                             ...
                             int* error)
{
    elpa_hermitian_multiply_a_h_a_dc (handle,
                                      uplo_a,
                                      uplo_c,
                                      ncb,
                                      reinterpret_cast<double _Complex*> (a),
...
inline void
    elpa_hermitian_multiply (elpa_t handle,
                             ...
                             int* error)
{
    elpa_hermitian_multiply_a_h_a_fc (handle,
                                      uplo_a,
                                      uplo_c,
                                      ncb,
                                      reinterpret_cast<float _Complex*> (a),
...
#if ELPA_API_VERSION < 20220501 // ELPA version before 2022.05.001
inline void
    elpa_invert_triangular (elpa_t handle, double* a, int* error)
{
    elpa_invert_trm_d (handle, a, error);
}
inline void
    elpa_invert_triangular (elpa_t handle, float* a, int* error)
{
    elpa_invert_trm_f (handle, a, error);
}
inline void
    elpa_invert_triangular (elpa_t handle, std::complex<double>* a, int* error)
{
    elpa_invert_trm_dc (handle, reinterpret_cast<double _Complex*> (a), error);
}
inline void
    elpa_invert_triangular (elpa_t handle, std::complex<float>* a, int* error)
{
