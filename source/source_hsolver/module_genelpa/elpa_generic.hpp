 ...
 *  \result void
 */
inline void elpa_generalized_eigenvectors(elpa_t handle,
                                          double* a,
                                          double* b,
                                          double* ev,
                                          double* q,
...
inline void elpa_cholesky(elpa_t handle, double* a, int* error) { elpa_cholesky_d(handle, a, error); }
inline void elpa_cholesky(elpa_t handle, float* a, int* error) { elpa_cholesky_f(handle, a, error); }
...
#else
inline void elpa_cholesky(elpa_t handle, double* a, int* error) { elpa_cholesky_a_h_a_d(handle, a, error); }
inline void elpa_cholesky(elpa_t handle, float* a, int* error) { elpa_cholesky_a_h_a_f(handle, a, error); }
inline void elpa_cholesky(elpa_t handle, std::complex<double>* a, int* error) {
 ...
 */
#if ELPA_API_VERSION < 20220501 // ELPA version before 2022.05.001
inline void elpa_hermitian_multiply(elpa_t handle,
                                    char uplo_a,
                                    char uplo_c,
                                    int ncb,
                                    double* a,
 ...
 */
#if ELPA_API_VERSION < 20220501 // ELPA version before 2022.05.001
inline void elpa_invert_triangular(elpa_t handle, double* a, int* error) { elpa_invert_trm_d(handle, a, error); }
...
#else
inline void elpa_invert_triangular(elpa_t handle, double* a, int* error) { elpa_invert_trm_a_h_a_d(handle, a, error); }
