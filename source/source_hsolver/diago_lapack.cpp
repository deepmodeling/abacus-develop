...
template <>
void
    DiagoLapack<double>::diag (hamilt::Hamilt<double>* phm_in, psi::Psi<double>& psi, Real* eigenvalue_in)
{
...
template <>
void
    DiagoLapack<std::complex<double>>::diag (hamilt::Hamilt<std::complex<double>>* phm_in,
...
template <>
void
    DiagoLapack<double>::diag_pool (hamilt::MatrixBlock<double>& h_mat,
...
template <>
void
    DiagoLapack<std::complex<double>>::diag_pool (hamilt::MatrixBlock<std::complex<double>>& h_mat,
...
std::pair<int, std::vector<int>>
    DiagoLapack<T>::dsygvx_once (const int ncol,
                                 const int nrow,
...
template <typename T>
std::pair<int, std::vector<int>>
    DiagoLapack<T>::zhegvx_once (const int ncol,
                                 const int nrow,
...
template <typename T>
void
    DiagoLapack<T>::dsygvx_diag (const int ncol,
                                 const int nrow,
                                 const double* const h_mat,
                                 const double* const s_mat,
                                 double* const ekb,
...
template <typename T>
void
    DiagoLapack<T>::zhegvx_diag (const int ncol,
                                 const int nrow,
                                 const std::complex<double>* const h_mat,
                                 const std::complex<double>* const s_mat,
                                 double* const ekb,
...
template <typename T>
void
    DiagoLapack<T>::post_processing (const int info, const std::vector<int>& vec)
{
