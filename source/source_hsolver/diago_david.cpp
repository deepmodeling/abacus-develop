...
template <typename T, typename Device>
int
    DiagoDavid<T, Device>::diag_once (const HPsiFunc& hpsi_func,
...
template <typename T, typename Device>
void
    DiagoDavid<T, Device>::cal_grad (const HPsiFunc& hpsi_func,
                                     const SPsiFunc& spsi_func,
                                     const int& dim,
...
template <typename T, typename Device>
void
    DiagoDavid<T, Device>::cal_elem (const int& dim,
...
template <typename T, typename Device>
void
    DiagoDavid<T, Device>::diag_zhegvx (const int& nbase,
                                        const int& nband,
                                        const T* hcc,
                                        const int& nbase_x,
...
template <typename T, typename Device>
void
    DiagoDavid<T, Device>::refresh (const int& dim,
                                    const int& nband,
                                    int& nbase,
                                    const int nbase_x, // maximum dimension of the reduced basis set
...
template <typename T, typename Device>
void
    DiagoDavid<T, Device>::SchmidtOrth (const int& dim,
                                        const int nband,
                                        const int m,
                                        const T* spsi,
                                        T* lagrange_m,
...
template <typename T, typename Device>
void
    DiagoDavid<T, Device>::planSchmidtOrth (const int nband,
...
template <typename T, typename Device>
int
    DiagoDavid<T, Device>::diag (const HPsiFunc& hpsi_func,
                                 const SPsiFunc& spsi_func,
                                 const int ld_psi,
                                 T* psi_in,
                                 Real* eigenvalue_in,
...
template <typename T, typename Device>
inline bool
    DiagoDavid<T, Device>::check_block_conv (const int& ntry,
                                             const int& notconv,
                                             const int& ntry_max,
                                             const int& notconv_max)
{
