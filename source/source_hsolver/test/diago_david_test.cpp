...
class DiagoDavPrepare
{
  public:
    ...
    void
        CompareEigen (psi::Psi<std::complex<double>>& phi, double* precondition)
    {
        ...
        auto hpsi_func
            = [phm] (std::complex<double>* psi_in, std::complex<double>* hpsi_out, const int ld_psi, const int nvec)
            {
