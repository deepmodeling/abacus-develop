...
class DiagoCGPrepare
{
  public:
	...
	//======================================================================
	    ...
	    ha =new hamilt::HamiltPW<std::complex<float>>(nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr);
        ...
        auto subspace_func = [ha, &diag_comm](std::complex<float>* psi_in,
        ...
        hsolver::DiagoCG<std::complex<float>> cg("pw",
                                                 "scf",
