...
class DiagoCGPrepare
{
  public:
        ...
        CompareEigen (double* precondition)
    {
        ...
        auto subspace_func
            = [ha] (double* psi_in, double* psi_out, const int ld_psi, const int nband, const bool S_orth)
            {
        ...
        auto hpsi_func = [ha] (double* psi_in, double* hpsi_out, const int ld_psi, const int nvec)
            {
        ...
        auto spsi_func = [ha] (double* psi_in, double* spsi_out, const int ld_psi, const int nvec)
