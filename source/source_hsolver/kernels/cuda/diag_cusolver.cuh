...
class Diag_Cusolver_gvd
{
  ...
  public:
    ...
    void
        Dngvd (int N, int M, double* A, double* B, double* W, double* V)
    {
        return Dngvd_double (N, M, A, B, W, V);
    };

    void
        Dngvd (int N, int M, std::complex<double>* A, std::complex<double>* B, double* W, std::complex<double>* V)
    {
