...
static calError_t
    allgather (void* src_buf, void* recv_buf, size_t size, void* data, void** request)
{
    MPI_Request req;
...
template <typename inputT>
int
    Diag_CusolverMP_gvd<inputT>::generalized_eigenvector (inputT* A,
                                                          inputT* B,
                                                          outputT* EigenValue,
                                                          inputT* EigenVector)
{
...
template <typename inputT>
void
    Diag_CusolverMP_gvd<inputT>::outputParameters ()
{
