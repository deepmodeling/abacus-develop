...
struct MD_para
{
    ...
    std::string md_thermostat = "nhc"; ///< specify the thermostat: nhc, anderson, berendsen, rescaling, rescale_v
    ...
    std::string md_pcouple = "none"; ///< whether couple different components: xyz, xy, yz, xz, none
    double md_tfreq = 0.0;   ///< Oscillation frequency, used to determine qmass of thermostats coupled with particles
    double md_pfirst = -1.0; ///< Initial pressure
    double md_plast = -1.0;  ///< Final pressure
    double md_pfreq = 0.0;   ///< Oscillation frequency, used to determine qmass of thermostats coupled with barostat
    ...
    bool dump_force = true;  ///< output atomic forces into the file MD_dump or not. liuyu 2023-03-01
    bool dump_vel = true;    ///< output atomic velocities into the file MD_dump or not. liuyu 2023-03-01
    bool dump_virial = true; ///< output lattice virial into the file MD_dump or not. liuyu 2023-03-01
