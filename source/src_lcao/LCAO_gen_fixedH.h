...
class LCAO_gen_fixedH
{
    ...
    friend class Force_LCAO_k_tddft;
    friend class Evolve_LCAO_Matrix;
  ...
  private:
    ...
    // void build_ST_new(const char& dtype, const bool& cal_deri, const UnitCell_pseudo &ucell, std::complex<double>*
    // SHlocR);
