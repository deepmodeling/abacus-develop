...
class Ions_Move_Methods {
  public:
    ...
    bool get_converged() const { return Ions_Move_Basic::converged; }
    double get_ediff() const { return Ions_Move_Basic::ediff; }
    double get_largest_grad() const { return Ions_Move_Basic::largest_grad; }
    double get_trust_radius() const { return Ions_Move_Basic::trust_radius; }
    double get_update_iter() const { return Ions_Move_Basic::update_iter; }
