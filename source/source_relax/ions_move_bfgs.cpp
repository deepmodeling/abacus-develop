...
void
    Ions_Move_BFGS::start (UnitCell& ucell, const ModuleBase::matrix& force, const double& energy_in)
{
...
void
    Ions_Move_BFGS::restart_bfgs (const double& lat0)
{
...
void
    Ions_Move_BFGS::bfgs_routine (const double& lat0)
{
