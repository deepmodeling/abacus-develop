...
void
    Ions_Move_Methods::allocate (const int& natom)
{
    ...
    if (Ions_Move_Basic::relax_method[0] == "bfgs" && Ions_Move_Basic::relax_method[1] != "1")
        ...
        {
            ModuleBase::WARNING ("Ions_Move_Methods::init",
                                 "the parameter Ions_Move_Basic::relax_method is not correct.");
        }
    return;
}
...
void
    Ions_Move_Methods::cal_movement (const int& istep,
