...
void
    Relax_old::init_relax (const int& natom)
{
...
bool
    Relax_old::relax_step (const int& istep,
                           const double& energy,
                           UnitCell& ucell,
...
bool
    Relax_old::if_do_relax (const UnitCell& ucell)
{
...
bool
    Relax_old::if_do_cellrelax (const UnitCell& ucell)
{
...
bool
    Relax_old::do_relax (const int& istep,
...
bool
    Relax_old::do_cellrelax (const int& istep,
