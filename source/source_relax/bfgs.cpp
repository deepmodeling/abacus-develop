...
void BFGS::GetPostaud(UnitCell& ucell, std::vector<ModuleBase::Vector3<double>>& pos_taud) {
...
void BFGS::CalculateLargestGrad(const ModuleBase::matrix& _force, UnitCell& ucell) {
    ...
    if (PARAM.inp.out_level == "ie") {
        std::cout << " LARGEST GRAD (eV/Angstrom)  : " << largest_grad * ModuleBase::Ry_to_eV / ModuleBase::BOHR_TO_A
                  << std::endl;
    }
}
