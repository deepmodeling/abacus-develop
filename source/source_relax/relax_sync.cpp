...
void
    Relax::init_relax (const int nat_in)
{
...
bool
    Relax::relax_step (UnitCell& ucell,
...
bool
    Relax::setup_gradient (const UnitCell& ucell, const ModuleBase::matrix& force, const ModuleBase::matrix& stress)
{
...
void
    Relax::move_cell_ions (UnitCell& ucell, const bool is_new_dir)
{
