...
void
    ESolver_KS::before_all_runners (UnitCell& ucell, const Input_para& inp)
{
...
void
    ESolver_KS::hamilt2rho_single (UnitCell& ucell, const int istep, const int iter, const double ethr)
{
}

void
    ESolver_KS::hamilt2rho (UnitCell& ucell, const int istep, const int iter, const double ethr)
{
...
void
    ESolver_KS::runner (UnitCell& ucell, const int istep)
{
...
void
    ESolver_KS::before_scf (UnitCell& ucell, const int istep)
{
...
void
    ESolver_KS::iter_init (UnitCell& ucell, const int istep, const int iter)
{
...
void
    ESolver_KS::iter_finish (UnitCell& ucell, const int istep, int& iter, bool& conv_esolver)
{
    ...
    module_charge::chgmixing_ks (iter,
                                 ucell,
                                 this->pelec,
                                 this->chr,
                                 this->p_chgmix,
    ...
    // print energies
    elecstate::print_etot (ucell.magnet, *pelec, conv_esolver, iter, drho, dkin, duration, diag_ethr);
...
void
    ESolver_KS::after_scf (UnitCell& ucell, const int istep, const bool conv_esolver)
{
...
void
    ESolver_KS::after_all_runners (UnitCell& ucell)
{
