...
void
    ESolver_FP::before_all_runners (UnitCell& ucell, const Input_para& inp)
{
    ...
    this->Pgrid.init (this->pw_rhod->nx,
                      this->pw_rhod->ny,
                      this->pw_rhod->nz,
                      this->pw_rhod->nplane,
                      this->pw_rhod->nrxx,
...
void
    ESolver_FP::after_scf (UnitCell& ucell, const int istep, const bool conv_esolver)
{
...
void
    ESolver_FP::before_scf (UnitCell& ucell, const int istep)
{
...
void
    ESolver_FP::iter_finish (UnitCell& ucell, const int istep, int& iter, bool& conv_esolver)
{
            ...
            if (iter % PARAM.inp.out_freq_elec == 0 || iter == PARAM.inp.scf_nmax || conv_esolver)
                {
                    ...
                    if (XC_Functional::get_ked_flag ())
                        {
                            std::vector<std::complex<double>> kin_g_space (PARAM.inp.nspin * this->chr.ngmc,
                                                                           {0.0, 0.0});
                            ...
                            ModuleIO::write_rhog (PARAM.globalv.global_out_dir + PARAM.inp.suffix
                                                      + "-TAU-DENSITY.restart",
                                                  PARAM.globalv.gamma_only_pw,
                                                  this->pw_rhod,
                                                  PARAM.inp.nspin,
...
void
    ESolver_FP::after_all_runners (UnitCell& ucell)
{
