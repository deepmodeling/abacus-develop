...
template <typename T>
void
    ESolver_KS_LIP<T>::allocate_hamilt (const UnitCell& ucell)
{
...
template <typename T>
void
    ESolver_KS_LIP<T>::before_scf (UnitCell& ucell, const int istep)
{
...
template <typename T>
void
    ESolver_KS_LIP<T>::before_all_runners (UnitCell& ucell, const Input_para& inp)
{
            ...
            if (GlobalC::exx_info.info_global.cal_exx)
                {
                    ...
                    this->exx_lip = std::unique_ptr<Exx_Lip<T>> (
                        new Exx_Lip<T> (GlobalC::exx_info.info_lip,
                                        ucell.symm,
                                        &this->kv,
                                        this->psi_local,
...
template <typename T>
void
    ESolver_KS_LIP<T>::iter_init (UnitCell& ucell, const int istep, const int iter)
{
...
template <typename T>
void
    ESolver_KS_LIP<T>::hamilt2rho_single (UnitCell& ucell, const int istep, const int iter, const double ethr)
{
...
template <typename T>
void
    ESolver_KS_LIP<T>::iter_finish (UnitCell& ucell, const int istep, int& iter, bool& conv_esolver)
{
...
template <typename T>
void
    ESolver_KS_LIP<T>::after_all_runners (UnitCell& ucell)
{
