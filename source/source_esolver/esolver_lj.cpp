...
void ESolver_LJ::before_all_runners(BaseCell& cell, const Input_para& inp)
{
    if (cell.kind() == BaseCell::Kind::md_cell)
    {
        ...
        before_all_runners_mdcell_(mdcell, inp);
        return;
    }
...
void ESolver_LJ::before_all_runners_mdcell_(MdCell& mdcell, const Input_para& inp)
{
    lj_potential = 0.0;
...
void ESolver_LJ::runner_mdcell_(MdCell& mdcell, const int istep)
{
    ...
    for (int local_i = 0; local_i < neighbor_list.get_nlocal(); ++local_i)
    {
        ...
        {
            const NeighborAtom& neighbor_atom = all_atoms[neighbor_list.get_firstneigh(local_i)[ad]];
            ModuleBase::Vector3<double> tau2(neighbor_atom.position_x, neighbor_atom.position_y, neighbor_atom.position_z);
    ...
    void ESolver_LJ::cal_force(BaseCell& cell, ModuleBase::matrix& force)
    {
        ...
        {
            MdCell& mdcell = static_cast<MdCell&>(cell);
            cal_force_mdcell_(mdcell, force);
            return;
        }
    ...
    void ESolver_LJ::cal_force_mdcell_(MdCell& mdcell, ModuleBase::matrix& force)
    {
    ...
    void ESolver_LJ::cal_stress(BaseCell& cell, ModuleBase::matrix& stress)
    {
        ...
        {
            MdCell& mdcell = static_cast<MdCell&>(cell);
            cal_stress_mdcell_(mdcell, stress);
            return;
        }
    ...
    void ESolver_LJ::cal_stress_mdcell_(MdCell& mdcell, ModuleBase::matrix& stress)
    {
        static_cast<void>(mdcell);
        stress = lj_virial;
    }
    ...
    void ESolver_LJ::after_all_runners(BaseCell& cell)
    {
        ...
        {
            MdCell& mdcell = static_cast<MdCell&>(cell);
            after_all_runners_mdcell_(mdcell);
            return;
        }
    ...
    void ESolver_LJ::after_all_runners_mdcell_(MdCell& mdcell)
    {
        static_cast<void>(mdcell);
        GlobalV::ofs_running << "\n --------------------------------------------" << std::endl;
        GlobalV::ofs_running << std::setprecision(16);
