...
void
    ESolver_NEP::before_all_runners (UnitCell& ucell, const Input_para& inp)
{
    nep_potential = 0.0;
...
void
    ESolver_NEP::runner (UnitCell& ucell, const int istep)
{
    ...
    GlobalV::ofs_running << " #TOTAL ENERGY# " << std::setprecision (11) << nep_potential * ModuleBase::Ry_to_eV
                         << " eV" << std::endl;
...
void
    ESolver_NEP::cal_force (UnitCell& ucell, ModuleBase::matrix& force)
{
    force = nep_force;
...
void
    ESolver_NEP::cal_stress (UnitCell& ucell, ModuleBase::matrix& stress)
{
    stress = nep_virial;
...
void
    ESolver_NEP::after_all_runners (UnitCell& ucell)
{
    GlobalV::ofs_running << "\n --------------------------------------------" << std::endl;
...
#ifdef __NEP
void
    ESolver_NEP::type_map (const UnitCell& ucell)
{
                    ...
                    if (label.find (ucell.atoms[it].label) == label.end ())
                        {
                            ModuleBase::WARNING_QUIT ("ESolver_NEP",
                                                      "The label " + ucell.atoms[it].label
