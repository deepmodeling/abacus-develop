...
template <typename TK, typename TR>
void
    ESolver_DM2rho<TK, TR>::before_all_runners (UnitCell& ucell, const Input_para& inp)
{
...
template <typename TK, typename TR>
void
    ESolver_DM2rho<TK, TR>::runner (UnitCell& ucell, const int istep)
{
...
template <typename TK, typename TR>
void
    ESolver_DM2rho<TK, TR>::after_all_runners (UnitCell& ucell)
{
