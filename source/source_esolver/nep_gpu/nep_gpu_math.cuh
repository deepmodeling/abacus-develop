/*
 * CUDA math primitives used by the ABACUS NEP4 GPU backend.
 *
 * The routines below implement the NEP cutoff, Chebyshev radial basis,
 * angular descriptor, neural-network, and force-derivative formulas.
 */
#pragma once
...
{
  const float x = 2.0f * (d12 * rcinv - 1.0f) * (d12 * rcinv - 1.0f) - 1.0f;
  const float half_fc12 = 0.5f * fc12;
  fn[0] = fc12;
