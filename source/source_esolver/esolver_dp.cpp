...
void
    ESolver_DP::before_all_runners (UnitCell& ucell, const Input_para& inp)
{
    dp_potential = 0;
...
void
    ESolver_DP::runner (UnitCell& ucell, const int istep)
{
...
void
    ESolver_DP::cal_force (UnitCell& ucell, ModuleBase::matrix& force)
{
    force = dp_force;
...
void
    ESolver_DP::cal_stress (UnitCell& ucell, ModuleBase::matrix& stress)
{
    stress = dp_virial;
...
void
    ESolver_DP::after_all_runners (UnitCell& ucell)
{
    GlobalV::ofs_running << "\n --------------------------------------------" << std::endl;
...
#ifdef __DPMD
void
    ESolver_DP::type_map (const UnitCell& ucell)
{
    std::string type = "";
