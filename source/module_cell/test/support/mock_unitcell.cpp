...
/*
    README:
    This file supports idea like "I dont need any functions of UnitCell, I want to avoid using UnitCell functions
   because there is GLobalC, which will bring endless compile troubles like undefined behavior"
*/
...
bool UnitCell::judge_big_cell() const
{
    return true;
}
