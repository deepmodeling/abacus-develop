...
void Symmetry_Basic::veccon(double* carpos,
                            double* rotpos,
                            const int num,
...
void Symmetry_Basic::setgroup(ModuleBase::Matrix3* symop, int& nop, const int& ibrav) const
{
    ...
    if (PARAM.inp.test_symmetry > 1)
    {
        ...
        for (int i = 0; i < nop; ++i)
        {
            GlobalV::ofs_running << " " << std::setw(3) << i + 1 << std::setw(4) << symop[i].e11 << std::setw(4)
                                 << symop[i].e12 << std::setw(4) << symop[i].e13 << std::setw(4) << symop[i].e21
                                 << std::setw(4) << symop[i].e22 << std::setw(4) << symop[i].e23 << std::setw(4)
                                 << symop[i].e31 << std::setw(4) << symop[i].e32 << std::setw(4) << symop[i].e33
                                 << std::endl;
        }
    }
...
int Symmetry_Basic::subgroup(const int& nrot,
                             const int& ninv,
                             const int& nc2,
                             const int& nc3,
                             const int& nc4,
...
bool Symmetry_Basic::pointgroup(const int& nrot,
                                int& pgnumber,
                                std::string& pgname,
                                ...
                                std::ofstream& ofs_running) const
{
    ...
    for (int i = 0; i < nrot; ++i)
    {
        ...
        if (trace == -1 && det == 1)
            ...
            ++ns6; // mohan add 2012-01-15
        else if (trace == -1 && det == -1)
            ++ns4;
        else if (trace == -2 && det == -1)
            ++ns3; // mohan add 2012-01-15
    }
...
void Symmetry_Basic::rotate(ModuleBase::Matrix3& gmatrix,
