...
public:
    ...
    double qqq_eps;           // qfunc is null if its norm is .lt. qqq_eps
    ...
    double* rinner = nullptr;        // rinner(2*lmax) r_L
    ...
    ModuleBase::realArray qfcoef;    // qfcoef(nbeta,nbeta,2*lmax,nqf) coefficients for Q for |r|<r_L
  ...
  private:
    ...
    // uspp upf201 liuyu 2023-09-18
    void read_pseudo_upf201_qij(std::ifstream& ifs);
};
