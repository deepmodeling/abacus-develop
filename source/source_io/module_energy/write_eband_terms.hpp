...
void
    write_eband_terms (const int nspin,
                       const int nbasis,
                       const int drank,
            ...
            for (int ik = 0; ik < kv.get_nks (); ++ik)
                {
                    ...
                    e_orb_kinetic.emplace_back (
                        orbital_energy (ik,
                                        nbands,
                                        cVc (kinetic_k_ao.get_hk (), &psi (ik, 0, 0), nbasis, nbands, *pv, p2d),
                                        p2d));
                }
    ...
    if (PARAM.inp.vl_in_h)
        {
            ...
            hamilt::Veff<hamilt::OperatorLCAO<TK, TR>> v_pp_local_op (&v_pp_local_k_ao,
                                                                      kv.kvec_d,
                                                                      &pot_local,
                                                                      &v_pp_local_R_ao,
                                                                      &ucell,
