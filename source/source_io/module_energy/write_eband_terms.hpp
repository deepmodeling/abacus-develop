...
void write_eband_terms(const int nspin,
    ...
    if (PARAM.inp.t_in_h) {
        ...
        hamilt::EKinetic<hamilt::OperatorLCAO<TK, TR>> kinetic_op(&kinetic_k_ao,
                                                                  kv.kvec_d,
                                                                  &kinetic_R_ao,
                                                                  &ucell,
                                                                  orb_cutoff,
        ...
        for (int ik = 0; ik < kv.get_nks(); ++ik) {
            ...
            e_orb_kinetic.emplace_back(
                orbital_energy(ik, nbands, cVc(kinetic_k_ao.get_hk(), &psi(ik, 0, 0), nbasis, nbands, *pv, p2d), p2d));
        }
    ...
    if (PARAM.inp.vl_in_h) {
        ...
        hamilt::Veff<hamilt::OperatorLCAO<TK, TR>>
            v_pp_local_op(&v_pp_local_k_ao, kv.kvec_d, &pot_local, &v_pp_local_R_ao, &ucell, orb_cutoff, &gd, nspin);
        ...
        for (int ik = 0; ik < kv.get_nks(); ++ik) {
            ...
            e_orb_pp_local.emplace_back(
                orbital_energy(ik,
                               nbands,
                               cVc(v_pp_local_k_ao.get_hk(), &psi(ik, 0, 0), nbasis, nbands, *pv, p2d),
                               p2d));
        }
    ...
    if (PARAM.inp.vnl_in_h) {
        ...
        hamilt::Nonlocal<hamilt::OperatorLCAO<TK, TR>> v_pp_nonlocal_op(&v_pp_nonlocal_k_ao,
                                                                        kv.kvec_d,
                                                                        &v_pp_nonlocal_R_ao,
                                                                        &ucell,
                                                                        orb_cutoff,
        ...
        for (int ik = 0; ik < kv.get_nks(); ++ik) {
            ...
            e_orb_pp_nonlocal.emplace_back(
                orbital_energy(ik,
                               nbands,
                               cVc(v_pp_nonlocal_k_ao.get_hk(), &psi(ik, 0, 0), nbasis, nbands, *pv, p2d),
                               p2d));
        }
    ...
    if (PARAM.inp.vh_in_h) {
        ...
        for (int is = 0; is < nspin0; ++is) {
            v_hartree_op[is] = new hamilt::Veff<hamilt::OperatorLCAO<TK, TR>>(&v_hartree_k_ao,
                                                                              kv.kvec_d,
                                                                              &pot_hartree,
                                                                              &v_hartree_R_ao[is],
                                                                              &ucell,
        ...
        for (int ik = 0; ik < kv.get_nks(); ++ik) {
            ...
            e_orb_hartree.emplace_back(
                orbital_energy(ik,
                               nbands,
                               cVc(v_hartree_k_ao.get_hk(), &psi(ik, 0, 0), nbasis, nbands, *pv, p2d),
                               p2d));
        }
        for (auto& op: v_hartree_op) {
            delete op;
        }
