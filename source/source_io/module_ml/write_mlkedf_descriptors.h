...
class Write_MLKEDF_Descriptors {
  public:
    Write_MLKEDF_Descriptors() { this->cal_tool = new Cal_MLKEDF_Descriptors(); }
    ...
    void generateTrainData_KS(const std::string& out_dir,
    ...
    void generateTrainData_KS(const std::string& dir,
    ...
    void generate_descriptor(const std::string& out_dir,
                             const double* const* prho,
                             ModulePW::PW_Basis* pw_rho,
                             std::vector<std::vector<double>>& nablaRho);

    std::string
    file_name(const std::string& out_dir, std::string parameter, const int kernel_type, const double kernel_scaling);
