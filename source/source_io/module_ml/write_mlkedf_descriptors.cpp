...
{
void
    Write_MLKEDF_Descriptors::generateTrainData_KS (const std::string& out_dir,
...
void
    Write_MLKEDF_Descriptors::generateTrainData_KS (const std::string& dir,
...
void
    Write_MLKEDF_Descriptors::generate_descriptor (const std::string& out_dir,
    ...
    for (int ik = 0; ik < this->cal_tool->nkernel; ++ik)
        {
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "gammanl", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   containernl);
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "tanhxi", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   new_container);
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "tanhxi_nl", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   new_containernl);
    ...
    for (int ik = 0; ik < this->cal_tool->nkernel; ++ik)
        {
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "tanh_pnl", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   new_containernl);
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "tanhp_nl", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   new_containernl);
    ...
    for (int ik = 0; ik < this->cal_tool->nkernel; ++ik)
        {
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "tanh_qnl", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   new_containernl);
            ...
            npy::SaveArrayAsNumpy (this->file_name (out_dir, "tanhq_nl", ktype, kscaling),
                                   false,
                                   1,
                                   cshape,
                                   new_containernl);
...
std::string
    Write_MLKEDF_Descriptors::file_name (const std::string& out_dir,
