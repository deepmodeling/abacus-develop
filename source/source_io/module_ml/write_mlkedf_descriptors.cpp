...
namespace ModuleIO {
void Write_MLKEDF_Descriptors::generateTrainData_KS(const std::string& out_dir,
...
void Write_MLKEDF_Descriptors::generateTrainData_KS(const std::string& dir,
...
void Write_MLKEDF_Descriptors::generate_descriptor(const std::string& out_dir,
...
std::string Write_MLKEDF_Descriptors::file_name(const std::string& out_dir,
