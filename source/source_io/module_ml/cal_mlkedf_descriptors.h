...
class Cal_MLKEDF_Descriptors {
  public:
    ...
    void getP(const double* const* prho,
              const ModulePW::PW_Basis* pw_rho,
    ...
    void getGammanl(const int ikernel,
                    std::vector<double>& pgamma,
                    const ModulePW::PW_Basis* pw_rho,
                    std::vector<double>& rgammanl);
    void
    getPnl(const int ikernel, std::vector<double>& pp, const ModulePW::PW_Basis* pw_rho, std::vector<double>& rpnl);
    void
    getQnl(const int ikernel, std::vector<double>& pq, const ModulePW::PW_Basis* pw_rho, std::vector<double>& rqnl);
    // new parameters 2023-02-03
    void getXi(std::vector<double>& pgamma, std::vector<double>& pgammanl, std::vector<double>& rxi);
    void getTanhXi(const int ikernel,
                   std::vector<double>& pgamma,
    ...
    void getNablaRho(const double* const* prho,
                     const ModulePW::PW_Basis* pw_rho,
    ...
    void
    read_kernel(const std::string& fileName, const double& scaling, const ModulePW::PW_Basis* pw_rho, double* kernel_);
