        ...
        item.check_value = [] (const Input_Item& item, const Parameter& para)
            {
                ...
                if (para.input.of_kinetic != "tf" && para.input.of_kinetic != "vw" && para.input.of_kinetic != "wt"
                    && para.input.of_kinetic != "ext-wt" && para.input.of_kinetic != "xwm"
...
* False: rho0 will change if volume of system has changed.)";
    ...
    }
    {
        ...
        item.category = "OFDFT: orbital free density functional theory";
        item.type = "Real";
        item.description = "Parameter for XWM kinetic energy functional. See PHYSICAL REVIEW B 100, 205132 (2019) for "
                           "optimal values.";
        item.default_value = "0.0";
        item.unit = "";
        item.availability = "OFDFT with of_kinetic=xwm";
...
* 3: Truncated kinetic kernel (TKK), the file containing TKK is specified by of_ml_kernel_file.)";
    ...
    }
    {
        ...
        item.type = "Vector of Real";
        item.description
            = "Containing nkernel (see of_ml_nkernel) elements. The i-th element specifies the hyperparameter chi_pnl "
              "of non-local descriptor tanh_pnl defined by the i-th kernel function.";
        item.default_value = "1.0";
        item.unit = "";
        item.availability = "OFDFT";
        item.read_value = [] (const Input_Item& item, Parameter& para)
    ...
    }
    {
        ...
        item.type = "Vector of Real";
        item.description
            = "Containing nkernel (see of_ml_nkernel) elements. The i-th element specifies the hyperparameter chi_qnl "
              "of non-local descriptor tanh_qnl defined by the i-th kernel function.";
        item.default_value = "1.0";
        item.unit = "";
        item.availability = "OFDFT";
        item.read_value = [] (const Input_Item& item, Parameter& para)
