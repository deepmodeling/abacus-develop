...
* True: A two-step method is employed, i.e. in the inner iterations, density matrix is updated, while in the outer iterations, is calculated based on density matrix that converges in the inner iteration.)";
    ...
    }
    {
        ...
        item.read_value
            = [] (const Input_Item& item, Parameter& para) { para.input.exx_fock_lambda = item.str_values; };
        item.reset_value = [] (const Input_Item& item, Parameter& para)
            {
                if (para.input.exx_fock_lambda.size () == 1 && para.input.exx_fock_lambda[0] == "default")
                    {
                        para.input.exx_fock_lambda
                            = std::vector<std::string> (para.input.exx_fock_alpha.size (), "0.3");
                    }
            };
    ...
    }
    {
        ...
        item.type = "Real";
        item.description
            = "To accelerate the evaluation of four-center integrals (), the product of atomic orbitals are expanded "
              "in the basis of auxiliary basis functions (ABF): . The size of the ABF (i.e. number of ) is reduced "
              "using principal component analysis. When a large PCA threshold is used, the number of ABF will be "
              "reduced, hence the calculation becomes faster. However, this comes at the cost of computational "
              "accuracy. A relatively safe choice of the value is 1e-4.";
    ...
    }
    {
        ...
        item.type = "Real";
        item.description
            = "See also the entry exx_pca_threshold. With the approximation , the four-center integral in Fock "
              "exchange is expressed as , where is a double-center integral. Smaller values of the V matrix can be "
              "truncated to accelerate calculation. The larger the threshold is, the faster the calculation and the "
    ...
    }
    {
        ...
        item.type = "Real";
        item.description
            = "The Fock exchange can be expressed as where D is the density matrix. Smaller values of the density "
              "matrix can be truncated to accelerate calculation. The larger the threshold is, the faster the "
              "calculation and the lower the accuracy. A relatively safe choice of the value is 1e-4.";
        item.default_value = "1E-4";
        item.unit = "";
        item.availability = "";
    ...
    }
    {
        ...
        item.category = "Exact Exchange (LCAO)";
        item.type = "Real";
        item.description = "See also the entry exx_pca_threshold. is used in force. Smaller components (less than "
                           "exx_c_grad_threshold) of the matrix are neglected to accelerate calculation. The larger "
                           "the threshold is, the faster the calculation and the lower the accuracy. A relatively safe "
                           "choice of the value is 1e-4.";
        item.default_value = "1E-4";
        item.unit = "";
        item.availability = "";
    ...
    }
    {
        ...
        item.description
            = "See also the entry exx_pca_threshold. With the approximation , the four-center integral in Fock "
              "exchange is expressed as , where is a double-center integral. is used in force. Smaller values of the V "
              "matrix can be truncated to accelerate calculation. The larger the threshold is, the faster the "
    ...
    }
    {
        ...
        item.category = "Exact Exchange (LCAO)";
        item.type = "Real";
        item.description = "See also the entry exx_pca_threshold. is used in stress. Smaller components (less than "
                           "exx_c_grad_r_threshold) of the matrix are neglected to accelerate calculation. The larger "
                           "the threshold is, the faster the calculation and the lower the accuracy. A relatively safe "
                           "choice of the value is 1e-4.";
        item.default_value = "1E-4";
        item.unit = "";
    ...
    }
    {
        ...
        item.category = "Exact Exchange (LCAO)";
        item.type = "Real";
        item.description = "See also the entry exx_pca_threshold. With the approximation , the four-center integral in "
                           "Fock exchange is expressed as , where is a double-center integral. is used in force and "
                           "stress. Smaller values of the V matrix can be truncated to accelerate calculation. The "
                           "larger the threshold is, the faster the calculation and the lower the accuracy. A "
    ...
    }
    {
        ...
        item.type = "String";
        item.description
            = "This parameter determines how many times larger the radial mesh required for calculating Columb "
              "potential is to that of atomic orbitals. The value should be larger than 0. Reducing this value can "
              "effectively increase the speed of self-consistent calculations using hybrid functionals.";
        item.default_value = "";
        item.unit = "";
        item.availability = "";
                ...
                if (para.input.exx_singularity_correction == "default")
                    {
                        ...
                        std::transform (dft_functional.begin (),
                                        ...
                                        tolower);
                        if (dft_functional_lower == "hf" || dft_functional_lower == "pbe0"
                            || dft_functional_lower == "b3lyp" || dft_functional_lower == "scan0"
                            || dft_functional_lower == "muller" || dft_functional_lower == "power"
                            || dft_functional_lower == "wp22" || dft_functional_lower == "lc_pbe"
                            || dft_functional_lower == "lc_wpbe" || dft_functional_lower == "lrc_wpbe"
