 ...
 */
std::complex<double> cal_LzijR (const std::unique_ptr<TwoCenterIntegrator>& calculator,
                                const int it,
                                const int ia,
                                const int il,
                                const int iz,
 ...
 * @return std::complex<double>
 */
std::complex<double> cal_LyijR (const std::unique_ptr<TwoCenterIntegrator>& calculator,
                                const int it,
                                const int ia,
                                const int il,
                                const int iz,
 ...
 * @return std::complex<double>
 */
std::complex<double> cal_LxijR (const std::unique_ptr<TwoCenterIntegrator>& calculator,
                                const int it,
                                const int ia,
                                const int il,
                                const int iz,
...
class AngularMomentumCalculator
{
  public:
     ...
     */
    AngularMomentumCalculator (const std::string& orbital_dir,
