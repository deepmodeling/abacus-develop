                                               ...
                                               const ModuleBase::Vector3<double> G)
{
    ...
    wfcpw->real2recip_impl<std::complex<double>,base_device::DEVICE_CPU>(psi_r, psi_r, ik_R);
                                                   ...
                                                   const ModuleBase::Vector3<double> G)
{
    ...
    // (2) fft and get value
    rhopw->recip2real(phase, phase);
    wfcpw->recip2real_impl<std::complex<double>,base_device::DEVICE_CPU>(&evc[0](ik_L, iband_L, 0), psi_up, ik_L);
    wfcpw->recip2real_impl<std::complex<double>,base_device::DEVICE_CPU>(&evc[0](ik_L, iband_L, npwx), psi_down, ik_L);
    ...
    // (3) calculate the overlap in ik_L and ik_R
    wfcpw->real2recip_impl<std::complex<double>,base_device::DEVICE_CPU>(psi_up, psi_up, ik_L);
    wfcpw->real2recip_impl<std::complex<double>,base_device::DEVICE_CPU>(psi_down, psi_down, ik_L);
