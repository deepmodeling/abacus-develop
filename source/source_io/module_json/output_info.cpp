...
void
    add_output_cell_coo_stress_force (const UnitCell* ucell,
...
void
    add_output_efermi_converge (const double efermi, const bool scf_converge)
{
...
void
    add_output_energy (const double energy)
{
    Json::AbacusJson::add_json ({"output", -1, "energy"}, energy, false);
}

void
    add_output_scf_mag (double total_mag, double absolute_mag, double energy, double ediff, double drho, double time)
{
