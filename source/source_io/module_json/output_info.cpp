...
void add_output_energy(const double energy) { Json::AbacusJson::add_json({"output", -1, "energy"}, energy, false); }

void add_output_scf_mag(double total_mag, double absolute_mag, double energy, double ediff, double drho, double time) {
