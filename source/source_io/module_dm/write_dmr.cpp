...
{
std::string
    dmr_gen_fname (const int out_type, const int ispin, const bool append, const int istep)
{
...
void
    write_dmr_csr (std::string& fname,
...
void
    write_dmr (const std::vector<hamilt::HContainer<double>*> dmr,
               const UnitCell* ucell,
               const int precision,
