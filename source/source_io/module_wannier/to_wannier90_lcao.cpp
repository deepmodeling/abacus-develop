...
void
    toWannier90_LCAO::calculate (const UnitCell& ucell,
...
void
    toWannier90_LCAO::cal_Mmn (const UnitCell& ucell, const K_Vectors& kv, const psi::Psi<std::complex<double>>& psi)
{
    // write .mmn file
...
void
    toWannier90_LCAO::cal_Amn (const UnitCell& ucell, const K_Vectors& kv, const psi::Psi<std::complex<double>>& psi)
{
                    ...
                    for (int iw = 0; iw < num_wannier; iw++)
                        {
                            for (int ib = 0; ib < num_bands; ib++)
                                {
                                    Amn_file
                                        << std::setw (5) << ib + 1 << std::setw (5) << iw + 1 << std::setw (5)
                                        << ik + 1 - start_k_index << std::setw (18) << std::showpoint << std::fixed
                                        << std::setprecision (12) << Amn (ib, iw).real () << std::setw (18)
...
void
    toWannier90_LCAO::out_unk (const psi::Psi<std::complex<double>>& psi)
{
}

void
    toWannier90_LCAO::initialize_orb_table (const UnitCell& ucell)
{
#ifdef __LCAO
...
void
    toWannier90_LCAO::set_R_coor (const UnitCell& ucell, const Grid_Driver& gd)
{
...
void
    toWannier90_LCAO::count_delta_k (const UnitCell& ucell, const K_Vectors& kv)
{
...
void
    toWannier90_LCAO::unkdotkb (const UnitCell& ucell,
                                const K_Vectors& kv,
...
void
    toWannier90_LCAO::produce_basis_orb ()
{
...
void
    toWannier90_LCAO::produce_trial_in_lcao ()
{
...
void
    toWannier90_LCAO::construct_overlap_table_project ()
{
    int row = this->ParaV->get_row_size ();
    int global_ir = 0;
...
void
    toWannier90_LCAO::cal_orbA_overlap_R (const UnitCell& ucell)
{
    int row = this->ParaV->get_row_size ();
    int R_num = R_coor_car.size ();
    int global_ir = 0;
                            ...
                            for (int iR = 0; iR < R_num; iR++)
                                {
                                    ...
                                    double overlap_o
                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index].at (0).cal_overlap (
                                            orb_center,
                                            project_orb_center,
                                            im1,
                                            m[wannier_index]);
                                    ...
                                    for (int iR = 0; iR < R_num; iR++)
                                        {
                                            ...
                                            double overlap_s
                                                = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                      .at (0)
                                            ...
                                            for (int iR = 0; iR < R_num; iR++)
                                                {
                                                    ...
                                                    double overlap_px
                                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                              ...
                                                              .cal_overlap (orb_center, project_orb_center, im1, 1);
                                                    psi_psiA_R[ir][wannier_index][iR]
                                                        = bs3 * overlap_s + 2.0 * bs6 * overlap_px;
                                                }
                                        }
                                }
                                    ...
                                    for (int iR = 0; iR < R_num; iR++)
                                        {
                                            ...
                                            psi_psiA_R[ir][wannier_index][iR]
                                                = 0.5
                                                  * (overlap_s + m_px * overlap_px + m_py * overlap_py
                                                     + m_pz * overlap_pz);
                                        }
                                }
                                            ...
                                            for (int iR = 0; iR < R_num; iR++)
                                                {
                                                    ...
                                                    double overlap_dz2
                                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                              ...
                                                              .cal_overlap (orb_center, project_orb_center, im1, 0);
                                                    psi_psiA_R[ir][wannier_index][iR]
                                                        = bs2 * (m_pz * overlap_pz + overlap_dz2);
                                                }
                                        }
                                }
                                            ...
                                            for (int iR = 0; iR < R_num; iR++)
                                                {
                                                    ...
                                                    double overlap_dz2
                                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                              .at (2)
                                                              .cal_overlap (orb_center, project_orb_center, im1, 0);
                                                    double overlap_dx2_y2
                                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                              .at (2)
                                                              .cal_overlap (orb_center, project_orb_center, im1, 3);
                                                    psi_psiA_R[ir][wannier_index][iR]
                                                        = bs6 * overlap_s + tmp_bs2 * overlap_px
                                            ...
                                            for (int iR = 0; iR < R_num; iR++)
                                                {
                                                    ...
                                                    double overlap_dx2_y2
                                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                              ...
                                                              .cal_overlap (orb_center, project_orb_center, im1, 3);
                                                    psi_psiA_R[ir][wannier_index][iR]
                                                        = bs6 * overlap_s + tmp_bs2 * overlap_py
                                                          + tmp_bs12 * overlap_dz2 + tmp_d * overlap_dx2_y2;
                                                }
                                        }
                                            ...
                                            for (int iR = 0; iR < R_num; iR++)
                                                {
                                                    ...
                                                    double overlap_dz2
                                                        = center2_orb11_A[iw2iorb[orb_index_row]][wannier_index]
                                                              .at (2)
                                                              .cal_overlap (orb_center, project_orb_center, im1, 0);
                                                    psi_psiA_R[ir][wannier_index][iR] = bs6 * overlap_s
                                                                                        + tmp_pz * bs2 * overlap_pz
                                                                                        + bs3 * overlap_dz2;
                                                }
                                        }
                                }
...
void
    toWannier90_LCAO::unkdotA (const K_Vectors& kv,
                               const psi::Psi<std::complex<double>>& psi_in,
                               const int& ik,
                               ModuleBase::ComplexMatrix& Amn)
{
                                            ...
                                            for (int ir = 0; ir < half_row; ir++)
                                                {
                                                    tmp += up_con[wannier_index] * std::conj (psi_in (ik, ic, 2 * ir))
                                                           ...
                                                           + dn_con[wannier_index]
                                                                 * std::conj (psi_in (ik, ic, 2 * ir + 1))
