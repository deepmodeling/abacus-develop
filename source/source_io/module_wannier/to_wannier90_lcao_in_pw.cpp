...
void toWannier90_LCAO_IN_PW::calculate(UnitCell& ucell,
...
psi::Psi<std::complex<double>>* toWannier90_LCAO_IN_PW::get_unk_from_lcao(const UnitCell& ucell,
...
void toWannier90_LCAO_IN_PW::nao_G_expansion(const int& ik,
                                             const ModulePW::PW_Basis_K* wfcpw,
...
void toWannier90_LCAO_IN_PW::get_lcao_wfc_global_ik(const int ik,
                                                    const psi::Psi<std::complex<double>>& psi_in,
                                                    ModuleBase::ComplexMatrix& lcao_wfc_global) {
