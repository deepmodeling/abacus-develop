...
void
    ctrl_iter_lcao (UnitCell& ucell,                          // unit cell *
    ...
    if (inp.calculation != "nscf")
        {
            if (GlobalC::exx_info.info_global.cal_exx)
                {
                    GlobalC::exx_info.info_ri.real_number ? exx_nao.exd->exx_iter_finish (kv,
                                                                                          ucell,
                                                                                          *p_hamilt,
                                                                                          *pelec,
                                                                                          &dm,
                                                                                          *p_chgmix,
                                                                                          ...
                                                                                          istep,
                                                                                          conv_esolver)
                                                          : exx_nao.exc->exx_iter_finish (kv,
                                                                                          ucell,
                                                                                          *p_hamilt,
                                                                                          *pelec,
                                                                                          &dm,
...
// TK: double  TR: double
template void ctrl_iter_lcao<double, double> (
    UnitCell& ucell,                              // unit cell *
    const Input_para& inp,                        // input parameters *
    K_Vectors& kv,                                // k points *
    elecstate::ElecState* pelec,                  // electronic info *
...
template void ctrl_iter_lcao<std::complex<double>, double> (
    UnitCell& ucell,                                            // unit cell *
    const Input_para& inp,                                      // input parameters *
    K_Vectors& kv,                                              // k points *
    elecstate::ElecState* pelec,                                // electronic info *
...
template void ctrl_iter_lcao<std::complex<double>, std::complex<double>> (
    UnitCell& ucell,                                                          // unit cell *
    const Input_para& inp,                                                    // input parameters *
    K_Vectors& kv,                                                            // k points *
    elecstate::ElecState* pelec,                                              // electronic info *
