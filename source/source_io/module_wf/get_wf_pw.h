...
void
    get_wf_pw (const std::vector<int>& out_wfc_norm,
                    ...
                    for (int ik = 0; ik < nks; ++ik)
                        {
                            ...
                            ss_file << global_out_dir << "wfi" << ib + 1 << "s" << spin_index + 1 << "k" << k_number
                                    << ".cube";
                    ...
                    for (int ik = 0; ik < nks; ++ik)
                        {
                            ...
                            ss_real << global_out_dir << "wfi" << ib + 1 << "s" << spin_index + 1 << "k" << k_number
                                    << "re.cube";
                            ...
                            ss_imag << global_out_dir << "wfi" << ib + 1 << "s" << spin_index + 1 << "k" << k_number
                                    << "im.cube";
