...
void
    ModuleIO::read_wf2rho_pw (const ModulePW::PW_Basis_K* pw_wfc,
    ...
    for (int ik = 0; ik < pw_wfc->nks; ++ik)
        {
            ...
            std::string fn = filename_output (readin_dir,
                                              "wf",
                                              "pw",
                                              ik,
                                              ik2iktot,
                            ...
                            if (w1 != 0.0)
                                {
                                    ...
                                    elecstate::elecstate_pw_op<double, base_device::DEVICE_CPU> () (
                                        ctx,
                                        PARAM.globalv.domag,
