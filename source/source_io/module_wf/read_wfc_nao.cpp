...
void ModuleIO::read_wfc_nao_one_data(std::ifstream& ifs, float& data) { ifs >> data; }

void ModuleIO::read_wfc_nao_one_data(std::ifstream& ifs, double& data) { ifs >> data; }
    ...
    auto read_one_file =
        [&](const std::string& ss, std::stringstream& error_message, const int ik, std::vector<T>& ctot) {
            ...
            if (nbands > nbands_file) {
                error_message
                    << "The number of bands to be read exceeds the number of bands in the file generated by ABACUS!\n";
