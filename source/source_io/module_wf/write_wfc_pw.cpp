...
void
    ModuleIO::write_wfc_pw (const int istep,
                            const int iter,
                            const int kpar,
                            const int my_pool,
                            const int my_rank,
            ...
            for (int ik_local = 0; ik_local < kv.get_nks (); ik_local++)
                {
                    ...
                    ofs_running << " Write G-space wave functions to file: " << fn << std::endl;
            ...
            int id = 0;
                                                    ...
                                                    if (id == 0)
                                                        {
                                                            ...
                                                            ofs2 << std::setw (10) << "Kpoint" << std::setw (10)
                                                                 << "nKpoint" << std::setw (10) << "kv.x"
                                                                 << std::setw (10) << "kv.y" << std::setw (10) << "kv.z"
                                                                 << std::setw (10) << "weight" << std::setw (10)
                                                                 << "ngtot" << std::setw (10) << "nband"
                                                                 << std::setw (10) << "ecut" << std::setw (10) << "lat0"
                                                                 << std::setw (10) << "2pi/lat0" << std::endl;
                                                            ofs2 << std::setw (10) << ikstot + 1 << std::setw (10)
                                                                 << nkstot << std::setw (10) << kv.kvec_c[ik].x
                                                                 << std::setw (10) << kv.kvec_c[ik].y << std::setw (10)
                                                                 << kv.kvec_c[ik].z << std::setw (10) << kv.wk[ik]
                                                                 << std::setw (10) << ikngtot << std::setw (10)
                                                                 << nbands << std::setw (10) << ecutwfc
                                                                 << std::setw (10) << wfcpw->lat0 << std::setw (10)
                                                                 << wfcpw->tpiba << std::endl;
                                                            ofs2 << "\n<Reciprocal Lattice Vector>" << std::endl;
                                                            ofs2 << std::setw (10) << wfcpw->G.e11 << std::setw (10)
                                                                 << wfcpw->G.e12 << std::setw (10) << wfcpw->G.e13
                                                                 << std::endl;
                                                            ofs2 << std::setw (10) << wfcpw->G.e21 << std::setw (10)
                                                                 << wfcpw->G.e22 << std::setw (10) << wfcpw->G.e23
                                                                 << std::endl;
                                                            ofs2 << std::setw (10) << wfcpw->G.e31 << std::setw (10)
                                                                 << wfcpw->G.e32 << std::setw (10) << wfcpw->G.e33
                                                                 << std::endl;
                                                    ...
                                                    for (int igl = 0; igl < wfcpw->npwk[ik]; ++igl)
                                                        {
                                                            ...
                                                            ofs2 << std::setw (10) << ix << std::setw (10) << iy
                                                                 << std::setw (10) << iz << std::endl;
                                                        }
                    ...
                    int id = 0;
                            ...
                            int id = 0;
                                                            ...
                                                            if (out_wfc_pw == 1)
                                                                {
                                                                    std::ofstream ofs2 (wfilename[ik].c_str (),
                                                                                        std::ios::app);
