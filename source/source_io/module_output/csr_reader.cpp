...
template <typename T>
std::vector<int>
    csrFileReader<T>::getRCoordinate (int index) const
{
...
template <typename T>
SparseMatrix<T>
    csrFileReader<T>::getMatrix (int index) const
{
...
template <typename T>
SparseMatrix<T>
    csrFileReader<T>::getMatrix (int Rx, int Ry, int Rz) const
{
...
template <typename T>
int
    csrFileReader<T>::getNumberOfR () const
{
    return numberOfR;
}
...
template <typename T>
int
    csrFileReader<T>::getMatrixDimension () const
{
