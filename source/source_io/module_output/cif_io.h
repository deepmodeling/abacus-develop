...
class CifParser
{
  public:
    ...
    static void write (const std::string& fcif,
                       ...
                       = nullptr, // may be this will be useful after impementation of VCA?
    ...
    static void write (const std::string& fcif,
                       ...
                       = {}, // may be this will be useful after impementation of VCA?
                       const std::string& cell_formula_units_z = "1");
     ...
     */
    static void
        read (const std::string& fcif, std::map<std::string, std::vector<std::string>>& out, const int rank = 0);
