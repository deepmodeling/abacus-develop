...
void
    ModuleIO::cal_pdos (const psi::Psi<std::complex<double>>* psi,
...
void
    ModuleIO::print_tdos_multik (const ModuleBase::matrix* pdos,
                                 const int nlocal,
                                 const int npoints,
                                 const double& emin,
                                 const double& dos_edelta_ev)
...
void
    ModuleIO::print_pdos_multik (const UnitCell& ucell,
            ...
            for (int j = 0; j < atom1->nw; ++j)
                {
                    ...
                    if (PARAM.inp.nspin == 1)
                    ...
                    else if (PARAM.inp.nspin == 2)
                        {
                            for (int n = 0; n < npoints; ++n)
                                {
                                    ofs2 << std::setw (20) << pdos[0](w, n) << std::setw (30) << pdos[1](w, n)
                                         << std::endl;
                                }
                        }
                    else if (PARAM.inp.nspin == 4)
                        {
                            ...
                            for (int n = 0; n < npoints; ++n)
                                {
                                    ofs2 << std::setw (20) << pdos[0](s0 + 2 * w0, n) + pdos[0](s0 + 2 * w0 + 1, n)
                                         << std::endl;
                                }
                        }
