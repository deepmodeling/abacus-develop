...
void
    ModuleIO::prepare_dos (std::ofstream& ofs_running,
...
bool
    ModuleIO::cal_dos (const int& is,         // index for spin
    ...
    if (GlobalV::MY_RANK == 0)
        {
            ...
            ofs_dos << "#" << std::setw (14) << "energy" << std::setw (15) << "elec_states" << std::setw (15)
                    << "sum_states" << std::setw (15) << "states_smear" << std::setw (15) << "sum_states" << std::endl;
        }
