...
template <typename T>
void
    Cal_ldos<T>::cal_ldos_lcao (const elecstate::Efermi& eferm,       // mohan add 2025-11-02
...
// pw case
void
    cal_ldos_pw (const elecstate::ElecStatePW<std::complex<double>>* pelec,
...
void
    stm_mode_pw (const elecstate::ElecStatePW<std::complex<double>>* pelec,
                 const psi::Psi<std::complex<double>>& psi,
                 const Parallel_Grid& pgrid,
                 const UnitCell& ucell)
{
...
void
    ldos_mode_pw (const elecstate::ElecStatePW<std::complex<double>>* pelec,
                  const psi::Psi<std::complex<double>>& psi,
                  const Parallel_Grid& pgrid,
                  const UnitCell& ucell)
{
...
void
    get_grid_points (const std::vector<double>& start,
...
void
    trilinear_interpolate (const std::vector<std::vector<int>>& points,
