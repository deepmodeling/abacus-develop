...
template <typename T>
T
    get_value (const std::complex<T>& val)
{
    return val.real ();
}
...
TYPED_TEST (SparseMatrixTest, CSR)
{
    ...
    if (std::is_same<TypeParam, double>::value)
        ...
        {
            EXPECT_THAT (output,
                         testing::HasSubstr ("(1.00e+00,0.00e+00) (2.00e+00,0.00e+00) (3.00e+00,0.00e+00) "
                                             "(4.00e+00,0.00e+00) (5.00e+00,0.00e+00) (6.00e+00,0.00e+00)"));
