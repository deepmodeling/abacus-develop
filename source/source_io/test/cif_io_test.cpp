...
TEST (CifParserTest, ReadMediumTest)
{
    ...
    EXPECT_EQ (data["_symmetry_equiv_pos_as_xyz"][0],
               "x,y,z -y,x-y,z y-x,-x,z -y,-x,z x,x-y,z y-x,y,z -x,-y,-z y,y-x,-z x-y,x,-z y,x,-z -x,y-x,-z x-y,-y,-z "
               "1/3+x,2/3+y,2/3+z 2/3+x,1/3+y,1/3+z 1/3-y,2/3+x-y,2/3+z 2/3-y,1/3+x-y,1/3+z 1/3-x+y,2/3-x,2/3+z "
               "2/3-x+y,1/3-x,1/3+z 1/3-y,2/3-x,2/3+z 2/3-y,1/3-x,1/3+z 1/3+x,2/3+x-y,2/3+z 2/3+x,1/3+x-y,1/3+z "
               "1/3-x+y,2/3+y,2/3+z 2/3-x+y,1/3+y,1/3+z 1/3-x,2/3-y,2/3-z 2/3-x,1/3-y,1/3-z 1/3+y,2/3-x+y,2/3-z "
               "2/3+y,1/3-x+y,1/3-z 1/3+x-y,2/3+x,2/3-z 2/3+x-y,1/3+x,1/3-z 1/3+y,2/3+x,2/3-z 2/3+y,1/3+x,1/3-z "
               "1/3-x,2/3-x+y,2/3-z 2/3-x,1/3-x+y,1/3-z 1/3+x-y,2/3-y,2/3-z 2/3+x-y,1/3-y,1/3-z");
...
TEST (CifParserTest, WriteTest)
{
    ...
    const std::vector<double> atom_site_fract
        = {0.0, 0.0, 0.75, 0.0, 0.0, 0.25, 0.333333, 0.666667, 0.75, 0.666667, 0.333333, 0.25};
