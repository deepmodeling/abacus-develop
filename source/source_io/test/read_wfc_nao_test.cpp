...
std::string filename_output(const std::string& directory,
...
TEST_F(ReadWfcNaoTest, ReadWfcNao) {
    ...
    // Act
    ModuleIO::read_wfc_nao(PARAM.sys.global_readin_dir, ParaV, psid, ekb, wg, ik2iktot, nkstot, nspin);
    // Assert
...
TEST_F(ReadWfcNaoTest, ReadWfcNaoPart) {
    ...
    // Act
    ModuleIO::read_wfc_nao(PARAM.sys.global_readin_dir,
                           ParaV,
                           psid,
                           ekb,
                           wg,
