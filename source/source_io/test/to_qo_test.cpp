...
{    
    ...
    PARAM.input_for_test().qo_screening_coeff = {0.1, 0.1};
    PARAM.input_for_test().qo_thr = 1e-6;
...
{    
    ...
    PARAM.sys_for_test().global_out_dir = "./";
    PARAM.input_for_test().qo_screening_coeff = {0.1};
    PARAM.input_for_test().qo_thr = 1e-6;
    // GlobalV::ofs_running = std::ofstream("unittest.log");
    GlobalV::MY_RANK = 0;
    GlobalV::NPROC = 1;
...
{
    define_fcc_cell(ucell);
    PARAM.input_for_test().qo_screening_coeff = {};
    toQO tqo("hydrogen", 
             {"minimal-nodeless", "minimal-nodeless"},
             PARAM.inp.qo_thr,
             PARAM.inp.qo_screening_coeff);
...
TEST_F(toQOTest, CalculateOvlpR)
{
    define_fcc_cell(ucell);
    PARAM.input_for_test().qo_screening_coeff = {};
    PARAM.input_for_test().qo_thr = 1e-10;
    toQO tqo("hydrogen", 
             {"minimal-nodeless", "minimal-nodeless"},
             PARAM.inp.qo_thr,
             PARAM.inp.qo_screening_coeff);
...
TEST_F(toQOTest, OrbitalFilterOut)
{
    ...
    PARAM.input_for_test().qo_screening_coeff = {0.5, 0.5};
    toQO tqo2("pswfc", {"s", "s"},
              PARAM.inp.qo_thr,
              PARAM.inp.qo_screening_coeff);
...
TEST_F(toQOTest, ScanSupercellSC2)
{
    ...
    tqo.build_nao(ucell.ntype, 
                  ...
                  ucell.orbital_fn.data(),
                  0);
    PARAM.input_for_test().qo_screening_coeff[0] = 0.1; // use this to control the tailing of radial function
    PARAM.input_for_test().qo_thr = 1e-6;
    tqo.build_ao(ucell.ntype,
                 "./",
                 ucell.pseudo_fn.data(),
...
TEST_F(toQOTest, ScanSupercellSC3)
{
    ...
    tqo.build_nao(ucell.ntype, 
                  ...
                  ucell.orbital_fn.data(),
                  0);
    PARAM.input_for_test().qo_screening_coeff[0] = 0.25; // use this to control the tailing of radial function
    PARAM.input_for_test().qo_thr = 1e-6;
    tqo.build_ao(ucell.ntype,
                 "./",
                 ucell.pseudo_fn.data(),
    ...
    PARAM.input_for_test().qo_screening_coeff[0] = 0.1;
}
...
TEST_F(toQOTest, ScanSupercellSC4)
{
    ...
    tqo.build_nao(ucell.ntype, 
                  ...
                  ucell.orbital_fn.data(),
                  0);
    PARAM.input_for_test().qo_screening_coeff[0] = 0.5; // use this to control the tailing of radial function
    PARAM.input_for_test().qo_thr = 1e-6;
    tqo.build_ao(ucell.ntype,
                 "./",
                 ucell.pseudo_fn.data(),
...
TEST_F(toQOTest, CalculateSelfOvlpKPswfcSymmetrical)
{
    define_fcc_cell(ucell);
    PARAM.input_for_test().qo_thr = 1e-10;
    PARAM.input_for_test().qo_screening_coeff = {2.0, 2.0};
    toQO tqo("pswfc", {"all", "all"},
             PARAM.inp.qo_thr,
             PARAM.inp.qo_screening_coeff);
