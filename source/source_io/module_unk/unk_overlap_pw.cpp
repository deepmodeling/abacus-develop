...
std::complex<double>
    unkOverlap_pw::unkdotp_G (const ModulePW::PW_Basis_K* wfcpw,
                              const int ik_L,
                              const int ik_R,
                              const int iband_L,
                              const int iband_R,
...
std::complex<double>
    unkOverlap_pw::unkdotp_G0 (const ModulePW::PW_Basis* rhopw,
...
std::complex<double>
    unkOverlap_pw::unkdotp_soc_G (const ModulePW::PW_Basis_K* wfcpw,
                                  const int ik_L,
                                  const int ik_R,
                                  const int iband_L,
                                  const int iband_R,
...
std::complex<double>
    unkOverlap_pw::unkdotp_soc_G0 (const ModulePW::PW_Basis* rhopw,
                                   const ModulePW::PW_Basis_K* wfcpw,
                                   const int ik_L,
                                   const int ik_R,
                                   const int iband_L,
