...
protected:
    ...
    void divide_sticks_1(
        ...
        const int* st_length     // the stick on (ix, iy) consists of st_length[ix*fftny+iy] planewaves.
    );
    ...
    void get_ig2isz_is2fftixy(
        const int* st_bottom,     // minimum z of stick, stored in 1d array with tot_nst elements.
