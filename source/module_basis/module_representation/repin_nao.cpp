...
template class RepIn_NAO<std::complex<double>, psi::DEVICE_CPU>;
template class RepIn_NAO<std::complex<float>, psi::DEVICE_CPU>;
// gamma point calculation support
template class RepIn_NAO<double, psi::DEVICE_CPU>;
template class RepIn_NAO<float, psi::DEVICE_CPU>;
// GPU support
#if ((defined __CUDA) || (defined __ROCM))
template class RepIn_NAO<std::complex<double>, psi::DEVICE_GPU>;
template class RepIn_NAO<std::complex<float>, psi::DEVICE_GPU>;
// gamma point calculation support
template class RepIn_NAO<double, psi::DEVICE_GPU>;
template class RepIn_NAO<float, psi::DEVICE_GPU>;
#endif