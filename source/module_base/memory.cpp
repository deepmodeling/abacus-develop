...
double Memory::complex_matrix_memory = 2*sizeof(double); //16.0 (Byte)
double Memory::double_memory = sizeof(double); //8.0 (Byte)
double Memory::int_memory = sizeof(int); //4.0 (Byte)
double Memory::bool_memory = sizeof(bool); // 1.0 (Byte)
double Memory::float_memory = sizeof(float);// 4(Byte)
double Memory::short_memory = sizeof(short); //2.0 (Byte)
