...
int main(int argc, char** argv) {
    ...
    if (myrank == 0) {
        ...
        cout << "fullnpw   npw1: " << pwtest1.npw << " nst1: " << pwtest1.nst << ";  npw2: " << pwtest2.npw
             << " nst2: " << pwtest2.nst << endl;
        cout << "halfnpw   npw3: " << pwtest3.npw << " nst3: " << pwtest3.nst << ";  npw4: " << pwtest4.npw
             << " nst4: " << pwtest4.nst << endl;
    }
    if (pwtest1.nx != pwtest2.nx || pwtest2.nx != pwtest3.nx || pwtest3.nx != pwtest4.nx || pwtest1.ny != pwtest2.ny ||
        pwtest2.ny != pwtest3.ny || pwtest3.ny != pwtest4.ny || pwtest1.nz != pwtest2.nz || pwtest2.nz != pwtest3.nz ||
        pwtest3.nz != pwtest4.nz) {
        cout << "Error" << endl;
        exit(0);
    }
