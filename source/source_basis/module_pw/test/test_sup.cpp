                            ...
                            for (int ix = 0; ix < pwdense.nx; ++ix)
                                {
                                    ...
                                    if (modulus <= ggecut)
                                        {
                                            EXPECT_EQ (tmpx[iz + iy * pwdense.nz + ix * pwdense.ny * pwdense.nz],
                                                       int (f.x));
                                            EXPECT_EQ (tmpy[iz + iy * pwdense.nz + ix * pwdense.ny * pwdense.nz],
                                                       int (f.y));
                                            EXPECT_EQ (tmpz[iz + iy * pwdense.nz + ix * pwdense.ny * pwdense.nz],
                                                       int (f.z));
                                        }
                                }
                        }
