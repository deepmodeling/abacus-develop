...
template <>
void
    PW_Basis_K::real2recip_dsp (const std::complex<float>* in,
...
template <>
void
    PW_Basis_K::recip2real_dsp (const std::complex<float>* in,
                                std::complex<float>* out,
                                const int ik,
                                const bool add,
                                const float factor) const
...
template <>
void
    PW_Basis_K::real2recip_dsp (const std::complex<double>* in,
...
template <>
void
    PW_Basis_K::recip2real_dsp (const std::complex<double>* in,
                                std::complex<double>* out,
                                const int ik,
                                const bool add,
                                const double factor) const
...
template <>
void
    PW_Basis_K::convolution (const base_device::DEVICE_CPU* ctx,
                             const int ik,
                             const int size,
