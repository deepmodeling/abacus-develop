...
///
void
    PW_Basis_Sup::setuptransform (const ModulePW::PW_Basis* pw_rho)
{
...
///
void
    PW_Basis_Sup::distribute_g (const ModulePW::PW_Basis* pw_rho)
{
...
///
void
    PW_Basis_Sup::distribution_method3 (const ModulePW::PW_Basis* pw_rho)
{
...
///
void
    PW_Basis_Sup::get_ig2isz_is2fftixy (
