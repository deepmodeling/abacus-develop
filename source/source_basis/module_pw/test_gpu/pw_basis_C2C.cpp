                                        ...
                                        if (modulus <= ggecut)
                                            {
                                                ...
                                                if (vy > 0)
                                                    {
                                                        tmp[offset + iz] += std::complex<T> (0, 1.0)
                                                                            / (std::abs (static_cast<T> (v.x) + 1) + 1);
                                                    }
                                                else if (vy < 0)
                                                    {
                                                        tmp[offset + iz]
                ...
                for (int ig = 0; ig < npw; ++ig)
                    {
                        ...
                        if (pwtest.gdirect[ig].y > 0)
                            {
                                h_rhog[ig]
                                    += std::complex<float> (0, 1.0) / (std::abs (float (pwtest.gdirect[ig].x) + 1) + 1);
                            }
                        else if (pwtest.gdirect[ig].y < 0)
                            {
                                h_rhog[ig] -= std::complex<float> (0, 1.0)
                                              / (std::abs (float (-pwtest.gdirect[ig].x) + 1) + 1);
                            }
                    }
