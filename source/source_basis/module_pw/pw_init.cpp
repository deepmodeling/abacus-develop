...
#ifdef __MPI
void
    PW_Basis::initmpi (const int poolnproc_in, const int poolrank_in, MPI_Comm pool_world_in)
{
...
///
void
    PW_Basis::initgrids (const double lat0_in,                // unit length (unit in bohr)
...
///
void
    PW_Basis::initgrids (const double lat0_in,
                         const ModuleBase::Matrix3 latvec_in, // Unitcell lattice vectors
                         const int nx_in,
                         int ny_in,
                         int nz_in)
...
void
    PW_Basis::initparameters (const bool gamma_only_in,
...
void
    PW_Basis::setfullpw (const bool inpt_full_pw, const int inpt_full_pw_dim)
{
