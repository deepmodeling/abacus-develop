...
int
    Parallel_Orbitals::get_wfc_global_nbands () const
{
#ifdef __MPI
...
int
    Parallel_Orbitals::get_wfc_global_nbasis () const
{
#ifdef __MPI
...
int
    Parallel_Orbitals::get_nbands () const
{
    return this->nbands;
}

void
    Parallel_Orbitals::set_atomic_trace (const int* iat2iwt, const int& nat, const int& nlocal)
{
...
int
    Parallel_Orbitals::get_col_size (int iat) const
{
...
int
    Parallel_Orbitals::get_row_size (int iat) const
{
...
std::vector<int>
    Parallel_Orbitals::get_indexes_row () const
{
...
std::vector<int>
    Parallel_Orbitals::get_indexes_col () const
{
...
std::vector<int>
    Parallel_Orbitals::get_indexes_row (int iat) const
{
...
std::vector<int>
    Parallel_Orbitals::get_indexes_col (int iat) const
{
...
#ifdef __MPI
void
    Parallel_Orbitals::set_desc_wfc_Eij (const int& nbasis, const int& nbands, const int& lld)
{
...
int
    Parallel_Orbitals::set_nloc_wfc_Eij (const int& N_A, std::ofstream& ofs_running, std::ofstream& ofs_warning)
{
