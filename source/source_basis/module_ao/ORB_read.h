...
class LCAO_Orbitals
{
  public:
    ...
    void Read_Orbitals (std::ofstream& ofs_in, // mohan add 2021-05-07
                        const int& ntype_in,
                        const int& lmax_in,
    ...
    void Read_PAO (std::ofstream& ofs_in,
                   const int& it,
                   const bool& force_flag, // mohan add 2021-05-07
                   const int& my_rank);    // mohan add 2021-04-26

    void Read_Descriptor (std::ofstream& ofs_in,
                          const bool& force_flag, // mohan add 2021-05-07
  ...
  private:
    ...
    void read_orb_file (std::ofstream& ofs_in,
                        std::ifstream& ifs,
                        const int& it,
                        int& lmax,
                        int& nchimax,
