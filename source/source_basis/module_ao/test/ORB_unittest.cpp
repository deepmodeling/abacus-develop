    ...
    while (ifs.good ())
        {
            ...
            if (x == "LATTICE_CONSTANT" || x == "NUMERICAL_ORBITAL" || x == "LATTICE_VECTORS"
                || x == "ATOMIC_POSITIONS")
                {
                    break;
                }
...
template <class c2o>
void
    test_orb::set_single_c2o (int TA, int TB, int LA, int NA, int LB, int NB)
{
