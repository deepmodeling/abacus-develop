...
void
    ORB_gaunt_table::init_Gaunt (const int& lmax)
{
    ////////////////////////////////////////
...
/// effective pointers
int
    ORB_gaunt_table::EP_EL (const int& L)
{
    if (L % 2 == 0)
        {
            return (L + 2) * (L + 4) * (3 * L * L + 14 * L + 24) / 192;
        }
    else
        {
...
int
    ORB_gaunt_table::index_func (const int& l1, const int& l2, const int& l3, const int& m3)
{
...
void
    ORB_gaunt_table::init_Gaunt_CH (const int& Lmax)
{
...
double
    ORB_gaunt_table::Calc_Gaunt_CH (const int& l1,
                                    const int& m1,
                                    const int& l2,
                                    const int& m2,
                                    const int& l3,
                                    const int& m3)
{
    ...
    double aux1
        = sqrt (Fact (l1 + m1) * Fact (l1 - m1) * Fact (l2 + m2) * Fact (l2 - m2) * Fact (l3 + m3) * Fact (l3 - m3));
...
double
    ORB_gaunt_table::Get_Gaunt_CH (const int& l1,
                                   const int& m1,
                                   const int& l2,
                                   const int& m2,
                                   const int& l3,
...
double
    ORB_gaunt_table::Get_Gaunt_SH (const int& l1,
                                   const int& mm1,
                                   const int& l2,
                                   const int& mm2,
                                   const int& l3,
            ...
            if (m1 * m2 * m3 > 0)
                {
                    if (m1 == m2 + m3)
                        {
                            return pow (-1.0, m1) * sqrt (2.0) / 2.0 * Get_Gaunt_CH (l1, -m1, l2, m2, l3, m3);
                        }
                    else if (m2 == m1 + m3)
                        {
            ...
            else
                {
                    if (m1 == 0 && m2 == 0 && m3 == 0)
                        {
                            return Get_Gaunt_CH (l1, 0, l2, 0, l3, 0);
                        }
                    else if ((m1 == 0) && (m2 == m3))
                        {
                            return pow (-1.0, m2) * Get_Gaunt_CH (l1, 0, l2, m2, l3, -m2);
                        }
                    else if ((m2 == 0) && (m3 == m1))
                        {
                            return pow (-1.0, m1) * Get_Gaunt_CH (l2, 0, l1, m1, l3, -m1);
                        }
                    else if ((m3 == 0) && (m1 == m2))
                        {
                            return pow (-1.0, m2) * Get_Gaunt_CH (l3, 0, l2, m2, l1, -m2);
                        }
                    else
                        {
                            return 0.0;
    ...
    else
        {
            if (m1 >= 0 && m2 < 0 && m3 < 0)
            ...
            else if (m3 >= 0 && m1 < 0 && m2 < 0)
                {
                    if ((m3 == 0) && (m1 == m2))
                        {
                            return pow (-1.0, m1) * Get_Gaunt_CH (l3, 0, l1, m1, l2, -m1);
                        }
...
double
    ORB_gaunt_table::Fact (const int& n)
{
    double val = 1.0;
    for (int i = 1; i <= n; i++)
        {
...
void
    ORB_gaunt_table::Swap (int& l1, int& m1, int& l2, int& m2)
{
    int tmp1 = 0, tmp2 = 0;
    if (l1 >= l2)
        {
...
int
    ORB_gaunt_table::Index_M (const int& m)
{
    if (m % 2 == 0)
        {
            return (-m / 2);
