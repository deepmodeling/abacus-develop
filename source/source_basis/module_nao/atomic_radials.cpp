...
void
    AtomicRadials::build (const std::string& file, const int itype, std::ofstream* ptr_log, const int rank)
{
...
void
    AtomicRadials::build (RadialSet* const other, const int itype, const double rcut)
{
...
void
    AtomicRadials::read_abacus_orb (std::ifstream& ifs, std::ofstream* ptr_log, const int rank)
{
    /*
