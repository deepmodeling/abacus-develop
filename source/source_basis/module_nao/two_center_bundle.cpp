...
void
    TwoCenterBundle::build_orb (int ntype, const std::string* file_orb0)
{
    ...
    if (GlobalV::MY_RANK == 0)
        {
            std::transform (file_orb0,
                            file_orb0 + ntype,
                            file_orb.begin (),
                            [] (const std::string& file) { return PARAM.inp.orbital_dir + file; });
        }
#ifdef __MPI
...
void
    TwoCenterBundle::build_beta (int ntype, Numerical_Nonlocal* nl)
{
...
void
    TwoCenterBundle::build_alpha (int ndesc, std::string* file_desc0)
{
...
void
    TwoCenterBundle::build_orb_onsite (const double& radius)
{
    if (radius > 0)
        {
...
void
    TwoCenterBundle::tabulate (const double lcao_ecut,
...
void
    TwoCenterBundle::to_LCAO_Orbitals (LCAO_Orbitals& ORB,
