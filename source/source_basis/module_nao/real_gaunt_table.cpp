...
const double&
RealGauntTable::operator()(const int l1, const int l2, const int l3, const int m1, const int m2, const int m3) const {
#ifdef __DEBUG
...
double
RealGauntTable::gaunt_lookup(const int l1, const int l2, const int l3, const int m1, const int m2, const int m3) const {
#ifdef __DEBUG
    assert(is_valid_lm(l1, l2, l3, m1, m2, m3));
