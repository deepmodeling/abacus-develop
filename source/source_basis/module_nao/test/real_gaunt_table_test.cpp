                            ...
                            if (gaunt > tol && cnt < len_gaunt) {
                                ...
                                if (l3 <= 10) {
                                    ...
                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l2, l1, l3, m2, m1, m3);
                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l2, l1, l3, -m2, -m1, -m3);

                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l2, l3, l1, m2, m3, m1);
                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l2, l3, l1, -m2, -m3, -m1);

                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l1, l3, l2, m1, m3, m2);
                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l1, l3, l2, -m1, -m3, -m2);

                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l3, l2, l1, m3, m2, m1);
                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l3, l2, l1, -m3, -m2, -m1);

                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l3, l1, l2, m3, m1, m2);
                                    gaunt_symmetry[cnt_sym++] =
                                        RealGauntTable::instance().gaunt(l3, l1, l2, -m3, -m1, -m2);
