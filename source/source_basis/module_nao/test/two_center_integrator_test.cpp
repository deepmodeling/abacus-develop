...
void
    TwoCenterIntegratorTest::TearDown ()
{
    delete[] file;
}
                                                            ...
                                                            for (int m2 = -l2; m2 <= l2; ++m2)
                                                                {
                                                                    ...
                                                                    EXPECT_NEAR ((elem_p - elem_m) / (2. * dx),
                                                                                 grad_elem[2],
                                                                                 tol_d);
            ...
            for (int zeta = 0; zeta < nbes; ++zeta)
                {
                    ...
                    ref = 0.5 * rcut
                          * std::pow (zeros[l * nbes + zeta] * Sphbes::sphbesj (l + 1, zeros[l * nbes + zeta]), 2);
