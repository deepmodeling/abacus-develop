...
class LapackConnector
{
  private:
    ...
    static inline complex<double>*
        transpose (const ComplexMatrix& a, const int n, const int lda)
    {
    ...
    static inline void
        transpose (const std::complex<double>* aux, ComplexMatrix& a, const int n, const int lda)
    {
        for (int i = 0; i < n; ++i)
            {
                for (int j = 0; j < lda; ++j)
  ...
  public:
    ...
    static inline void
        zpotrf (char uplo, int n, ComplexMatrix& a, const int lda, int& info)
    {
        /*		complex<double> *aux = LapackConnector::transpose(a, n, lda);
    ...
    static inline void
        zpotri (char uplo, int n, ComplexMatrix& a, const int lda, int& info)
    {
        /*		complex<double> *aux = LapackConnector::transpose(a, n, lda);
