...
class Simulated_Annealing {
  public:
    ...
    virtual void
    judge_accept_reject(double& new_function, size_t itemperature, size_t istep, bool& accept_flag, bool& reject_flag);
  ...
  public:
    Simulated_Annealing& set_temperature_num(size_t temperature_num_in) {
        temperature_num = temperature_num_in;
        return *this;
    }
    Simulated_Annealing& set_step_num(size_t step_num_in) {
        step_num = step_num_in;
        return *this;
    }
    Simulated_Annealing& set_temperature(double temperature_in) {
        temperature = temperature_in;
        return *this;
    }
    Simulated_Annealing& set_old_function(double old_function_in) {
