...
Matrix3::Matrix3 (const double& r11,
                  const double& r12,
                  const double& r13,
                  const double& r21,
                  const double& r22,
...
// m/s
Matrix3
    operator/ (const Matrix3& m, const double& s)
{
    return Matrix3 (m.e11 / s, m.e12 / s, m.e13 / s, m.e21 / s, m.e22 / s, m.e23 / s, m.e31 / s, m.e32 / s, m.e33 / s);
}
...
// s*m
Matrix3
    operator* (const double& s, const Matrix3& m)
{
    return Matrix3 (m.e11 * s, m.e12 * s, m.e13 * s, m.e21 * s, m.e22 * s, m.e23 * s, m.e31 * s, m.e32 * s, m.e33 * s);
}
...
// m*u
Vector3<double>
    operator* (const Matrix3& m, const Vector3<double>& u)
{
...
// u*m
Vector3<double>
    operator* (const Vector3<double>& u, const Matrix3& m)
{
...
bool
    operator== (const Matrix3& m1, const Matrix3& m2)
{
    if (m1.e11 == m2.e11 && m1.e12 == m2.e12 && m1.e13 == m2.e13 && m1.e21 == m2.e21 && m1.e22 == m2.e22
        && m1.e23 == m2.e23 && m1.e31 == m2.e31 && m1.e32 == m2.e32 && m1.e33 == m2.e33)
        {
            return true;
        }
    return false;
