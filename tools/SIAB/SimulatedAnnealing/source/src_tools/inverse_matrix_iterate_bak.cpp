    ...
    if (this->matrix_info.symmetry)
        {
            this->error_matrix
                = this->identity
                  - multiply_special (this->matrix_info.symmetry, 'L', this->matrix_info.uplo, *(this->A_ptr), old_X);
        }
    else
        {
