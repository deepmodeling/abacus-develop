...
void
    Simulated_Annealing::cal_all_temperature ()
{
...
void
    Simulated_Annealing::cal_each_step (size_t itemperature, size_t istep)
{
...
void
    Simulated_Annealing::judge_accept_reject (double& new_function,
                                              size_t itemperature,
                                              size_t istep,
                                              bool& accept_flag,
                                              bool& reject_flag)
{
    if (must_accept_before (new_function, itemperature, istep))
        {
            accept_flag = true;
        }
    else if (must_reject_before (new_function, itemperature, istep))
        {
            reject_flag = true;
        }
    if (accept_flag || reject_flag)
    ...
    else
        {
            ...
            if (must_accept_after (new_function, itemperature, istep))
                {
                    accept_flag = true;
                }
            else if (must_reject_after (new_function, itemperature, istep))
                {
                    reject_flag = true;
                }
        }
...
void
    Simulated_Annealing::process_accept_reject (double& new_function,
                                                size_t itemperature,
                                                size_t istep,
                                                bool& accept_flag,
                                                bool& reject_flag)
...
void
    Simulated_Annealing::accept_process (double new_function, size_t itemperature, size_t istep)
{
