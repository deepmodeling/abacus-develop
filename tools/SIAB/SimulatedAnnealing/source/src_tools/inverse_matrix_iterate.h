...
class Inverse_Matrix_Iterate
{
  ...
  public:
    ...
    Inverse_Matrix_Iterate&
        set_tolerate_error (double tolerate_error_in)
    {
        this->tolerate_error2 = tolerate_error_in * tolerate_error_in;
        return *this;
    }
    Inverse_Matrix_Iterate&
        set_fluctrate_error (double fluctrate_error_in)
    {
        this->fluctrate_error2 = fluctrate_error_in * fluctrate_error_in;
        return *this;
    }
    Inverse_Matrix_Iterate&
        set_symmetric_info (char symmetry_in, char uplo_in)
    {
