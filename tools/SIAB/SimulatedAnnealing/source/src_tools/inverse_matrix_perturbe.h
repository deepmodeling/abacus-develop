...
class Inverse_Matrix_Perturbe
{
  ...
  public:
    ...
    Inverse_Matrix_Perturbe&
        set_A_inverse (ComplexMatrix* A_inverse_in)
    {
    ...
    const int&
        get_plus_minus_state ()
    {
        return plus_minus_state;
    }
    Inverse_Matrix_Perturbe&
        set_plus_minus_state (int plus_minus_state_in)
    {
