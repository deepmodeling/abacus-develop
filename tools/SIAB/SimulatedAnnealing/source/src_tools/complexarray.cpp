...
void
    ComplexArray::create (const int d1, const int d2, const int d3, const int d4)
{
    size = d1 * d2 * d3 * d4;
    assert (size > 0);
...
void
    ComplexArray::create (const int d1, const int d2, const int d3)
{
    size = d1 * d2 * d3;
    assert (size > 0);
...
const ComplexArray&
    ComplexArray::operator= (const ComplexArray& right)
{
...
const ComplexArray&
    ComplexArray::operator= (const std::complex<double>& right)
{
    for (int i = 0; i < size; i++)
        {
            ptr[i] = right;
...
const std::complex<double>&
    ComplexArray::operator() (const int ind1, const int ind2, const int ind3) const
{
...
//********************************************************
const std::complex<double>&
    ComplexArray::operator() (const int ind1, const int ind2, const int ind3, const int ind4) const
{
...
//********************************************************
complex<double>&
    ComplexArray::operator() (const int ind1, const int ind2, const int ind3)
{
    const int ind = (ind1 * bound2 + ind2) * bound3 + ind3;
...
//********************************************************
complex<double>&
    ComplexArray::operator() (const int ind1, const int ind2, const int ind3, const int ind4)
{
    const int ind = ((ind1 * bound2 + ind2) * bound3 + ind3) * bound4 + ind4;
    return ptr[ind]; // reference return
}
