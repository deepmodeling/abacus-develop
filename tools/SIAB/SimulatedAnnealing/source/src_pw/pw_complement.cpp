...
int
    PW_complement::get_total_pw_number (const double& ggcut_start,
...
void
    PW_complement::get_total_pw (double* gg,
                                 Vector3<double>* ig,
...
void
    PW_complement::get_FFT_dimension (const Matrix3& latvec, const double& ggcut, int& nx_tmp, int& ny_tmp, int& nz_tmp)
{
...
//==========================================================
void
    PW_complement::setup_GVectors (const Matrix3& G,
                                   const int& ngmc_g_in,
                                   double* gg,
                                   Vector3<double>* ig,
                                   Vector3<double>* g)
{
    ...
    for (int i = 0; i < ngmc_g_in; i++)
        {
            igsort[i] = ig[ind[i]];
            //		cout << i << " " << ind[i] << " " << ig[ind[i]].x << " " << ig[ind[i]].y << " " << ig[ind[i]].z <<
            // endl;
        }
