    ...
    main (int argc, char** argv)
{
    ...
    input.Coef.init (NTYPE, LMAXUSED, NMAXUSED, ECUT, ECUT_JLQ, RCUT, TOLERENCE);
    ...
    mz.metro.Psi2.init (input.ifs, NE, LMAXUSED, RCUT, NCHIUSED, TOLERENCE);
    ...
    // (4) output time.
    timer::finish ();
    time_t time_finish = time (nullptr);
