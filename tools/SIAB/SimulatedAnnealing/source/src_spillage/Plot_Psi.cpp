        ...
        for (int L = 0; L < mz.lmax_type[it] + 1; L++) {
            ...
            for (int N = 0; N < mz.l_nchi(it, L); N++) {
                ...
                mz.metro.Psi2.ofsk << "\n"
                                   << "Type=" << it + 1 << " L=" << L << " N=" << N + 1;
                mz.metro.Psi2.ofsk << "\n"
                                   << setw(5) << "nq" << setw(20) << "Coefficient" << setw(20) << "Eigen(Ry)"
                ...
                for (int ie = 0; ie < ne; ie++) {
                    ...
                    mz.metro.Psi2.ofsk << "\n"
                                       ...
                                       << setw(20) << c4[ie] << setw(20) << eigen1[ie] * eigen1[ie] << setw(20) << kin
                                       << " (Rydberg)" << setprecision(6);
...
void Plot_Psi::get_psi(const int& mesh,
                       const double* r,
                       const int& l,
                       double* psi,
                       double* c4,
...
// Peize Lin add 2015-11-20
void Plot_Psi::orthogonalization(const int& mesh, double* r, const matrix& psi) {
