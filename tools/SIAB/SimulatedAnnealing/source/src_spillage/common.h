...
bool SCAN_BEGIN (ifstream& ifs, const string& TargetName, const bool restart = true, const bool quit = true);
...
template <class T>
void
    OUT (ofstream& ofs, const string& name, const T& a)
{
    stringstream name2;
    name2 << "[" << name << "]";
...
template <class T>
void
    OUT (ofstream& ofs, const string& name, const T& x, const T& y, const T& z)
{
    stringstream name2;
    name2 << "[" << name << "]";
