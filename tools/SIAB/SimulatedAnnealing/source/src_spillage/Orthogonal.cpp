...
void
    Orthogonal::start (SpillageStep& step1, SpillageStep& step2)
{
    if (test == 1)
        {
    ...
    for (int istr = 0; istr < STRNUM; istr++)
        {
            ...
            if (test == 1)
                {
                    cout << "\n"
                         << setw (10) << "nks" << setw (10) << "nbands" << setw (10) << "ne" << setw (10) << "nwfc_all"
                         << setw (10) << "nwfc2";
                                            ...
                                            if (USEPW)
                                                {
                                                    ...
                                                    //		{
                                                    //			cout << "\n iw=" << iw << " ie=" << ie << " mu=" << mu
                                                    //<< " first_part=" << first_part; 			BLOCK_HERE("haha");
                                                    //		}
                                                }
                                            else
                                                {
                                                    for (int iemu = 0; iemu < ne; iemu++)
                                                        {
                                                            first_part
                                                                += input.Coef.C4 (Tmu, Lmu, Nmu, iemu)
