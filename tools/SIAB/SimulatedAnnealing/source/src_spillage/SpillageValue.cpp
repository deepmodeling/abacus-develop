...
void
    SpillageValue::allocate (const int& dim_in)
{
    this->dim = dim_in;
    assert (dim < 100);
    assert (dim > 0);
...
double
    SpillageValue::cal_defined_value (bool get_new_flag)
{
...
void
    SpillageValue::save_level (const int& ilevel)
{
