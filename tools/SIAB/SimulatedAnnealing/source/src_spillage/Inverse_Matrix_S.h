...
class Inverse_Matrix_S
{
  public:
    ...
    const ComplexMatrix&
        get_inverse ()
    {
        return (0 == loop_count) ? inverse.A : inverse_iterate.get_inverse ();
    }
    inline void update ();
    void
        reset_loop ()
  ...
  public:
    ...
    Inverse_Matrix_S&
        set_exact_loop_num (size_t exact_loop_num_in)
    {
        this->exact_loop_num = exact_loop_num_in;
        return *this;
    }
    size_t
        get_dim ()
