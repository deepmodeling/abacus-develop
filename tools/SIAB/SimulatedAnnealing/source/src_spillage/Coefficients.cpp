...
void
    Coefficients::init (const int& ntype_in,
                        const int& lmax_in,
                        const int& nmax_in,
...
void
    Coefficients::allocate_C4 ()
{
    if (test == 1)
        {
            TITLE ("Coefficients", "allocate_C4");
        }
            ...
            if (MY_RANK == 0)
                {
                    ...
                    if (!ifs)
                        {
                            WARNING_QUIT ("Coefficients::allocate_C4()",
                                          "can't find the restart file: ORBITAL_RESULTS.txt");
                        }
                    else
                        {
                                                            ...
                                                            for (int ie = 0; ie < ne_in; ie++)
                                                                {
                                                                    ...
                                                                    cout << setiosflags (ios::fixed)
                                                                         << setprecision (20)
                                                                         << setiosflags (ios::showpoint) << setw (25)
                                                                         << C4_old (it, il, in, ie);
                                                                }
                                                            ++count_nchi;
                                                            // if count_nchi == nchi_in, all needed C4 have been read
                                                            // in!
                                                            if (count_nchi == nchi_in)
                                                                {
                                                                    return;
                                                                }
                                                        }
...
void
    Coefficients::trial_c4 (const int& t, const int& l, const int& n, const int& ie)
{
    // (1)
...
void
    Coefficients::update_c4 (const int& t, const int& l, const int& n, const int& ie)
{
    //===============================================
...
void
    Coefficients::go_back_c4 (const int& t, const int& l, const int& n, const int& ie)
{
    //==================================
