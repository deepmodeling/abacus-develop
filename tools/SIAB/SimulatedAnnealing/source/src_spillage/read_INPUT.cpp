            ...
            if (ifs)
                {
                    ...
                    if (SCAN_BEGIN (ifs, "<BANDS>", true, false))
                        {
                    ...
                    if (SCAN_BEGIN (ifs, "<BLOCK_NE>", true, false))
                        {
                    ...
                    if (SCAN_BEGIN (ifs, "<BLOCK_NE_ENERGY>", true, false))
                        {
                            ...
                            ofs_running << "\n New BLOCK_NE = " << BLOCK_NE << " energy_cut = " << block_ne_energy
                    ...
                    // 3: add kapa value.
                    if (SCAN_BEGIN (ifs, "<SCHEME_VALUE>", true, false))
                        {
                    ...
                    if (SCAN_BEGIN (ifs, "<PARALLEL>", true, false))
                        {
                ...
                {
                    if (SCAN_BEGIN (ifs2, "<FILE>", true, false))
                        {
                            READ_VALUE (ifs2, WFC_FILE);
                        }

                    if (SCAN_BEGIN (ifs2, "<SPHERICAL_BESSEL>", true, false))
                        {
                    ...
                    if (SCAN_BEGIN (ifs2, "<PARALLEL>", true, false))
                        {
