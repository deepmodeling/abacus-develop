...
//====================================================================
void
    Calculate_C4::Find_Eigenvalues (const int& Enumber,
                                    matrix& en,
                                    const int& lmax,
                                    const double& rcut,
...
//===================================================================
void
    Calculate_C4::Test_Orthogonal (const double& rcut,
                                   const double& dr,
                                   const int& L,
                                   const matrix& en,
                                   const int& Enumber,
...
//===================================================================
void
    Calculate_C4::key_solver (const string& name, const int& L, const matrix& en, const int& Enumber, double* C4)
{
...
void
    Calculate_C4::norm_ic (realArray& C4,
                    ...
                    for (int n = 0; n < nmax; n++)
                        {
                            ...
                            if (test == 2)
                                {
                                    cout << "it=" << it << " L=" << l << " N=" << n << " norm = " << norm << endl;
                                }
                            norm = sqrt (norm);
                            assert (norm > 1.0e-5);
                            for (int ie = 0; ie < enumber; ie++)
...
void
    Calculate_C4::plot (ifstream& ifs)
{
...
void
    Calculate_C4::Test (ifstream& ifs, const double& ecut, const double& tolerence)
{
...
void
    Calculate_C4::init (ifstream& ifs, const double& ecut, const double& rcut, const double& tolerence, const int& lmax)
{
