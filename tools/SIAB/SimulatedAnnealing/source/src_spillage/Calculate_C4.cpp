...
//====================================================================
void Calculate_C4::Find_Eigenvalues(const int& Enumber,
                                    matrix& en,
                                    const int& lmax,
                                    const double& rcut,
...
// P.S: (4)
//===================================================================
void Calculate_C4::Test_Orthogonal(const double& rcut,
                                   const double& dr,
                                   const int& L,
                                   const matrix& en,
                                   const int& Enumber,
...
void Calculate_C4::norm_ic(realArray& C4,
...
void Calculate_C4::init(ifstream& ifs,
                        const double& ecut,
                        const double& rcut,
                        const double& tolerence,
                        const int& lmax) {
