...
void Parallel_Kpoints::init(void) {
    ...
    for (int i = 0; i < NPROC; i++) {
        if (MY_RANK == i) {
            cout << " I'm" << setw(8) << MY_RANK << setw(8) << MY_POOL << setw(13) << RANK_IN_POOL << setw(6) << NPROC
                 << setw(6) << KPAR << setw(14) << NPROC_IN_POOL << endl;

            ofs_running << " I'm" << setw(8) << MY_RANK << setw(8) << MY_POOL << setw(13) << RANK_IN_POOL << setw(6)
                        << NPROC << setw(6) << KPAR << setw(14) << NPROC_IN_POOL << endl;
        }
