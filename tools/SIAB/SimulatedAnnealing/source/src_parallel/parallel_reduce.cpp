...
void
    Parallel_Reduce::reduce_int_all (int& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_int_pool (int& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_all (double& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_all (double* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_pool (double& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_pool (double* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_double_allpool (double& object)
{
    if (KPAR == 1)
        {
            return;
...
void
    Parallel_Reduce::reduce_complex_double_all (complex<double>& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_complex_double_pool (complex<double>& object)
{
#ifdef __MPI
...
void
    Parallel_Reduce::reduce_complex_double_pool (complex<double>* object, const int n)
{
#ifdef __MPI
...
void
    Parallel_Reduce::gather_min_int_all (int& v)
{
#ifdef __MPI
...
void
    Parallel_Reduce::gather_max_double_all (double& v)
{
#ifdef __MPI
...
void
    Parallel_Reduce::gather_max_double_pool (double& v)
{
#ifdef __MPI
    if (NPROC_IN_POOL == 1)
        return;
...
void
    Parallel_Reduce::gather_min_double_pool (double& v)
{
#ifdef __MPI
    if (NPROC_IN_POOL == 1)
        return;
...
void
    Parallel_Reduce::gather_min_double_all (double& v)
{
#ifdef __MPI
    double* value = new double[NPROC];
    ZEROS (value, NPROC);
...
bool
    Parallel_Reduce::check_if_equal (double& v)
{
#ifdef __MPI
