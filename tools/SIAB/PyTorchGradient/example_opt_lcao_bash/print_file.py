...
def print_file_opt(info, dis):
    ...
    with open("input.json", "w") as file:
        input = {
            "file_list": [
                f'../{info["input"]["element"]}-{info["input"]["rcut"]}-{distance}/test.{utils.lat0}.dat'
            ...
            "info": {
                ...
                "Nb_true": (
                    info["input"]["ref_bands"]
                    if isinstance(info["input"]["ref_bands"], list)
                    else [info["input"]["ref_bands"]]
            ...
            "V_info": {"same_band": True, "init_from_file": False},
        }
