...
class PyChargeAccessor
{
  public:
    ...
    bool
        is_valid () const
    {
        return (chr_ptr_ != nullptr || rho_ptr_ != nullptr) && nspin_ > 0;
    }
...
class PyEnergyAccessor
{
  public:
    ...
    double
        get_hartree_energy () const
    {
        return hartree_energy_;
    }
...
class PyHamiltonianAccessor
{
  public:
    ...
    bool
        is_valid () const
    {
        return (hamilt_ptr_ != nullptr || nbasis_ > 0) && nks_ > 0;
    }
...
class PyESolverLCAO
{
  public:
    ...
    pyabacus::esolver::ISCFController*
        get_scf_controller ()
    {
    ...
    pyabacus::esolver::IHamiltonianBuilder<TK, TR>*
        get_hamiltonian_builder ()
    {
        if (scf_controller_)
            {
    ...
    pyabacus::esolver::IDiagonalizer<TK>*
        get_diagonalizer ()
    {
        if (scf_controller_)
            {
    ...
    void
        set_convergence_criteria (double drho_threshold, double energy_threshold, int max_iter)
    {
    ...
    /// Set mixing method
    void
        set_mixing_method (const std::string& method)
    {
        if (auto* mixer = get_charge_mixer ())
            {
