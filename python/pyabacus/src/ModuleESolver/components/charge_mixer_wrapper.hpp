...
class ChargeMixerWrapper : public IChargeMixer
{
  public:
    ...
    py::array_t<double>
        mix (const py::array_t<double>& rho_in, const py::array_t<double>& rho_out) override
    {
    ...
    void
        set_config (const MixingConfig& config) override
    {
        config_ = config;
    ...
    void
        set_mixing_beta (double beta) override
    {
    ...
    double
        get_mixing_beta () const override
    {
        return config_.beta;
    }

    void
        set_mixing_method (MixingMethod method) override
    {
    ...
    MixingMethod
        get_mixing_method () const override
    {
    ...
    void
        set_dimensions (int nspin, int nrxx)
    {
        nspin_ = nspin;
        nrxx_ = nrxx;
        reset ();
  ...
  private:
    ...
    void
        mix_plain (const double* rho_in, const double* rho_out, double* rho_mixed)
    {
    ...
    // Pulay mixing (DIIS)
    void
        mix_pulay (const double* rho_in, const double* rho_out, double* rho_mixed)
    {
    ...
    void
        mix_broyden (const double* rho_in, const double* rho_out, double* rho_mixed)
    {
    ...
    // Anderson mixing
    void
        mix_anderson (const double* rho_in, const double* rho_out, double* rho_mixed)
    {
    ...
    std::vector<double>
        solve_linear_system (std::vector<double>& A, std::vector<double>& b, int n)
    {
