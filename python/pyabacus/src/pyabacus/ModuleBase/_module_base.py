...
from ._base_pack import (
    Sphbes as _Sphbes,
    Integral as _Integral,
    SphericalBesselTransformer as _SphericalBesselTransformer,
)
...
class Sphbes(_Sphbes):
    ...
    @staticmethod
    def sphbesj(
        n: int, r: NDArray[np.float64], q: int, l: int, jl: NDArray[np.float64]
    ) -> None: ...
    ...
    @staticmethod
    def dsphbesj(
        n: int, r: NDArray[np.float64], q: int, l: int, djl: NDArray[np.float64]
    ) -> None: ...
...
class Integral(_Integral):
    ...
    def Simpson_Integral(
        mesh: int, func: NDArray[np.float64], rab: NDArray[np.float64], asum: float
    ) -> float: ...
    @overload
    @staticmethod
    def Simpson_Integral(
        mesh: int, func: NDArray[np.float64], dr: float, asum: float
    ) -> float: ...
    ...
    @overload
    @staticmethod
    def simpson(n: int, f: NDArray[np.float64], dx: float) -> float: ...
    @overload
    @staticmethod
    def simpson(
        n: int,
