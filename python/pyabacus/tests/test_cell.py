...
class TestCell(unittest.TestCase):
    ...
    def test_from_stru_file(self):
        ...
        expected_lattice = np.array(
            [[6.1416, 0.0, 0.0], [-3.0708, 5.3186256, 0.0], [0.0, 0.0, 9.82656]]
        )
    ...
    def test_auto_parameters(self):
        ...
        cell = Cell()
        cell.add_atom("H", [0, 0, 0])
        cell.lattice = [[5.0, 0.0, 0.0], [0.0, 5.0, 0.0], [0.0, 0.0, 5.0]]
        cell.build()
    ...
    def test_stru_coordinates(self):
        ...
        expected_scaled = np.array(
            [[0.00, 0.00, 0.00], [0.33333, 0.66667, 0.50]]  # Zn  # O
        )

        np.testing.assert_array_almost_equal(
            scaled_positions, expected_scaled, decimal=4
        )
    ...
    def test_file_operations(self):
        ...
        # Compare structures
        np.testing.assert_array_almost_equal(
            original_cell.positions, new_cell.positions
        )
