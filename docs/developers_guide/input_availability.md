...
4. Serialize the AST as a transient YAML stream from the ABACUS executable.
5. Generate `docs/advanced/input_files/input-main.md` from that stream during
   the Sphinx build; neither generated artifact is stored in the repository.
