...
- **Type**: Integer
- **Description**: Determine the precision level of vc-md. Note that this parameter is only used in variable-cell MD!
  ...
  - 1: FFT grids change per MD step. This level is suitable for cases where the variation of the volume and shape is large, such as the MSST method. However, accuracy comes at the cost of efficiency.
- **Default**: 0
